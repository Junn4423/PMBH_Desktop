...
if(isset($_GET['ajaxitemsend']))
{
	...
	if($vContractID!="" && $vContractID!=NULL)
	{
		...
		if($vDetailID!='' && $vDetailID!=NULL && $_GET['public']==1)
			...
			$vsql="insert into sl_lv0014(lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv011,lv012,lv014,lv016,lv019) select '$vContractID','$vItemID',1,A.lv004,A.lv007,A.lv008,0,'$vPercent','$vPoint',concat(CurDate(),' ',CurTime()),'".$lvsl_lv0102->LV_UserID."',0 from sl_lv0007 A where lv001='$vItemID'";
