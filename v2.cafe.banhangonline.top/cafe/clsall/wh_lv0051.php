...
////////////
	...
	{
		$sqlS = "SELECT A.*,C.lv004 UnitID,C.lv005 OtherUnitID,C.lv006 Converts,C.lv007 Price,C.lv008 UnitPrice,C.lv011 Tax,C.lv013 SupID FROM mn_lv0009 A inner join sl_lv0013 B on A.lv002=B.lv001 left join sl_lv0007 C on A.lv003=C.lv001 WHERE B.lv011=1 and A.lv010=1 and ( A.lv001 not in (select BBB.lv098 from wh_lv0022 BBB)) and ( A.lv001 not in (select BBB.lv098 from wh_lv0051 BBB))";
		$vorder=$curRow;
