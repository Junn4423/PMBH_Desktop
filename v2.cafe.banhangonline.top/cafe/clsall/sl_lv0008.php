...
class sl_lv0008 extends lv_controler
{
	...
	function LV_Insert()
	{
		...
		if ($vReturn)
			$this->InsertLogOperation($this->DateCurrent, 'sl_lv0008.insert', sof_escape_string($lvsql));
		return $vReturn;
	}
	function LV_Update()
	{
		...
		$vReturn = db_query($lvsql);
		if ($vReturn)
			$this->InsertLogOperation($this->DateCurrent, 'sl_lv0008.update', sof_escape_string($lvsql));
		return $vReturn;
	}
