						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)"><option value="">...</option>
							   <?php echo $lvsl_lv0020->LV_LinkField('lv002',$vlv002);?>
                              </select>
							    <br>
							  <table><tr><td>
...
<tr>
								...
								<?php echo $lvsl_lv0020->LV_LinkField('lv003',$vlv003);?>
...
<tr>
								...
								<option value="">...</option>
							  <?php echo $lvsl_lv0020->LV_LinkField('lv007',$vlv007);?>
							  </select>	<br><table><tr><td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $lvsl_lv0020->LV_LinkField('lv008',$vlv008);?>
							  </select><br><table><tr><td>
							  <ul id="pop-nav2" lang="pop-nav2" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
