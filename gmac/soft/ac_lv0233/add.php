...
$lvac_lv0233->lv001=$_POST['txtlv001'];
$lvac_lv0233->lv002=$_GET['ID'];
					...
					<form action="#"  name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv003" type="text"  id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvac_lv0233->lv003;?>"/>			</td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[18];?></td>
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvac_lv0233->lv004;?>"/></td>
</tr>							  
							<tr>
