				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  <td  height="20"><?php echo $vLangArr[31];?>(yyyy-mm-dd)</td>
							  <td  height="20"><input name="txtlv017" type="text" id="txtlv017" value="<?php echo $vlv017;?>" tabindex="21" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
				  ...
				  <td  height="20"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="8" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							...
							<tr>
							  <td  height="20"><?php echo $vLangArr[19];?>(yyyy-mm-dd)</td>
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvsl_lv0001->FormatView($vlv005,2);?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
						    </tr>
								<tr>
						  ...
						  <tr>
								...
								<td  height="20"><table width="80%"><tr><td width="50%">
									<select name="txtlv022" id="txtlv022"   tabindex="24"  style="width:100%" onKeyPress="return CheckKey(event,7)"/>
										<?php echo $lvsl_lv0001->LV_LinkField('lv022',$vlv022);?>
									</select></td>
									<td width="50%">
