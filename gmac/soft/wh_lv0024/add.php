...
$lvwh_lv0024->lv001=InsertWithCheckExt('wh_lv0024', 'lv001', '',0);
if($_GET['ID']=="")
$lvwh_lv0024->lv002=$_POST['txtlv002'];
else
$lvwh_lv0024->lv002=$_GET['ID'];
$lvwh_lv0024->lv003=$_POST['txtlv003'];
$lvwh_lv0024->lv004=$_POST['txtlv004'];
$lvwh_lv0024->lv005=GetServerDate()." ".GetServerTime();
$lvwh_lv0024->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvwh_lv0024->LV_Insert();
		if($vresult==true) {
