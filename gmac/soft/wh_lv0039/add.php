...
$data = array();
  ...
  function add_person( $lv003, $lv004, $lv005,$lv006,$lv007,$lv008,$lv009,$lv014,$lv015,$lv017,$lv018,$lv019,$lv020)
  {
  global $data;
	 ...
	 if ( $_FILES['file']['tmp_name'] )
	  ...
	  foreach ($rows as $row)
	  {
		  if ( !$first_row )
		  {
			  ...
			  if ( $index == 10 ) $lv017 = $cell->nodeValue;
			  if ( $index == 11 ) $lv018 = $cell->nodeValue;
			  if ( $index == 12 ) $lv019 = $cell->nodeValue;
			  if ( $index == 13 ) $lv020 = $cell->nodeValue;
			  
			  $index += 1;
		  }
	  	add_person( $lv003, $lv004, $lv005,$lv006,$lv007,$lv008,$lv009,$lv014,$lv015,$lv017,$lv018,$lv019,$lv020);
	  }
	  $first_row = false;
	  }
  }
foreach( $data as $row )
{
	...
	{
	$lvwh_lv0039->lv001=InsertWithCheckExt('wh_lv0039', 'lv001', '',1);
	$lvwh_lv0039->lv002=getInfor($_SESSION['ERPSOFV2RUserID'],2);
	$lvwh_lv0039->lv003=$lvsl_lv0007->lv001;
	$lvwh_lv0039->lv004=$row['lv004'];
	$lvwh_lv0039->lv005=$row['lv005'];
	$lvwh_lv0039->lv006=$row['lv006'];
	$lvwh_lv0039->lv007=$row['lv007'];
	$lvwh_lv0039->lv008=$row['lv008'];
	$lvwh_lv0039->lv009=$row['lv009'];
	$lvwh_lv0039->lv014=$row['lv014'];
	$lvwh_lv0039->lv015=$row['lv015'];
	$lvwh_lv0039->lv016=$lvNow;
	$lvwh_lv0039->lv017=$row['lv017'];
	$lvwh_lv0039->lv018=$row['lv018'];
	$lvwh_lv0039->lv019=$row['lv019'];
	$lvwh_lv0039->lv020=$row['lv020'];
	
	$vresult=$lvwh_lv0039->LV_Insert();
	}
}
		if($vresult==true) {
