...
$mowh_lv0021->ArrFunc[5]=GetLangExcept('Rpt',$plang);
$mowh_lv0021->ArrFunc[6]=GetLangExcept('Apr',$plang);
$mowh_lv0021->ArrFunc[7]=GetLangExcept('UnApr',$plang);
$mowh_lv0021->ArrFunc[8]=$vLangArr[10];
$mowh_lv0021->ArrFunc[9]=$vLangArr[12];
$mowh_lv0021->ArrFunc[10]=$vLangArr[0];
$mowh_lv0021->ArrFunc[11]=$vLangArr[35];
$mowh_lv0021->ArrFunc[12]=$vLangArr[36];
$mowh_lv0021->ArrFunc[13]=$vLangArr[37];
$mowh_lv0021->ArrFunc[14]=$vLangArr[38];
$mowh_lv0021->ArrFunc[15]=$vLangArr[39];

////Other
$mowh_lv0021->ArrOther[1]=$vLangArr[33];
$mowh_lv0021->ArrOther[2]=$vLangArr[34];
//////Delete message///
$lvMessage=array();
...
if($flagID==1)
{
	...
	$strar="'".$strar."'";
	$vresult=$mowh_lv0021->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"wh_lv0021",$lvMessage);
}
elseif($flagID==2)
{
$mowh_lv0021->lv001=$_POST['txtlv001'];
if($_GET['ID']=="")
$lvwh_lv0021->lv002=$_POST['txtlv002'];
else
$lvwh_lv0021->lv002=$_GET['ID'];
$mowh_lv0021->lv003=$_POST['txtlv003'];
$mowh_lv0021->lv004=$_POST['txtlv004'];
$mowh_lv0021->lv005=$_POST['txtlv005'];
$mowh_lv0021->lv006=$_POST['txtlv006'];
$mowh_lv0021->lv007=$_POST['txtlv007'];
$mowh_lv0021->lv008=$_POST['txtlv008'];
$mowh_lv0021->lv009=$_POST['txtlv009'];
$mowh_lv0021->lv010=$_POST['txtlv010'];
$mowh_lv0021->lv011=$_POST['txtlv011'];
$mowh_lv0021->lv012=$_POST['txtlv012'];
$mowh_lv0021->lv013=$_POST['txtlv013'];
$mowh_lv0021->lv014=$_POST['txtlv014'];
}
elseif($flagID==3)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$mowh_lv0021->LV_Aproval($strar);
}
elseif($flagID==4)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$mowh_lv0021->LV_UnAproval($strar);
}
//first is load
if($_POST["txtFlag"]=="")
{
...
$mowh_lv0021->SaveOperation($_SESSION['ERPSOFV2RUserID'],'wh_lv0021',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);

}
if($_GET['ID']=="")
$mowh_lv0021->lv002=$_POST['txtlv002'];
else
$mowh_lv0021->lv002=$_GET['ID'];
...
{
	var str="<br><iframe id='lvframefrm' height=1200 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>wh_lv0021?func=<?php echo $_GET['func'];?>&childfunc="+func+"&ID=<?php echo $_GET['ID'];?>&ChildID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mowh_lv0021->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mowh_lv0021->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $mowh_lv0021->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $mowh_lv0021->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $mowh_lv0021->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $mowh_lv0021->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $mowh_lv0021->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $mowh_lv0021->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $mowh_lv0021->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $mowh_lv0021->lv009;?>"/>
						<input type="hidden" name="txtlv010" id="txtlv010" value="<?php echo $mowh_lv0021->lv010;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $mowh_lv0021->lv011;?>"/>
...
div.innerHTML='<?php echo $mowh_lv0021->ArrPush[0];?>';	
</script>
</html>