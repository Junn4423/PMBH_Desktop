					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20">
							  <table width="80%" border=0><tr><td width="50%"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $vlv002;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" readonly="true"/>
							    	</td><td>
...
<tr>
								...
								<td  height="20"><table width="80%" border=0><tr><td width="50%"><select name="txtlv007" id="txtlv007"   tabindex="11"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  	<option value="">...</option>
								<?php echo $lvwh_lv0021->LV_LinkField('lv007',$vlv007);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20">
							  <table width="80%" border=0><tr><td width="50%"><select name="txtlv008" id="txtlv008"   tabindex="12"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
								  <option value="">...</option>
								<?php echo $lvwh_lv0021->LV_LinkField('lv008',$vlv008);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20"><textarea name="txtlv009" rows="20" id="txtlv009" style="width:80%" tabindex="13" ><?php echo $vlv009;?></textarea></td>
							</tr>
                          <tr>
							  <td  height="20"><?php echo $vLangArr[24];?></td>
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $vlv010;?>" tabindex="14" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
						  </tr>	
						  <tr>
