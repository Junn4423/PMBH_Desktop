...
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","MN0010.txt",$plang);
...
$momn_lv0010->ArrPush[9]=$vLangArr[26];
$momn_lv0010->ArrPush[10]=$vLangArr[27];
$momn_lv0010->ArrPush[11]=$vLangArr[28];
$momn_lv0010->ArrPush[12]=$vLangArr[36];
$momn_lv0010->ArrPush[13]=$vLangArr[37];
...
$momn_lv0010->ArrFunc[6]='';
$momn_lv0010->ArrFunc[7]='';
$momn_lv0010->ArrFunc[8]=$vLangArr[10];
$momn_lv0010->ArrFunc[9]=$vLangArr[12];
$momn_lv0010->ArrFunc[10]=$vLangArr[0];
$momn_lv0010->ArrFunc[11]=$vLangArr[33];
$momn_lv0010->ArrFunc[12]=$vLangArr[34];
$momn_lv0010->ArrFunc[13]=$vLangArr[35];
$momn_lv0010->ArrFunc[14]=$vLangArr[36];
$momn_lv0010->ArrFunc[15]=$vLangArr[37];

////Other
$momn_lv0010->ArrOther[1]=$vLangArr[31];
$momn_lv0010->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$momn_lv0010->lv002=base64_decode($_GET['ID']);
...
?>
						...
						<?php echo $momn_lv0010->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
