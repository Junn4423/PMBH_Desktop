...
$mosl_lv0057->ArrPush[18]=$vLangArr[35];
$mosl_lv0057->ArrPush[19]=$vLangArr[36];
$mosl_lv0057->ArrPush[20]=$vLangArr[37];
$mosl_lv0057->ArrPush[21]=$vLangArr[38];
$mosl_lv0057->ArrPush[22]=$vLangArr[39];
$mosl_lv0057->ArrPush[23]=$vLangArr[40];
$mosl_lv0057->ArrPush[24]=$vLangArr[41];
$mosl_lv0057->ArrPush[25]=$vLangArr[42];
$mosl_lv0057->ArrPush[26]=$vLangArr[43];
$mosl_lv0057->ArrPush[27]=$vLangArr[44];
$mosl_lv0057->ArrPush[28]=$vLangArr[45];
$mosl_lv0057->ArrPush[29]=$vLangArr[46];
$mosl_lv0057->ArrPush[30]=$vLangArr[47];
$mosl_lv0057->ArrPush[31]=$vLangArr[48];
$mosl_lv0057->ArrPush[32]=$vLangArr[49];
$mosl_lv0057->ArrPush[33]=$vLangArr[50];
$mosl_lv0057->ArrPush[34]=$vLangArr[51];
$mosl_lv0057->ArrPush[35]=$vLangArr[52];
$mosl_lv0057->ArrPush[36]=$vLangArr[53];
$mosl_lv0057->ArrPush[37]=$vLangArr[54];
$mosl_lv0057->ArrPush[38]=$vLangArr[55];
$mosl_lv0057->ArrPush[39]=$vLangArr[56];
$mosl_lv0057->ArrPush[40]=$vLangArr[57];
$mosl_lv0057->ArrPush[41]=$vLangArr[58];
$mosl_lv0057->ArrPush[42]=$vLangArr[59];
$mosl_lv0057->ArrPush[43]=$vLangArr[60];
...
$mosl_lv0057->ArrFunc[5]='';
$mosl_lv0057->ArrFunc[6]='';
$mosl_lv0057->ArrFunc[7]='';
$mosl_lv0057->ArrFunc[8]=$vLangArr[10];
$mosl_lv0057->ArrFunc[9]=$vLangArr[12];
$mosl_lv0057->ArrFunc[10]=$vLangArr[0];
$mosl_lv0057->ArrFunc[11]=$vLangArr[63];
$mosl_lv0057->ArrFunc[12]=$vLangArr[64];
$mosl_lv0057->ArrFunc[13]=$vLangArr[65];
$mosl_lv0057->ArrFunc[14]=$vLangArr[66];

////Other
$mosl_lv0057->ArrOther[1]=$vLangArr[61];
$mosl_lv0057->ArrOther[2]=$vLangArr[62];
//////Delete message///
$lvMessage=array();
...
?>
						...
						<?php echo $mosl_lv0057->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
