						...
						<TR vAlign="center" align="middle">				
							<td><form name="frmhr_employee" action="#" method="post">
									<select name="cbxoption" tabindex="1" onChange="callchange(this)">
										<option value="4" <?php echo ($molv_menusl0017->level3lst==4)?'selected="selected"':'';?> >4.<?php echo $vLangArr[10];?></option>
										<option value="1" <?php echo ($molv_menusl0017->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[7];?></option>
										
										<option value="2" <?php echo ((int)$molv_menusl0017->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[8];?></option>
										<option value="3" <?php echo ((int)$molv_menusl0017->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[9];?></option>
										<option value="10" <?php echo ($molv_menusl0017->level3lst==10)?'selected="selected"':'';?> >10.<?php echo 'ĐVị-QĐổi';?></option>
									</select>
							...
							<TD><a class="toolbar" href="javascript:rundisplayLayer(4);">
								<img src="../images/icon/bom.png" title="<?php echo $vLangArr[100];?>" 
							...
							<TD><a class="toolbar" href="javascript:rundisplayLayer(1);">
								<img src="../images/icon/bom.png" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[7];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<!--<TD><a class="toolbar" href="javascript:rundisplayLayer(2);">
								<img src="../images/icon/style.png" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[8];?></a></TD>
							<TD>&nbsp;</TD>							
							<TD>&nbsp;</TD>		
							<TD><a class="toolbar" href="javascript:rundisplayLayer(3);">
								<img src="../images/icon/color.png" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[9];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>	-->		
							<TD><a class="toolbar" href="javascript:rundisplayLayer(10);">
								<img src="../images/icon/bom.png" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo 'ĐVị-QĐổi';?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>				
