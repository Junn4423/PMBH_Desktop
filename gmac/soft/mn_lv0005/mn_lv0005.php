...
$momn_lv0005->ArrFunc[5]=GetLangExcept('Rpt',$plang);
...
function Report(vValue)
{
	...
	o.slin.value=document.frmchoose.slin.value;
	o.isqrcode.value=document.frmchoose.isqrcode.value;
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0005?childfunc=rpt&ID="+vValue+"&slin="+o.slin.value+"&isqrcode="+o.isqrcode.value;
	o.method="post" ;
	o.submit();
}	
function Save()
...
<body  onkeyup="KeyPublicRun(event)">
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&ChildID=<?php echo $_GET['ChildID'];?>&ID=<?php echo $_GET['ID']?>&<?php  echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,4,0);?>" method="post" name="frmchoose" id="frmchoose">
					  ...
					  <table>
							<tr>
								<td width="100">Số lượng in:</td>
								<td width="100"><input style="height:25px" type="textbox" name="slin" value="1"/></td>
								<td  width="50">QRCODE</td>
								<td>
								<select name="isqrcode" id="isqrcode" >
				  ...
				  <form method="get" enctype="multipart/form-data" name="frmprocess" > 
						...
						<input type="hidden" type="textbox" name="slin" value="1"/>
						<input type="hidden" type="textbox" name="isqrcode" value="1"/>
				  </form>
