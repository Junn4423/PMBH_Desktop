...
$lvsl_lv0015->lv001=InsertWithCheckExt('sl_lv0015', 'lv001', '',0);
$lvsl_lv0015->lv002=$_GET['ChildID'];
$lvsl_lv0015->lv003=$_POST['txtlv003'];
$lvsl_lv0015->lv004=$_POST['txtlv004'];
$lvsl_lv0015->lv005=GetServerDate()." ".GetServerTime();
$lvsl_lv0015->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvsl_lv0015->LV_Insert();
		if($vresult==true) {
