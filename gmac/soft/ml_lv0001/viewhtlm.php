...
if($vFlag==1)
{
		...
		if(strpos($lvml_lv0001->lv009,str_replace("\n","<br/>",$lvml_lv0007->lv004))===false)
			 $lvml_lv0001->lv009=$lvml_lv0001->lv009.str_replace("\n","<br/>",$lvml_lv0007->lv004);
					...
					<form name="frm_mail" id="frm_mail" action="#" method="post" enctype="multipart/form-data" autocomplete="off">
					  <table width="100%" border="0" align="left" id="table1">							  
					     ...
					     <tr class="lvlinehtable0">
							...
							<tr class="lvlinehtable1">
							  <td  height="20" colspan="2"><input type="hidden" name="txtmail_lv010" id="txtmail_lv010" value='<?php echo $lvml_lv0001->lv010;?>'/>
						<input type="hidden" name="txtmail_lv013" id="txtmail_lv013" value='<?php echo $lvml_lv0001->lv013;?>'/><input name="txtFlag" type="hidden" id="txtFlag" /><input name="txtFlagFw" type="hidden" id="txtFlagFw"  value="<?php echo $_POST['txtFlagFw'];?>"/></td>
						  </tr>
					<tr>
