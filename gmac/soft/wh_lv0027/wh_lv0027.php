...
////////init object////////////////////
	...
	$mowh_lv0009->objwh_lv0001=$mowh_lv0001;
...
if(isset($_GET['ajax']))
{
	...
	echo '[CHECK]';
	echo '<select name="txtlv903" id="txtlv903"   tabindex="20"  style="width:50%" onkeypress="return CheckKeys(event,1,this)" onBlur="LoadItem()"/>'.$mowh_lv0009->LV_LinkFieldExt('lv003',$vwarehouseid).'</select>	';
	echo '[ENDCHECK]';
	exit;
}	
if($plang=="") $plang="EN";
...
if($mowh_lv0009->lv007=="" || $mowh_lv0009->lv007==NULL) $mowh_lv0009->lv007="M";
if($mowh_lv0009->lv009=="" || $mowh_lv0009->lv009==NULL) $mowh_lv0009->lv009="KG";
if($flagCtrl == 1){
...
<script language="javascript" src="<?php echo $vDir;?>../javascript/engine.js"></script>
	...
	function Add()
	{
		...
		var strvalue="&txtlv003="+o.txtlv903.value+"&txtlv004="+o.txtlv904.value+"&txtlv005="+o.txtlv905.value+"&txtlv006="+o.txtlv906.value+"&txtlv007="+o.txtlv907.value+"&txtlv008="+o.txtlv908.value+"&txtlv009="+o.txtlv909.value+"&txtlv011="+o.txtlv911.value+"&txtlv013="+vlv913+"&txtlv014="+o.txtlv914.value+"&txtlv015="+o.txtlv915.value+"&txtOpt=1";
	...
	function LoadType(to)
	{
		...
		switch(vo)
		{
			...
			case 'MUAHANG':
				...
				break;
			case 'SUP':
				LoadPopupParent(to,'txtlv806','wh_lv0003','concat(lv002,@! - @!,lv001)');
				break;
			case 'CUS':
	...
	{
		var o=document.frmadd;
		ajax_do ('wh_lv0027/wh_lv0027exce.php?&lang=<?php echo $plang;?>&childfunc=load'+'&lv002='+o.txtlv903.value+'&lv003='+o.txtlv802.value,1);
	}
	...
	if(o.txtlv913.checked)		vlv013='1';
		...
		{
			case 'GMAC':
				ajax_do ('wh_lv0027/wh_lv0027excesource.php?&lang=<?php echo $plang;?>&Type=GMAC&&childfunc=load'+'&lv002='+o.txtlv802.value+'&lv005='+o.txtlv805.value+'&lv006='+o.txtlv806.value+'&lv913='+vlv013,1);
			...
			case 'TRAHANG':
				...
				break;
			case 'MUAHANG':
				ajax_do ('wh_lv0027/wh_lv0027excesource.php?&lang=<?php echo $plang;?>&Type=MUAHANG&&childfunc=load'+'&lv002='+o.txtlv802.value	+'&lv005='+o.txtlv805.value+'&lv006='+o.txtlv806.value+'&lv913='+vlv013,1);
				window.setTimeout('RunFunction()',500);
				break;
		}
...
<body  onkeyup="KeyPublicRun(event)">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
									...
									<td class="td" align="center">
										<form   name="frmadd" id="frmadd"  id="frmadd" method="POST" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0);?>" autocomplete="off">
											...
											<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
												...
												<?php }?>
												<tr>
													<td class="tdpar" height="20px" align="left" width="95"><?php echo $vLangArr[20];?></td>
													<td class="tdpar" ><select name="txtlv802" id="txtlv802"   tabindex="2"   onkeypress="return CheckKey(event,7)" onchange="changewarehourse_change(this.value)">
                                                    <?php echo $mowh_lv0008->LV_LinkField('lv002',$mowh_lv0008->lv002);?>
                                                  </select>                                   </td>
												  <td class="tdpar" height="20px" align="left" width="30"></td>	
												  <td class="tdpar" height="20px" align="left" width="95"><?php echo $vLangArr[22];?></td>
												  <td height="20px" class="tdpar"><input name="txtlv804" type="text" id="txtlv804"  value="<?php echo $mowh_lv0008->lv004;?>" maxlength="225"  onKeyPress="return CheckKey(event,7)"/></td>		
												  <td class="tdpar" ><input name="txtlv801" type="text" id="txtlv801" title="<?php echo $vLangArr[19];?>"  value="<?php echo InsertWithCheck('wh_lv0008', 'lv001', 'PN-'.getmonth($vNow)."/".getyear($vNow)."-",4);?>" maxlength="32"  onKeyPress="return CheckKey(event,7)"  readonly="true"/></td>
												 </tr>
												<tr> 
												<td class="tdpar" ><?php echo $vLangArr[27];?></td>
												<td class="tdpar">
													<input name="txtlv809" type="text" id="txtlv809" value="<?php echo $mowh_lv0008->FormatView($mowh_lv0008->lv009,2);?>" tabindex="3" maxlength="100"  onKeyPress="return CheckKey(event,7)"  /> 
                                                </td> 
												<td class="tdpar">
												    ...
												    <td class="tdpar" colspan="2"><textarea name="txtlv808" rows="1" id="txtlv808" tabindex="13" ><?php echo $mowh_lv0008->lv008;?></textarea></td>
												</tr>
												<tr height="1">
													<td  class="tdpar"  height="20px" align="left" valign="top"><?php echo $vLangArr[23];?></td>
													<td height="20px" class="tdpar" valign="top">
													  <select name="txtlv805" id="txtlv805"   tabindex="4"   onkeypress="return CheckKey(event,7)"/>
												
                                                      <?php echo $mowh_lv0008->LV_LinkField('lv005',$mowh_lv0008->lv005);?>
                                                      </select>
													</td>
													<td class="tdpar">
                                                      <input type="button" tabindex="6" name="Load2" value="۩▲Lấy DL" tabindex="20" onClick="LoadSource()" style="padding:3px;height:30px!important;width:80px;">
													</td>
												    <td height="20px" class="tdpar"><?php echo $vLangArr[24];?></td>
												    <td height="20px" class="tdpar"> <input name="txtlv806" type="text" id="txtlv806"  value="<?php echo $mowh_lv0008->lv006;?>" tabindex="5" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" readonly="true"/>
                                                    </td>
													<td class="tdpar"><ul id="pop-nav" lang="pop-nav1" onkeyup="ChangeName(this,1)" onMouseOver="ChangeName(this,1)" style="padding:0px;list-style:none;padding-left:5px;">
                                                              <li class="menupopT">
		...
		<tr>
			...
			<td><table width="100%" border="0" style="postion:relative;">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                      <td align="center" style="postion:relative;"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                        <tr>
															<td class="tdpar" width="80">
																<?php echo $vLangArr[31];?>
															</td>
															<td class="tdpar" width="150"  class="tdpar">
																<input tabindex="20" title="barcode hoặc mã sản phẩm" name="txtlv903" id="txtlv903" onkeypress="return CheckKeys(event,9,this)" onBlur="LoadItem()" />
															</td>
															<td class="tdpar" width="100" >
															...
															<td class="tdpar" width="80"><?php echo $vLangArr[42];?></td>
															<td class="tdpar"  width="150">
																<input  name="txtlv914" type="text" id="txtlv914" value="<?php echo $mowh_lv0009->lv014;?>" tabindex="24" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,1,this)" /></td>
															<td class="tdpar"  width="80">
                                                            ...
                                                            <td class="tdpar" align="left"  width="30">
																<input type="checkbox" name="txtlv913" id="txtlv913" value="0"/>
															</td>
															<td class="tdpar">
																<?php echo $vLangArr[41];?>
															</td>
															
                                                        </tr>
														<tr>
                                                          <td class="tdpar"><?php echo $vLangArr[32];?></td>
                                                          <td class="tdpar"><input  name="txtlv904" id="txtlv904"   tabindex="21" onKeyPress="return CheckKey(event,1)" value="<?php echo (float)$mowh_lv0009->lv004;?>"/></td>
                                                          <td class="tdpar"><select title="<?php echo $vLangArr[33];?>" name="txtlv905" id="txtlv905"  onkeypress="return CheckKey(event,1)"/>
                                                            <?php echo $mowh_lv0009->LV_LinkField('lv005',$mowh_lv0009->lv005);?>
                                                            </select>
                                                           </td>
														   <td class="tdpar"><?php echo $vLangArr[39];?></td>
															<td class="tdpar" colspan="2"><input name="txtlv911" type="text" id="txtlv911" onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv911);return false;" value="<?php echo $mowh_lv0009->FormatView($vNow,2);?>" tabindex="25" maxlength="100" onKeyPress="return CheckKey(event,1)" /></td>
															<td class="tdpar">
																<img src="<?php echo $vDir;?>../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="123" border="0" style="cursor:pointer" width="16" height="16" align="top" onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv911);return false;" />
															</td>
															<td  class="tdpar" colspan="2">
															</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td class="tdpar"><input name="txtlv906" type="text" id="txtlv906" value="<?php echo (float)$mowh_lv0009->lv006;?>" tabindex="21" maxlength="255" onKeyPress="return CheckKey(event,1)" /></td>
                                                          <td class="tdpar"></td>
                                                          <td class="tdpar"><select title="<?php echo $vLangArr[35];?>" name="txtlv907" id="txtlv907"  tabindex="29" onkeypress="return CheckKey(event,1)"/>
                                                       ...
                                                       -->                               
                                                        <tr>
															...
															<td class="tdpar"><input type="text" name="txtlv908" id="txtlv908"  tabindex="23"  value="<?php echo (float)$mowh_lv0009->lv008;?>" onKeyPress="return CheckKey(event,1)"></td>
															<td class="tdpar">
															...
															<td class="tdpar" colspan="5"><input  name="txtlv915" type="text" id="txtlv915" value="<?php echo $mowh_lv0009->lv015;?>" tabindex="26" maxlength="255" onKeyPress="return CheckKey(event,1)" /></td>
                                                        </tr>
                                                         <tr>
