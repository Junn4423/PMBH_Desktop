...
$data = array();
  ...
  function add_person( $lv003, $lv004, $lv005,$lv006,$lv007)
  {
  global $data;
...
if($vFlag==1)
{
	 ...
	 if ( $_FILES['file']['tmp_name'] )
	  ...
	  foreach ($rows as $row)
	  {
	  	...
	  	add_person( $lv003, $lv004, $lv005,$lv006,$lv007);
	  }
	  $first_row = false;
	  }
  }
foreach( $data as $row )
{
	...
	{
	$lvsl_lv0063->lv001=InsertWithCheckExt('sl_lv0063', 'lv001', '',1);
	$lvsl_lv0063->lv002=getInfor($_SESSION['ERPSOFV2RUserID'],2);
	$lvsl_lv0063->lv003=$lvsl_lv0007->lv001;
	$lvsl_lv0063->lv004=$row['lv004'];
	$lvsl_lv0063->lv005=$row['lv005'];
	$lvsl_lv0063->lv006=$row['lv006'];
	$lvsl_lv0063->lv007=$row['lv007'];
	$lvsl_lv0063->lv016=$lvNow;
	
	$vresult=$lvsl_lv0063->LV_Insert();
	}
}
		if($vresult==true) {
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#"   name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data" >
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								<td width="166"  height="20px"><?php echo $vLangArr[24];?></td>
								<td  height="20px">
									<input type="file" name="file" />			</td>
							</tr>															
							<tr>
							  <td  height="20px" colspan="2"><input name="txtFlag" type="hidden" id="txtFlag"  /> <a href="MAU_CHUONG_TRINH_CK_DIEM_TEMPLATE.zip" title="<?php echo $vLangArr[30];?>"><?php echo $vLangArr[25];?></a></td>
							</tr>
							<tr>
