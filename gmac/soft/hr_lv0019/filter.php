...
<tr>
							...
							<tr>
							  ...
							  <option value="">...</option><?php echo $lvhr_lv0019->LV_LinkField('lv007',$lvhr_lv0019->lv007);?>
        ...
        <TR vAlign=center align=middle>
          ...
          <TD nowrap="nowrap"><a class=lvtoolbar 
            ...
            name=remove> <?php echo $vLangArr[6];?></a></TD>
					    ...
					    <input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="8" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
					</form>	
