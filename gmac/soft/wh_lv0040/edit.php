...
require_once("../../clsall/wh_lv0040.php");
//////////////init object////////////////
$lvwh_lv0040=new wh_lv0040($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0037');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvwh_lv0040->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
...
if($vFlag==1)
{
$lvwh_lv0040->lv002=$_POST['txtlv002'];
$lvwh_lv0040->lv003=$_POST['txtlv003'];
$lvwh_lv0040->lv004=$_POST['txtlv004'];
$lvwh_lv0040->lv005=$_POST['txtlv005'];
$lvwh_lv0040->lv006=$_POST['txtlv006'];
$lvwh_lv0040->lv007=$_POST['txtlv007'];
$lvwh_lv0040->lv008=$_POST['txtlv008'];
$lvwh_lv0040->lv009=$_POST['txtlv009'];
$lvwh_lv0040->lv010=$_POST['txtlv010'];
$lvwh_lv0040->lv011=$_POST['txtlv011'];
$lvwh_lv0040->lv012=$_POST['txtlv012'];
$lvwh_lv0040->lv013=$_POST['txtlv013'];
$lvwh_lv0040->lv014=$_POST['txtlv014'];
$lvwh_lv0040->lv015=$_POST['txtlv015'];
$lvwh_lv0040->lv016=GetServerDate()." ".GetServerTime();
$lvwh_lv0040->lv017=$_POST['txtlv017'];
$lvwh_lv0040->lv018=$_POST['txtlv018'];
$lvwh_lv0040->lv019=$_POST['txtlv019'];
		
		$vresult=$lvwh_lv0040->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvwh_lv0040->LV_LoadID($lvwh_lv0040->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0040->lv001=="")?InsertWithCheckExt('wh_lv0040', 'lv001', '',10):$lvwh_lv0040->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvwh_lv0040->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvwh_lv0040->LV_LinkField('lv003',$lvwh_lv0040->lv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
	              ...
	              <td  height="20"><input type="hidden" name="txtlv004old" id="txtlv004old" value="<?php echo $lvwh_lv0040->lv004;?>" />
			                  <input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvwh_lv0040->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvwh_lv0040->LV_LinkField('lv005',$lvwh_lv0040->lv005);?>
							  ...
							  <td  height="20"><input type="hidden" name="txtlv006old" id="txtlv006old" value="<?php echo $lvwh_lv0040->lv006;?>" /><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvwh_lv0040->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvwh_lv0040->LV_LinkField('lv007',$lvwh_lv0040->lv007);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv008" id="txtlv008"  style="width:80%"  tabindex="12"  value="<?php echo (float)$lvwh_lv0040->lv008;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvwh_lv0040->LV_LinkField('lv009',$lvwh_lv0040->lv009);?>
							  </select>	<br><table><tr><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch9" id="txtlvsearch9" tabindex="200" style="width:200px" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0040->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','hr_lv0018','lv002')" onFocus="LoadSelf(this,'txtlv009','hr_lv0018','lv002')">
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvwh_lv0040->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							 <tr>
							  ...
							  <?php echo $lvwh_lv0040->LV_LinkField('lv011',$lvwh_lv0040->lv011);?>
							  </select><br>
							  <table><tr><td>
							  <ul id="pop-nav5" lang="pop-nav5" onMouseOver="ChangeName(this,5)" onkeyup="ChangeName(this,5)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch5" id="txtlvsearch4" style="width:200px" onKeyUp="LoadPopup(this,'txtlv011','ac_lv0003','lv002')" onFocus="LoadPopup(this,'txtlv011','ac_lv0003','lv002')" tabindex="200" >
					...
					<!--
							<tr>
							  ...
							  <?php echo $lvwh_lv0040->LV_LinkField('lv012',$lvwh_lv0040->lv012);?>
							  </select><br><table><tr><td>
							  <ul id="pop-nav5" lang="pop-nav5" onMouseOver="ChangeName(this,5)" onkeyup="ChangeName(this,5)"> <li class="menupopT">
							...
							<tr>
							  ...
							  <?php echo $lvwh_lv0040->LV_LinkField('lv013',$lvwh_lv0040->lv013);?>
							  </select><br><table><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv014" type="text" id="txtlv014" value="<?php echo $lvwh_lv0040->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[29];?></td>
				  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvwh_lv0040->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                           <tr>
							  <td  height="20"><?php echo $vLangArr[38];?></td>
				  <td  height="20"><input  name="txtlv017" type="text" id="txtlv017" value="<?php echo $lvwh_lv0040->lv017;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                           <tr>
							  <td  height="20"><?php echo $vLangArr[39];?></td>
				  <td  height="20"><input  name="txtlv018" type="text" id="txtlv018" value="<?php echo $lvwh_lv0040->lv018;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                           <tr>
							  <td  height="20"><?php echo $vLangArr[40];?></td>
				  <td  height="20"><input  name="txtlv019" type="text" id="txtlv019" value="<?php echo $lvwh_lv0040->lv019;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						<tr>
