    ...
    <h3>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20px"><table style="width:80%"><tr><td><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $vlv002;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKey(event,7)" readonly="true"/><br></td><td>
				  ...
				  <table style="width:80%"><tr><td>
								<select name="txtlv003" id="txtlv003"   tabindex="6"  style="width:100%" onKeyPress="return CheckKey(event,7)"/>
									<option value="">...</option>
									<?php echo $lvsl_lv0060->LV_LinkField('lv003',$vlv003);?>
								</select></td><td>
							...
							<tr>
							  ...
							  <td  height="20"></select>
							  <input name="txtlv004" type="text" id="txtlv004"  value="<?php echo $vlv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td></tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[19];?></td>
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005"  value="<?php echo $vlv005;?>" tabindex="9" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						  </tr>
								<tr>
