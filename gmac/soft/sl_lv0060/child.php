...
require_once("../paras.php");
require_once("../../clsall/sl_menulv0060.php");
...
//init object
$mosl_menulv0060=new sl_menulv0060();
//Set variant
$mosl_menulv0060->itemlst=$pitemlst;
$mosl_menulv0060->childlst=$pchildlst;
$mosl_menulv0060->level3lst=$plevel3lst;
$mosl_menulv0060->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($mosl_menulv0060->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>	
					</select>
	...
	<?php
	$mosl_menulv0060->Dir="../";
include($mosl_menulv0060->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $mosl_menulv0060->level3lst;?>";
