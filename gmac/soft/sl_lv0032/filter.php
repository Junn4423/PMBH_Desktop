					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value="">...</option><?php echo $lvsl_lv0032->LV_LinkField('lv003',$vlv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
							...
							<tr>
							  ...
							  <?php echo $lvsl_lv0032->LV_LinkField('lv005',$vlv005);?>
...
<tr>
							  ...
							  <?php echo $lvsl_lv0032->LV_LinkField('lv007',$vlv007);?>
							  </select>	<br><table><tr><td>
