...
/////////////init object//////////////
$mosl_lv0032=new sl_lv0032($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0016');
...
$mosl_lv0032->ArrPush[3]=$vLangArr[20];
...
$mosl_lv0032->ArrPush[15]=$vLangArr[32];
...
$mosl_lv0032->ArrFunc[11]=$vLangArr[33];
$mosl_lv0032->ArrFunc[12]=$vLangArr[34];
$mosl_lv0032->ArrFunc[13]=$vLangArr[35];
$mosl_lv0032->ArrFunc[14]=$vLangArr[36];
$mosl_lv0032->ArrFunc[15]=$vLangArr[37];

////Other
$mosl_lv0032->ArrOther[1]=$vLangArr[31];
$mosl_lv0032->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mosl_lv0032->lv002=base64_decode($_GET['ID']);
...
?>
						...
						<?php echo $mosl_lv0032->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
