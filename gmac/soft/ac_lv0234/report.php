...
$moac_lv0234->ArrPush[17]=$vLangArr[46];
$moac_lv0234->ArrPush[18]=$vLangArr[47];
$moac_lv0234->ArrPush[19]=$vLangArr[48];
$moac_lv0234->ArrPush[20]=$vLangArr[49];
$moac_lv0234->ArrPush[21]=$vLangArr[41];
$moac_lv0234->ArrPush[26]=$vLangArr[54];
$moac_lv0234->ArrPush[25]='Thành tiền';
$moac_lv0234->ArrPush[905]='Ngày đơn hàng';
$moac_lv0234->ArrPush[995]='Giờ vào';
$moac_lv0234->ArrPush[996]='Giờ ra';
...
$moac_lv0234->ArrFunc[11]=$vLangArr[33];
$moac_lv0234->ArrFunc[12]=$vLangArr[34];
$moac_lv0234->ArrFunc[13]=$vLangArr[35];
$moac_lv0234->ArrFunc[14]=$vLangArr[36];
$moac_lv0234->ArrFunc[15]=$vLangArr[37];

////Other
$moac_lv0234->ArrOther[1]=$vLangArr[31];
$moac_lv0234->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
<table style="width:100%;max-with:375px;" border="0" cellspacing="0" cellpadding="0" align="center">
	<?php echo ($moac_lv0234->lv011>0)?"<tr><td><img style='max-width:375px;width:100%;height:50px;' src='../../clsall/barcode/barcode.php?barnumber=".$mosl_lv0013->lv001."'></td></tr>":"<tr><td height=5></td></tr>";?>
   <tr>
    <td align="center" onDblClick="this.innerHTML=''">
	<div style="clear:both;"> 
		<div style="float:left;width:85%;text-align:left;">
		
			<strong><span style="font:18px arial,tahoma"><?php echo $moac_lv0234->GetCompany();?></span></strong>
			<br><span style="font:12px arial,tahoma"><?php echo 'ĐC: ';?><?php echo $moac_lv0234->GetAddress();?></span>
			<br><span style="font:12px arial,tahoma"><?php echo 'ĐT: ';?><?php echo $moac_lv0234->GetPhone();?>  </span>
			<!--<br><span style="font:10px arial,tahoma"><?php echo 'Web';?><?php echo $moac_lv0234->GetWeb();?>   </span> -->
	</div>
  ...
  <tr>
   ...
   <tr>
	...
	<td>
  <?php
			echo $strDataShow = $moac_lv0234->PrintInOutPutInStockDetail($plang, $vLangArr,$moac_lv0234->datefrom,$moac_lv0234->dateto,$moac_lv0234->optrpt);
		?>		
                        <td>
    </tr>
    <td>
