...
<tr>
				  ...
				  <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0013->FormatView($lvsl_lv0013->lv004,2);?>"/><span class="td"><img tabindex="8" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlvopt1" id="txtlvopt1"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="LoadText(this,'txtlv009','sl_lv0016','lv003',document.frmedit.txtlv002.value,1,'<?php echo $plang;?>')"/>
							  <option value="">...</option>
							...
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[33];?></td>
							  <td  height="20"><select name="txtlvopt2" id="txtlvopt2"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="LoadText(this,'txtlv013','sl_lv0016','lv003',document.frmedit.txtlv002.value,1,'<?php echo $plang;?>')"/>
							  <option value="">...</option>
							  <?php echo $lvsl_lv0013->LV_LinkField('lv015',$lvsl_lv0013->lv013);?>
							  </select>							  </td>
							  </tr>
