...
require_once("$vDir../clsall/ac_lv0074.php");
require_once("$vDir../clsall/ac_lv0076.php");
require_once("$vDir../clsall/hr_lv0001.php");
////////init object////////////////////
	$moac_lv0074=new ac_lv0074($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'AC0074');
...
if(isset($_GET['ajax']))
{
	...
	echo '[CHECK]';
	echo InsertWithCheck('ac_lv0004', 'lv001', $mohr_lv0001->lv020,$mohr_lv0001->lv023);
	echo '[ENDCHECK]';
	exit;
}
	$vLangArr=GetLangFile("$vDir../","AC0048.txt",$plang);
///Load user
//////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
$moac_lv0074->lv001=$_POST['txtlv801'];//InsertWithCheck('ac_lv0004', 'lv001', 'PT-'.getmonth($vNow)."/".getyear($vNow)."-",3);
$isExists =0;//$moac_lv0074->LV_Exist($moac_lv0074->lv001);
$moac_lv0074->lv009=$_POST['txtlv809'];
$moac_lv0074->lv009=($moac_lv0074->lv009=="")?GetServerDate():$moac_lv0074->lv009;
if($moac_lv0074->lv010=="" || $moac_lv0074->lv010==NULL) $moac_lv0074->lv010="1111";
$moac_lv0074->lv003=$_POST['txtlv803'];
if($moac_lv0074->lv003=="" || $moac_lv0074->lv003==NULL) $moac_lv0074->lv003="CUS";
if($flagCtrl == 1){
$moac_lv0074->lv002='0';
$moac_lv0074->lv004=$_POST['txtlv804'];
$moac_lv0074->lv005=$_POST['txtlv805'];
$moac_lv0074->lv006=$_POST['txtlv806'];
$moac_lv0074->lv007=$_POST['txtlv807'];
$moac_lv0074->lv008=getInfor($_SESSION['ERPSOFV2RUserID'],2);
$moac_lv0074->lv009=$_POST['txtlv809'];
if($moac_lv0074->lv009=="" || $moac_lv0074->lv009==NULL) $moac_lv0074->lv009=$moac_lv0074->FormatView($vNow,2);
$moac_lv0074->lv010=$_POST['txtlv810'];
$moac_lv0074->lv011=$_POST['txtlv811'];
$moac_lv0074->lv012=$_POST['txtlv812'];
$moac_lv0074->lv013=$_POST['txtlv813'];
$moac_lv0074->lv014=$_POST['txtlv814'];
if($moac_lv0074->lv014=="" || $moac_lv0074->lv014==NULL) $moac_lv0074->lv014=$moac_lv0074->FormatView($vNow,2);
$moac_lv0074->lv015=$_POST['txtlv815'];
$moac_lv0074->lv016='0';
$moac_lv0074->lv018=$_POST['txtlv818'];
$moac_lv0074->lv022=$_POST['txtlv822'];
	$vStrMessage = "";
	if((int)$isExists==0){
		if( $moac_lv0076->GetCountUser($_SESSION['ERPSOFV2RUserID'],$moac_lv0074->lv013)>0)
		{
		$bResultI = $moac_lv0074->LV_Insert();
		if($bResultI == true){
			$moac_lv0076->LV_InsertTemp($moac_lv0074->lv001,$_SESSION['ERPSOFV2RUserID'],$moac_lv0074->lv013);
	...
	} else if((int)$isExists>=1 && (int)$moac_lv0076->lv007==0){
			$moac_lv0074->LV_Update();
			$moac_lv0076->LV_InsertTemp($moac_lv0074->lv001,getInfor($_SESSION['ERPSOFV2RUserID'],2));	
			$vStrMessage = $vLangArr[13];
			$flagCtrl = 1;
	}
}
$moac_lv0076->lv005=$_POST['txtlv905'];
if($moac_lv0076->lv005=="" || $moac_lv0076->lv005==NULL) $moac_lv0076->lv005="1111";
$moac_lv0076->lv006=$_POST['txtlv906'];
if($moac_lv0076->lv006=="" || $moac_lv0076->lv006==NULL) $moac_lv0076->lv006="131";
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if((int)$isExists>=1){
//	$moac_lv0074->Load($moac_lv0074->ID);
}
//////////////////////////////////////////////////////////////////////////////////////////////////////
$vLangArr1=GetLangFile("../","AC0007.txt",$plang);
$moac_lv0074->lang=strtoupper($plang);
//////////////////////////////////////////////////////////////////////////////////////////////////////
$moac_lv0074->ArrPush[0]=$vLangArr1[17];
$moac_lv0074->ArrPush[1]=$vLangArr1[18];
$moac_lv0074->ArrPush[2]=$vLangArr1[19];
$moac_lv0074->ArrPush[3]=$vLangArr1[20];
$moac_lv0074->ArrPush[4]=$vLangArr1[21];
$moac_lv0074->ArrPush[5]=$vLangArr1[22];
$moac_lv0074->ArrPush[6]=$vLangArr1[23];
$moac_lv0074->ArrPush[7]=$vLangArr1[24];
$moac_lv0074->ArrPush[8]=$vLangArr1[25];
$moac_lv0074->ArrPush[9]=$vLangArr1[26];
$moac_lv0074->ArrPush[10]=$vLangArr1[27];
$moac_lv0074->ArrPush[11]=$vLangArr1[28];
$moac_lv0074->ArrPush[12]=$vLangArr1[29];
$moac_lv0074->ArrPush[13]=$vLangArr1[30];
$moac_lv0074->ArrPush[14]=$vLangArr1[31];
$moac_lv0074->ArrPush[15]=$vLangArr1[32];
$moac_lv0074->ArrPush[16]=$vLangArr1[33];
$moac_lv0074->ArrPush[17]=$vLangArr1[34];
$moac_lv0074->ArrPush[18]=$vLangArr1[43];
$moac_lv0074->ArrPush[19]=$vLangArr1[42];
$vFieldList="lv001,lv004,lv005,lv017";
$strParent=$moac_lv0074->LV_BuilListReportMini($vFieldList,'document.frmchoose','chkAll','lvChk',0, 1000,1,$vOrderList,$vNow);
	...
	.tblcaption
{
	...
	{
	var str="<br><iframe id='lvframefrm' height=900 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir;?>ac_lv0076/ac_lv0076.php?&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
	...
	var str="<br><iframe id='lvframefrm' height=900 marginheight=0 marginwidth=0 frameborder=0 src='<?php echo $vDir;?>ac_lv0076/ac_lv0076.php?&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>"+strvalue+"' class=lvframe></iframe>";
	div = document.getElementById('lvloaddata');
	div.innerHTML=str;
	o.txtlv903.focus();
	}
	...
	{
	var o=document.frmadd;
		ajax_do ('ac_lv0074/ac_lv0074exce.php?&lang=<?php echo $plang;?>&childfunc=load'+'&lv002='+o.txtlv811.value,1);
		window.setTimeout('CalculateM()',1000);
	}
	function CalculateM()
	{
		var o=document.frmadd;
		o.txtlv904.value= NumberWithCommas(parseFloat(o.txtlv903.value*o.txtlv812.value));
	}
	function LoadSource()
	{
		var o=document.frmadd;
		var vo=o.txtlv803.value;
		ajax_do ('ac_lv0074/ac_lv0074excesource.php?&lang=<?php echo $plang;?>&childfunc=load'+'&CusID='+o.txtlv804.value+'&Type='+o.txtlv803.value+'&HDID='+o.txtlv813.value+'&lv005='+o.txtlv905.value+'&lv006='+o.txtlv906.value+'&lv011='+o.txtlv811.value+'&lv012='+o.txtlv812.value,1);
										...
										<form  name="frmadd" id="frmadd"  method="POST" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0);?>" autocomplete="off">
											...
											<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
												...
												<tr>
												  ...
												  <td  class="tdpar" width="25%"><input name="txtlv809" type="text" id="txtlv809" value="<?php echo $moac_lv0074->FormatView($moac_lv0074->lv009,2);?>" tabindex="4" maxlength="100" style="" onKeyPress="return CheckKey(event,7)" />
												  </td>
												  ...
												  <td colspan="2" class="tdpar" width="32%"><input readonly="true" name="txtlv801" type="text" id="txtlv801"  value="<?php echo InsertWithCheck('ac_lv0004', 'lv001', 'PT-'.getmonth($vNow)."/".getyear($vNow)."-",3);?>" tabindex="3" maxlength="32" style="" onKeyPress="return CheckKey(event,7)"/></td>
												...
												<tr>
													...
													<td height="20px" class="tdpar"><label>
                                                      ...
                                                      <?php echo $moac_lv0074->LV_LinkField('lv003',$moac_lv0074->lv003);?>
                                                      </select>
													  </td>
													  <td  class="tdpar">
												  ...
												  <td class="tdpar"><input  tabindex="6" name="txtlv818" type="text" id="txtlv818"  value="<?php echo $moac_lv0074->lv018;?>" maxlength="225" style="" onKeyPress="return CheckKey(event,7)"/></td>	
													
												</tr>
												<tr>
												<td class="tdpar"height="20px" align="left" valign="top"><?php echo $vLangArr[22];?></td>
												<td class="tdpar"><input name="txtlv804" type="text" id="txtlv804"  value="<?php echo $moac_lv0074->lv004;?>" tabindex="4" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/> </td>
												  ...
												  <td class="tdpar" height="20px" align="left" valign="top"><?php echo $vLangArr[33];?></td>
												    <td class="tdpar" ><input  tabindex="6" name="txtlv815" type="text" id="txtlv815"  value="<?php echo $moac_lv0074->lv015;?>" maxlength="225" style="" onKeyPress="return CheckKey(event,7)"/></td>
												</tr>
												<tr>
													<td class="tdpar"height="20px" align="left"><?php echo $vLangArr[23];?></td>
												  <td height="20px" colspan="4" class="tdpar"><input name="txtlv805" type="text" id="txtlv805"  value="<?php echo $moac_lv0074->lv005;?>" tabindex="6" maxlength="225" style="" onKeyPress="return CheckKey(event,7)"/></td>		
												  
											    </tr>												
												<tr height="1">
												  <td class="tdpar"><?php echo $vLangArr[24];?></td>
												  <td colspan="4" class="tdpar"><input name="txtlv806" type="text" id="txtlv806"  value="<?php echo $moac_lv0074->lv006;?>" tabindex="6" maxlength="225" style="" onKeyPress="return CheckKey(event,7)"/></td>
												 
											  </tr>
												<tr height="1">
													<td class="tdpar"><?php echo $vLangArr[25];?></td>
												    <td colspan="5" class="tdpar"><textarea name="txtlv807" rows="3" id="txtlv807" style="" tabindex="6" ><?php echo $moac_lv0074->lv007;?></textarea></td>
												</tr>	
												  ...
												  <td class="tdpar" colspan="7"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                      <td><select name="txtlv811" id="txtlv811"   tabindex="8"  style="" onkeypress="return CheckKey(event,7)" onChange="LoadCurency()"/>
														<?php echo $moac_lv0074->LV_LinkField('lv011',$moac_lv0074->lv011);?>
														</select>                                                      </td>
                                                      <td><input name="txtlv812" id="txtlv812"   tabindex="9"  style="" onKeyPress="return CheckKey(event,7)" value="<?php echo ((float)$moac_lv0074->lv012==0)?"1":(float)$moac_lv0074->lv012;?>"/>                                                      </td>
                                                      <td><table border="0" width="100%">
                                                        <tr>
                                                          <td width="50%">
                                                          	<select name="txtlv810" id="txtlv810"   tabindex="10"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
                                                      			<?php echo $moac_lv0074->LV_LinkField('lv010',$moac_lv0074->lv010);?>
                                                      		</select>
                                                      	  </td>
                                                      ...
                                                      <td>
                                                     		<table width="100%" border="0">
                                                     					<tr>
                                                     						<td width="50%">
                                                     							<input name="txtlv813" type="text" id="txtlv813"  value="<?php echo $moac_lv0074->lv013;?>" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
                                                     						</td>
                                                     						<td width="5%">
                                                      ...
                                                      <td><table width="100%" border="0">
                                                     					<tr>
                                                     						<td width="80%"><input name="txtlv814" type="text" id="txtlv814" value="<?php echo $moac_lv0074->FormatView($moac_lv0074->lv014,2);?>" tabindex="110" maxlength="100" style="width:100%" onKeyPress="return CheckKey(event,7)" />
                                                     						</td>
                                                     						<td>
							                                                    <img src="<?php echo $vDir;?>../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
																						border="0" style="cursor:pointer" width="16" height="16" align="top" 
                                                    ...
                                                    <tr>
                                                      <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          ...
                                                          <td class="tdpar" width="20%"><input type="text" name="txtlv903" id="txtlv903"  style=""  tabindex="25"  value="<?php echo (float)$moac_lv0076->lv003;?>" onKeyPress="return CheckKey(event,1)" onKeyUp="CalculateM()"  onChange="CalculateM()"></td>
                                                          ...
                                                          <td class="tdpar" width="20%">
															<select name="txtlv905" id="txtlv905"   tabindex="27"  style="width:100%" onkeypress="return CheckKeys(event,1,this)"/>
                                                         						 <?php echo $moac_lv0076->LV_LinkField('lv005',$moac_lv0076->lv005);?>
                                                            					</select>
														</td>
							  							<td  class="tdpar" width="20%">
                                                        ...
                                                        <tr>
															...
															<td class="tdpar" ><input  name="txtlv904" type="text" id="txtlv904" value="<?php echo (float)$moac_lv0076->lv004;?>" tabindex="26" maxlength="255" style="" onKeyPress="return CheckKey(event,1)"  readonly="TRUE"/></td> 
															...
															<?php echo $moac_lv0076->LV_LinkField('lv006',$moac_lv0076->lv006);?>
															</select>
														</td>
														<td  class="tdpar">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td  class="tdpar"colspan="4"><input name="txtlv907" type="text" id="txtlv907"  value="<?php echo $moac_lv0076->lv007;?>"  tabindex="29" maxlength="225" style="" onKeyPress="return CheckKey(event,7)"/></td>
                                                        </tr>
                                                      </table></td>
                                                    </tr>
                                                    <tr>
