...
require_once("../../clsall/sl_lv0038.php");
//////////////init object////////////////
$lvsl_lv0038=new sl_lv0038($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0015');
...
<tr>
								...
								<option value="">...</option>
							  <?php echo $lvsl_lv0038->LV_LinkField('lv007',$vlv007);?>
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $lvsl_lv0038->LV_LinkField('lv008',$vlv008);?>
							  </select><br><table><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo $vlv011;?>" tabindex="15" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
						  </tr>		
						    <tr>
								...
								<option value="">...</option>
							  <?php echo $lvsl_lv0038->LV_LinkField('lv012',$lvsl_lv0038->lv012);?>
							  </select>	<br><table><tr><td>
