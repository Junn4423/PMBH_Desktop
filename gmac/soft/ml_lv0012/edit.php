...
$lvml_lv0012->LV_LoadID($lvml_lv0012->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvml_lv0012->lv002;?>";
		o.txtlv003.value="<?php echo $lvml_lv0012->lv003;?>";
		o.txtlv004.value="<?php echo $lvml_lv0012->lv004;?>";
		o.txtlv005.value="<?php echo $lvml_lv0012->lv005;?>";
		o.txtlv006.value="<?php echo $lvml_lv0012->lv006;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
...
<tr>
				  ...
				  <td  height="20px"><input  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvml_lv0012->lv003;?>"/></td>
							...
							<tr>
							  ...
							  <td  height="20px"><input  name="txtlv004" type="password" id="txtlv004" value="<?php echo $lvml_lv0012->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
