...
require_once("$vDir../clsall/ml_lv0012.php");
/////////////init object//////////////
$moml_lv0012=new ml_lv0012($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ml0012');
$moml_lv0012->Dir=$vDir;
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("$vDir../","ML0024.txt",$plang);
...
$moml_lv0012->ArrPush[9]=$vLangArr[27];
...
$moml_lv0012->ArrFunc[6]=GetLangExcept('Send',$plang);
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$moml_lv0012->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"ml_lv0012",$lvMessage);
}
elseif($flagID==2)
{
$moml_lv0012->lv001=$_POST['txtlv001'];
$moml_lv0012->lv002=$_POST['txtlv002'];
$moml_lv0012->lv003=$_POST['txtlv003'];
$moml_lv0012->lv004=$_POST['txtlv004'];
$moml_lv0012->lv005=$_POST['txtlv005'];
$moml_lv0012->lv006=$_POST['txtlv006'];
$moml_lv0012->lv007=$_POST['txtlv007'];
}
...
if($flagID==4)
{
	...
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$moml_lv0012->LV_Aproval($strar);
}
//first is load
if($_POST["txtFlag"]=="")
{
...
$moml_lv0012->SaveOperation($_SESSION['ERPSOFV2RUserID'],'ml_lv0012',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);

}
if($maxRows ==0) $maxRows = 10;
if($_SESSION['ERPSOFV2RUserID']!="admin") $moml_lv0012->lv002=$_SESSION['ERPSOFV2RUserID'];
...
{
	var str="<br><iframe id='lvframefrm' height=500 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>ml_lv0012?func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
	div = document.getElementById('lvright');
	div.innerHTML=str;ProcessHiden();scrollToBottom();
}
function FunctRunning1(vID)
{
	window.open('<?php echo $vDir;?>'+'ml_lv0012/?lang=<?php echo $plang;?>&childfunc=download&ID='+vID,'download','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
...
<body  onkeyup="KeyPublicRun(event)">
					...
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,3,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $moml_lv0012->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $moml_lv0012->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002"  value="<?php echo $moml_lv0012->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $moml_lv0012->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $moml_lv0012->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $moml_lv0012->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $moml_lv0012->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $moml_lv0012->lv007;?>"/>
				  </form>
...
div.innerHTML='<?php echo $moml_lv0012->ArrPush[0];?>';	
</script>
</html>