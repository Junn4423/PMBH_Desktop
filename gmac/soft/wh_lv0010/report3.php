...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  <tr>
   ...
   <tr>
    <td><div align="center" class="lv0"><?php echo 'PHIẾU ĐỀ NGHỊ LƯU CHUYỂN KHO';?></div></td>
	</tr>
	<tr>
	<td><div align="center" >Ngày chuyển <?php echo getday($mowh_lv0010->lv009);?> tháng <?php echo getmonth($mowh_lv0010->lv009);?> năm <?php echo getyear($mowh_lv0010->lv009);?></div></td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td align="center">
		<div style="float:left;text-align:left;width:50%;font-weight:none">
			<div style="padding-right:10px">
				...
				<br><strong>Chuyển từ kho:</strong><?php $mowh_lv0001->LV_LoadID($mowh_lv0010->lv002);echo $mowh_lv0001->lv003;?>
				<br/><strong>NV tạo:</strong> <?php $mohr_lv0020->LV_LoadID($mowh_lv0010->lv003); echo $mohr_lv0020->lv004." ".$mohr_lv0020->lv003." ".$mohr_lv0020->lv002;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
			</div>
		</div>
		<div style="float:left;text-align:left;width:50%;font-weight:none">
			<div style="padding-left:10px">
			<strong>Tiêu đề:</strong> <?php echo $mowh_lv0010->lv004;;?>
			<br/>
			<strong>Kho đến:</strong> <?php $mowh_lv0001->LV_LoadID($mowh_lv0010->lv099);echo $mowh_lv0001->lv003;?>
			<br/><strong>NV nhận kho:</strong> <?php $mohr_lv0020->LV_LoadID($mowh_lv0010->lv011); echo $mohr_lv0020->lv004." ".$mohr_lv0020->lv003." ".$mohr_lv0020->lv002;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>	
			</div>
		</div>
	</td>
  </tr>
...
<?php
if($mowh_lv0010->lv010!='NOIBO' && ($mowh_lv0010->lv099==''|| $mowh_lv0010->lv099==NULL))
{
?>
<script>
window.close();
