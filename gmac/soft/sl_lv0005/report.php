...
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0010.txt",$plang);
...
?>
				...
				<?php echo $mosl_lv0005->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
