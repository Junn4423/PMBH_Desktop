...
$mosl_lv0005->ArrFunc[11]=$vLangArr[25];
$mosl_lv0005->ArrFunc[12]=$vLangArr[26];
$mosl_lv0005->ArrFunc[13]=$vLangArr[27];
$mosl_lv0005->ArrFunc[14]=$vLangArr[28];
$mosl_lv0005->ArrFunc[15]=$vLangArr[29];
////Other
$mosl_lv0005->ArrOther[1]=$vLangArr[23];
$mosl_lv0005->ArrOther[2]=$vLangArr[24];
//////Delete message///
$lvMessage=array();
...
{
	var str="<br><iframe id='lvframefrm' height=550 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir;?>sl_lv0005?&func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
...
<div class="hd_cafe">
	...
	{
	echo '<li><div class="licafe" onclick="nhapsanpham()">CÔNG THỨC</div></li>';
	}
	?>	
