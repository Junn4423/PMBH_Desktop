...
require_once("$vDir../clsall/sl_lv0016.php");

/////////////init object//////////////
$mosl_lv0016=new sl_lv0016($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0018');
$mosl_lv0016->Dir=$vDir;
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("$vDir../","SL0034.txt",$plang);
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$mosl_lv0016->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"sl_lv0016",$lvMessage);
}
elseif($flagID==2)
{
$mosl_lv0016->lv001=$_POST['txtlv001'];
$mosl_lv0016->lv002=$_POST['txtlv002'];
$mosl_lv0016->lv003=$_POST['txtlv003'];
}
...
$mosl_lv0016->SaveOperation($_SESSION['ERPSOFV2RUserID'],'sl_lv0016',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
{
	var str="<br><iframe id='lvframefrm' height=550 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir;?>sl_lv0016?&func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
...
<body  onkeyup="KeyPublicRun(event)">
					...
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?><?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mosl_lv0016->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mosl_lv0016->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002"  value="<?php echo $mosl_lv0016->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003"  value="<?php echo $mosl_lv0016->lv003;?>"/>
...
div.innerHTML='<?php echo $mosl_lv0016->ArrPush[0];?>';	
</script>
</html>