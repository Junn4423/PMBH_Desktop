...
$lvwh_lv0023->lv001=InsertWithCheckExt('wh_lv0023', 'lv001', '',0);
$lvwh_lv0023->lv002=$_GET['ChildID'];
$lvwh_lv0023->lv003=$_POST['txtlv003'];
$lvwh_lv0023->lv004=$_POST['txtlv004'];
$lvwh_lv0023->lv005=GetServerDate()." ".GetServerTime();
$lvwh_lv0023->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvwh_lv0023->LV_Insert();
		if($vresult==true) {
