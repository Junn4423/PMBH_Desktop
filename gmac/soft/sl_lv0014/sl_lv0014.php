...
$mosl_lv0014->ArrPush[18]=$vLangArr[41];
$mosl_lv0014->ArrPush[19]=$vLangArr[42];
$mosl_lv0014->ArrPush[20]=$vLangArr[43];
$mosl_lv0014->ArrPush[21]=$vLangArr[44];
$mosl_lv0014->ArrPush[22]=$vLangArr[45];
$mosl_lv0014->ArrPush[23]=$vLangArr[46];
$mosl_lv0014->ArrPush[24]=$vLangArr[47];
$mosl_lv0014->ArrPush[25]=$vLangArr[48];
$mosl_lv0014->ArrPush[26]=$vLangArr[49];
...
$mosl_lv0014->ArrFunc[6]=GetLangExcept('Apr',$plang);
$mosl_lv0014->ArrFunc[7]=GetLangExcept('UnApr',$plang);
$mosl_lv0014->ArrFunc[8]=$vLangArr[10];
$mosl_lv0014->ArrFunc[9]=$vLangArr[12];
$mosl_lv0014->ArrFunc[10]=$vLangArr[0];
$mosl_lv0014->ArrFunc[11]=$vLangArr[36];
$mosl_lv0014->ArrFunc[12]=$vLangArr[37];
$mosl_lv0014->ArrFunc[13]=$vLangArr[38];
$mosl_lv0014->ArrFunc[14]=$vLangArr[39];
$mosl_lv0014->ArrFunc[15]=$vLangArr[40];

////Other
$mosl_lv0014->ArrOther[1]=$vLangArr[34];
$mosl_lv0014->ArrOther[2]=$vLangArr[35];
//////Delete message///
$lvMessage=array();
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$mosl_lv0014->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"sl_lv0014",$lvMessage);
}
elseif($flagID==2)
{
$mosl_lv0014->lv001=$_POST['txtlv001'];
if($_GET['ChildID']=="")
 $mosl_lv0014->lv002=$_POST['txtlv002'];
else
$mosl_lv0014->lv002=$_GET['ChildID'];
$mosl_lv0014->lv003=$_POST['txtlv003'];
$mosl_lv0014->lv004=$_POST['txtlv004'];
$mosl_lv0014->lv005=$_POST['txtlv005'];
$mosl_lv0014->lv006=$_POST['txtlv006'];
$mosl_lv0014->lv007=$_POST['txtlv007'];
$mosl_lv0014->lv008=$_POST['txtlv008'];
$mosl_lv0014->lv009=$_POST['txtlv009'];
$mosl_lv0014->lv010=$_POST['txtlv010'];
$mosl_lv0014->lv011=$_POST['txtlv011'];
$mosl_lv0014->lv012=$_POST['txtlv012'];
}
elseif($flagID==3)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$mosl_lv0014->LV_Aproval($strar);
}
elseif($flagID==4)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$mosl_lv0014->LV_UnAproval($strar);
}
//first is load
if($_POST["txtFlag"]=="")
{
...
$mosl_lv0014->SaveOperation($_SESSION['ERPSOFV2RUserID'],'sl_lv0014',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
{
	if($mosl_lv0014->lv002!="" && $mosl_lv0014->lv002!=NULL)
	{
		$mosl_lv0013=new sl_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0016');
		$mosl_lv0013->LV_LoadID($mosl_lv0014->lv002);
		$lvgetdata=(int)$mosl_lv0013->lv015;
	}
	else
	$lvgetdata=0;
}
 $mosl_lv0014->lvgetdata=$lvgetdata;
...
{
	var str="<br><iframe id='lvframefrm' height=650 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir;?>sl_lv0014/?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&childdetailfunc="+func+"&ID=<?php echo $_GET['ID'];?>&ChildID=<?php echo $_GET['ChildID'];?>&ChildDetailID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&ChildID=<?php echo $_GET['ChildID'];?>&ID=<?php echo $_GET['ID']?>&<?php  echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose">
                      ...
                      <select name="lvgetdata" id="lvgetdata" style="width:50%" onChange="document.frmchoose.submit();">
						...
						<?php echo $mosl_lv0014->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mosl_lv0014->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $mosl_lv0014->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $mosl_lv0014->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $mosl_lv0014->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $mosl_lv0014->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $mosl_lv0014->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $mosl_lv0014->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $mosl_lv0014->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $mosl_lv0014->lv009;?>"/>
						<input type="hidden" name="txtlv010" id="txtlv010" value="<?php echo $mosl_lv0014->lv010;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $mosl_lv0014->lv011;?>"/>
						<input type="hidden" name="txtlv012" id="txtlv012" value="<?php echo $mosl_lv0014->lv012;?>"/>
...
div.innerHTML='<?php echo $mosl_lv0014->ArrPush[0];?>';	
</script>
</html>