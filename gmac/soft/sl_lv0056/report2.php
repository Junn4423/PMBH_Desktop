...
if($mosl_lv0013->GetView()==1)
{
  $mosl_lv0013->LV_LoadID($vlv001);
	...
	$vFieldList="lv002,lv003,lv004,lv005,lv008,lv009,lv010,lv011,lv012,lv013";
	 $strDetail=$mosl_lv0014->LV_BuilListReportOther($vFieldList,'document.frmchoose','chkAll','lvChk',0, 1000,$paging,$vOrderList,$mosl_lv0013->lv006,1);
