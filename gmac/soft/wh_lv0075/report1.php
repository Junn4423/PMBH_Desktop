...
////Init object//////////////
		...
		$mowh_lv0075->path_server="";
$mowh_lv0075->path_web="";
/////////Varian////////////////		
		...
		<tr>
			<td align="center" colspan="6">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<td align="center">
							<font style="font-size:14px;font-weight:bold"><?php echo $mowh_lv0075->GetCompany();?></font>
							<br/>
							<div>
							Địa chỉ:<?php echo $mowh_lv0075->GetAddress();?>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
						switch($vOptRun)
							{
								case 2:
									$strDataShow = $mowh_lv0075->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012);
									break;
								case 3:
									$strDataShow = $mowh_lv0075->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),1,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012);									
									break;
								case 4:
									$strDataShow = $mowh_lv0075->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),4,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012);									
									break;
								case 5:
									$strDataShow = $mowh_lv0075->PrintInOutCompareDay($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),4,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage);									
									break;
								case 6:
									$strDataShow = $mowh_lv0075->PrintInOutCompareMonth($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),4,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage);									
									break;
							}
