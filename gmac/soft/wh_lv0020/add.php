...
$lvwh_lv0020->lv001=$_POST['txtlv001'];
if($_GET['ID']=="")
$lvwh_lv0020->lv002=$_POST['txtlv002'];
else
$lvwh_lv0020->lv002=$_GET['ID'];
					...
					<form action="#"   name="frmadd" id="frmadd"  method="post">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0020->lv001=="")?InsertWithCheckExt('wh_lv0020', 'lv001', 'LOT',4):$lvwh_lv0020->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
				  ...
				  <td  height="20px"><table width="80%" border=0><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							...
							<tr>
							  ...
							  <td  height="20px"><input  name="txtlv004"  id="txtlv004"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" type="text" value="<?php echo $lvwh_lv0020->FormatView($lvwh_lv0020->lv004,2);?>"/> <img src="<?php echo $vDir;?>../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															...
															onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv004);return false;" /></td>
							</tr>
							<tr>
							...
							<tr>
							  ...
							  <td  height="20px"><input  name="txtlv007"  id="txtlv007"  tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0020->lv007;?>"/></td>
							  </tr>
							  <tr>
