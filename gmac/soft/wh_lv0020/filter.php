			...
			<tr>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20px">
							  <table width="80%" border=0><tr><td width="50%"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $vlv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKeys(event,7,this)" /></td><td>
				  ...
				  <td  height="20px"><table width="80%" border=0><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  	<option value="">...</option>
								<?php echo $lvwh_lv0020->LV_LinkField('lv003',$vlv003);?>
							  </select></td><td>
