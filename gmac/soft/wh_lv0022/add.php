...
$lvwh_lv0022->lv001=$_POST['txtlv001'];
$lvwh_lv0022->lv002=$_GET['ChildID'];
					...
					<form action="#"   name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0022->lv001=="")?InsertWithCheckExt('wh_lv0022', 'lv001', '',1):$lvwh_lv0022->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
...
<tr>
							...
							<tr>
							  ...
							  <td  height="20"><table width="80%" border=0><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvwh_lv0022->lv012;?>" tabindex="16" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						   ...
						   <tr>
							  <td  height="20"><?php echo $vLangArr[30];?></td>
								<td  height="20"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv013);return false;"   name="txtlv013" type="text" id="txtlv013" value="<?php echo $lvwh_lv0022->FormatView($lvwh_lv0022->lv013,2);?>" tabindex="20" maxlength="255" style="width:40%"/><input   name="txtlv013_" type="text" id="txtlv013_" value="<?php echo substr($lvwh_lv0022->lv013,11,8);?>" tabindex="20" maxlength="255" style="width:40%" onKeyPress="return CheckKey(event,7)"/><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
