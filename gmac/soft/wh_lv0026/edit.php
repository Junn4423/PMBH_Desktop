...
*/
session_start();
//require_once("../../clsall/wh_lv0026.php");
...
require_once("../../clsall/wh_lv0026.php");
//////////////init object////////////////
$lvwh_lv0026=new wh_lv0026($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0026');
/////////Get ID///////////////
$lvwh_lv0026->lv001=$_GET['ChildID'];
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0034.txt",$plang);
...
if($vFlag==1)
{
		$lvwh_lv0026->lv002=$_POST['txtlv002'];
		$lvwh_lv0026->lv003=$_POST['txtlv003'];
		$lvwh_lv0026->lv004=$_POST['txtlv004'];
		$lvwh_lv0026->lv005=$_POST['txtlv005'];
		$lvwh_lv0026->lv006=$_POST['txtlv006'];
		$lvwh_lv0026->lv007=$_POST['txtlv007'];	
		$lvwh_lv0026->lv008=$_POST['txtlv008'];			
		$vresult=$lvwh_lv0026->LV_Update();
		if($vresult==true) {
...
$lvwh_lv0026->LV_LoadID($lvwh_lv0026->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvwh_lv0026->lv002;?>";
		o.txtlv003.value="<?php echo $lvwh_lv0026->lv003;?>";
		o.txtlv004.value="<?php echo $lvwh_lv0026->lv004;?>";
		o.txtlv005.value="<?php echo $lvwh_lv0026->lv005;?>";
		o.txtlv006.value="<?php echo $lvwh_lv0026->lv006;?>";	
		o.txtlv007.value="<?php echo $lvwh_lv0026->lv007;?>";
		o.txtlv002.focus();
	}
	function Cancel()
	{
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f1f1f1">
			...
			<tr>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					...
					<?php		
						...
						?>
							...
							<tr>
								...
								<td  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvwh_lv0026->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px">
							  <table  style="border:0px;width:80%"><tr><td width="50%"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvwh_lv0026->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td><td>
				  ...
				  <td  height="20px"><input type="text" value=" <?php echo $lvwh_lv0026->lv003;?>"  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
				  
							 </td>
							  </tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvwh_lv0026->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"> <input name="txtlv005" type="text" tabindex="9" value="<?php echo $lvwh_lv0026->lv005;?>" style="width:80%" />
						 </td>
							</tr>	
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvwh_lv0026->FormatView(($lvwh_lv0026->lv006==""?GetServerDate():$lvwh_lv0026->lv006),2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $lvwh_lv0026->FormatView($lvwh_lv0026->lv007,2);?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"></td>
							  </tr>
								<tr>
							  <td  height="20px" valign="top"><?php echo $vLangArr[22];?></td>
							  <td  height="20px"><textarea name="txtlv008" cols="50" rows="9" id="txtlv008" style="width:80%" tabindex="11" ><?php echo $lvwh_lv0026->lv008;?></textarea></td>
							  </tr>					 
							<tr>
