...
$lvwh_lv0026->lv001=InsertWithCheckExt('wh_lv0026', 'lv001', '',10);
$lvwh_lv0026->lv002=$_GET['ID'];
...
$lvwh_lv0026->lv006=$_POST['txtlv006'];
 $lvwh_lv0026->lv007=GetServerDate();
$lvwh_lv0026->lv008=$_POST['txtlv008'];
if($vFlag==1)
{
		
		$vresult=$lvwh_lv0026->LV_Insert();
		if($vresult==true) {
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#"   name="frmadd" id="frmadd"  method="post">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20px">
							  <table  style="border:0px;width:80%"><tr><td width="50%"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvwh_lv0026->lv002;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" readonly="true"/></td><td>
				  ...
				  <td  height="20px"><input type="text" value=" <?php echo $lvwh_lv0026->lv003;?>"  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $lvwh_lv0026->FormatView($lvwh_lv0026->lv007,2);?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
