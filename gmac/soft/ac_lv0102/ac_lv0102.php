...
$vNow=GetServerDate();
$moac_lv0102->lv002=getyear($vNow)."-".getmonth($vNow)."-"."01";
$moac_lv0102->lv003=$vNow;
$moac_lv0102->lv008='156';
//$ma=$_GET['ma'];
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form  method="get" name="frmRpt" id="frmRpt" enctype="multipart/form-data">
					 <table width="100%" border="0" align="center" id="table1">
				      ...
				      <td width="178"  height="20"><input name="txtlv002" type="text" id="txtlv002" value="<?php echo formatdate($moac_lv0102->lv002,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				      ...
				      <td  height="20"><input name="txtlv003" type="text" id="txtlv003" value="<?php echo formatdate($moac_lv0102->lv003,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				        <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
															onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmRpt.txtlv003);return false;" /></span></td>
						  </tr>
						 <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[14];?></td>
							  <td  height="20"><table width="80%"><tr><td width="50%"><select name="txtlv005" id="txtlv005"   tabindex="7"  style="width:100%" onkeypress="return CheckKey(event,7)"/>
							    
							  <option value="">...</option>
							  <?php echo $moac_lv0102->LV_LinkField('lv005',$moac_lv0102->lv006);?>
							  </select></td><td>
						   ...
						   <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[15];?></td>
							  <td  height="20">
							   <table width="80%"><tr><td width="50%">
							  <select name="txtlv006" id="txtlv006"   tabindex="20"  style="width:100%" onkeypress="return CheckKey(event,7)"/>
							    
							  <option value="">...</option>
							  <?php echo $moac_lv0102->LV_LinkField('lv006',$moac_lv0102->lv006);?>
							  </select>	
							  </td><td>
							  <ul id="pop-nav2" lang="pop-nav2" onkeyup="ChangeName(this,2)" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv006_search" id="txtlv006_search" style="width:100%" onkeyup="LoadPopupParent(this,'txtlv006','ac_lv0002','concat(lv001,@! @!,lv002)')" onfocus="LoadPopupParent(this,'txtlv006','ac_lv0002','concat(lv001,@! @!,lv002)')" tabindex="200" />
