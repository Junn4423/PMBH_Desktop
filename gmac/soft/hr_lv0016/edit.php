...
require_once("../../clsall/hr_lv0016.php");
//////////////init object////////////////
$lvhr_lv0016=new hr_lv0016($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0042');
/////////Get ID///////////////
$lvhr_lv0016->lv001=$_GET['ID'];
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","HR0134.txt",$plang);
...
if($vFlag==1)
{
		$lvhr_lv0016->lv002=$_POST['txtlv002'];		
		$vresult=$lvhr_lv0016->LV_Update();
		if($vresult==true) {
...
$lvhr_lv0016->LV_LoadID($lvhr_lv0016->lv001);
...
function isphone(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvhr_lv0016->lv002;?>";
		o.txtlv003.value="<?php echo $lvhr_lv0016->lv003;?>";
		o.txtlv004.value="<?php echo $lvhr_lv0016->lv004;?>";
		o.txtlv005.value="<?php echo $lvhr_lv0016->lv005;?>";	
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvhr_lv0016->lv001;?>" /></td>
							</tr>
						<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input  name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvhr_lv0016->lv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
