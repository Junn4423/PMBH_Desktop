...
$lvhr_lv0006->LV_LoadID($lvhr_lv0006->lv001);
...
function isphone(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvhr_lv0006->lv002;?>";
		o.txtlv003.value="<?php echo $lvhr_lv0006->lv003;?>";
		o.txtlv004.value="<?php echo $lvhr_lv0006->lv004;?>";
		o.txtlv005.value="<?php echo $lvhr_lv0006->lv005;?>";
		o.txtlv006.value="<?php echo $lvhr_lv0006->lv006;?>";		
		o.txtlv007.value="<?php echo $lvhr_lv0006->lv007;?>";		
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvhr_lv0006->lv001;?>" /></td>
							</tr>
							<tr>
...
<tr>
				  ...
				  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvhr_lv0006->lv004;?>" tabindex="8" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							  </tr>							  
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvhr_lv0006->lv005;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>
								<tr>
							  <td  height="20px"><?php echo $vLangArr[20];?></td>
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvhr_lv0006->lv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>						 
							<tr>
