					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $lvac_lv0019->LV_LinkField('lv003',$vlv003);?></select>
								</td><td>
...
<tr>
				  ...
				  <option value="">...</option>
				  <?php echo $lvac_lv0019->LV_LinkField('lv010',$vlv010);?></select>
				  </td><td>
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $lvac_lv0019->LV_LinkField('lv011',$vlv011);?></select>
							  </td><td>
...
<tr>
							...
							<tr>
								...
								<td width="178"  height="20">
									...
									<?php echo $lvac_lv0019->LV_LinkField('lv022',$vlv022);?></select>
								</td>
					      </tr>		
						  <tr>
