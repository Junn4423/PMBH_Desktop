...
$lvac_lv0019->lang=strtoupper($plang);
$curPage=(int)$_POST['curPg'];	
$vFlag=(int)$_POST['txtFlag'];
$vNow=GetServerDate();
$lvac_lv0019->lv001=$_POST['txtlv001'];
$lvac_lv0019->lv002='1';
...
if($lvac_lv0019->lv009=="" || $lvac_lv0019->lv009==NULL) $lvac_lv0019->lv009=$vNow;
...
if($lvac_lv0019->lv014=="" || $lvac_lv0019->lv014==NULL) $lvac_lv0019->lv014=$vNow;
...
if($lvac_lv0019->lv022=="" || $lvac_lv0019->lv022==NULL) $lvac_lv0019->lv022="TRUONGNAM";
if($vFlag==1)
{
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<select onblur="changecompany_change(this.value)" name="txtlv022" id="txtlv022"   tabindex="3"  style="width:80%" onKeyPress="return CheckKeys(event,7,this)"><?php echo $lvac_lv0019->LV_LinkField('lv022',$lvac_lv0019->lv022);?></select>
								</td>
					      </tr>		
							<tr>
								<td width="166"  height="20"><?php echo $vLangArr[15];?></td>
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvac_lv0019->lv001=="")?InsertWithCheck('ac_lv0004', 'lv001', 'PC-'.getmonth($vNow)."/".getyear($vNow)."-",3):$lvac_lv0019->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
