...
$lvwh_lv0004->lv001=$_GET['ChildID'];
if($plang=="") $plang="EN";
...
$lvwh_lv0004->lv007=$_FILES['userfile']['name'];
$lvwh_lv0004->lv008=$_POST['txtlv008'];
$lvwh_lv0004->lv009=$_POST['txtlv009'];
$lvwh_lv0004->lv010=$_POST['txtlv010'];
$lvwh_lv0004->lv011=$_POST['txtlv011'];
$lvwh_lv0004->lv012=$_POST['txtlv012'];
$lvwh_lv0004->lv013=$_POST['txtlv013'];
$lvwh_lv0004->lv014=$_POST['txtlv014'];
$lvwh_lv0004->lv015=$_POST['txtlv015'];
$lvwh_lv0004->lv016=$_POST['txtlv016'];
		
		$vresult=$lvwh_lv0004->LV_Update();
		if($vresult==true) {
					...
					<form action="#" name="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0004->lv001=="")?InsertWithCheckExt('huyvanv2_0.wh_lv0004', 'lv001', '',10):$lvwh_lv0004->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
