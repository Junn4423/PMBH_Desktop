...
require_once("../paras.php");
require_once("../../clsall/sl_menusl0031.php");
...
//init object
$sl_menusl0031=new sl_menusl0031();
//Set variant
$sl_menusl0031->itemlst=$pitemlst;
$sl_menusl0031->childlst=$pchildlst;
$sl_menusl0031->level3lst=$plevel3lst;
$sl_menusl0031->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($sl_menusl0031->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$sl_menusl0031->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<!--<option value="3" <?php echo ((int)$sl_menusl0031->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>-->
	...
	<?php
	$sl_menusl0031->Dir="../";
include($sl_menusl0031->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $sl_menusl0031->level3lst;?>";
