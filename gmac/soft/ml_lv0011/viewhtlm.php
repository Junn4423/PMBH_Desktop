...
if($lvml_lv0011->lv001!=0) $lvml_lv0011->LV_LoadID($lvml_lv0011->lv001);
					...
					<form name="frm_mail" action="#" method="post" enctype="multipart/form-data" autocomplete="off">
					  <table width="680" border="0" align="left" id="table1">							  
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtmail_lv005" id="txtmail_lv005" type="text" style="width:90%" value='<?php echo $lvml_lv0011->lv005;?>' tabindex="15"/></td>
						    </tr>
							<tr>
							...
							<tr>
							  <td  height="20" colspan="2"><input type="hidden" name="txtmail_lv010" id="txtmail_lv010" value='<?php echo $lvml_lv0011->lv010;?>'/>
						<input type="hidden" name="txtmail_lv013" id="txtmail_lv013" value='<?php echo $lvml_lv0011->lv013;?>'/><input name="txtFlag" type="hidden" id="txtFlag" /><input name="txtFlagFw" type="hidden" id="txtFlagFw"  value="<?php echo $_POST['txtFlagFw'];?>"/></td>
						  </tr>
					<tr>
