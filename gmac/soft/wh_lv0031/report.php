...
$mowh_lv0031->ArrFunc[11]=$vLangArr[36];
$mowh_lv0031->ArrFunc[12]=$vLangArr[37];
$mowh_lv0031->ArrFunc[13]=$vLangArr[38];
$mowh_lv0031->ArrFunc[14]=$vLangArr[39];
$mowh_lv0031->ArrFunc[15]=$vLangArr[40];
////Other
$mowh_lv0031->ArrOther[1]=$vLangArr[31];
$mowh_lv0031->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
?>
						...
						<?php echo $mowh_lv0031->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
