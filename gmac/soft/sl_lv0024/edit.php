...
require_once("../../clsall/sl_lv0024.php");
//////////////init object////////////////
$lvsl_lv0024=new sl_lv0024($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0024');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvsl_lv0024->lv001=$_GET['ChildID'];
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0041.txt",$plang);
...
$lvsl_lv0024->lv003=$_POST['txtlv003'];
$lvsl_lv0024->lv004=$_POST['txtlv004'];
$lvsl_lv0024->lv005=$_POST['txtlv005'];
$lvsl_lv0024->lv006=$_POST['txtlv006'];
if($_FILES['userfile']['name']=="")
$lvsl_lv0024->lv007=$_POST['txtlv007'];
else
$lvsl_lv0024->lv007=$_FILES['userfile']['name'];
$lvsl_lv0024->lv008=$_POST['txtlv008'];
$lvsl_lv0024->lv009=$_POST['txtlv009'];
$lvsl_lv0024->lv010=$_POST['txtlv010'];
$lvsl_lv0024->lv011=$_POST['txtlv011'];
$lvsl_lv0024->lv012=$_POST['txtlv012'];
$lvsl_lv0024->lv013=$_POST['txtlv013'];
$lvsl_lv0024->lv014=$_POST['txtlv014'];
$lvsl_lv0024->lv015=$_POST['txtlv015'];
$lvsl_lv0024->lv016=$_POST['txtlv016'];
		
		$vresult=$lvsl_lv0024->LV_Update();
		if($vresult==true) {
...
$lvsl_lv0024->LV_LoadID($lvsl_lv0024->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0024->lv001=="")?InsertWithCheckExt('sofv1_0.sl_lv0024', 'lv001', '',10):$lvsl_lv0024->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
							  ...
							  <td  height="20"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
							   <?php echo $lvsl_lv0024->LV_LinkField('lv002',$lvsl_lv0024->lv002);?>
                              </select>
							    <br>
							  <table><tr><td>
...
<tr>
								...
								<?php echo $lvsl_lv0024->LV_LinkField('lv003',$lvsl_lv0024->lv003);?>
							...
							<tr>
							  ...
							  <td  height="20"></select>
							  <input name="txtlv004" type="text" id="txtlv004"  value="<?php echo $lvsl_lv0024->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <br></td></tr>
							<tr>
							  ...
							  <td  height="20"><select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:80%" onkeypress="return CheckKey(event,7)"/>
								<?php echo $lvsl_lv0024->LV_LinkField('lv005',$lvsl_lv0024->lv005);?>
							  </select>	<br><table><tr><td>
							  <ul id="pop-nav2" lang="pop-nav2" onkeyup="ChangeName(this,2)" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
						  ...
						  <tr>
							  ...
							  <td  height="20"></select>
							  <input name="txtlv006" type="text" id="txtlv006"  value="<?php echo $lvsl_lv0024->lv006;?>" tabindex="10" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <br></td></tr>
							<tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvsl_lv0024->FormatView($lvsl_lv0024->lv009,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20"><textarea name="txtlv008" rows="20" id="txtlv008" style="width:80%" tabindex="13" ><?php echo $lvsl_lv0024->lv007;?></textarea></td>
						    </tr>		
						<tr>
