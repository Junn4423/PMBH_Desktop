...
$lvsl_lv0024->lv001=$_POST['txtlv001'];
if($_GET['ID']=="")
...
if($lvsl_lv0024->lv009=="") $lvsl_lv0024->lv009=GetServerDate();
if($vFlag==1)
{
		
		$vresult=$lvsl_lv0024->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0024->lv001=="")?InsertWithCheck('sofv1_0.wh_lv0010', 'lv001', 'BH',10):$lvsl_lv0024->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
