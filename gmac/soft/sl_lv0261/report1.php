			...
			<td align="center" colspan="6">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
				  <tr>
					...
					<tr>
					<td align="center">
					<font style="font-size:14px;font-weight:bold"><?php echo $mosl_lv0261->GetCompany();?></font>
					<br/>
					<div>
					Địa chỉ:<?php echo $mosl_lv0261->GetAddress();?>
...
?>			
		...
		<tr>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
				echo $strDataShow = $mosl_lv0261->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv022,$vlv015);
				?></td>
		</tr>
