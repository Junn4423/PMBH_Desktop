...
require_once("$vDir../clsall/sl_lv0103.php");
...
////////init object////////////////////
	$lvsl_lv0103=new sl_lv0103($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0103');
	$lvsl_lv0105=new sl_lv0105($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0016');	
	$lvsl_lv0070=new sl_lv0070($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0070');
	$lvsl_lv0070->LV_Load();
	$lvsl_lv0103->obj_conf=$lvsl_lv0070;
	$lvsl_lv0103->nhommon=$lvsl_lv0070->lv021;
$vNow=GetServerDate();	
if($lvsl_lv0103->GetAdd()>0)
{
...
if(isset($_GET['ajaxprice']))
{
	...
	echo '[CHECKDONHANG]';
		...
		$vdata=$lvsl_lv0103->LV_GetBH_Invoice($_GET['chitietid']);
		//if($_GET['qty']<=0) $lvsl_lv0105->LV_Delete($_GET['chitietid']);
		echo $_GET['bangid'];
		//echo $vdata[1];
		echo '[ENDCHECKDONHANG]';
		echo '[DONHANGMONEY]';
			echo $lvsl_lv0103->FormatView($vdata[2],10);
		echo '[ENDDONHANGMONEY]';
		echo '[DONHANGMONEYCL]';
			echo $lvsl_lv0103->FormatView($vdata[3]-$vdata[2],10);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$lvsl_lv0103->ArrPush[0]=$vLangArr1[17];
$lvsl_lv0103->ArrPush[1]=$vLangArr1[18];
$lvsl_lv0103->ArrPush[2]=$vLangArr1[19];
$lvsl_lv0103->ArrPush[3]=$vLangArr1[20];
$lvsl_lv0103->ArrPush[4]=$vLangArr1[21];
$lvsl_lv0103->ArrPush[5]=$vLangArr1[22];
$lvsl_lv0103->ArrPush[6]=$vLangArr1[23];
$lvsl_lv0103->ArrPush[7]=$vLangArr1[24];
$lvsl_lv0103->ArrPush[8]=$vLangArr1[25];
$lvsl_lv0103->ArrPush[9]=$vLangArr1[26];
$lvsl_lv0103->ArrPush[10]=$vLangArr1[27];
$lvsl_lv0103->ArrPush[11]=$vLangArr1[28];
$lvsl_lv0103->ArrPush[12]=$vLangArr1[29];
$lvsl_lv0103->ArrPush[13]=$vLangArr1[41];
$lvsl_lv0103->ArrPush[14]=$vLangArr1[40];
$lvsl_lv0103->ArrPush[15]=$vLangArr1[42];
$lvsl_lv0103->ArrPush[16]=$vLangArr1[45];
$lvsl_lv0103->ArrPush[17]=$vLangArr1[43];
$lvsl_lv0103->ArrPush[18]=$vLangArr1[44];
$lvsl_lv0103->ArrPush[19]=$vLangArr1[46];
$lvsl_lv0103->ArrPush[20]=$vLangArr1[47];
$lvsl_lv0103->ArrPush[21]=$vLangArr1[48];
$lvsl_lv0103->ArrPush[22]=$vLangArr1[49];
$lvsl_lv0103->ArrPush[23]=$vLangArr1[50];
$lvsl_lv0103->ArrPush[24]=$vLangArr1[51];
$lvsl_lv0103->ArrPush[25]=$vLangArr1[52];
$lvsl_lv0103->ArrPush[26]=$vLangArr1[53];
$vFieldList="lv001,lv002,lv003,lv010,lv023";
$lvsl_lv0103->LV_GetBangRun($lvsl_lv0105);
$strParent=$lvsl_lv0103->LV_BuilListReportMini($vFieldList,'document.frmchoose','chkAll','lvChk',0, 1000,1,$vOrderList,$vNow);
$strParent=str_replace("'","\'",$strParent);
$strParent=str_replace("
","",$strParent);

if((int)$isExists>=1){
//	$lvsl_lv0103->Load($lvsl_lv0103->ID);
}
//////////////////////////////////////////////////////////////////////////////////////////////////////
?>
...
<div class="hd_cafe">
	<ul class="qlycafe">
		...
		<li><div class="licafe" ><span id="curday"><?php echo $lvsl_lv0103->FormatView($vNow,2);?></span> <span style="" title="<?php echo GetServerTimeSec();?>" id="countdown">11</span></li>
...
<div id="viewhere_6" style="display:none">
	<?php
		$vStr=$lvsl_lv0103->LV_GetDetailGroup($vLangArr,$vSum,0);
		echo $vStr;
	?>
</div>
<div id="viewhere_7" style="display:none">
	<?php
		$vStr=$lvsl_lv0103->LV_GetDetailGroup($vLangArr,$vSum,1);
		echo $vStr;
	?>
</div>
...
<!--////////////////////////////////////Code add here///////////////////////////////////////////-->			</td>
			<div style="display:none;position:absolute;left:240px;bottom:0px;z-index:999999999999;" id="roomid"><select name="txtlv807tmp" id="txtlv807tmp"   tabindex="2"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)" onchange="DoiBang(this)"/>
															<?php echo $lvsl_lv0103->LV_LinkField('lv007',$lvsl_lv0103->lv007);?>
										</select></div>
										</form>
			</div>
	</div>
...
<?php
echo $lvsl_lv0103->LV_getTangMini($vLangArr);
?>
</div>
...
{
	var sumtangall=<?php echo $lvsl_lv0103->sumTang;?>;
	if(opt==0) opt=6;
	switch(opt)
	{
		case 1:
