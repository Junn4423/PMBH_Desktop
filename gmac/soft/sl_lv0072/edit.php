...
/////////Get ID///////////////
$lvsl_lv0072->lv001=$_GET['ChildID'];
...
if($vFlag==1)
{
		...
		$lvsl_lv0072->lv008=$_POST['txtlv008'];			
		$vresult=$lvsl_lv0072->LV_Update();
		if($vresult==true) {
...
$lvsl_lv0072->LV_LoadID($lvsl_lv0072->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvsl_lv0072->lv002;?>";
		o.txtlv003.value="<?php echo $lvsl_lv0072->lv003;?>";
		o.txtlv004.value="<?php echo $lvsl_lv0072->lv004;?>";
		o.txtlv005.value="<?php echo $lvsl_lv0072->lv005;?>";
		o.txtlv006.value="<?php echo $lvsl_lv0072->lv006;?>";	
		o.txtlv007.value="<?php echo $lvsl_lv0072->lv007;?>";
		o.txtlv002.focus();
	}
	function Cancel()
	{
