...
else
{
	...
	$mosl_lv0059->Values['lv001']=InsertWithCheck('sl_lv0059', 'lv001', $vYear.$vMonth,2);
...
{
	//////////////////////////////////////////////////////////////////////////////////////////////////////
$mosl_lv0059->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'sl_lv0059');
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
$mosl_lv0059->SaveOperation($_SESSION['ERPSOFV2RUserID'],'sl_lv0059',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
