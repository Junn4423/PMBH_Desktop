...
$lvsl_lv0059->lv001=$_POST['txtlv001'];
$lvsl_lv0059->lv002=$_POST['txtlv002'];
$lvsl_lv0059->lv003=$_POST['txtlv003'];
if($lvsl_lv0059->lv003==NULL && $lvsl_lv0059->lv003=="") $lvsl_lv0059->lv003=GetServerDate()." 00:00:00";
$lvsl_lv0059->lv004=$_POST['txtlv004'];
if($lvsl_lv0059->lv004==NULL && $lvsl_lv0059->lv004=="") $lvsl_lv0059->lv004=LV_DATE_ADD(GetServerDate(),30)." 23:59:59";
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0059->lv001=="")?InsertWithCheck('sl_lv0059', 'lv001', 'PRO',1):$lvsl_lv0059->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
						    <tr>
