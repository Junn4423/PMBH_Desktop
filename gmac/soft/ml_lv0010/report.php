...
$moml_lv0010->ArrFunc[11]=$vLangArr[29];
$moml_lv0010->ArrFunc[12]=$vLangArr[30];
$moml_lv0010->ArrFunc[13]=$vLangArr[31];
$moml_lv0010->ArrFunc[14]=$vLangArr[32];
$moml_lv0010->ArrFunc[15]=$vLangArr[33];
////Other
$moml_lv0010->ArrOther[1]=$vLangArr[27];
$moml_lv0010->ArrOther[2]=$vLangArr[28];
//////Delete message///
$lvMessage=array();
...
?>
				...
				<?php echo $moml_lv0010->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
