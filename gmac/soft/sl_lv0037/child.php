...
require_once("../paras.php");
require_once("../../clsall/sl_menulv0037.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0056.txt",$plang);
//init object
$mosl_menulv0037=new sl_menulv0037();
//Set variant
$mosl_menulv0037->itemlst=$pitemlst;
$mosl_menulv0037->childlst=$pchildlst;
$mosl_menulv0037->level3lst=$plevel3lst;
$mosl_menulv0037->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($mosl_menulv0037->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$mosl_menulv0037->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
					</select>
	...
	<?php
	$mosl_menulv0037->Dir="../";
include($mosl_menulv0037->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $mosl_menulv0037->level3lst;?>";
