				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
								...
								<td width="178"  height="20"><input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $vlv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						    </tr>
							 <tr>
								<td width="166"  height="20"><?php echo $vLangArr[16];?></td>
								<td width="178"  height="20">
									<input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $vlv013;?>" readonly="true" tabindex="17" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>	
									<br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv003" type="text" id="txtlv003" readonly="true"  value="<?php echo $vlv003;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  <br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  <br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><textarea name="txtlv006" rows="5" id="txtlv006" style="width:80%" tabindex="23" onKeyPress="return CheckKey(event,7)"><?php echo $vlv006;?></textarea></td>
						    </tr>						  
							<tr>
