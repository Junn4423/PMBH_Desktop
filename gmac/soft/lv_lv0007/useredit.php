...
if($vFlag==1)
{
	...
	$vsql="Update lv_lv0007 SET lv004='$vUserName',lv002='$vUserGroupID',lv003='$vUserRight',lv006='$vEmployeeID',lv099='$vThemes' where lv001='$vUserID'";
...
$vsql="select * from lv_lv0007 Where lv001='$vUserID'";
$vresult=db_query($vsql);
