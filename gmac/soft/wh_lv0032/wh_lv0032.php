...
require_once("$vDir../clsall/wh_lv0032.php");

/////////////init object//////////////
$mowh_lv0032=new wh_lv0032($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0032');
$mowh_lv0032->Dir=$vDir;
...
$mowh_lv0032->ArrFunc[11]=$vLangArr[43];
$mowh_lv0032->ArrFunc[12]=$vLangArr[44];
$mowh_lv0032->ArrFunc[13]=$vLangArr[45];
$mowh_lv0032->ArrFunc[14]=$vLangArr[46];
$mowh_lv0032->ArrFunc[15]=$vLangArr[47];

////Other
$mowh_lv0032->ArrOther[1]=$vLangArr[41];
$mowh_lv0032->ArrOther[2]=$vLangArr[42];
//////Delete message///
$lvMessage=array();
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$mowh_lv0032->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"wh_lv0032",$lvMessage);
}
elseif($flagID==2)
{
$mowh_lv0032->lv001=$_POST['txtlv001'];
$mowh_lv0032->lv002=$_POST['txtlv002'];
$mowh_lv0032->lv003=$_POST['txtlv003'];
$mowh_lv0032->lv004=$_POST['txtlv004'];
$mowh_lv0032->lv005=$_POST['txtlv005'];
$mowh_lv0032->lv006=$_POST['txtlv006'];
$mowh_lv0032->lv007=$_POST['txtlv007'];
$mowh_lv0032->lv008=$_POST['txtlv008'];
$mowh_lv0032->lv009=$_POST['txtlv009'];
$mowh_lv0032->lv010=$_POST['txtlv010'];
$mowh_lv0032->lv011=$_POST['txtlv011'];
$mowh_lv0032->lv012=$_POST['txtlv012'];
$mowh_lv0032->lv013=$_POST['txtlv013'];
}

if($flag==1)
{
	$mowh_lv0032->lv001=$_GET['txtlv001'];
	$mowh_lv0032->lv002=getInfor($_SESSION['ERPSOFV2RUserID'],2);
	$mowh_lv0032->lv003=$_GET['txtlv003'];
	$mowh_lv0032->lv004=$_GET['txtlv004'];
	$mowh_lv0032->lv005=$_GET['txtlv005'];
	$mowh_lv0032->lv006=$_GET['txtlv006'];
	$mowh_lv0032->lv007=$_GET['txtlv007'];
	$mowh_lv0032->lv008=$_GET['txtlv008'];
	$mowh_lv0032->lv009=$_GET['txtlv009'];
	$mowh_lv0032->lv010=$_GET['txtlv010'];
	$mowh_lv0032->lv011=$_GET['txtlv011'];
	$mowh_lv0032->lv012=$_GET['txtlv012'];
	$mowh_lv0032->lv013=$_GET['txtlv013'];
	$strReturn=$mowh_lv0032->LV_Insert();
...
$mowh_lv0032->SaveOperation($_SESSION['ERPSOFV2RUserID'],'wh_lv0032',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&ChildID=<?php echo $_GET['ChildID'];?>&ID=<?php echo $_GET['ID']?>&<?php  echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mowh_lv0032->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mowh_lv0032->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $mowh_lv0032->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $mowh_lv0032->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $mowh_lv0032->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $mowh_lv0032->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $mowh_lv0032->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $mowh_lv0032->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $mowh_lv0032->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $mowh_lv0032->lv009;?>"/>
						<input type="hidden" name="txtlv010" id="txtlv010" value="<?php echo $mowh_lv0032->lv010;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $mowh_lv0032->lv011;?>"/>
						<input type="hidden" name="txtlv012" id="txtlv012" value="<?php echo $mowh_lv0032->lv012;?>"/>
						<input type="hidden" name="txtlv013" id="txtlv013" value="<?php echo $mowh_lv0032->lv013;?>"/>
						<input type="hidden" name="txtlv014" id="txtlv014" value="<?php echo $mowh_lv0032->lv014;?>"/>	
...
div.innerHTML='<?php echo $mowh_lv0032->ArrPush[0];?>';	
</script>
</html>