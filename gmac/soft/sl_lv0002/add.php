...
$lvsl_lv0002->lv001=InsertWithCheckExt('sl_lv0002', 'lv001', '',0);
if($_GET['ID']=="")
$lvsl_lv0002->lv002=$_POST['txtlv002'];
else
$lvsl_lv0002->lv002=$_GET['ID'];
$lvsl_lv0002->lv003=$_POST['txtlv003'];
$lvsl_lv0002->lv004=$_POST['txtlv004'];
$lvsl_lv0002->lv005=GetServerDate()." ".GetServerTime();
$lvsl_lv0002->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvsl_lv0002->LV_Insert();
		if($vresult==true) {
