...
include("../paras.php");
include("../../clsall/hr_menu0014.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","HR0207.txt",$plang);
//init object
$mohr_menu0014=new hr_menu0014();
//Set variant
$mohr_menu0014->itemlst=$pitemlst;
$mohr_menu0014->childlst=$pchildlst;
$mohr_menu0014->level3lst=$plevel3lst;
$mohr_menu0014->child3lst=$pchild3lst;
$vEmpName = "";
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($mohr_menu0014->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
					</select>
	...
	<?php
	$mohr_menu0014->Dir="../";
include($mohr_menu0014->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $mohr_menu0014->level3lst;?>";
