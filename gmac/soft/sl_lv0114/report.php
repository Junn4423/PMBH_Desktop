...
$mosl_lv0114->ArrPush[21]=$vLangArr[41];
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mosl_lv0114->lv002=base64_decode($_GET['ID']);
...
?>
						...
						<?php echo $mosl_lv0114->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
