...
/////////Varian////////////////	
$mosl_lv0070->LV_Load();
$mosl_lv0073->obj_conf=$mosl_lv0070;	
...
<body onLoad="moveImgPrint()" onResize="moveImgPrint()">
	<table border="0" cellpadding="0" cellspacing="0" width="940px" align="center">
	    ...
	    <td align="center" colspan="6"><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" valign="middle"  ondblclick="this.innerHTML=''"><img  src="<?php echo $mosl_lv0073->GetLogo();?>" /></td>
              </tr>
              <tr>
		...
		<tr height="40px">
			<td width="399" valign="middle" class="address">
				<div id="addr" align="left" style="width:480px;">
					<?php echo $mosl_lv0073->GetCompany();?>
				<br><?php echo $vLangArr[18].":".$mosl_lv0073->GetAddress();?>	
					<br><?php echo $vLangArr[15].":".$mosl_lv0073->GetPhone()."&nbsp;&nbsp;&nbsp;".$vLangArr[16].":".$mosl_lv0073->GetFax();?>
		  </div></td>
...
?>			
		...
		<tr>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				...
				switch($vOptRun)
				{	case 4:
						echo $strDataShow = $mosl_lv0073->PrintInOutPutInStockEmp($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv007,$vlv007_opt);
						break;
					case 3:
						echo $strDataShow = $mosl_lv0073->PrintInOutPutInStockCustomer($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv007,$vlv007_opt);
						break;
					case 2:
						echo $strDataShow = $mosl_lv0073->PrintInOutPutInStockSum($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv007,$vlv007_opt);
						break;
					case 1:
						echo $strDataShow = $mosl_lv0073->PrintInOutPutInStock($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv007,$vlv007_opt);
						break;
					case 5:
						echo $strDataShow = $mosl_lv0073->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv007,$vlv007_opt);
						break;
						
					default:
						echo $strDataShow = $mosl_lv0073->PrintInOutPutInStockInvoiceSum($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv007,$vlv007_opt);
						break;
				}
				?></td>
		</tr>
