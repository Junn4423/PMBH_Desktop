...
if($vFlag==1)
{
$lvac_lv0018->lv001_=$_POST['txtlv001_'];
$lvac_lv0018->lv002='0';
...
$lvac_lv0018->LV_LoadID($lvac_lv0018->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="hidden" id="txtlv001"  value="<?php echo $lvac_lv0018->lv001;?>" tabindex="5" maxlength="32" style="width:40%" onKeyPress="return CheckKey(event,7)" readonly="true"/>
									<input readonly="true" name="txtlv001_" type="text" id="txtlv001_"  value="<?php echo $lvac_lv0018->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						    </tr>
							<tr>
...
<tr>
						 ...
						 <tr>
								...
								<td width="178"  height="20">
									<select name="txtlv022" id="txtlv022"   tabindex="7"  style="width:80%" onKeyPress="return CheckKeys(event,7,this)"><?php echo $lvac_lv0018->LV_LinkField('lv022',$lvac_lv0018->lv022);?></select>
								</td>
					      </tr>		
						<tr>
