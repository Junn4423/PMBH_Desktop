...
//////////////init object////////////////
$lvac_lv0018=new ac_lv0018($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ac0018');
...
if(isset($_GET['ajax']))
{
	...
	$vLangArr=GetLangFile("../../","AC0008.txt",$plang);
$lvac_lv0018->lang=strtoupper($plang);
$curPage=(int)$_POST['curPg'];	
$vFlag=(int)$_POST['txtFlag'];
$vNow=GetServerDate();
$lvac_lv0018->lv001=$_POST['txtlv001'];
$lvac_lv0018->lv002='0';
$lvac_lv0018->lv003=$_POST['txtlv003'];
$lvac_lv0018->lv004=$_POST['txtlv004'];
$lvac_lv0018->lv005=$_POST['txtlv005'];
$lvac_lv0018->lv006=$_POST['txtlv006'];
$lvac_lv0018->lv007=$_POST['txtlv007'];
$lvac_lv0018->lv008=getInfor($_SESSION['ERPSOFV2RUserID'],2);
$lvac_lv0018->lv009=$_POST['txtlv009'];
if($lvac_lv0018->lv009=="" || $lvac_lv0018->lv009==NULL) $lvac_lv0018->lv009=$vNow;
$lvac_lv0018->lv010=$_POST['txtlv010'];
$lvac_lv0018->lv011=$_POST['txtlv011'];
$lvac_lv0018->lv012=$_POST['txtlv012'];
$lvac_lv0018->lv013=$_POST['txtlv013'];
$lvac_lv0018->lv014=$_POST['txtlv014'];
if($lvac_lv0018->lv014=="" || $lvac_lv0018->lv014==NULL) $lvac_lv0018->lv014=$vNow;
$lvac_lv0018->lv015=$_POST['txtlv015'];
$lvac_lv0018->lv016=$_POST['txtlv016'];
$lvac_lv0018->lv018=$_POST['txtlv018'];
$lvac_lv0018->lv022=$_POST['txtlv022'];
if($lvac_lv0018->lv022=="" || $lvac_lv0018->lv022==NULL) $lvac_lv0018->lv022="TRUONGNAM";
if($vFlag==1)
{
		
		$vresult=$lvac_lv0018->LV_Insert();
		if($vresult==true) {
			...
			$lvac_lv0018->lv009=$_POST['txtlv009'];
			$lvac_lv0018->lv014=$_POST['txtlv014'];
			$lvac_lv0018->lv001=InsertWithCheck('ac_lv0004', 'lv001', 'PT-'.getmonth($vNow)."/".getyear($vNow)."-",3);
			if($vresult==true) {
			$vStrMessage=$vLangArr[9];
			$vFlag = 1;
			} else{
...
?>
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
							...
							<tr>
							 ...
							 <tr>
								...
								<td width="178"  height="20">
									<select onblur="changecompany_change(this.value)" name="txtlv022" id="txtlv022"   tabindex="4"  style="width:80%" onKeyPress="return CheckKeys(event,7,this)"><?php echo $lvac_lv0018->LV_LinkField('lv022',$lvac_lv0018->lv022);?></select>
								</td>
					      </tr>		
							<tr>
								<td width="166"  height="20"><?php echo $vLangArr[15];?></td>
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvac_lv0018->lv001=="")?InsertWithCheck('ac_lv0004', 'lv001', 'PT-'.getmonth($vNow)."/".getyear($vNow)."-",3):$lvac_lv0018->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><table width="80%"><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"><?php echo $lvac_lv0018->LV_LinkField('lv003',$lvac_lv0018->lv003);?></select>
								</td><td>
				  ...
				  <td  height="20"><table width="80%"><tr><td width="50%"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvac_lv0018->lv004;?>" tabindex="8" maxlength="100" style="width:100%" onKeyPress="return CheckKey(event,7)"/>
				  <td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvac_lv0018->lv005;?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
						    </tr>
								<tr>
							  <td  height="20"><?php echo $vLangArr[20];?></td>
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvac_lv0018->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
								<td width="166"  height="20" valign="top"><?php echo $vLangArr[21];?></td>
								<td width="178"  height="20"><input name="txtlv007" id="txtlv007"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvac_lv0018->lv007;?>"></td>
					      </tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[22];?></td>
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvac_lv0018->lv008;?>"></td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20"><input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvac_lv0018->FormatView($lvac_lv0018->lv009,2);?>">
				  ...
				  <td  height="20"><table width="80%"><tr><td width="50%"><select name="txtlv010" id="txtlv010"   tabindex="14"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"><?php echo $lvac_lv0018->LV_LinkField('lv010',$lvac_lv0018->lv010);?></select>
				  </td><td>
							...
							<tr>
							  ...
							  <td  height="20"><table width="80%"><tr><td width="50%"><select name="txtlv011" id="txtlv011"   tabindex="15"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"><?php echo $lvac_lv0018->LV_LinkField('lv011',$lvac_lv0018->lv011);?></select>
							  </td><td>
							  ...
							  <td  height="20"><input name="txtlv012" type="text" id="txtlv012" value="<?php echo (float)$lvac_lv0018->lv012;?>" tabindex="16" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>		
<tr>
								<td width="166"  height="20"><?php echo $vLangArr[27];?></td>
								<td width="178"  height="20">
									<input name="txtlv013" type="text" id="txtlv013"  value="<?php echo $lvac_lv0018->lv013;?>" tabindex="17" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
					      </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[28];?></td>
							  <td  height="20"><input name="txtlv014" type="text" id="txtlv014"  value="<?php echo  $lvac_lv0018->FormatView($lvac_lv0018->lv014,2);?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						      <img tabindex="18" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
								...
								<td width="178"  height="20">
									<input name="txtlv015" type="text" id="txtlv015"  value="<?php echo $lvac_lv0018->lv015;?>" tabindex="19" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
					      </tr>			
					      <tr>
								<td width="166"  height="20"><?php echo $vLangArr[36];?></td>
								<td width="178"  height="20">
									<input name="txtlv018" type="text" id="txtlv018"  value="<?php echo $lvac_lv0018->lv018;?>" tabindex="19" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
					      </tr>		
...
<script language="javascript"> var o=document.frmadd; resizeFrameAll(document.body.offsetWidth,o.offsetHeight);
		...
		function stateChanged()
		{
			if (xmlhttp.readyState==4)
			{
				...
				document.getElementById('txtlv001').value=domainid;
				
				document.getElementById('txtlv001').focus();
			}
		}
