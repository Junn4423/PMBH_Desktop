		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f1f1f1">
			...
			<tr>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><table width="80%"><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
							  <option value="">...</option>
							  <?php echo $lvac_lv0018->LV_LinkField('lv003',$vlv003);?></select>
								</td><td>
				  ...
				  <td  height="20"><table width="80%"><tr><td width="50%"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="8" maxlength="100" style="width:100%" onKeyPress="return CheckKey(event,7)"/>
				  <td>
...
<tr>
								...
								<td width="178"  height="20"><input name="txtlv007" id="txtlv007"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $vlv007;?>"></td>
					      </tr>
							<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $vlv009;?>">
				  ...
				  <td  height="20"><table width="80%"><tr><td width="50%"><select name="txtlv010" id="txtlv010"   tabindex="14"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
				  <option value="">...</option>
				  <?php echo $lvac_lv0018->LV_LinkField('lv010',$vlv010);?></select>
				  </td><td>
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $lvac_lv0018->LV_LinkField('lv011',$vlv011);?></select></td><td>
...
<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv014" type="text" id="txtlv014"  value="<?php echo  $vlv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv015" type="text" id="txtlv015"  value="<?php echo $vlv015;?>" tabindex="19" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
					      </tr>	
							<tr>
								<td width="166"  height="20"><?php echo $vLangArr[36];?></td>
								<td width="178"  height="20">
									<input name="txtlv018" type="text" id="txtlv018"  value="<?php echo $vlv018;?>" tabindex="19" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
					      </tr>		
							<tr>
								<td width="166"  height="20"><?php echo 'Chọn chi nhánh';?></td>
								<td width="178"  height="20">
									<select name="txtlv022" id="txtlv022"   tabindex="7"  style="width:80%" onKeyPress="return CheckKeys(event,7,this)"><option value="">...</option>
									<?php echo $lvac_lv0018->LV_LinkField('lv022',$vlv022);?></select>
								</td>
					      </tr>		
						  <tr>
