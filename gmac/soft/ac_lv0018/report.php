...
$moac_lv0018->ArrPush[18]=$vLangArr[35];
$moac_lv0018->ArrPush[19]=$vLangArr[36];
$moac_lv0018->ArrPush[20]=$vLangArr[37];
$moac_lv0018->ArrPush[21]=$vLangArr[38];
$moac_lv0018->ArrPush[22]=$vLangArr[39];
$moac_lv0018->ArrPush[23]=$vLangArr[40];
$moac_lv0018->ArrPush[24]=$vLangArr[41];
$moac_lv0018->ArrPush[25]=$vLangArr[42];
$moac_lv0018->ArrPush[26]=$vLangArr[43];
$moac_lv0018->ArrPush[27]=$vLangArr[44];
$moac_lv0018->ArrPush[28]=$vLangArr[45];
$moac_lv0018->ArrPush[29]=$vLangArr[46];
$moac_lv0018->ArrPush[30]=$vLangArr[47];
$moac_lv0018->ArrPush[31]=$vLangArr[48];
$moac_lv0018->ArrPush[32]=$vLangArr[49];
$moac_lv0018->ArrPush[33]=$vLangArr[50];
$moac_lv0018->ArrPush[34]=$vLangArr[51];
$moac_lv0018->ArrPush[35]=$vLangArr[52];
$moac_lv0018->ArrPush[36]=$vLangArr[53];
$moac_lv0018->ArrPush[37]=$vLangArr[54];
$moac_lv0018->ArrPush[38]=$vLangArr[55];
$moac_lv0018->ArrPush[39]=$vLangArr[56];
$moac_lv0018->ArrPush[40]=$vLangArr[57];
$moac_lv0018->ArrPush[41]=$vLangArr[58];
$moac_lv0018->ArrPush[42]=$vLangArr[59];
$moac_lv0018->ArrPush[43]=$vLangArr[60];
...
$moac_lv0018->ArrFunc[5]='';
$moac_lv0018->ArrFunc[6]='';
$moac_lv0018->ArrFunc[7]='';
$moac_lv0018->ArrFunc[8]=$vLangArr[10];
$moac_lv0018->ArrFunc[9]=$vLangArr[12];
$moac_lv0018->ArrFunc[10]=$vLangArr[0];
$moac_lv0018->ArrFunc[11]=$vLangArr[63];
$moac_lv0018->ArrFunc[12]=$vLangArr[64];
$moac_lv0018->ArrFunc[13]=$vLangArr[65];
$moac_lv0018->ArrFunc[14]=$vLangArr[66];

////Other
$moac_lv0018->ArrOther[1]=$vLangArr[61];
$moac_lv0018->ArrOther[2]=$vLangArr[62];
//////Delete message///
$lvMessage=array();
...
?>
						...
						<?php echo $moac_lv0018->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
