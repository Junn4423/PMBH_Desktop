...
$lvhr_lv0086->lv001=getInfor($_SESSION['ERPSOFV2RUserID'],2);
...
if($lvhr_lv0086->lv015=="" || $lvhr_lv0086->lv015==NULL) $lvhr_lv0086->lv015=getmonth($vNow);
$lvhr_lv0086->lv016=$_POST['txtlv016'];
if($lvhr_lv0086->lv016=="" || $lvhr_lv0086->lv016==NULL) $lvhr_lv0086->lv016=getyear($vNow);
$lvhr_lv0086->lv002=$vNow." ".GetServerTime();
if($vFlag==1)
{		
	$vresult=$lvhr_lv0086->LV_InsertMonth();
	if($vresult==true) {
