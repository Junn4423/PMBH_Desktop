...
$lvsl_lv0011->lv001=$_POST['txtlv001'];
$lvsl_lv0011->lv002=$_GET['ChildID'];
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0011->lv001=="")?InsertWithCheckExt('sl_lv0011', 'lv001', '',10):$lvsl_lv0011->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
...
<tr>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv008" id="txtlv008"  style="width:80%"  tabindex="12"  value="<?php echo (float)$lvsl_lv0011->lv008;?>">					  </td>
						    </tr>
							<tr>
