...
require_once("../../clsall/sl_lv0011.php");
//////////////init object////////////////
$lvsl_lv0011=new sl_lv0011($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0013');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvsl_lv0011->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0024.txt",$plang);
$mosl_lv0011->lang=strtoupper($plang);
$curPage=(int)$_POST['curPg'];	
$vFlag=(int)$_POST['txtFlag'];
if($vFlag==1)
{
$lvsl_lv0011->lv002=$_POST['txtlv002'];
$lvsl_lv0011->lv003=$_POST['txtlv003'];
$lvsl_lv0011->lv004=$_POST['txtlv004'];
$lvsl_lv0011->lv005=$_POST['txtlv005'];
$lvsl_lv0011->lv006=$_POST['txtlv006'];
$lvsl_lv0011->lv007=$_POST['txtlv007'];
$lvsl_lv0011->lv008=$_POST['txtlv008'];
$lvsl_lv0011->lv009=$_POST['txtlv009'];
$lvsl_lv0011->lv010=$_POST['txtlv010'];
$lvsl_lv0011->lv011=$_POST['txtlv011'];
$lvsl_lv0011->lv012=$_POST['txtlv012'];
		
		$vresult=$lvsl_lv0011->LV_Update();
		if($vresult==true) {
...
$lvsl_lv0011->LV_LoadID($lvsl_lv0011->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvsl_lv0011->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>		</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvsl_lv0011->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvsl_lv0011->LV_LinkField('lv003',$lvsl_lv0011->lv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvsl_lv0011->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvsl_lv0011->LV_LinkField('lv005',$lvsl_lv0011->lv005);?>
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvsl_lv0011->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvsl_lv0011->LV_LinkField('lv007',$lvsl_lv0011->lv007);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvsl_lv0011->lv008;?>"/>							  </td>
						    </tr>
							<tr>
							  ...
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:200px"onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0011->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','sl_lv0017','lv003')" onFocus="LoadSelf(this,'txtlv009','sl_lv0017','lv003')">
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvsl_lv0011->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							  <tr>
							  <td  height="20"><?php echo $vLangArr[25];?></td>
				  <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvsl_lv0011->lv011;?>" tabindex="15" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	 	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[26];?></td>
				  <td  height="20"><input  name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvsl_lv0011->lv012;?>" tabindex="16" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						<tr>
