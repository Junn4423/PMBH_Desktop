...
$lvsl_lv0058->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
...
{
$lvsl_lv0058->lv002='0';
$lvsl_lv0058->lv003=$_POST['txtlv003'];
$lvsl_lv0058->lv004=$_POST['txtlv004'];
$lvsl_lv0058->lv005=$_POST['txtlv005'];
$lvsl_lv0058->lv006=$_POST['txtlv006'];
$lvsl_lv0058->lv007=$_POST['txtlv007'];
$lvsl_lv0058->lv008=getInfor($_SESSION['ERPSOFV2RUserID'],2);
$lvsl_lv0058->lv009=$_POST['txtlv009'];
$lvsl_lv0058->lv010=$_POST['txtlv010'];
$lvsl_lv0058->lv011=$_POST['txtlv011'];
$lvsl_lv0058->lv012=$_POST['txtlv012'];
$lvsl_lv0058->lv013=$_POST['txtlv013'];
$lvsl_lv0058->lv014=$_POST['txtlv014'];
$lvsl_lv0058->lv015=$_POST['txtlv015'];
$lvsl_lv0058->lv016=$_POST['txtlv016'];
$lvsl_lv0058->lv018=$_POST['txtlv018'];
$lvsl_lv0058->lv019=$_POST['txtlv019'];				
		$vresult=$lvsl_lv0058->LV_Update();
		if($vresult==true) {
...
$lvsl_lv0058->LV_LoadID($lvsl_lv0058->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0058->lv001=="")?InsertWithCheckExt('ac_lv0004', 'lv001', '',1):$lvsl_lv0058->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
