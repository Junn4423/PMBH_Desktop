...
<?php
	...
	$vorder=1;
	$sqlS = "SELECT A.*,B.lv003 CateID,B.lv002 ItemName,C.lv002 UnitName,D.lv002 ProgName FROM sl_lv0014 A inner join sl_lv0007 B on A.lv003=B.lv001 left join sl_lv0005 C on A.lv005=C.lv001 left join sl_lv0059 D on A.lv009=D.lv001 WHERE A.lv101<>1 and B.lv003 not in ($vlsCate) and A.lv002='".$mosl_lv0013->lv001."' and trim(A.lv015)='".trim($vroworder['vorder'])."' order by A.lv015 asc,A.lv001 asc";
	$bResult = db_query($sqlS);
	$sumMoney=0;
	$sumScore=0;
	$sumDiscount=0;
