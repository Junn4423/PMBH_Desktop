...
if($vFlag==1)
{
		...
		$vresult=$lvhr_lv0002->LV_Update();
		if($vresult==true) {
			$vStrMessage=$vLangArr[18];
			$vFlag=1;
		} else{
			$vStrMessage=$vLangArr[19].sof_error();
			$vFlag=0;
		}

}

$lvhr_lv0002->LV_LoadID($lvhr_lv0002->lv001);
...
function isphone(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvhr_lv0002->lv002;?>";
		o.txtlv003.value="<?php echo $lvhr_lv0002->lv003;?>";
		o.txtlv004.value="<?php echo $lvhr_lv0002->lv004;?>";
		o.txtlv005.value="<?php echo $lvhr_lv0002->lv005;?>";	
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvhr_lv0002->lv001;?>" /></td>
							</tr>
							<tr>
						  ...
						  <div id="lv_popup" lang="lv_popup1"> </div>						  
							...
							<tr>
							  ...
							  <td  height="20px"><input  name="txtlv003" type="text" id="txtlv003" value="<?php echo $lvhr_lv0002->lv003;?>" tabindex="8	" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
<tr>
				  ...
				  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvhr_lv0002->lv004;?>" tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvhr_lv0002->lv005;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>
							<tr>
