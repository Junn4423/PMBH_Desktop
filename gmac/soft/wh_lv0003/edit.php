...
$lvwh_lv0003->lv007=$_FILES['userfile']['name'];
...
$lvwh_lv0003->LV_LoadID($lvwh_lv0003->lv001);
					...
					<form action="#" name="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0003->lv001=="")?InsertWithCheckExt('wh_lv0003', 'lv001', '',10):$lvwh_lv0003->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
...
<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0003->lv009;?>"></td>
						    </tr>
                          <tr>
...
<tr>
				  ...
				  <td  height="20"><input  name="txtlv017" type="text" id="txtlv017" value="<?php echo $lvwh_lv0003->lv017;?>" tabindex="21" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						  ...
						  <tr>
							  ...
							  <td  height="20"><table style="width:80%"><tr>
							  <td width="50%"><select name="txtlv018" id="txtlv018"   tabindex="22"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  	<option value="">...</option>
