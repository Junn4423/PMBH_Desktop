...
/////////Get ID///////////////
$lvsl_lv0027->lv001=$_GET['ChildID'];
...
$lvsl_lv0027->LV_LoadID($lvsl_lv0027->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvsl_lv0027->lv002;?>";
		o.txtlv003.value="<?php echo $lvsl_lv0027->lv003;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
...
<tr>
				  ...
				  <td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <?php echo $lvsl_lv0027->LV_LinkField('lv003',$lvsl_lv0027->lv003);?>
							  </select>	</td>
						  </tr>	
							<tr>
