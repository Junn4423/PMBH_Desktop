...
require_once("../../clsall/sl_lv0027.php");
//////////////init object////////////////
$lvsl_lv0027=new sl_lv0027($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0019');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0038.txt",$plang);

$curPage=(int)$_POST['curPg'];	
$vFlag=(int)$_POST['txtFlag'];
$lvsl_lv0027->lv001=InsertWithCheckExt('sl_lv0027', 'lv001', '',0);
if($_GET['ID']=="")
$lvsl_lv0027->lv002=$_POST['txtlv002'];
else
$lvsl_lv0027->lv002=$_GET['ID'];
$lvsl_lv0027->lv003=$_POST['txtlv003'];

if($vFlag==1)
{
		
		$vresult=$lvsl_lv0027->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvsl_lv0027->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvsl_lv0027->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/><br>
							  <table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20px"><input  name="txtlv003" type="text" id="txtlv003" value="<?php echo $lvsl_lv0027->lv003;?>" tabindex="7" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>																	
							<tr>
