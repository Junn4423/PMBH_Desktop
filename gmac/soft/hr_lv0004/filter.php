...
require_once("../paras.php");
//////////////init object////////////////
$lvhr_lv0004=new hr_lv0004($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0004');
					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv003" type="text" id="txtlv003"  tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"><?php echo $lvhr_lv0004->LV_LinkField('lv003',$lvhr_lv0004->lv003);?></select></td>
