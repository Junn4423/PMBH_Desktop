...
if($vFlag==1)
{
$lvwh_lv0008->lv001_=$_POST['txtlv001_'];	
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="hidden" id="txtlv001"  value="<?php echo $lvwh_lv0008->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			
									<input name="txtlv001_" type="text" id="txtlv001_"  value="<?php echo $lvwh_lv0008->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)"/>	</td>
						    </tr>
							<tr>
