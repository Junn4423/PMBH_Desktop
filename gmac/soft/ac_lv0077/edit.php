...
//require_once("../../clsall/ac_lv0077.php");
...
require_once("../../clsall/ac_lv0077.php");
//////////////init object////////////////
$lvac_lv0077=new ac_lv0077($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ac0077');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvac_lv0077->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","AC0025.txt",$plang);
$moac_lv0077->lang=strtoupper($plang);
$curPage=(int)$_POST['curPg'];	
$vFlag=(int)$_POST['txtFlag'];
if($vFlag==1)
{
$lvac_lv0077->lv002=$_POST['txtlv002'];
$lvac_lv0077->lv003=$_POST['txtlv003'];
$lvac_lv0077->lv004=$_POST['txtlv004'];
$lvac_lv0077->lv005=$_POST['txtlv005'];
$lvac_lv0077->lv006=$_POST['txtlv006'];
$lvac_lv0077->lv007=$_POST['txtlv007'];
$lvac_lv0077->lv016=GetServerDate()." ".GetServerTime();
		
		$vresult=$lvac_lv0077->LV_Update();
		if($vresult==true) {
...
$lvac_lv0077->LV_LoadID($lvac_lv0077->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvac_lv0077->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><input name="txtlv003" type="text"  id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvac_lv0077->lv003;?>"/>			</td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[18];?></td>
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvac_lv0077->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvac_lv0077->LV_LinkField('lv005',$lvac_lv0077->lv005);?>
							  </select><br>
							  <table><tr><td>
							  <ul id="pop-nav" lang="pop-nav1" onkeyup="ChangeName(this,1)" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:200px" onKeyUp="LoadPopup(this,'txtlv005','ac_lv0002','concat(lv001,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv005','ac_lv0002','concat(lv001,@! @!,lv002)')" tabindex="200" >
...
<tr>
								...
								<td width="178"  height="20"><select name="txtlv006" id="txtlv006"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  <?php echo $lvac_lv0077->LV_LinkField('lv006',$lvac_lv0077->lv006);?>
							  ...
							  <ul id="pop-nav2" lang="pop-nav2" onkeyup="ChangeName(this,2)" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch2" id="txtlvsearch2" style="width:200px" onKeyUp="LoadPopup(this,'txtlv006','ac_lv0002','concat(lv001,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv006','ac_lv0002','concat(lv001,@! @!,lv002)')" tabindex="200" >
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv007" id="txtlv007"  style="width:80%"  tabindex="12"  value="<?php echo $lvac_lv0077->lv007;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
						<tr>
