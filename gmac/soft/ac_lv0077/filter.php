					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv003" type="text"  id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $vlv003;?>"/>			</td>
						    </tr>
<tr>
							...
							<tr>
							  ...
							  <?php echo $lvac_lv0077->LV_LinkField('lv005',$vlv005);?>
							  </select><br>
							  <table><tr><td>
...
<tr>
								...
								<td width="178"  height="20"><select name="txtlv006" id="txtlv006"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value="">...</option>
							  <?php echo $lvac_lv0077->LV_LinkField('lv006',$vlv006);?>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv007" id="txtlv007"  style="width:80%"  tabindex="12"  value="<?php echo $vlv007;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>					  
						  <tr>
