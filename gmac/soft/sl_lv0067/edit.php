...
/////////Get ID///////////////
$lvtc_lv0007->lv001=$_GET['ChildDetailID'];
...
if($vFlag==1)
{
		$lvtc_lv0007->lv002=$_POST['txtlv002'];
...
$lvtc_lv0007->LV_LoadID($lvtc_lv0007->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv003.value="<?php echo $lvtc_lv0007->lv003;?>";
		o.txtlv004.value="<?php echo $lvtc_lv0007->lv004;?>";
		o.txtlv005.value="<?php echo $lvtc_lv0007->lv005;?>";
		o.txtlv006.value="<?php echo $lvtc_lv0007->lv006;?>";		
		o.txtlv007.value="<?php echo $lvtc_lv0007->lv007;?>";	
		o.txtlv008.value="<?php echo $lvtc_lv0007->lv008;?>";	
		o.txtlv002.focus();
	}
	function Cancel()
	{
