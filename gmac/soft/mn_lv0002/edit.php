...
$lvmn_lv0002->lv007=$_FILES['userfile']['name'];
...
$lvmn_lv0002->LV_LoadID($lvmn_lv0002->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvmn_lv0002->lv001=="")?InsertWithCheckExt('mn_lv0002', 'lv001', 'CUS',7):$lvmn_lv0002->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
...
<tr>
								...
								<td width="178"  height="20"><input name="txtlv007" id="txtlv007"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvmn_lv0002->lv007;?>" type="text"/>							 </td>
					      </tr>
							<tr>
