...
<tr>
								...
								<option value="">...</option>
							  <?php echo $lvsl_lv0113->LV_LinkField('lv007',$vlv007);?>
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $lvsl_lv0113->LV_LinkField('lv008',$vlv008);?>
							  </select><br><table><tr><td>
				  ...
				  <td  height="20"><select name="txtlv011" id="txtlv011"   tabindex="16"  style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							
							  <?php echo $lvsl_lv0113->LV_LinkField('lv011',$vlv011);?>
							  <option value="" <?php echo ($vlv011=="")?'selected="selected"':'';?>>...</option>
							  </select></td>
						  </tr>		
						    <tr>
								...
								<option value="">...</option>
							  <?php echo $lvsl_lv0113->LV_LinkField('lv012',$vlv012);?>
							  </select>	<br><table><tr><td>
