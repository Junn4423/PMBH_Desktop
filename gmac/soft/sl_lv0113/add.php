...
//////////////init object////////////////
$lvsl_lv0113=new sl_lv0113($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0113');
...
$lvsl_lv0113->lv001=$_POST['txtlv001'];
if($_GET['ID']=="")
$lvsl_lv0113->lv002=$_POST['txtlv002'];
else
$lvsl_lv0113->lv002=$_GET['ID'];
$lvsl_lv0113->lv003=$_POST['txtlv003'];
$lvsl_lv0113->lv004=$_POST['txtlv004'];
$lvsl_lv0113->lv005=$_POST['txtlv005'];
$lvsl_lv0113->lv006=$_POST['txtlv006'];
$lvsl_lv0113->lv007=$_POST['txtlv007'];
$lvsl_lv0113->lv008=$_POST['txtlv008'];
$lvsl_lv0113->lv009=$_POST['txtlv009'];
$lvsl_lv0113->lv010=$_POST['txtlv010'];
$lvsl_lv0113->lv011=$_POST['txtlv011'];
$lvsl_lv0113->lv012=$_POST['txtlv012'];
$lvsl_lv0113->lv013=$_POST['txtlv013'];
$lvsl_lv0113->lv014=$_POST['txtlv014'];
$lvsl_lv0113->lv015=0;
$lvsl_lv0113->lv016=$_POST['txtlv016'];
$lvsl_lv0113->lv017=$_POST['txtlv017'];	
$lvsl_lv0113->lv022=$_POST['txtlv022'];	
if($vFlag==1)
{
		
		$vresult=$lvsl_lv0113->LV_Insert();
		if($vresult==true) {
			$lvsl_lv0114=new sl_lv0114($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0016');
			$lvsl_lv0114->LV_InsertOther($vresult=$lvsl_lv0113->lv012,$vresult=$lvsl_lv0113->lv001);
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0113->lv001=="")?InsertWithCheckExt('sl_lv0113', 'lv001', '',10):$lvsl_lv0113->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
                            <tr>
							  <td  height="20"><?php echo $vLangArr[34];?></td>
				  <td  height="20"><input  name="txtlv016" type="text" id="txtlv016" value="<?php echo $lvsl_lv0113->lv016;?>" tabindex="5" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20">
							  <table width="80%"><tr><td width="50%">
							  <input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvsl_lv0113->lv002;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" readonly="true"/>
							  </td>
							  <td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv003" id="txtlv003"   tabindex="7"  style="width:40%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0113->lv003;?>" type="text"/>	<input name="txtlv014" id="txtlv014"   tabindex="7"  style="width:40%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0113->lv014;?>" type="text"/>	</td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[18];?></td>
				  <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0113->FormatView($lvsl_lv0113->lv004,2);?>"/><span class="td"><img tabindex="8" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvsl_lv0113->FormatView($lvsl_lv0113->lv005,2);?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="9"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvsl_lv0113->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							  <tr>
								<td width="166"  height="20" valign="top"><?php echo $vLangArr[21];?></td>
								<td width="178"  height="20">
								<table width="80%"><tr><td width="50%"><select name="txtlv007" id="txtlv007"   tabindex="11"  style="width:100%" onKeyPress="return CheckKey(event,7)"/>
							  <?php echo $lvsl_lv0113->LV_LinkField('lv007',$lvsl_lv0113->lv007);?>
							  </select></td><td>
						  ...
						  <tr>
							  ...
							  <td  height="20"><input name="txtlv022" type="text" id="txtlv022" value="<?php echo (float)$lvsl_lv0113->lv022;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							<tr>
							  ...
							  <?php echo $lvsl_lv0113->LV_LinkField('lv008',$lvsl_lv0113->lv008);?>
							  </select>
							  </td>
							  <td>
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $lvsl_lv0113->LV_LinkField('lv015',$lvsl_lv0113->lv013);?>
							  </select>							  </td>
							  </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20"><textarea name="txtlv009" rows="20" id="txtlv009" style="width:80%" tabindex="13"><?php echo $lvsl_lv0113->lv009;?></textarea></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[33];?></td>
							...
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20"><textarea name="txtlv013" rows="20" id="txtlv013" style="width:80%" tabindex="14"><?php echo $lvsl_lv0113->lv013;?></textarea></td>
						    </tr>
                          <tr>
							  <td  height="20"><?php echo $vLangArr[24];?></td>
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvsl_lv0113->LV_UserID;?>" tabindex="14" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
						  </tr>	
						  <tr>
                                ...
                                <option value="">...</option>
							  <?php echo $lvsl_lv0113->LV_LinkField('lv012',$lvsl_lv0113->lv012);?>
							  </select>
							  </td>
							  <td>
                          ...
                          <tr>
                                ...
                                <option value="">...</option>
							  <?php echo $lvsl_lv0113->LV_LinkField('lv017',$lvsl_lv0113->lv017);?>
							  </select>
							  </td>
							  <td>
							  <ul id="pop-nav6" lang="pop-nav6" onMouseOver="ChangeName(this,6)" onkeyup="ChangeName(this,6)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv017_search" id="txtlv017_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv017','sl_lv0113','concat(lv003,@! @!,lv016,@! @!,lv001)')" onFocus="LoadPopup(this,'txtlv017','sl_lv0113','concat(lv003,@! @!,lv016,@! @!,lv001)')" tabindex="200" >
