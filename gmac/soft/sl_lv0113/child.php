...
require_once("../paras.php");
require_once("../../clsall/lv_menusl0113.php");
...
//init object
$lv_menusl0113=new lv_menusl0113();
//Set variant
$lv_menusl0113->itemlst=$pitemlst;
$lv_menusl0113->childlst=$pchildlst;
$lv_menusl0113->level3lst=$plevel3lst;
$lv_menusl0113->child3lst=$pchild3lst;
...
<div id="content_child">
                ...
                <td><TABLE id="toolbar" cellSpacing="0" cellPadding="0" border="0" width="100%">
					<TBODY>
	 			 	...
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)" style="width:80px">
						<option value="1" <?php echo ($lv_menusl0113->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
					...
					<input type="hidden" name="txtFlagDocument" id="txtFlagDocument" />
							...
							<TD  class="toolbar_<?php echo ($lv_menusl0113->level3lst==1)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(1);">
	...
	<?php
	$lv_menusl0113->Dir="../";
include($lv_menusl0113->GetLinkEmp());
?>
	</div></div></td>
              </tr>
            </table>
...
document.frmhr_employee.cbxoption.value="<?php echo $lv_menusl0113->level3lst;?>";
