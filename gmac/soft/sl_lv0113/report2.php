...
$vOrderList="1,2,3,6,7,8,9,10,4,5,11,12,13,14,15,16,17,18,19";
/////////////init object//////////////
...
if($mosl_lv0113->GetView()==1)
{
  $mosl_lv0113->LV_LoadID($vlv001);
	...
	$vFieldList="lv002,lv003,lv004,lv005,lv009,lv010,lv011,lv012,lv013";
	else
	$vFieldList="lv002,lv003,lv004,lv005,lv008,lv009,lv010,lv011,lv012,lv013";
	 $strDetail=$mosl_lv0114->LV_BuilListReportOther($vFieldList,'document.frmchoose','chkAll','lvChk',0, 1000,$paging,$vOrderList,$mosl_lv0113->lv006,1);
...
<body  onkeyup="KeyPublicRun(event)">
  ...
  <tr>
    <td align="center"><?php echo str_replace("<!--strAttack-->",$strDetail,$mosl_lv0113->lv013);?></td>
  </tr>
</table>
</body>
<?php
	if(trim($mosl_lv0113->lv013)=="")
	{
?>
