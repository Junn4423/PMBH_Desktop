...
/////////////init object//////////////
$mowh_lv0012=new wh_lv0012($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0009');
...
$mowh_lv0012->ArrPush[16]=$vLangArr[33];
...
$mowh_lv0012->ArrFunc[11]=$vLangArr[36];
$mowh_lv0012->ArrFunc[12]=$vLangArr[37];
$mowh_lv0012->ArrFunc[13]=$vLangArr[38];
$mowh_lv0012->ArrFunc[14]=$vLangArr[39];
$mowh_lv0012->ArrFunc[15]=$vLangArr[40];
////Other
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mowh_lv0012->lv002=base64_decode($_GET['ID']);
...
?>
						...
						<?php echo $mowh_lv0012->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
