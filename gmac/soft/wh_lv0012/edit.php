...
require_once("../../clsall/wh_lv0012.php");
//////////////init object////////////////
$lvwh_lv0012=new wh_lv0012($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0012');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvwh_lv0012->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
...
if($vFlag==1)
{
$lvwh_lv0012->lv002=$_POST['txtlv002'];
$lvwh_lv0012->lv003=$_POST['txtlv003'];
$lvwh_lv0012->lv004=$_POST['txtlv004'];
$lvwh_lv0012->lv005=$_POST['txtlv005'];
$lvwh_lv0012->lv006=$_POST['txtlv006'];
$lvwh_lv0012->lv007=$_POST['txtlv007'];
$lvwh_lv0012->lv008=$_POST['txtlv008'];
$lvwh_lv0012->lv009=$_POST['txtlv009'];
$lvwh_lv0012->lv010=$_POST['txtlv010'];
$lvwh_lv0012->lv011=$_POST['txtlv011'];
$lvwh_lv0012->lv012=$_POST['txtlv012'];
$lvwh_lv0012->lv013=$_POST['txtlv013'];
		
		$vresult=$lvwh_lv0012->LV_Update();
		if($vresult==true) {
...
$lvwh_lv0012->LV_LoadID($lvwh_lv0012->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0012->lv001=="")?InsertWithCheckExt('wh_lv0012', 'lv001', '',10):$lvwh_lv0012->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvwh_lv0012->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20">
							  <table width="80%" border=0><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><?php echo $lvwh_lv0012->LV_LinkField('lv003',$lvwh_lv0012->lv003);?>
							  </select></td><td>
...
<tr>
	              ...
	              <td  height="20"><input type="hidden" name="txtlv004old" id="txtlv004old" value="<?php echo $lvwh_lv0012->lv004;?>" />
			                  <input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvwh_lv0012->lv004;?>"/></td>
</tr>							  
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[19];?></td>
							  <td  height="20"><table width="80%" border=0><tr><td width="50%"><select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  <?php echo $lvwh_lv0012->LV_LinkField('lv005',$lvwh_lv0012->lv005);?>
							  </select></td><td>
							  ...
							  <td  height="20"><input type="hidden" name="txtlv006old" id="txtlv006old" value="<?php echo $lvwh_lv0012->lv006;?>" /><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvwh_lv0012->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvwh_lv0012->LV_LinkField('lv007',$lvwh_lv0012->lv007);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv008" id="txtlv008"  style="width:80%"  tabindex="12"  value="<?php echo (float)$lvwh_lv0012->lv008;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20"><table width="80%" border=0><tr><td width="50%"><select name="txtlv009" id="txtlv009"   tabindex="13"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  <?php echo $lvwh_lv0012->LV_LinkField('lv009',$lvwh_lv0012->lv009);?>
							  </select></td><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv009_search" id="txtlv009_search" tabindex="200" style="width:100%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0012->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','hr_lv0018','lv002')" onFocus="LoadSelf(this,'txtlv009','hr_lv0018','lv002')">
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvwh_lv0012->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							 <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[25];?></td>
							  <td  height="20">
							  <table width="80%" border=0><tr><td width="50%"><select name="txtlv011" id="txtlv011"   tabindex="15"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
							  <?php echo $lvwh_lv0012->LV_LinkField('lv011',$lvwh_lv0012->lv011);?>
							  </select></td><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							...
							<tr>
							  ...
							  <td  height="20"><table width="80%" border=0><tr><td width="50%"><select name="txtlv012" id="txtlv012"   tabindex="16"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  <?php echo $lvwh_lv0012->LV_LinkField('lv012',$lvwh_lv0012->lv012);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20"><table width="80%" border=0><tr><td width="50%"><select name="txtlv013" id="txtlv013"   tabindex="17"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  <?php echo $lvwh_lv0012->LV_LinkField('lv013',$lvwh_lv0012->lv013);?>
							  </select></td><td>
