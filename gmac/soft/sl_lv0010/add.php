...
$lvsl_lv0010->lv001=$_POST['txtlv001'];
$vNow=GetServerDate();
if($_GET['ID']=="")
...
if($lvsl_lv0010->lv004=="" || $lvsl_lv0010->lv004==NULL) $lvsl_lv0010->lv004=$vNow;
$lvsl_lv0010->lv005=$_POST['txtlv005'];
if($lvsl_lv0010->lv005=="" || $lvsl_lv0010->lv005==NULL) $lvsl_lv0010->lv005=LV_DATE_ADD($vNow,30);
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0010->lv001=="")?InsertWithCheckExt('sl_lv0010', 'lv001', '',10):$lvsl_lv0010->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvsl_lv0010->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>
							    	<br>
							  <table><tr><td>
...
<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvsl_lv0010->LV_LinkField('lv008',$lvsl_lv0010->lv008);?>
							  </select><br>
							  <table><tr><td>
