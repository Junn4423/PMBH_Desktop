...
require_once("../paras.php");
require_once("../../clsall/lv_menusl0010.php");
...
//init object
$lv_menusl0010=new lv_menusl0010();
//Set variant
$lv_menusl0010->itemlst=$pitemlst;
$lv_menusl0010->childlst=$pchildlst;
$lv_menusl0010->level3lst=$plevel3lst;
$lv_menusl0010->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($lv_menusl0010->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$lv_menusl0010->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<!--<option value="3" <?php echo ((int)$lv_menusl0010->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>-->
	...
	<?php
	$lv_menusl0010->Dir="../";
include($lv_menusl0010->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $lv_menusl0010->level3lst;?>";
