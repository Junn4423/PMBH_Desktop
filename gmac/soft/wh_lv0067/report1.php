...
////Init object//////////////
		...
		$mowh_lv0013 = new wh_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0013');
		$mohr_lv0002 = new hr_lv0002($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0002');	
		
		$mowh_lv0067->path_server="";
$mowh_lv0067->path_web="";
/////////Varian////////////////		
		...
		<tr>
			<td align="center" colspan="6">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<td align="center">
							<font style="font-size:14px;font-weight:bold"><?php echo $mowh_lv0067->GetCompany();?></font>
							<br/>
							<div>
							Địa chỉ:<?php echo $mowh_lv0067->GetAddress();?>
...
?>  
		...
		<tr class="address"><td colspan="6" height="35px">
		<strong><?php echo ($vDSKho!='')?(($plang=='VN')?'Kho: ':'Warehouse: ').$vDSKho:(($plang=='VN')?'Tất cả các kho':'All warehouse');?>&nbsp;</strong>
		<?php
		if($vlv004!='')
		{
			$mowh_lv0013->LV_LoadID($vlv004);
			$mohr_lv0002->LV_LoadID($vlv005);
			if($mohr_lv0002->lv003!='') echo '<br/>'.$mowh_lv0013->lv002.': '.$mohr_lv0002->lv003;
		}
		if($vlv011!='')
		{
			$mohr_lv0020->LV_LoadID($vlv011);
			echo '<br/>Nhân viên nhận kho: '.$mohr_lv0020->lv002.'('.$vlv011.')';
		}
		?>
		</td></tr>
		<tr>
						...
						switch($vOptRun)
							{
								case 2:
									if($vQuiDoi==1)
										$strDataShow = $mowh_lv0067->PrintInOutPutInStockDetailQuiDoi($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012,$vlv011);
									else
										$strDataShow = $mowh_lv0067->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012,$vlv011);
									break;
								case 3:
									if($vQuiDoi==1)
										$strDataShow = $mowh_lv0067->PrintInOutPutInStockDetailQuiDoi($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012,$vlv011);
									else
										$strDataShow = $mowh_lv0067->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),1,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012,$vlv011);									
									break;
								case 4:
									if($vQuiDoi==1)
										$strDataShow = $mowh_lv0067->PrintInOutPutInStockDetailQuiDoi($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012,$vlv011);
									else
										$strDataShow = $mowh_lv0067->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),4,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012,$vlv011);									
									break;
								case 5:
									if($vQuiDoi==1)
										$strDataShow = $mowh_lv0067->PrintInOutPutInStockDetailQuiDoi($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$isbalance,$vlv012,$vlv011);
									else
										$strDataShow = $mowh_lv0067->PrintInOutCompareDay($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),4,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$vlv011);									
									break;
								case 6:
									$strDataShow = $mowh_lv0067->PrintInOutCompareMonth($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),4,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage,$vlv011);									
									break;
							}
