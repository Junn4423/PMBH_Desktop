...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$mowh_lv0005->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"wh_lv0005",$lvMessage);
}
elseif($flagID==2)
{
$mowh_lv0005->lv001=$_POST['txtlv001'];
$mowh_lv0005->lv002=$_POST['txtlv002'];
$mowh_lv0005->lv003=$_POST['txtlv003'];
$mowh_lv0005->lv004=$_POST['txtlv004'];
$mowh_lv0005->lv005=$_POST['txtlv005'];
$mowh_lv0005->lv006=$_POST['txtlv006'];
$mowh_lv0005->lv007=$_POST['txtlv007'];
$mowh_lv0005->lv008=$_POST['txtlv008'];
$mowh_lv0005->lv009=$_POST['txtlv009'];
$mowh_lv0005->lv010=$_POST['txtlv010'];
$mowh_lv0005->lv011=$_POST['txtlv011'];
$mowh_lv0005->lv012=$_POST['txtlv012'];
}
//first is load
if($_POST["txtFlag"]=="")
{
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&ChildID=<?php echo $_GET['ChildID'];?>&ID=<?php echo $_GET['ID']?>&<?php  echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mowh_lv0005->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mowh_lv0005->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $mowh_lv0005->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $mowh_lv0005->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $mowh_lv0005->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $mowh_lv0005->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $mowh_lv0005->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $mowh_lv0005->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $mowh_lv0005->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $mowh_lv0005->lv009;?>"/>
						<input type="hidden" name="txtlv010" id="txtlv010" value="<?php echo $mowh_lv0005->lv010;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $mowh_lv0005->lv011;?>"/>
