...
/////////Get ID///////////////
$lvac_lv0034->lv001=$_GET['ChildID'];
...
if($vFlag==1)
{
		$lvac_lv0034->lv002=$_POST['txtlv002'];
		$lvac_lv0034->lv003=$_POST['txtlv003'];
		$lvac_lv0034->lv004=$_POST['txtlv004'];
		$lvac_lv0034->lv005=$_POST['txtlv005'];
		if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
		{
		$lvac_lv0034->lv006=$_FILES['userfile']['name'];
		}
		else
			{
			$lvac_lv0034->lv006=$_POST['txtlv006'];	
			}		
		$vresult=$lvac_lv0034->LV_Update();
		if($vresult==true) {
			if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
			{
			UploadImg($lvac_lv0034->lv002."_".$lvac_lv0034->lv001, $lvac_lv0034->lv006);
			}
...
function UploadImg($folder_name, $fname){
	...
	$path = "../../images/human/File/ac_outcome/";
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvac_lv0034->lv002;?>";
		o.txtlv003.value="<?php echo $lvac_lv0034->lv003;?>";
		o.txtlv004.value="<?php echo $lvac_lv0034->lv004;?>";
		o.txtlv005.value="<?php echo $lvac_lv0034->lv005;?>";
		o.txtlv006.value="<?php echo $lvac_lv0034->lv006;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
						...
						?>
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvac_lv0034->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvac_lv0034->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
<tr>
				  ...
				  <td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <?php echo $lvac_lv0034->LV_LinkField('lv003',$lvac_lv0034->lv003);?>
							  </select>	</td>
						  </tr>								
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvac_lv0034->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
						  
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvac_lv0034->FormatView($lvac_lv0034->lv005,2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <input name="txtlv006" type="hidden" id="txtlv006" value="<?php echo $lvac_lv0034->lv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>				 
							<tr>
