...
$lvac_lv0034->lv001=InsertWithCheckExt('ac_lv0034', 'lv001', '',0);
$lvac_lv0034->lv002=$_GET['ChildID'];
$lvac_lv0034->lv003=$_POST['txtlv003'];
$lvac_lv0034->lv004=$_POST['txtlv004'];
$lvac_lv0034->lv005=GetServerDate()." ".GetServerTime();
$lvac_lv0034->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvac_lv0034->LV_Insert();
		if($vresult==true) {
