...
require_once("../paras.php");
require_once("../../clsall/ml_menusl0004.php");
...
//init object
$ml_menusl0004=new ml_menusl0004();
//Set variant
$ml_menusl0004->itemlst=$pitemlst;
$ml_menusl0004->childlst=$pchildlst;
$ml_menusl0004->level3lst=$plevel3lst;
$ml_menusl0004->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($ml_menusl0004->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$ml_menusl0004->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$ml_menusl0004->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
	...
	<?php
	$ml_menusl0004->Dir="../";
include($ml_menusl0004->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $ml_menusl0004->level3lst;?>";
