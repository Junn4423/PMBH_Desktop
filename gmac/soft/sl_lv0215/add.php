...
$lvsl_lv0214->lv001=$_POST['txtlv001'];
$lvsl_lv0214->lv002=$_GET['ChildID'];
...
if($vFlag==1)
{
		...
		$vresult=$lvsl_lv0214->LV_Insert();
		if($vresult==true) {
...
<body onkeyup="KeyPublicRun(event)"><div id="content_child" ><div class="story"><h2 id="pageName"><?php echo $vLangArr[0];?></h2><h3><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td>
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0214->lv001=="")?InsertWithCheckExt('sl_lv0214', 'lv001', '',1):$lvsl_lv0214->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
				  ...
				  <td  height="20"><input name="txtlv014" id="txtlv014"   tabindex="18"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0214->FormatView($lvsl_lv0214->lv014,4);?>"/><span class="td"><img tabindex="18" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
							...
							<td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo (int)$lvsl_lv0214->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
							<tr>
