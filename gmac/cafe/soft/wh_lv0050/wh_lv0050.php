...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$mowh_lv0050->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"wh_lv0050",$lvMessage);
}
elseif($flagID==2)
{
$mowh_lv0050->lv001=$_POST['txtlv001'];
$mowh_lv0050->lv002=$_POST['txtlv002'];
$mowh_lv0050->lv003=$_POST['txtlv003'];
}
...
$mowh_lv0050->SaveOperation($_SESSION['ERPSOFV2RUserID'],'wh_lv0050',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
{
	var str="<br><iframe id='lvframefrm' height=250 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>wh_lv0050?&func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
...
<body  onkeyup="KeyPublicRun(event)">
					...
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?><?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mowh_lv0050->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mowh_lv0050->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002"  value="<?php echo $mowh_lv0050->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003"  value="<?php echo $mowh_lv0050->lv003;?>"/>
...
div.innerHTML='<?php echo $mowh_lv0050->ArrPush[0];?>';	
</script>
</html>