...
$lvwh_lv0052->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
...
{
$lvwh_lv0052->lv002='1';
$lvwh_lv0052->lv003=$_POST['txtlv003'];
$lvwh_lv0052->lv004=$_POST['txtlv004'];
$lvwh_lv0052->lv005=$_POST['txtlv005'];
$lvwh_lv0052->lv006=$_POST['txtlv006'];
...
$lvwh_lv0052->lv013=$_POST['txtlv013'];
$lvwh_lv0052->lv014=$_POST['txtlv014'];
$lvwh_lv0052->lv015=$_POST['txtlv015'];
$lvwh_lv0052->lv016=$_POST['txtlv016'];
$lvwh_lv0052->lv018=$_POST['txtlv018'];
$lvwh_lv0052->lv019=$_POST['txtlv019'];		
		$vresult=$lvwh_lv0052->LV_Update();
		if($vresult==true) {
...
$lvwh_lv0052->LV_LoadID($lvwh_lv0052->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0052->lv001=="")?InsertWithCheckExt('ac_lv0004', 'lv001', '',1):$lvwh_lv0052->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
