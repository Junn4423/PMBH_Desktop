...
require_once("../../clsall/wh_lv0053.php");
//////////////init object////////////////
$lvwh_lv0053=new wh_lv0053($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0053');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvwh_lv0053->lv001=$_GET['ChildID'];
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0062.txt",$plang);
...
$lvwh_lv0053->lv003=getInfor($_SESSION['ERPSOFV2RUserID'],2);
$lvwh_lv0053->lv004=$_POST['txtlv004'];
$lvwh_lv0053->lv005=$_POST['txtlv005'];
$lvwh_lv0053->lv006=$_POST['txtlv006'];
$lvwh_lv0053->lv007=$_POST['txtlv007'];
$lvwh_lv0053->lv008=$_POST['txtlv008'];
$lvwh_lv0053->lv009=$_POST['txtlv009'];
$lvwh_lv0053->lv010=$_POST['txtlv010'];
$lvwh_lv0053->lv011=$_POST['txtlv011'];
$lvwh_lv0053->lv012=$_POST['txtlv012'];
$lvwh_lv0053->lv013=$_POST['txtlv013'];
$lvwh_lv0053->lv014=$_POST['txtlv014'];
$lvwh_lv0053->lv015=$_POST['txtlv015'];
$lvwh_lv0053->lv016=$_POST['txtlv016'];
		
		$vresult=$lvwh_lv0053->LV_Update();
		if($vresult==true) {
...
$lvwh_lv0053->LV_LoadID($lvwh_lv0053->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0053->lv001=="")?InsertWithCheckExt('wh_lv0053', 'lv001', '',10):$lvwh_lv0053->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
							  ...
							  <table width="80%"><tr><td width="50%"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:100%" onkeypress="return CheckKeys(event,7,this)">
							   <?php echo $lvwh_lv0053->LV_LinkField('lv002',$lvwh_lv0053->lv002);?>
                              </select>
                              </td>
                              <td>
...
<tr>
								...
								<td  height="20"><input type="text" name="txtlv003" id="txtlv003"   tabindex="7" style="width:80%" onkeypress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0053->lv003;?>" readonly="readonly" />
							  				 </td>
					      </tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[18];?></td>
							  <td  height="20"></select>
							  <input name="txtlv004" type="text" id="txtlv004"  value="<?php echo $lvwh_lv0053->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <br></td></tr>
							<tr>
							  ...
							  <td  height="20"><table width="80%"><tr><td width="50%"><select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
								<?php echo $lvwh_lv0053->LV_LinkField('lv005',$lvwh_lv0053->lv005);?>
							  </select>
							  </td>
							  <td>
							  <ul id="pop-nav3" lang="pop-nav3" onMouseOver="ChangeName(this,3)" onkeyup="ChangeName(this,3)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv005_search" id="txtlv005_search" style="width:200px" onKeyUp="LoadPopup(this,'txtlv005','wh_lv0013','lv002')" onFocus="LoadPopup(this,'txtlv005','wh_lv0013','lv002)')" tabindex="200" >
						  ...
						  <tr>
							  ...
							  <td  height="20"></select>
							  <input name="txtlv006" type="text" id="txtlv006"  value="<?php echo $lvwh_lv0053->lv006;?>" tabindex="10" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <br></td></tr>
							<tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvwh_lv0053->FormatView($lvwh_lv0053->lv009,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20"><textarea name="txtlv008" rows="20" id="txtlv008" style="width:80%" tabindex="13" ><?php echo $lvwh_lv0053->lv008;?></textarea></td>
						    </tr>		
						<tr>
