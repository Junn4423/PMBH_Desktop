...
$lvsl_lv0014->lv001=$_POST['txtlv001'];
$lvsl_lv0014->lv002=$_GET['ChildID'];
$lvsl_lv0014->lv003=$_POST['txtlv003'];
$lvsl_lv0014->lv004=$_POST['txtlv004'];
$lvsl_lv0014->lv005=$_POST['txtlv005'];
$lvsl_lv0014->lv006=$_POST['txtlv006'];
$lvsl_lv0014->lv007=$_POST['txtlv007'];
$lvsl_lv0014->lv008=$_POST['txtlv008'];
$lvsl_lv0014->lv009=$_POST['txtlv009'];
$lvsl_lv0014->lv010=$_POST['txtlv010'];
$lvsl_lv0014->lv011=$_POST['txtlv011'];
$lvsl_lv0014->lv012=$_POST['txtlv012'];
$lvsl_lv0014->lv013=$_POST['txtlv013'];
$lvsl_lv0014->lv014=$_POST['txtlv014'];

if($vFlag==1)
{
		
		$vresult=$lvsl_lv0014->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0014->lv001=="")?InsertWithCheckExt('sl_lv0014', 'lv001', '',1):$lvsl_lv0014->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvsl_lv0014->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvsl_lv0014->LV_LinkField('lv003',$lvsl_lv0014->lv003);?>
							  </select>	<br>
							  <table><tr><td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:200px" onKeyUp="LoadPopup(this,'txtlv003','sl_lv0007','concat(lv001,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv003','sl_lv0007','concat(lv001,@! @!,lv002)')" tabindex="200" >
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvsl_lv0014->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvsl_lv0014->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <ul id="pop-nav3" lang="pop-nav3" onMouseOver="ChangeName(this,3)" onkeyup="ChangeName(this,3)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch3" id="txtlvsearch3" style="width:200px" onKeyUp="LoadPopup(this,'txtlv007','hr_lv0018','lv002')" onFocus="LoadPopup(this,'txtlv007','hr_lv0018','lv002')" tabindex="200" >
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvsl_lv0014->lv008;?>"/>							  </td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20"><table><tr><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" name="txtlv009" id="txtlv009" tabindex="13"  value="<?php echo $lvsl_lv0014->lv009;?>" style="width:200px"onKeyPress="return CheckKey(event,7)"  onKeyUp="LoadSelf(this,'txtlv009','sl_lv0017','lv003')" onFocus="LoadSelf(this,'txtlv009','sl_lv0017','lv003')">
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvsl_lv0014->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							  <tr>
				  ...
				  <td  height="20"><select name="txtlv011" id="txtlv011"   tabindex="15"  style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <ul id="pop-nav3" lang="pop-nav3" onMouseOver="ChangeName(this,3)" onkeyup="ChangeName(this,3)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch3" id="txtlvsearch3" style="width:200px" onKeyUp="LoadPopup(this,'txtlv011','sl_lv0029','lv002')" onFocus="LoadPopup(this,'txtlv011','sl_lv0029','lv002')" tabindex="200" >
				  ...
				  <td  height="20"><input  name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvsl_lv0014->lv012;?>" tabindex="16" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
                            <tr>
							  <td  height="20"><?php echo $vLangArr[27];?></td>
				  <td  height="20"><input name="txtlv013" id="txtlv013"   tabindex="17"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0014->FormatView($lvsl_lv0014->lv013,2);?>"/><span class="td"><img tabindex="8" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
				  ...
				  <td  height="20"><input name="txtlv014" id="txtlv014"   tabindex="18"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0014->FormatView($lvsl_lv0014->lv014,2);?>"/><span class="td"><img tabindex="8" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
