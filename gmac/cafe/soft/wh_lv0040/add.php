...
$data = array();
  ...
  function add_person( $lv003, $lv004, $lv005,$lv006,$lv007,$lv008,$lv009,$lv014,$lv015)
  {
  global $data;
...
if($vFlag==1)
{
	 ...
	 if ( $_FILES['file']['tmp_name'] )
	  ...
	  foreach ($rows as $row)
	  {
	  	...
	  	add_person( $lv003, $lv004, $lv005,$lv006,$lv007,$lv008,$lv009,$lv014,$lv015);
	  }
	  $first_row = false;
	  }
  }
foreach( $data as $row )
{
	...
	{
	$lvwh_lv0040->lv001=InsertWithCheckExt('wh_lv0040', 'lv001', '',1);
	$lvwh_lv0040->lv002=getInfor($_SESSION['ERPSOFV2RUserID'],2);
	$lvwh_lv0040->lv003=$lvsl_lv0007->lv001;
	$lvwh_lv0040->lv004=$row['lv004'];
	$lvwh_lv0040->lv005=$row['lv005'];
	$lvwh_lv0040->lv006=$row['lv006'];
	$lvwh_lv0040->lv007=$row['lv007'];
	$lvwh_lv0040->lv008=$row['lv008'];
	$lvwh_lv0040->lv009=$row['lv009'];
	$lvwh_lv0040->lv014=$row['lv014'];
	$lvwh_lv0040->lv015=$row['lv015'];
	$lvwh_lv0040->lv016=$lvNow;
	
	$vresult=$lvwh_lv0040->LV_Insert();
	}
}
		if($vresult==true) {
