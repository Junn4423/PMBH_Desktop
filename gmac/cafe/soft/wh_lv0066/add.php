...
$lvwh_lv0066->lv001=$_POST['txtlv001'];
$lvwh_lv0066->lv002=$_GET['ChildID'];
$lvwh_lv0066->lv003=$_POST['txtlv003'];
$lvwh_lv0066->lv004=$_POST['txtlv004'];
$lvwh_lv0066->lv005=$_POST['txtlv005'];
$lvwh_lv0066->lv006=$_POST['txtlv006'];
$lvwh_lv0066->lv007=$_POST['txtlv007'];
$lvwh_lv0066->lv008=$_POST['txtlv008'];
$lvwh_lv0066->lv009=$_POST['txtlv009'];
$lvwh_lv0066->lv010=$_POST['txtlv010'];
$lvwh_lv0066->lv011=$_POST['txtlv011'];
$lvwh_lv0066->lv012=$_POST['txtlv012'];
$lvwh_lv0066->lv013=$_POST['txtlv013'];
$lvwh_lv0066->lv014=$_POST['txtlv014'];
$lvwh_lv0066->lv015=$_POST['txtlv015'];
if($vFlag==1)
{
		
		$vresult=$lvwh_lv0066->LV_Insert();
		if($vresult==true) {
...
<body onkeyup="KeyPublicRun(event)"><div id="content_child" ><div class="story"><h2 id="pageName"><?php echo $vLangArr[0];?></h2><h3><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td>
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0066->lv001=="")?InsertWithCheckExt('wh_lv0066', 'lv001', '',1):$lvwh_lv0066->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvwh_lv0066->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  ...
							  <table width="80%">
								<tr><td width="50%">
										<select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><?php echo $lvwh_lv0066->LV_LinkField('lv003',$lvwh_lv0066->lv003);?>
										</select></td>
									<td>
							...
							<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvwh_lv0066->lv004;?>"/></td>
							</tr>							  
							<tr>
							  ...
							  <?php echo $lvwh_lv0066->LV_LinkField('lv005',$lvwh_lv0066->lv005);?>
							  </select></td><td>
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvwh_lv0066->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							<tr>
							  ...
							  <?php echo $lvwh_lv0066->LV_LinkField('lv007',$lvwh_lv0066->lv007);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvwh_lv0066->lv008;?>"/>							  </td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvwh_lv0066->LV_LinkField('lv099',$lvwh_lv0066->lv009);?>
							  </select></td><td>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvwh_lv0066->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							  <tr>
							  <td  height="20"><?php echo $vLangArr[25];?></td>
				  <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvwh_lv0066->lv011;?>" tabindex="15" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	 	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[26];?></td>
				  <td  height="20"><input  name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvwh_lv0066->lv012;?>" tabindex="16" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
                            <tr>
							  <td  height="20"><?php echo $vLangArr[27];?></td>
				  <td  height="20"><input name="txtlv013" id="txtlv013"   tabindex="17"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0066->FormatView($lvwh_lv0066->lv013,4);?>"/><span class="td"><img tabindex="18" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
				  ...
				  <td  height="20"><input name="txtlv014" id="txtlv014"   tabindex="18"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0066->FormatView($lvwh_lv0066->lv014,4);?>"/><span class="td"><img tabindex="18" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							...
							<td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo (int)$lvwh_lv0066->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
							<tr>
