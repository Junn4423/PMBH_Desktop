...
require_once("../clsall/wh_lv0067.php");

/////////////init object//////////////
$mowh_lv0067=new  wh_lv0067($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0067');
/////////////init object//////////////
...
$vNow=GetServerDate();
$mowh_lv0067->lv002=getyear($vNow)."-".getmonth($vNow)."-"."01";
$mowh_lv0067->lv003=$vNow;
//$ma=$_GET['ma'];
...
function LoadType(to)
	{
		...
		{
			case 'KIEMKHO':
				LoadPopupParent(to,'txtlv005','wh_lv0004','concat(lv005,@! @!,lv002,@! @!,lv001)');
				break;
			case 'BANHANG':
			...
			case 'TRAHANG':
				...
				break;
			case 'CHINHANH':
				LoadPopupParent(to,'txtlv005','hr_lv0002','concat(lv003,@! - @!,lv001)');
				break;
			case 'MUAHANG':
			...
			case 'CUS':
				...
				break;
			case 'WEBTRANSAC':
				LoadPopupParentSecond(to,'txtlv005','wb_lv0016','concat(lv002,@! @!,lv005,@! @!,lv009,@! @!,lv015,@! =@!,lv001)');
				break;
		}
	}
...
?>
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                    ...
                    <input type="hidden" name="lang" value="<?php echo $plang;?>" />
					 <table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20">
							  <input name="txtlv001" type="hidden" id="txtlv001" value="<?php echo $morp_lv0005->lv001;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> 
								<div style="max-height:200px;overflow:auto">
							  		<?php echo $mowh_lv0067->GetBuilCheckListDept($mowh_lv0067->lv001,'chklv001',10,'wh_lv0001','lv002',$mowh_lv0067->lv001);?>
								</div>
							<!--  <select name="txtlv001" id="txtlv001"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
							   				<?php
												if($mowh_lv0067->GetApr()==11)
												{
												?>
												<option value="">...</option>
												<?php
												...
												?>
							  <?php //echo $mowh_lv0067->LV_LinkField('lv002',$mowh_lv0067->lv002);?>
							 
                              </select>-->							    </td>
							</tr><tr>
				      <td  height="20"><?php echo $vLangArr[2];?></td>
				      <td  height="20"><input name="txtlv002" type="text" id="txtlv002" value="<?php echo formatdate($mowh_lv0067->lv002,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				      ...
				      <td  height="20"><input name="txtlv003" type="text" id="txtlv003" value="<?php echo formatdate($mowh_lv0067->lv003,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				        <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
						 ...
						 <tr>
							  ...
							  <option value="">...</option>
							  <?php echo $mowh_lv0067->LV_LinkField('lv004',$mowh_lv0067->lv004);?>
						  ...
						  <tr>
							  ...
							  <td  height="20">
							   <table width="80%"><tr><td width="50%">
							    <input name="txtlv005" type="text" id="txtlv005"  value="<?php echo $mowh_lv0067->lv005;?>" tabindex="10" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7)"/>
							    </td>
							    <td>
						 ...
						 <tr>
							  ...
							  <td  height="20">
							  <table width="80%"><tr><td width="50%">
							   <!--<input name="txtlv006" type="text" id="txtlv006"  value="<?php echo $mowh_lv0067->lv006;?>" tabindex="7" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7)"/>
							  --><select name="txtlv006" id="txtlv006"   tabindex="7"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
							    
							  <option value="">...</option>
							  <?php echo $mowh_lv0067->LV_LinkField('lv006',$mowh_lv0067->lv006);?>
							  </select>
							  </td>
							  <td>
							...
							<tr>
							  <td  height="20" valign="top"><?php echo 'Người nhận kho';?></td>
							  <td  height="20">
								<table width="80%"><tr><td width="50%">
									<input name="txtlv011" type="text" id="txtlv011"  value="<?php echo $mowh_lv0067->lv011;?>" tabindex="7" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7)"/>								
								</td>
								<td>
									<ul id="pop-nav22" lang="pop-nav22" onMouseOver="ChangeName(this,22)" onkeyup="ChangeName(this,22)"> <li class="menupopT">
										<input type="text" autocomplete="off" class="search_img_btn" name="txtlv011_search" id="txtlv011_search" style="width:100%" onKeyUp="LoadPopupParent(this,'txtlv011','hr_lv0020','concat(lv002,@! @!,lv001)')" onFocus="LoadPopupParent(this,'txtlv011','hr_lv0020','concat(lv002,@! @!,lv001)')" tabindex="200" >
                             ...
                             <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[39];?></td>
							 	<td  height="20">
								<input name="txtlv008" type="hidden" id="txtlv008" value="<?php echo $mowh_lv0067->lv008;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
									<div style="width:100%;height:100px;overflow:scroll;"> 
									<?php echo $mowh_lv0067->GetBuilCheckList($mowh_lv0067->lv008,'chklv008',10);?>
								</div>
								</td>
						    </tr>
							<tr>
				  ...
				  <td  height="20">
							  <table width="80%"><tr><td width="50%">
							  <input  name="txtlv007" type="text" id="txtlv007" value="<?php echo $mowh_lv0067->lv007;?>" tabindex="9" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" />
							  </td>
							  <td>
				  ...
				  <td  height="20">
							  <table width="80%"><tr><td width="50%">
							  <input  name="txtlv009" type="text" id="txtlv009" value="<?php echo $mowh_lv0067->lv009;?>" tabindex="9" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" />
							  </td>
							  <td>
						  ...
						  <tr>
							...
							<td>
							<input name="txtlv012" type="hidden" id="txtlv012" value="<?php echo $morp_lv0005->lv012;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mowh_lv0067->GetBuilCheckListGia($mowh_lv0067->lv012,'chklv012',10,'','lv002',$mowh_lv0067->lv012);?>	
							</td>
						  </tr>
						  <tr>
					   ...
					   <tr><td colspan="2"><?php echo $vLangArr[40];?><input type="checkbox" value="1" name="txtexist" checked="checked" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="lotcurview" name="lotcurview" style="display:none"> <?php echo $vLangArr[47];?> <input type="checkbox" value="1" name="txtexistcur" /></div></td></tr>
						...
						<tr><td colspan="2"><?php echo 'Chọn mẫu có qui đổi';?><input type="checkbox" value="1" name="txtquidoi" checked="checked" /> </td></tr>
						<tr>
