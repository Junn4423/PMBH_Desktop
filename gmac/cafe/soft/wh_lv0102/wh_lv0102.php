...
<head>
    ...
    .bt_setdefaultmini {
        width: <?php echo ($lvsl_lv0070->lv009==0)?100:$lvsl_lv0070->lv009-10;
        ?>px !important;
    }

    .viewlift {
        width: <?php echo ($lvsl_lv0070->lv009==0)?90:($lvsl_lv0070->lv009);
        ?>px !important;
    }
    </style>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <link rel="stylesheet" href="<?php echo $vDir;?>../css/<?php echo getInfor($_SESSION['ERPSOFV2RUserID'],99);?>.css"
        type="text/css">
    ...
    function LoadItem() {
        var o = document.frmadd;
        ajax_do('wh_lv0102/wh_lv0102exce.php?&lang=<?php echo $plang;?>&childfunc=load' + '&lv002=' + o.txtlv903.value,
            1);
    ...
    function LoadSource() {
        ...
        switch (vo) {
            ...
            case 'TRAHANG':
                break;
            case 'MUAHANG':
                ajax_do('wh_lv0102/wh_lv0102excesource.php?&lang=<?php echo $plang;?>&childfunc=load' + '&lv002=' + o
    ...
    function Report(vValue) {
        ...
        o.target = "_blank";
        o.action = "<?php echo $vDir;?>wh_lv0102?func=<?php echo $_GET['func'];?>&childfunc=rptretail&ID=" + vValue +
            "&lang=<?php echo $plang;?>";
        o.submit();
    }
    ...
    function ReportMoreEmpty(vValue) {
        ...
        var o = document.frmprocess;
        o.target = "_blank";
        o.action = "<?php echo $vDir;?>wh_lv0102?func=<?php echo $_GET['func'];?>&childfunc=rptempty&ID=" + vValue +
            "&lang=<?php echo $plang;?>";
        o.submit();
    }
    ...
    function notSpecialChar(evt) {
        ...
        if (charCode == 75 || charCode == 72 || charCode == 8 || charCode == 46 || charCode == 9 || charCode == 39 ||
        ...
        <li>
            <div onclick="CombackHome()" style="cursor:pointer;background:#eaeaea;padding:7px;">
                &nbsp;&nbsp;&nbsp;&nbsp;<img src="images/controlright/move_f2.png" height="25" alt="Cancel"
                    name="cancel" title="Quay lại trang chủ" border="0" align="middle" id="cancel">&nbsp;&nbsp;&nbsp;
        </li>
    </ul>
</div>
<?php
...
<body onkeyup="KeyPublicRun(event)">
    <form name="frmadd" id="frmadd" id="frmadd" method="POST"
        action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0);?>"
        autocomplete="off">
        ...
        <div class="hd_cafe">
            <div style="clear:both;padding:5px;font:bold 18px Arial,Tahoma;line-height:35px;">
                <div style="float:left;width:105px;padding-right:5px;">
                    <input readonly="true" class="kk_txtContractID" type="textbox" title="Mã nhập kho"
                        name="txtContractID" id="txtContractID"
                        style="width:100px;text-align:center;height:20px;color:blue"
                        value="<?php echo ($lvwh_lv0008->lv001=='')?'Mã nhập kho':$lvwh_lv0008->lv001;?>"
                        onblur="ChangeOrderID(this.value)"><input type="hidden" name="txtContractIDOld"
                        id="txtContractIDOld" style="width:80px;text-align:center;height:20px;color:blue"
                        value="<?php echo $lvwh_lv0008->lv001;?>">
                </div>
                ...
                <div style="float:left;width:75px;padding-right:5px;">
                    <input class="kk_txtcontractend" style="width:70px;text-align:center;height:20px;color:blue"
                        onblur="if(this.value == '') {this.value = this.title;} else {UpdateContract(this,5);}"
                        onfocus="ProcessDateMore(); if(this.value == this.title) {this.value = '';}  "
                        value="<?php echo ($lvwh_lv0008->lv005!="" && $lvwh_lv0008->lv005!=NULL)?$lvwh_lv0008->FormatView($lvwh_lv0008->lv005,2):$lvwh_lv0008->FormatView($vNow,2);?>"
                        title="Ngày kiểm" class="textview" name="txtcontractend" id="txtcontractend" type="text"
                        tabindex="50"
                        ondblclick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtcontractend);return false;"
                        readonly="true" />
                </div>
                <div style="float:left;width:100px;padding-right:5px;">
                    <input class="kk_txtcontractnote" style="width:95px;text-align:center;height:20px;color:blue"
                        onblur="if(this.value == '') {this.value = this.title;} else {UpdateContract(this,9);}"
                        onfocus="if(this.value == this.title) this.value = '';"
                        value="<?php echo ($lvwh_lv0008->lv006!="" && $lvwh_lv0008->lv006!=NULL)?$lvwh_lv0008->lv006:'Ghi chú';?>"
                        title="Ghi chú" class="textview" name="txtcontractnote" id="txtcontractnote" type="text"
                        tabindex="50" />
                    <div style="display:none" id="tongsoluongkho"></div>
                </div>
                <div style="float:left;width:65px;padding-top:7px;height:30px;" id="kk_del">
                    <center>
                        <img tabindex="2" border="0" title="Xoá phiếu" class="imgButton" onclick="DelPhieu()"
                            onmouseout="this.src='../images/iconcontrol/btn_delete.jpg';"
                            onmouseover="this.src='../images/iconcontrol/btn_delete_02.jpg';"
                            src="../images/iconcontrol/btn_delete.jpg" onkeypress="return CheckKey(event,11)">
                    </center>
                </div>

                <div style="float:left;width:95px;padding-right:5px;">
                    <select class="kk_txtkho" name="txtlv994" id="txtlv994" onblur="UpdateContract(this,94)"
                        tabindex="50" style="width:90px;height:25px;" onkeypress="return CheckKey(event,1)" />
                    ...
                    <table border="0" cellspacing=0 cellpadding=0>
                        <tr>
                            <td style="padding-right:5px">
                                <input tabindex="19" title="barcode hoặc mã sản phẩm" name="txtlv903" id="txtlv903"
                                    tabindex="19" style="width:75px;height:22px;text-align:center;"
                                    onkeypress="return CheckKeys(event,1,this)"
                                    value="<?php echo $lvwh_lv0009->lv003;?>"
                                    onFocus="if(document.frmadd.txtlv913.value=='') document.frmadd.txtlv913.value=document.frmadd.txtlv805.value"
                            ...
                            <td style="padding-right:5px">
                                <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" xml:lang="pop-nav1">
                                    <li class="menupopT">
                                        <input type="text" autocomplete="off" class="search_img_btn"
                                            name="txtlv903_search" id="txtlv903_search" style="width:75px;height:20px;"
                                            onKeyUp="LoadPopupParent(this,'txtlv903','sl_lv0007','concat(lv002,@! @!,lv001)')"
                                            onFocus="LoadPopupParent(this,'txtlv903','sl_lv0007','concat(lv002,@! @!,lv001)')"
                                            tabindex="200">
                ...
                <div class="kk_chonsanpham" style="float:left;width:70px;font:bold 12px Arial,Tahoma;padding-right:5px;"
                    onclick="ShowNhomSanPham()">
                    <div class="sanpham_bg_bnt" style="height:15px;padding:5px;">
                        <center>Chọn SP</center>
                    </div>
                </div>
            ...
            <div id="viewhere_1" style="display:block;">
                <div>
                    ...
                    <div class="khungsp">
                        ...
                        <div id="kk_monan"
                            style="background:#fff;display:none;position:absolute;top:0;left:0px;width:100%;z-index:9999999;overflow: scroll">
                            <div style="position:absolute;top:-10px;right:-5px;z-index:999999"><img
                                    onclick="AnNhomSanPham()" width="60" src="images/icon/closefull.png" /></div>
                            <div style="clear:both;width:100%;overflow:hidden;">


                                <div id="kk_thanhprocess"
                                    style="float:right;overflow: auto;height:400px;padding:0px!important;overflow: scroll"
                                    class="kk_thanhprocess">
                                    <div style="padding:5px">
                                        <?php 
									...
									$vthanhcon1='
										...
										<div>
											...
											while($vrow1=db_fetch_array($vresult1))
											{
												...
												$vthanhcon2=$vthanhcon2.'
												<span style="text-transform:none!important"  style="margin-left:<?php echo $vWidth;?>px;">'.$vrow1['lv002'].'</span>
                                    </div>
                                    </li>';
                                    }
                                    if($vthanhcon2!='')
                            ...
                            $vthanhcon=$vthanhcon.$vthanhcon3.$vthanhconall.'
                        </div>';
                        $vthanhconall='';
                        }
                ...
                ';
                echo $vthanhcon;
                echo '<div id="kk_thanhnhom" class="kk_thanhnhom"
                    style="float:left;width:115px;overflow: scroll;height:400px">
                    <div style="padding:5px"><input type="hidden" id="txttongthanh" value="'.$i.'" />'.$strthanh.'</div>
                </div>';
                ?>
            </div>
        </div>
        ...
        <div>
            <div style="position:absolute;left:0px;bottom:0px;height:25px">
                <div class="vitribang" style="width:1000px">
                    <div class="banhangmini" style="height:40px;border-bottom:2px #fff solid;float:left;"
                        onclick="tratien('',2);"><a tabindex="99" href="javascript:" style="color:inherit"
                            title="Chưa thu tiền và chưa xuất kho"><br />Xong</a></div>
                    <div class="banhangmini" style="height:40px;border-bottom:2px #fff solid;float:left;"
                        onclick="ReportMoreEmpty('<?php echo $lvwh_lv0008->lv001;?>')"><br />Báo cáo</div>
                    <div class="banhangmini" style="height:40px;border-bottom:2px #fff solid;float:left;"
                        onclick="CombackHome();"><br />Quay lại</div>
                    <div style="float:left;"><input style="padding:0px;margin:0px;height:10px;" type="checkbox" value=1
                            CHECKED="true" id="txtupdate" /></div>
                </div>
                <!---------------End SP------------------------>
                <!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                </td>
                <div style="display:none;position:absolute;left:240px;bottom:0px;z-index:999999999999;" id="roomid">
                    <select name="txtlv807tmp" id="txtlv807tmp" tabindex="2" style="width:100%"
        ...
        <iframe width=174 height=189 name="gToday:normal:agenda.js" id="gToday:normal:agenda.js"
            src="<?php echo $vDir;?>../javascript/ipopeng.php?lang=<?php echo $_GET['lang'];?>" scrolling="no"
            frameborder="0"
...
function AddItemNew(hdid, WHID, vo) {
    ...
    var ArItem = Array();
    ArItem = vo.split(".", 2);
    url = url + "?&ajaxitemsend=ajaxcheck" + "&ContractID=" + hdid + "&WHID=" + WHID + "&ItemID=" + ArItem[1] +
        "&update=" + vUpdate;
    url = url.replace("#", "");
...
function changeqty(o, chitietid) {
    ...
    xmlhttp3.send(null);
    document.getElementById('thanhtien_' + chitietid).innerHTML = NumberWithCommas(parseFloat(document.getElementById(
        'soluong_' + chitietid).value) * parseFloat(document.getElementById('dongia_' + chitietid).value));
}
...
function UpdateCustomer(o, option) {
    ...
    var url = document.location;
    url = url + "?&ajaxcustomertext=ajaxcheck" + "&donhangid=" + donhangid + "&cusid=" + cusid + "&textup=" + o.value +
        "&optrun=" + option;
    url = url.replace("#", "");
...
function tratiendl(donhangid, opt) {
    ...
    var url = document.location;
    url = url + "?&ajaxaproval=ajaxcheck" + "&donhangid=" + donhangid + "&cusid=" + cusid + "&empid=" + empid +
        "&trangthai=" + opt + "&content=" + vcontent + "&cusname=" + cusname;
    url = url.replace("#", "");
