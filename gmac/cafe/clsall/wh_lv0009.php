<?php
/////////////coding wh_lv0009///////////////
class wh_lv0009 extends lv_controler
{
	public $lv001 = null;
	public $lv002 = null;
	public $lv003 = null;
	...
	///////////
	public $DefaultFieldList = "lv001,lv002,lv003,lv088,lv004,lv005,lv008,lv009,lv011,lv013,lv014,lv015,lv016,lv017";
	////////////////////GetDate
	...
	public $paging = null;
	public $lang = null;
	protected $objhelp = 'wh_lv0009';
	public $objlot = null;
	////////////
	var $ArrOther = array();
	var $ArrPush = array();
	var $ArrFunc = array();
	var $ArrGet = array("lv001" => "2", "lv002" => "3", "lv003" => "4", "lv004" => "5", "lv005" => "6", "lv006" => "7", "lv007" => "8", "lv008" => "9", "lv009" => "10", "lv010" => "11", "lv011" => "12", "lv012" => "13", "lv013" => "14", "lv014" => "15", "lv015" => "16", "lv016" => "17", "lv017" => "18", "lv088" => '89', "lv099" => "100");
	var $ArrView = array("lv001" => "0", "lv002" => "0", "lv003" => "0", "lv004" => "20", "lv005" => "21", "lv006" => "10", "lv007" => "0", "lv008" => "10", "lv009" => "21", "lv010" => "10", "lv011" => "2", "lv012" => "0", "lv013" => "10", "lv014" => "0", "lv015" => "0", "lv016" => "22", "lv017" => "10", "lv088" => '0', "lv099" => "100");
	...
	//KEBAO
	function MB_LoadID($vlv001)
	{
		$lvsql = "select * from  wh_lv0009 Where lv002='$vlv001'";
		$vresult = db_query($lvsql);
		return $vresult;

	}
	//ENDCODE MOBILE_KEBAO
	function LV_LoadID($vlv002)
	{
		$lvsql = "select * from  wh_lv0009 Where lv002='$vlv002'";
		$vresult = db_query($lvsql);
		$vrow = db_fetch_array($vresult);
		if ($vrow) {
			$this->lv001 = $vrow['lv001'];
	...
	function LV_Insert()
	{
		if ($this->isAdd == 0)
			return false;
		if (!$this->LV_CheckLocked($this->lv002))
			return false;
		...
		$lvsql = "insert into wh_lv0009 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv098,lv099) values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016','$this->lv098','$this->lv099')";
		$vReturn = db_query($lvsql);
		if ($vReturn) {
			$vWHID = $this->GetParentWH($this->lv002);
			$this->CheckChild($this->lv003, $vWHID);
			$tsql = "Update wh_lv0012 set lv004=lv004+$this->lv004,lv006=lv006+$this->lv006 where lv002='$this->lv003' and lv003 in (select C.lv002 from wh_lv0008 C where C.lv001='$this->lv002')";
			if (db_query($tsql)) {
				$vWhId = $this->GetParentWH($this->lv002);
				$this->AddLotReciept($this->lv014, $this->lv003, $vWhId, $this->lv006, $this->lv008, $this->lv019, $this->lv015, $this->lv011);
				if ($this->objwh_lv0001 != null)
					$this->objwh_lv0001->LV_ApprovalItem($vWhId, $this->lv003);
				$this->InsertLogOperation($this->DateCurrent, 'wh_lv0012.Update', sof_escape_string($tsql));
			}
			$this->InsertLogOperation($this->DateCurrent, 'wh_lv0009.insert', sof_escape_string($lvsql));
	...
	{
		$lvsql = "select '$vTemID' lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv098,lv099 from wh_lv0030 where lv002='$vlv002' and lv004<>0";
		$vReturn = db_query($lvsql);
		while ($vrow = db_fetch_array($vReturn)) {
			...
			$this->lv009 = $vrow['lv009'];
			$this->lv010 = $vrow['lv010'];
			$this->lv011 = $this->FormatView($vrow['lv011'], 2);
			$this->lv012 = $vrow['lv012'];
			$this->lv013 = $vrow['lv013'];
			$this->lv014 = $vrow['lv014'];
			$this->lv015 = $vrow['lv015'];
			...
			if (strpos($this->lv015, "-") === false) {
				...
				$arlv015 = explode("-", $this->lv015, 2);
				$this->lv017 = $arlv015[1];
				$this->lv018 = $arlv015[0];
			}
	...
	{
		$lvsql = "select '$vInvoiceID' lv002,A.lv003,A.lv004*$vQty lv004,A.lv005 lv005,'' lv006,'' lv007,B.lv007 lv008,B.lv008 lv009,'' lv010,'' lv011,concat(CURDATE(),' ',CURTIME()) lv016,B.lv016 WHID from mn_lv0004 A inner join sl_lv0007 B on A.lv003=B.lv001  where A.lv002='$vTemID'";
		$vReturn = db_query($lvsql);
		while ($vrow = db_fetch_array($vReturn)) {
			$this->lv002 = $vrow['lv002'];
			$this->lv003 = $vrow['lv003'];
	...
	{
		$lvsql = "select '$vInvoiceID' lv002,A.lv003,A.lv004,B.lv004 lv005,'' lv006,'' lv007,A.lv006 lv008,A.lv007 lv009,A.lv008 lv010,'' lv011,concat(CURDATE(),' ',CURTIME()) lv016,B.lv016 WHID from sl_lv0014 A inner join sl_lv0007 B on A.lv003=B.lv001  where A.lv002='$vlv002'";
		$vReturn = db_query($lvsql);
		while ($vrow = db_fetch_array($vReturn)) {
			$this->lv002 = $vrow['lv002'];
			$this->lv003 = $vrow['lv003'];
	...
	{
		$this->isAdd = 1;
		$lvsql = "select '$vInvoiceID' lv002,A.lv003,(A.lv008-A.lv006) lv004,A.lv005,(A.lv008-A.lv006) lv006,A.lv005 lv007,C.lv008 lv008,A.lv011 lv009,0 lv010,'' lv011,concat(CURDATE(),' ',CURTIME()) lv016,B.lv016 WHID,concat(CURDATE(),'222222') LotID from wh_lv0005 A inner join sl_lv0007 B on A.lv003=B.lv001 left join wh_lv0012 C on C.lv002=B.lv001 and C.lv003='$vWarehourID' where A.lv002='$vlv002' and (A.lv008-A.lv006)>0";
		$vReturn = db_query($lvsql);
		while ($vrow = db_fetch_array($vReturn)) {
			$this->lv002 = $vrow['lv002'];
			$this->lv003 = $vrow['lv003'];
			...
			$this->lv012 = $vrow['lv012'];
			$this->lv013 = $vrow['lv013'];
			$this->lv014 = str_replace("-", "", $vrow['LotID']);
			$this->lv015 = $vrow['lv015'];
			$this->lv016 = $vrow['lv016'];
			$this->lv017 = $vrow['lv017'];
			$this->lv018 = $vrow['lv018'];
			...
			if ($this->lv004 > 0) {
				$this->LV_Insert();
				$this->AddLotReciept($this->lv014, $this->lv003, $vWarehourID, $this->lv017, $this->lv018, $this->lv019, $this->lv015, $this->lv016);
				//$this->LV_InsertTempSLChild($vInvoiceID,$this->lv003,$this->lv004);
			}
		}
		return $vReturn;
	...
	function LV_InsertOutStockNoCondition($vlv002)
	{
		$lvsql = "insert into wh_lv0031 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016) select '" . getInfor($_SESSION['ERPSOFV2RUserID'], 2) . "',lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv012,'',lv013,lv014,lv015,lv016 from wh_lv0009 where lv002='$vlv002'";
		$vReturn = db_query($lvsql);
		return $vReturn;
	}
	function LV_InsertOutStock($vlv002)
	{
		$lvsql = "insert into wh_lv0031 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016) select lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv012,'',lv013,lv014,lv015,lv016 from wh_lv0030 where lv013=1 and lv002='$vlv002'";
		$vReturn = db_query($lvsql);
		return $vReturn;
	}
	...
	function LV_UpdateEdit($vOldlv004, $vOldlv006)
	{
		...
		$vReturn = db_query($lvsql);
		if ($vReturn) {
			$vsql1 = "update wh_lv0012 set lv004=lv004+($this->lv004-$vOldlv004),lv006=lv006+($this->lv006-$vOldlv006) where lv002='$this->lv0003' and lv003='$vlv003'";
			if (db_query($vsql1)) {
				$vWhId = $this->GetParentWH($this->lv002);
				$this->AddLotReciept($this->lv014, $this->lv003, $vWhId, $this->lv017, $this->lv018, $this->lv019, $this->lv015, $this->lv011);
				if ($this->objwh_lv0001 != null)
					$this->objwh_lv0001->LV_ApprovalItem($vWhId, $this->lv003);
				$this->InsertLogOperation($this->DateCurrent, 'wh_lv0009.update', sof_escape_string($vsql1));
			}
			$this->InsertLogOperation($this->DateCurrent, 'wh_lv0009.update', sof_escape_string($lvsql));
			if ($this->obj_wb_lv0006 != null) {
				$this->obj_wb_lv0006->LV_get_slt_lot($this->lv003, $vlv003);
			}
	...
	function LV_Delete($lvarr)
	{
		if ($this->isDel == 0)
			return false;
		$lvsql = "DELETE FROM wh_lv0009  WHERE wh_lv0009.lv001 IN ($lvarr) and (select lv007 from wh_lv0008 B where  B.lv001= wh_lv0009.lv002)<=0  ";
		$vReturn = db_query($lvsql);
		if ($vReturn) {
			$this->InsertLogOperation($this->DateCurrent, 'wh_lv0009.delete', sof_escape_string($lvsql));
		}
		return $vReturn;
	}
	function LV_DeleteDetail($lvarr)
	{
		$sqlD = "SELECT A.lv001 lv001,A.lv002 lv002,A.lv003 lv003,A.lv004 lv004,A.lv006 lv006,B.lv002 lvb002 FROM wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 WHERE A.lv001 IN ($lvarr) and (select lv007 from wh_lv0008 B where  B.lv001= A.lv002)<=0;";
		...
		while ($vrow = db_fetch_array($vresult)) {
			...
			if (db_query($vsql)) {
				$tsql = "delete from wh_lv0009 where lv001='" . $vrow['lv001'] . "'";
				if (db_query($tsql)) {
					$strReturn = true;
					if ($this->obj_wb_lv0006 != null) {
	...
	{
		$sqlD = "SELECT A.*,B.lv002 lvb002 FROM wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 WHERE B.lv007<=0;";
		$vresult = db_query($sqlD);
		$strReturn = false;
		while ($vrow = db_fetch_array($vresult)) {
			$vsql = "update wh_lv0012 set lv004=lv004-" . $vrow['lv004'] . ",lv006=lv006-" . $vrow['lv006'] . " where lv002='" . $vrow['lv003'] . "' and lv003='" . $vrow['lvb002'] . "'";
	...
	{
		$lvsql = "select lv001 from  wh_lv0009 Where lv002='$vContracID' and lv003='$vItemID'";
		$vresult = db_query($lvsql);
		$vrow = db_fetch_array($vresult);
		if ($vrow) {
			return $vrow['lv001'];
	...
	protected function GetCondition()
	{
		$strCondi = "";
		if ($this->lv001 != "")
			$strCondi = $strCondi . " and A.lv001  like '%$this->lv001%'";
		if ($this->lv002 != "")
			$strCondi = $strCondi . " and A.lv002 ='$this->lv002'";
		if ($this->lv003 != "")
			$strCondi = $strCondi . " and A.lv003  like '%$this->lv003%'";
		if ($this->lv004 != "")
			$strCondi = $strCondi . " and A.lv004  like '%$this->lv004%'";
		if ($this->lv005 != "")
			$strCondi = $strCondi . " and A.lv005  like '%$this->lv005%'";
		if ($this->lv006 != "")
			$strCondi = $strCondi . " and A.lv006  like '%$this->lv006%'";
		if ($this->lv007 != "")
			$strCondi = $strCondi . " and A.lv007 like '%$this->lv007%'";
		if ($this->lv008 != "")
			$strCondi = $strCondi . " and A.lv008 like '%$this->lv008%'";
		if ($this->lv009 != "")
			$strCondi = $strCondi . " and A.lv009 like '%$this->lv009%'";
		if ($this->lv010 != "")
			$strCondi = $strCondi . " and A.lv010 like '%$this->lv010%'";
		if ($this->lv011 != "")
			$strCondi = $strCondi . " and A.lv011 like '%$this->lv011%'";
		if ($this->lv012 != "")
			$strCondi = $strCondi . " and A.lv012 like '%$this->lv012%'";
		if ($this->lv013 != "")
			$strCondi = $strCondi . " and A.lv013 like '%$this->lv013%'";
		if ($this->lv014 != "")
			$strCondi = $strCondi . " and A.lv014 like '%$this->lv014%'";
		if ($this->lv015 != "")
			$strCondi = $strCondi . " and A.lv015 like '%$this->lv015%'";
		if ($this->lv016 != "")
			$strCondi = $strCondi . " and A.lv016 like '%$this->lv016%'";
		$strwh = $this->Get_WHControler();
		$strCondi = $strCondi . " and A.lv002 in (select B.lv001 from wh_lv0008 B where B.lv002 in ($strwh))";
		return $strCondi;
	}
	////////////////Count///////////////////////////
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums FROM wh_lv0009 A WHERE 1=1 " . $this->GetCondition();
		$bResultC = db_query($sqlC);
		$arrRowC = db_fetch_array($bResultC);
		return $arrRowC['nums'];
	}
...
//////////////////////Buil list////////////////////
	function LV_BuilList($lvList, $lvFrom, $lvChkAll, $lvChk, $curRow, $maxRows, $paging, $lvOrderList, $lvSortNum)
	{
		...
		$lvSumTd = "<tr><td colspan=\"" . count($lstArr) . "\"><strong>" . $this->ArrPush[99] . ": @#01</strong></td></tr>";
		$lvTotalNumTd = "<tr><td colspan=\"" . count($lstArr) . "\"><strong>" . $this->ArrPush[99] . ": @#01</strong></td></tr>";
		$sqlS = "SELECT A.*,A.lv003 lv088,IF(ISNULL(CC.lv016),BB.lv006,CC.lv016) lv099 FROM wh_lv0009 A inner join wh_lv0008 BB on A.lv002=BB.lv001 left join sl_lv0013 CC on BB.lv006=CC.lv001 and BB.lv005 in ('GMAC','TRAHANG')  WHERE 1=1  " . $this->GetCondition() . " $strSort LIMIT $curRow, $maxRows";
		$vorder = $curRow;
		...
		while ($vrow = db_fetch_array($bResult)) {
			$strL = "";
			$vorder++;
			$vlineamount = $vrow['lv004'] * $vrow['lv008'] + $vrow['lv004'] * $vrow['lv008'] * $vrow['lv010'] / 100 - $vrow['lv004'] * $vrow['lv008'] * $vrow['lv012'] / 100;
	...
	function ListFieldExport($lvFrom, $lvList, $maxRows)
	{
		...
		{
			window.open('" . $this->Dir . "wh_lv0009/?lang=" . $this->lang . "&childdetailfunc='+value+'&ID=" . base64_encode($this->lv002) . "','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
";
	...
	function LV_BuilListReport($lvList, $lvFrom, $lvChkAll, $lvChk, $curRow, $maxRows, $paging, $lvOrderList)
	{
		...
		$lvTdH = "<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd = "<td align=@#05>@02</td>";
		$sqlS = "SELECT A.*,A.lv003 lv088,IF(ISNULL(CC.lv016),BB.lv006,CC.lv016) lv099 FROM wh_lv0009 A inner join wh_lv0008 BB on A.lv002=BB.lv001 left join sl_lv0013 CC on BB.lv006=CC.lv001 and BB.lv005 in ('GMAC','TRAHANG')  WHERE 1=1  " . $this->RptCondition . " $strSort LIMIT $curRow, $maxRows";
		$vorder = $curRow;
		$bResult = db_query($sqlS);
		$this->Count = db_num_rows($bResult);
		$strTrH = "";
	...
	function LV_BuilListReportOther($lvList, $lvFrom, $lvChkAll, $lvChk, $curRow, $maxRows, $paging, $lvOrderList, $vTax)
	{
		...
		while ($vrow = db_fetch_array($bResult)) {
			...
			$vsumamount = $vsumamount + $vlineamount;
			$vtotalnum = $vtotalnum + $vrow['lv004'];
			$vtotalnum1 = $vtotalnum1 + $vrow['lv006'] * $vrow['lv004'];
			$vtotalnum2 = $vtotalnum2 + $vrow['lv008'] * $vrow['lv004'];
			for ($i = 0; $i < count($lstArr); $i++) {
				switch ($lstArr[$i]) {
					case 'lv017':
						$vTemp = str_replace("@02", $this->getvaluelink($lstArr[$i], $this->FormatView($vlineamount, (int) $this->ArrView[$lstArr[$i]])), $this->Align($lvTd, (int) $this->ArrView[$lstArr[$i]]));
						break;
					case 'lv006':
						$vTemp = str_replace("@02", $this->getvaluelink($lstArr[$i], $this->FormatView($vrow['lv006'] * $vrow['lv004'], (int) $this->ArrView[$lstArr[$i]])), $this->Align($lvTd, (int) $this->ArrView[$lstArr[$i]]));
						break;
					case 'lv013':
						$vslline = $this->objlot->LV_Get_slt_lot_all($vrow['lv014'], $vrow['lv003']);
						$vTemp = str_replace("@02", $this->getvaluelink($lstArr[$i], $this->FormatView($vslline, (int) $this->ArrView[$lstArr[$i]])) . (($lstArr[$i] == 'lv010' || $lstArr[$i] == 'lv012') ? '%' : ''), $lvTd);
						break;
					default:
						$vTemp = str_replace("@02", $this->getvaluelink($lstArr[$i], $this->FormatView($vrow[$lstArr[$i]], (int) $this->ArrView[$lstArr[$i]])), $this->Align($lvTd, (int) $this->ArrView[$lstArr[$i]]));
						break;
			...
			$strTr = $strTr . str_replace("@#01", $strL, str_replace("@02", $vrow['lv001'], str_replace("@03", $vorder, str_replace("@01", $vorder % 2, $lvTr))));
			if ($vTax > 0 || $vTax == -1) {
				$strSubTotal = $strSubTotal + $vrow['lv004'] * $vrow['lv008'] - $vrow['lv004'] * $vrow['lv008'] * $vrow['lv012'] / 100;
			} else {
				$strSubTotal = $strSubTotal + $vrow['lv004'] * $vrow['lv008'] + $vrow['lv004'] * $vrow['lv008'] * $vrow['lv010'] / 100 - $vrow['lv004'] * $vrow['lv008'] * $vrow['lv012'] / 100;
			}
		}
		/*$strLine=str_replace("@01",$this->FormatView($strSubTotal,1),$lvTrTotal);
				 $strLine=str_replace("@03",$this->ArrPush[42],$strLine);
				 ...
				 $strLine=str_replace("@03",str_replace("@02",$this->FormatView($vTax,10),$this->ArrPush[43]),$strLine);
				 $strLine=str_replace("@04",count($lstArr),$strLine);
				 $strTr=$strTr.$strLine;
				 }
				 ...
				 $strLine=str_replace("@03",$this->ArrPush[44],$strLine);
				 $strLine=str_replace("@04",count($lstArr),$strLine);
				 $strTr=$strTr.$strLine;*/
		$strF = $strF . "</tr>";
		$strF = str_replace("<!--lv004-->", $this->FormatView($vtotalnum, 10), $strF);
		$strF = str_replace("<!--lv006-->", $this->FormatView($vtotalnum1, 10), $strF);
		$strF = str_replace("<!--lv017-->", $this->FormatView($vsumamount, 10), $strF);
		$strF = str_replace("<!--lv003-->", '<p style="text-align:center;padding:5px">Tổng:</p>', $strF);
		$lvTable = str_replace("@#02", $strF, $lvTable);
	...
	function Get_String_BuilHeader()
	{
		$this->lvHeader = "";
		$strTD = "";
		$sqlS1 = "SELECT lv014  FROM wh_lv0009 A WHERE 1=1  " . $this->GetCondition() . " ";
		...
		$strTD = array();
		$vArSize = $ArSize;
		$this->lvHeader = '<td class="lvhtable" align="center">' . $this->ArrPush[4] . '</td><td class="lvhtable" align="center">' . $this->ArrPush[46] . '</td>';
		...
		$this->lvHeader = $this->lvHeader . '<td class="lvhtable" align="center">TC SL</td><td class="lvhtable" align="center">' . $this->ArrPush[6] . '</td><td class="lvhtable" align="center">' . $this->ArrPush[16] . '</td>';
	...
	function LV_BuilListReportOtherSoon($lvList, $lvFrom, $lvChkAll, $lvChk, $curRow, $maxRows, $paging, $lvOrderList, $vTax)
	{
		...
		$strF = "<tr><td colspan=\"2\">&nbsp;</td>";
		$lvTdF = "<td align=\"right\"><strong>@01</strong></td>";
		$sqlS = "select * from (SELECT lv003,lv014,sum(lv004) lv004,lv005,lv003 lv088 FROM wh_lv0009 A WHERE 1=1  " . $this->GetCondition() . " group by lv003,lv014) MP order by MP.lv003";
		$vorder = $curRow;
		$bResult = db_query($sqlS);
		$this->Count = db_num_rows($bResult);
		$strTrH = "";
	...
	function LV_GetValue($vArrRow, $vItem, $vLotID, $vStrItem, &$vorder)
	{
		...
		if (!strpos($vStrItem, "<!--%$CodeID%-->") === false)
			return $vStrItem;
		if ($vStrItem == "") {
	...
	private function sqlconditionext($vFile, $vSelectID)
	{
		...
		switch ($vFile) {
			case 'lv003':
				$vsql = "select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007 where 1=1 and lv015>=0 and (lv016 ='$vSelectID' or lv016='')";
				break;
			case 'lv005':
			...
			case 'lv018':
				...
				break;
			case 'lv019':
				$vsql = "select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0029";
				break;
		}
		return $vsql;
	}
	private function sqlcondition($vFile, $vSelectID)
	{
		...
		switch ($vFile) {
			case 'lv003':
				$strwh = $this->Get_WHControler();
				$vsql = "select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007 where 1=1 and lv015>=0 and (lv016 in ($strwh)) order by lv001 asc";
				break;
			case 'lv005':
				$vsql = "select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0005";
				break;
	...
	private function getvaluelink($vFile, $vSelectID)
	{
		...
		switch ($vFile) {
			...
			case 'lv009':
				...
				break;
			case 'lv018':
				$vsql = "select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0028 where lv001='$vSelectID'";
				break;
			case 'lv019':
	...
	function MB_Insert()
	{
		...
		if (!$this->LV_CheckLocked($this->lv002))
			return false;
		$this->lv006 = 0;
		$this->lv016 = date(format: "Y-m-d H:i:s");
		//$this->lv015 = ($this->lv015!="")?recoverdate(($this->lv015), $this->lang):$this->DateDefault;
		$this->lv011 = ($this->lv011 != "") ? recoverdate(($this->lv011), $this->lang) : $this->DateDefault;
		$lvsql = "insert into wh_lv0009 (lv002,lv003,lv004,lv005,lv006,lv008,lv009,lv016) values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv008','$this->lv009','$this->lv016')";
		$vReturn = db_query($lvsql);
		if ($vReturn) {
			// $vWHID=$this->GetParentWH($this->lv002);
			// $this->CheckChild($this->lv003,$vWHID);
			$tsql = "Update wh_lv0012 set lv004=lv004+$this->lv004,lv006=lv006+$this->lv006 where lv002='$this->lv003' and lv003 in (select C.lv002 from wh_lv0008 C where C.lv001='$this->lv002')";
			$vReturn2 = db_query($tsql);
		}
		return $vReturn;
	}
