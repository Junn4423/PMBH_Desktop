...
////////////
	...
	{
		$lvsql="select '$vInvoiceID' lv002,A.lv003,A.lv004,B.lv004 lv005,'' lv006,'' lv007,A.lv006 lv008,A.lv007 lv009,A.lv008 lv010,A.lv011 lv011,concat(CURDATE(),' ',CURTIME()) lv016,B.lv016 WHID,B.lv012 TypeWH,A.lv015 isCN,B.lv015 StateNTD from sl_lv0014 A inner join sl_lv0007 B on A.lv003=B.lv001  where A.lv002='$vlv002' and B.lv015>=0 and A.lv030<1";
		$vReturn= db_query($lvsql);
		while($vrow=db_fetch_array($vReturn))
		{
			$this->lv002=$vrow['lv002'];
	...
	{
		$lvsql="select '$vInvoiceID' lv002,A.lv003,A.lv004,B.lv004 lv005,'' lv006,'' lv007,A.lv006 lv008,A.lv007 lv009,A.lv008 lv010,A.lv011 lv011,concat(CURDATE(),' ',CURTIME()) lv016,B.lv016 WHID,B.lv012 TypeWH,A.lv015 isCN,B.lv015 StateNTD from sl_lv0014 A inner join sl_lv0007 B on A.lv003=B.lv001  where A.lv001 in ('$vDetailID') and A.lv030=1";
		$vReturn= db_query($lvsql);
		while($vrow=db_fetch_array($vReturn))
		{
			$this->lv002=$vrow['lv002'];
	...
	{
		$this->isAdd=1;
		$lvsql="select '$vInvoiceID' lv002,A.lv003,(A.lv006-A.lv008) lv004,A.lv005,(A.lv006-A.lv008) lv006,A.lv005 lv007,C.lv008 lv008,A.lv011 lv009,0 lv010,'' lv011,concat(CURDATE(),' ',CURTIME()) lv016,B.lv016 WHID,B.lv012 TypeWH from wh_lv0005 A inner join sl_lv0007 B on A.lv003=B.lv001 left join wh_lv0012 C on C.lv002=B.lv001 and C.lv003='$vWarehourID'  where A.lv002='$vlv002' and (A.lv008-A.lv006)<0";
		$vReturn= db_query($lvsql);
		while($vrow=db_fetch_array($vReturn))
		{
			$this->lv002=$vrow['lv002'];
...
//////////////////////Buil list////////////////////
	...
	private function sqlconditionext($vFile,$vSelectID)
	{
		...
		{
			case 'lv003':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007 where 1=1 and lv015>=0 and (lv016 ='$vSelectID'  or lv016='') order by lv001 asc";
				break;
			case 'lv103':
	...
	function MB_LoadID($vlv002) {
		// Truy vấn để lấy tất cả các chi tiết phiếu nhập có lv002
		$lvsql = "select * from  wh_lv0011 Where lv002='$vlv002'";
		$vresult = db_query($lvsql);
		return $vresult;
	}
}
