...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select B.lv001 InvoiceID,J.lv002 RoomName,B.lv004 DateInvoice,B.lv011 State,F.lv002 stateName,B.lv005 DateInvoiceTo,B.lv002 CustomerID,B.lv003 CustomerName,B.lv009 CustomerAdd,B.lv013 CustomerNote,B.lv010 EmployeeID,sum(A.lv006*A.lv004) SumTotal,TIME_TO_SEC(substr(B.lv004,12,8)) timeview,TIME_TO_SEC(TIMEDIFF('24:00:00',substr(B.lv004,12,8))) timeagain,TIME_TO_SEC('24:00:00') h24,DATEDIFF(B.lv005,B.lv004) days,TIME_TO_SEC(substr(B.lv005,12,8)) curtime from wh_lv0022 A inner join wh_lv0021 B on A.lv002=B.lv001 left join sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 left join sl_lv0054 F on B.lv011=F.lv001 left join sl_lv0009 J on B.lv007=J.lv001 where 1=1 $vCondition group by  A.lv002";	
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select A.*,concat(E.lv002,'(',E.lv001,')') ProgramName,B.lv022 CKTM,D.lv002 UnitName,C.lv002 ItemName,B.lv001 InvoiceID,B.lv004 DateInvoice,B.lv002 CustomerID,B.lv010 EmployeeID from wh_lv0022 A inner join wh_lv0021 B on A.lv002=B.lv001 left join sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
	...
	$vHeaderReportInventory="
		...
		if($vCateID!="")
		{
		 ...
		 $sqlS = "select A.lv003,A.lv004,A.lv006,A.lv008,A.lv011,A.lv012,B.lv022 CKTM,C.lv002 ItemName from wh_lv0022 A inner join wh_lv0021 B on A.lv002=B.lv001 left join sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition order by A.lv003 asc";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
	...
	$vHeaderReportInventory="
		...
		if($vCateID!="")
		{
		 ...
		 $sqlS = "select B.lv010 lv003,sum(A.lv004) sl,sum(A.lv004*A.lv006) thanhtien,sum(A.lv004*A.lv006*A.lv008/100) thue,sum(A.lv004*A.lv006*A.lv011/100) chietkhau,sum(A.lv012) diem,sum(A.lv004*A.lv006*B.lv022/100) CKTM,concat(C.lv004,' ',C.lv003,' ',C.lv002) CusName from wh_lv0022 A inner join wh_lv0021 B on A.lv002=B.lv001 left join hr_lv0020 C on B.lv010=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition group by lv003";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
