...
//////////////////////Buil list////////////////////
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		{
			case 'lv002':
				$vsql="select lv001,concat(lv004,' ',lv003,' ',lv002,'(',lv001,')') lv002,IF(lv001='$vSelectID',1,0) lv003 from  hr_lv0020";
				break;
			case 'lv003':
				$vsql="select lv001,concat(lv004,' ',lv003,' ',lv002,'(',lv001,')') lv002,IF(lv001='$vSelectID',1,0) lv003 from  hr_lv0020";
				break;
	...
	private  function getvaluelink($vFile,$vSelectID)
	{
		...
		{
			case 'lv002':
				$vsql="select lv001,concat(lv004,' ',lv003,' ',lv002,'(',lv001,')') lv002,IF(lv001='$vSelectID',1,0) lv003 from  hr_lv0020 where lv001='$vSelectID'";
				break;
			case 'lv003':
				$vsql="select lv001,concat(lv004,' ',lv003,' ',lv002,'(',lv001,')') lv002,IF(lv001='$vSelectID',1,0) lv003 from  hr_lv0020 where lv001='$vSelectID'";
				break;
