...
////////////
	...
	{
		//$vsql="insert into hr_lv0106 select *,$month,$year from  sl_lv0070";
		//$vresult=db_query($vsql);
		return $vresult;
	}
	...
	{
		$lvsql="select * from  sl_lv0070 Where lv001='$vlv001'";
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM sl_lv0070  WHERE sl_lv0070.lv007<=0 AND sl_lv0070.lv001 IN ($lvarr) and (select count(*) from wh_lv0009 B where  B.lv002= sl_lv0070.lv001)<=0  ";
		$vReturn= db_query($lvsql);
	...
	function LV_Exist()
	{
		$lvsql="select count(*) num from  sl_lv0070 ";
		$vresult=db_query($lvsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
	...
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums FROM sl_lv0070 WHERE 1=1 ".$this->GetCondition();
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class='@#04' align='@#05'>@02</td>";
		$sqlS = "SELECT * FROM sl_lv0070 WHERE 1=1  ".$this->RptCondition." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
...
//////////////////////Buil list////////////////////
	function LV_BuilListReportMini($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvDateSort)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class='@#04' align='@#05'>@02</td>";
		$sqlS = "SELECT * FROM sl_lv0070 WHERE 1=1 and lv009='$lvDateSort' ".$this->GetConditionMini()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
	...
	function LV_BuilListReportOther($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class='@#04' align='@#05'>@02</td>";
		$sqlS = "SELECT * FROM sl_lv0070 WHERE 1=1  ".$this->GetConditionRpt()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv003':
				...
				break;
			case 'lv008':
				$vsql="select lv001,lv002 lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007";
				break;
			case 'lv010':
				$vsql="select lv001,lv002 lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007";
				break;
