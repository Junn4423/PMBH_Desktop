...
////////////
	...
	function LV_GetQuantityRecieption($vPOID,$vItemID,$vSize,$vColor)
	{
		...
		$lvsql="select sum(A.lv004) TotalQty,C.lv006 Quidoi from wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 left join sl_lv0007 C on A.lv003=C.lv001 where  B.lv006='$vPOID' and B.lv005='MUAHANG' and A.lv003='$vItemID' And A.lv014 in ($strLotID)";
		$vReturn= db_query($lvsql);
		if($vReturn)
		{
			$vrow=db_fetch_array($vReturn);
