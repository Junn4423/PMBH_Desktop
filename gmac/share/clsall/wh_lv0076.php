<?php
class wh_lv0076 extends lv_controler{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select A.*,B.lv002 DonViTinh,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' and A11.lv002='$vlv001')) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' and A11.lv002='$vlv001')) InReceiptQty,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' and A21.lv002='$vlv001')) ReOutWH ,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' and A21.lv002='$vlv001')) InOutWH  from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 where 1=1 and A.lv015>=0";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vNumline++;			
				$vLineRun = str_replace("@05", ($arrS['DonViTinh']!="" || $arrS['DonViTinh']!=NULL)?$arrS['DonViTinh']:"-", $vLineRun);
				$vLineRun = str_replace("@06", Lcurrency($arrS['ReReceiptQty']-$arrS['ReOutWH'],$plang), $vLineRun);
				$vLineRun = str_replace("@07", LCurrency($arrS['InReceiptQty'],$plang), $vLineRun);
				$vLineRun = str_replace("@08", LCurrency($arrS['InOutWH'],$plang), $vLineRun);				
				$vLineRun = str_replace("@09", LCurrency( ( $arrS['ReReceiptQty']-$arrS['ReOutWH'])+( $arrS['InReceiptQty']-$arrS['InOutWH']),$plang), $vLineRun);								
				$strExpportAll = $strExpportAll.$vLineRun;
				$vLineRun = $vRowLightText;
			}
		} else {
		...
		$sqlS = "select MP.lv004,MP.DonViTinh,sum(IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)+IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)-IF(ISNULL(MP.ReOutWH),0,MP.ReOutWH)-IF(ISNULL(MP.InOutWH),0,MP.InOutWH) ) SumQty from (select A.lv004,B.lv002 DonViTinh,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' and A11.lv002='$vlv001')) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' and A11.lv002='$vlv001')) InReceiptQty,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' and A21.lv002='$vlv001')) ReOutWH ,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' and A21.lv002='$vlv001')) InOutWH   from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 where 1=1 and A.lv015>=0) MP group by MP.lv004,MP.DonViTinh ";		
...
function PrintInOutPutInStockDetail($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strCategory,$vVS_Color,$vExistItem,$vExistItemCur,$vshowimage,$isbalance=0,$islstprice='',$vNguoiNhanKho='')
	{
	...
	$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" class=\"tblprint\">
		<tr height=\"30px\" class=\"tblcaption\">
			<td rowspan=\"3\" class=\"htable\" width=\"3%\" >Mã tài sản</td>
			<td rowspan=\"3\" class=\"htable\" width=\"10%\">Mã vạch</td>
			<td rowspan=\"3\"class=\"htable\" width=\"*%\" >Tên tài sản</td>
			<td rowspan=\"3\" class=\"htable\" width=\"5%\" >Đơn vị tính</td>
			<td rowspan=\"3\" class=\"htable\" width=\"5%\" >Đơn vị qui đổi</td>
			<td rowspan=\"2\" class=\"htable\" width=\"5%\" colspan=\"3\" >Tồn đầu ky</td>				
			<td class=\"htable\" width=\"5%\" colspan=\"6\" >Nhập trong kỳ</td>
			<td class=\"htable\" width=\"5%\" colspan=\"9\" >Xuất trong kỳ</td>			
			<td rowspan=\"2\" class=\"htable\" width=\"5%\" colspan=\"3\" >Tồn cuối kỳ</td>
		</tr>
		<tr>
			<td class=\"htable\" align=\"center\" colspan=\"3\" >Điều chuyển</td>
			<td class=\"htable\" align=\"center\" colspan=\"3\" >Mua</td>
			<td class=\"htable\" align=\"center\" colspan=\"3\" >Điều chuyển</td>
			<td class=\"htable\" align=\"center\" colspan=\"3\" >Xuất</td>
			<td class=\"htable\" align=\"center\" colspan=\"3\" >Trả nhà CC</td>
		</tr>
		<tr>
			<td class=\"htable\" align=\"center\">SL</td>
			<td class=\"htable\" align=\"center\">ĐG</td>
			<td class=\"htable\" align=\"center\">TT</td>
			<td class=\"htable\" align=\"center\">SL</td>
			<td class=\"htable\" align=\"center\">ĐG</td>
			<td class=\"htable\" align=\"center\">TT</td>
			<td class=\"htable\" align=\"center\">SL</td>
		...
		$vRowFirst="
			<tr>
				...
				<td class=\"right_style\">@09</td>
				<td class=\"center_style\">@10</td>
				<td class=\"center_style\">@11</td>
				<td class=\"right_style\">@12</td>
				<td class=\"center_style\">@13</td>
				<td class=\"center_style\">@14</td>
				<td class=\"right_style\">@15</td>
				<td class=\"center_style\">@16</td>
				<td class=\"center_style\">@17</td>
				<td class=\"right_style\">@18</td>
				<td class=\"center_style\">@19</td>
				<td class=\"center_style\">@20</td>
				<td class=\"right_style\">@21</td>	
				<td class=\"center_style\">@22</td>
				<td class=\"center_style\">@23</td>
				<td class=\"right_style\">@24</td>
				<td class=\"center_style\">@25</td>
				<td class=\"center_style\">@26</td>
				<td class=\"right_style\">@27</td>
			</tr>
			";
		$vRowLast="
			<tr>
				<td class=\"center_style\"  valign=\"top\" colspan=\"5\" >".(($this->lang=='VN')?'Tổng':'Total')."</td>
				<td class=\"center_style\">@07</td>
				<td class=\"center_style\">@08</td>
				<td class=\"right_style\">@09</td>
				<td class=\"center_style\">@10</td>
		...
		if($vNguoiNhanKho!='')
		{
			$vAddContractR=$vAddContractR." AND (A11.lv011 = '$vNguoiNhanKho') ";
			$vAddContractO=$vAddContractO." AND  (A21.lv011 = '$vNguoiNhanKho')  ";
		}
		if($strlv014!="") {
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		...
		$vSPNhap2=$this->LV_GetSophieu("select A11.lv001 from wh_lv0008 A11  Where A11.lv005<>'MUAHANG' and (A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR) $vOrContractR2");
		$vSPNhap3=$this->LV_GetSophieu("select A11.lv001 from wh_lv0008 A11  Where A11.lv005='MUAHANG' and (A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR) $vOrContractR2");
		
		$vSPXuat1=$this->LV_GetSophieu("select A21.lv001 from wh_lv0010 A21 Where (A21.lv009<'$vDateStart' $vAddContractO) $vOrContractO1");
		$vSPXuat2=$this->LV_GetSophieu("select A21.lv001 from wh_lv0010 A21 Where (A21.lv005<>'DIEUCHUYEN' and A21.lv005<>'TRAHANG') and (A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO) $vOrContractO2");
		$vSPXuat3=$this->LV_GetSophieu("select A21.lv001 from wh_lv0010 A21 Where  A21.lv005='DIEUCHUYEN' and (A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO) $vOrContractO2");
		$vSPXuat4=$this->LV_GetSophieu("select A21.lv001 from wh_lv0010 A21 Where  A21.lv005='TRAHANG' and (A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO) $vOrContractO2");
		
		$sqlS = "select * from (select A.*,IF(ISNULL(ABC.lv008),0,ABC.lv008) giavon,B.lv002 DonViTinh,(select sum(A1.lv004) from wh_lv0009 A1  $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPNhap1) ) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPNhap2) ) InReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPNhap3) ) InReceiptQty3,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat1) ) ReOutWH ,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat2) ) InOutWH,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat3) ) InOutWH3,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat4) ) InOutWH4,BB.lv002 DonViKhac from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 left join sl_lv0005 BB on A.lv005=BB.lv001 left join wh_lv0012 ABC on ABC.lv002=A.lv001 and ABC.lv003='KHOTONG' where 1=1  and A.lv015>=0 $vConditionStock) MP  where ((IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)-IF(ISNULL(MP.ReOutWH),0,MP.ReOutWH))<>0 or  IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)<>0 or IF(ISNULL(MP.InOutWH),0,MP.InOutWH)<>0 or (IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)-IF(ISNULL(MP.ReOutWH),0,MP.ReOutWH)+IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)-IF(ISNULL(MP.InOutWH),0,MP.InOutWH))<>0)";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vNumline++;			
				$vSumDK=$vSumDK+$arrS['ReReceiptQty']-$arrS['ReOutWH'];
				$vSumNTK=$vSumNTK+$arrS['InReceiptQty'];
				$vSumNTK3=$vSumNTK3+$arrS['InReceiptQty3'];
				$vSumXTK=$vSumXTK+$arrS['InOutWH'];
				$vSumXTK3=$vSumXTK3+$arrS['InOutWH3'];
				$vSumXTK4=$vSumXTK4+$arrS['InOutWH4'];
				$vTonCuoiKy=( $arrS['ReReceiptQty']-$arrS['ReOutWH'])+( $arrS['InReceiptQty']+$arrS['InReceiptQty3']-($arrS['InOutWH']+$arrS['InOutWH3']+$arrS['InOutWH4']));
				$vSumTCK=$vSumTCK+$vTonCuoiKy;
				$vGiaVon=$arrS['giavon'];
				$vThanhTien=$vGiaVon*$vTonCuoiKy;
				$vTongTien=$vTongTien+$vThanhTien;
				$vThanhTienDK=$vGiaVon*($arrS['ReReceiptQty']-$arrS['ReOutWH']);
				$vTongTienDK=$vTongTienDK+$vThanhTienDK;

				$vThanhTienNTK=$vGiaVon*$arrS['InReceiptQty'];
				$vThanhTienNTK3=$vGiaVon*$arrS['InReceiptQty3'];

				$vTongTienNTK=$vTongTienNTK+$vThanhTienNTK;
				$vTongTienNTK3=$vTongTienNTK3+$vThanhTienNTK3;
				
				$vThanhTienXTK=$vGiaVon*$arrS['InOutWH'];
				$vThanhTienXTK3=$vGiaVon*$arrS['InOutWH3'];
				$vThanhTienXTK4=$vGiaVon*$arrS['InOutWH4'];
				$vTongTienXTK=$vTongTienXTK+$vThanhTienXTK;
				
				$vLineRun = str_replace("@05", ($arrS['DonViTinh']!="" || $arrS['DonViTinh']!=NULL)?$arrS['DonViTinh']:"-", $vLineRun);
				$vLineRun = str_replace("@06", ($arrS['DonViKhac']!="" || $arrS['DonViKhac']!=NULL)?$arrS['DonViKhac']:"-", $vLineRun);
				//Tồn đầu kỳ
				$vLineRun = str_replace("@07", $this->FormatView($arrS['ReReceiptQty']-$arrS['ReOutWH'],10), $vLineRun);
				$vLineRun = str_replace("@08", $this->FormatView((($arrS['ReReceiptQty']-$arrS['ReOutWH'])>0)?$vGiaVon:0,10), $vLineRun);
				$vLineRun = str_replace("@09", $this->FormatView(round($vThanhTienDK,0),10), $vLineRun);
				//Nhập kho điều chuyển
				$vLineRun = str_replace("@10", $this->FormatView($arrS['InReceiptQty'],10), $vLineRun);
				$vLineRun = str_replace("@11", $this->FormatView(($arrS['InReceiptQty']>0)?round($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@12", $this->FormatView(round($vThanhTienNTK,0),10), $vLineRun);
				//Nhập kho mua hàng
				$vLineRun = str_replace("@13", $this->FormatView($arrS['InReceiptQty3'],10), $vLineRun);
				$vLineRun = str_replace("@14", $this->FormatView(($arrS['InReceiptQty3']>0)?round($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@15", $this->FormatView(round($vThanhTienNTK3,0),10), $vLineRun);
				//Xuất kho điều chuyển
				$vLineRun = str_replace("@16", $this->FormatView($arrS['InOutWH3'],10), $vLineRun);
				$vLineRun = str_replace("@17", $this->FormatView(($arrS['InOutWH3']>0)?$vGiaVonround($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@18", $this->FormatView(round($vThanhTienXTK3,20),10), $vLineRun);
				//Xuất kho khác
				$vLineRun = str_replace("@19", $this->FormatView($arrS['InOutWH'],10), $vLineRun);
				$vLineRun = str_replace("@20", $this->FormatView(($arrS['InOutWH']>0)?round($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@21", $this->FormatView(round($vThanhTienXTK,0),10), $vLineRun);
				//Xuất kho trả hàng
				$vLineRun = str_replace("@22", $this->FormatView($arrS['InOutWH4'],10), $vLineRun);
				$vLineRun = str_replace("@23", $this->FormatView(($arrS['InOutWH4']>0)?round($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@24", $this->FormatView(round($vThanhTienXTK4,0),10), $vLineRun);
				//Cuối kỳ
				
				$vLineRun = str_replace("@25",$this->FormatView( $vTonCuoiKy,10), $vLineRun);
				$vLineRun = str_replace("@26", $this->FormatView(($vTonCuoiKy>0)?round($vGiaVon,2):0,10), $vLineRun);				
				$vLineRun = str_replace("@27", $this->FormatView(round($vThanhTien,0),10), $vLineRun);
				//$vLineRun = str_replace("@25", $this->FormatView($arrS['lv014'],6), $vLineRun);
				$vdetail='';
				switch($stropt)
				{
					case 2:
		...
		//Tồn đầu kỳ
		$vRowLast=str_replace("@07",$this->FormatView($vSumDK,0),$vRowLast);
		$vRowLast=str_replace("@08",'&nbsp;',$vRowLast);
		$vRowLast=str_replace("@09",$this->FormatView(round($vTongTienDK,0),10),$vRowLast);
		//Nhập kho điều chuyển
		$vRowLast=str_replace("@10",$this->FormatView($vSumNTK,0),$vRowLast);
		$vRowLast=str_replace("@11",'&nbsp;',$vRowLast);
		$vRowLast=str_replace("@12",$this->FormatView(round($vTongTienNTK,0),10),$vRowLast);
		//Nhập kho mua hàng
		$vRowLast = str_replace("@13", $this->FormatView($vSumNTK3,10), $vRowLast);
		$vRowLast = str_replace("@14", '&nbsp;', $vRowLast);
		$vRowLast = str_replace("@15", $this->FormatView(round($vTongTienNTK3,0),10), $vRowLast);
		//Xuất kho điều chuyển
		$vRowLast = str_replace("@16", $this->FormatView($vSumXTK3,10), $vRowLast);
		$vRowLast = str_replace("@17", '&nbsp;', $vRowLast);
		$vRowLast = str_replace("@18", $this->FormatView(round($vThanhTienXTK3,0),10), $vRowLast);
		//Xuất kho khác
		$vRowLast=str_replace("@19",$this->FormatView($vSumXTK,0),$vRowLast);
		$vRowLast=str_replace("@20",'&nbsp;',$vRowLast);
		$vRowLast=str_replace("@21",$this->FormatView(round($vTongTienXTK,0),10),$vRowLast);
		//Xuất kho trả hàng
		$vRowLast = str_replace("@22", $this->FormatView($vSumXTK4,10), $vRowLast);
		$vRowLast = str_replace("@23", '&nbsp;', $vRowLast);
		$vRowLast = str_replace("@24", $this->FormatView(round($vThanhTienXTK4,0),10), $vRowLast);
		//Cuối kỳ
		$vRowLast=str_replace("@25",$this->FormatView($vSumTCK,0),$vRowLast);
		$vRowLast=str_replace("@26",'&nbsp;',$vRowLast);
		$vRowLast=str_replace("@27",$this->FormatView(round($vTongTien,0),10),$vRowLast);
		$strExpportAll=$strExpportAll.$vRowLast;
		if($vExistItemCur!=1)
		{
	  		//$sqlS = "select MP.lv004,MP.DonViTinh,sum(IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)+IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)-IF(ISNULL(MP.ReOutWH),0,MP.ReOutWH)-IF(ISNULL(MP.InOutWH),0,MP.InOutWH) ) SumQty from (select A.lv004,B.lv002 DonViTinh,(select sum(A1.lv004) from wh_lv0009 A1  $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR) ) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR) ) InReceiptQty,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO) ) ReOutWH ,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO) ) InOutWH  from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001  where 1=1 and A.lv015>=0 $vConditionStock) MP group by MP.lv004,MP.DonViTinh ";		
			//$strExpportAll=$strExpportAll.$this->SumSQLRun($sqlS,(($vshowimage==1)?28:27),$vArrLang[14],$plang);
		}	
		$strExpportAll = str_replace("@01", $vNumline, $strExpportAll);		
		///////////////////////////////////////////////////////////////
		$vHeader = $vHeaderReportInventory;
	...
	function PrintInOutPutInStockDetailQuiDoi($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strCategory,$vVS_Color,$vExistItem,$vExistItemCur,$vshowimage,$isbalance=0,$islstprice='',$vNguoiNhanKho='')
	{
	//if($islstprice=="") $islstprice="0,1,2,3";
	$arrPrice=explode(",",$islstprice);
	foreach($arrPrice as $isP)
	...
	$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" class=\"tblprint\">
		<tr height=\"30px\" class=\"tblcaption\">
			<td rowspan=\"3\" class=\"htable\" width=\"3%\" >STT</td>
			<td rowspan=\"3\" class=\"htable\" width=\"10%\">Mã SP</td>
			<td rowspan=\"3\"class=\"htable\" width=\"*%\" >Tên SP</td>
			<td rowspan=\"3\" class=\"htable\" width=\"5%\" >Đơn vị tính</td>
			<td rowspan=\"3\" class=\"htable\" width=\"5%\" >Đơn vị qui đổi</td>
			<td rowspan=\"2\" class=\"htable\" width=\"5%\" colspan=\"4\" >Tồn đầu ky</td>				
			<td class=\"htable\" width=\"5%\" colspan=\"8\" >Nhập trong kỳ</td>
			<td class=\"htable\" width=\"5%\" colspan=\"12\" >Xuất trong kỳ</td>			
			<td rowspan=\"2\" class=\"htable\" width=\"5%\" colspan=\"4\" >Tồn cuối kỳ</td>
		</tr>
		<tr>
			<td class=\"htable\" align=\"center\" colspan=\"4\" >Điều chuyển</td>
			<td class=\"htable\" align=\"center\" colspan=\"4\" >Mua</td>
			<td class=\"htable\" align=\"center\" colspan=\"4\" >Điều chuyển</td>
			<td class=\"htable\" align=\"center\" colspan=\"4\" >Xuất</td>
			<td class=\"htable\" align=\"center\" colspan=\"4\" >Trả nhà CC</td>
		</tr>
		<tr>
			<td class=\"htable\" align=\"center\">SL</td>
			<td class=\"htable\" align=\"center\">SLQĐ</td>
			<td class=\"htable\" align=\"center\">ĐG</td>
			<td class=\"htable\" align=\"center\">TT</td>
			<td class=\"htable\" align=\"center\">SL</td>
			<td class=\"htable\" align=\"center\">SLQĐ</td>
		...
		$vRowFirst="
			<tr>
				...
				<td class=\"left_style\" >@06</td>
				<td class=\"center_style\">@07</td>
				<td class=\"center_style\">@81</td>
				<td class=\"center_style\">@08</td>
				<td class=\"right_style\">@09</td>
				<td class=\"center_style\">@10</td>
				<td class=\"center_style\">@82</td>
				<td class=\"center_style\">@11</td>
				<td class=\"right_style\">@12</td>
				<td class=\"center_style\">@13</td>
				<td class=\"center_style\">@83</td>
				<td class=\"center_style\">@14</td>
				<td class=\"right_style\">@15</td>
				<td class=\"center_style\">@16</td>
				<td class=\"center_style\">@84</td>
				<td class=\"center_style\">@17</td>
				<td class=\"right_style\">@18</td>
				<td class=\"center_style\">@19</td>
				<td class=\"center_style\">@85</td>
				<td class=\"center_style\">@20</td>
				<td class=\"right_style\">@21</td>	
				<td class=\"center_style\">@22</td>
				<td class=\"center_style\">@86</td>
				<td class=\"center_style\">@23</td>
				<td class=\"right_style\">@24</td>
				<td class=\"center_style\">@25</td>
				<td class=\"center_style\">@87</td>
				<td class=\"center_style\">@26</td>
				<td class=\"right_style\">@27</td>
			</tr>
			";
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				//Tồn đầu kỳ
				$vLineRun = str_replace("@07", $this->FormatView($arrS['ReReceiptQty']-$arrS['ReOutWH'],10), $vLineRun);
				$vLineRun = str_replace("@81", $this->FormatView(($arrS['ReReceiptQty']-$arrS['ReOutWH'])*$vQuiDoi,10), $vLineRun);
				$slv081=$slv081+($arrS['ReReceiptQty']-$arrS['ReOutWH'])*$vQuiDoi;
				
				$vLineRun = str_replace("@08", $this->FormatView((($arrS['ReReceiptQty']-$arrS['ReOutWH'])>0)?$vGiaVon:0,10), $vLineRun);
				$vLineRun = str_replace("@09", $this->FormatView(round($vThanhTienDK,0),10), $vLineRun);
				//Nhập kho điều chuyển
				$vLineRun = str_replace("@10", $this->FormatView($arrS['InReceiptQty'],10), $vLineRun);
				$vLineRun = str_replace("@82", $this->FormatView(($arrS['InReceiptQty'])*$vQuiDoi,10), $vLineRun);
				$slv082=$slv082+($arrS['InReceiptQty'])*$vQuiDoi;
				$vLineRun = str_replace("@11", $this->FormatView(($arrS['InReceiptQty']>0)?round($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@12", $this->FormatView(round($vThanhTienNTK,0),10), $vLineRun);
				//Nhập kho mua hàng
				$vLineRun = str_replace("@13", $this->FormatView($arrS['InReceiptQty3'],10), $vLineRun);
				$vLineRun = str_replace("@83", $this->FormatView(($arrS['InReceiptQty3'])*$vQuiDoi,10), $vLineRun);
				$slv083=$slv083+($arrS['InReceiptQty3'])*$vQuiDoi;
				$vLineRun = str_replace("@14", $this->FormatView(($arrS['InReceiptQty3']>0)?round($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@15", $this->FormatView(round($vThanhTienNTK3,0),10), $vLineRun);
				//Xuất kho điều chuyển
				$vLineRun = str_replace("@16", $this->FormatView($arrS['InOutWH3'],10), $vLineRun);
				$vLineRun = str_replace("@84", $this->FormatView(($arrS['InOutWH3'])*$vQuiDoi,10), $vLineRun);
				$slv084=$slv084+($arrS['InOutWH3'])*$vQuiDoi;
				$vLineRun = str_replace("@17", $this->FormatView(($arrS['InOutWH3']>0)?$vGiaVonround($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@18", $this->FormatView(round($vThanhTienXTK3,20),10), $vLineRun);
				//Xuất kho khác
				$vLineRun = str_replace("@19", $this->FormatView($arrS['InOutWH'],10), $vLineRun);
				$vLineRun = str_replace("@85", $this->FormatView(($arrS['InOutWH'])*$vQuiDoi,10), $vLineRun);
				$slv085=$slv085+($arrS['InOutWH'])*$vQuiDoi;
				$vLineRun = str_replace("@20", $this->FormatView(($arrS['InOutWH']>0)?round($vGiaVon,2):0,10), $vLineRun);
				$vLineRun = str_replace("@21", $this->FormatView(round($vThanhTienXTK,0),10), $vLineRun);
				//Xuất kho trả hàng
				$vLineRun = str_replace("@22", $this->FormatView($arrS['InOutWH4'],10), $vLineRun);
				$vLineRun = str_replace("@86", $this->FormatView(($arrS['InOutWH4'])*$vQuiDoi,10), $vLineRun);
				$slv086=$slv086+($arrS['InOutWH4'])*$vQuiDoi;
				...
				$vLineRun = str_replace("@25",$this->FormatView( $vTonCuoiKy,10), $vLineRun);
				$vLineRun = str_replace("@87", $this->FormatView(($vTonCuoiKy)*$vQuiDoi,10), $vLineRun);
				$slv087=$slv087+$vTonCuoiKy*$vQuiDoi;
				$vLineRun = str_replace("@26", $this->FormatView(($vTonCuoiKy>0)?round($vGiaVon,2):0,10), $vLineRun);				
				$vLineRun = str_replace("@27", $this->FormatView(round($vThanhTien,0),10), $vLineRun);
				//$vLineRun = str_replace("@25", $this->FormatView($arrS['lv014'],6), $vLineRun);
				$vdetail='';
		...
		//Tồn đầu kỳ
		$vRowLast=str_replace("@07",$this->FormatView($vSumDK,0),$vRowLast);
		$vRowLast=str_replace("@81",$this->FormatView($slv081,0),$vRowLast);
		$vRowLast=str_replace("@08",'&nbsp;',$vRowLast);
		$vRowLast=str_replace("@09",$this->FormatView(round($vTongTienDK,0),10),$vRowLast);
		//Nhập kho điều chuyển
		$vRowLast=str_replace("@10",$this->FormatView($vSumNTK,0),$vRowLast);
		$vRowLast=str_replace("@82",$this->FormatView($slv0812,0),$vRowLast);
		$vRowLast=str_replace("@11",'&nbsp;',$vRowLast);
		$vRowLast=str_replace("@12",$this->FormatView(round($vTongTienNTK,0),10),$vRowLast);
		//Nhập kho mua hàng
		$vRowLast = str_replace("@13", $this->FormatView($vSumNTK3,10), $vRowLast);
		$vRowLast=str_replace("@83",$this->FormatView($slv083,0),$vRowLast);
		$vRowLast = str_replace("@14", '&nbsp;', $vRowLast);
		$vRowLast = str_replace("@15", $this->FormatView(round($vTongTienNTK3,0),10), $vRowLast);
		//Xuất kho điều chuyển
		$vRowLast = str_replace("@16", $this->FormatView($vSumXTK3,10), $vRowLast);
		$vRowLast=str_replace("@84",$this->FormatView($slv084,0),$vRowLast);
		$vRowLast = str_replace("@17", '&nbsp;', $vRowLast);
		$vRowLast = str_replace("@18", $this->FormatView(round($vThanhTienXTK3,0),10), $vRowLast);
		//Xuất kho khác
		$vRowLast=str_replace("@19",$this->FormatView($vSumXTK,0),$vRowLast);
		$vRowLast=str_replace("@85",$this->FormatView($slv085,0),$vRowLast);
		$vRowLast=str_replace("@20",'&nbsp;',$vRowLast);
		$vRowLast=str_replace("@21",$this->FormatView(round($vTongTienXTK,0),10),$vRowLast);
		//Xuất kho trả hàng
		$vRowLast = str_replace("@22", $this->FormatView($vSumXTK4,10), $vRowLast);
		$vRowLast=str_replace("@86",$this->FormatView($slv086,0),$vRowLast);
		$vRowLast = str_replace("@23", '&nbsp;', $vRowLast);
		$vRowLast = str_replace("@24", $this->FormatView(round($vThanhTienXTK4,0),10), $vRowLast);
		//Cuối kỳ
		$vRowLast=str_replace("@25",$this->FormatView($vSumTCK,0),$vRowLast);
		$vRowLast=str_replace("@87",$this->FormatView($slv087,0),$vRowLast);
		$vRowLast=str_replace("@26",'&nbsp;',$vRowLast);
		$vRowLast=str_replace("@27",$this->FormatView(round($vTongTien,0),10),$vRowLast);
		$strExpportAll=$strExpportAll.$vRowLast;
		if($vExistItemCur!=1)
	...
	$vHeaderReportInventory="
		...
		//if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		  ...
		  $sqlS = "select A.lv001, A.lv002 ,A.lv004,C.lv002 DonViTinh,B.lv010 HTXNK,B.lv005 Type,B.lv009 DateEnter,'N' CategoryPut,B.lv004 Title,B.lv099 KhoDen,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference,B.lv002 WhID  from wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 and (((B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR) $vOrContractR2)  left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' $vAddLot
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 DonViTinh,B.lv010 HTXNK,B.lv005 Type,B.lv009 DateEnter,'X' CategoryPut,B.lv004 Title,B.lv099 KhoDen,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference,B.lv002 WhID from wh_lv0011 A inner join wh_lv0010 B on A.lv002=B.lv001 and ((B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO) $vOrContractO2) left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' $vAddLot 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vNumline++;			
				$vLineRun = str_replace("@05", ($arrS['lv004']!="" || $arrS['lv004']!=NULL)?$this->FormatView($arrS['lv004'],10)."(".$arrS['DonViTinh'].")":"-", $vLineRun);
...
//////////////////////////////////Purchase Order////////////////////////////
	...
	$vHeaderReportInventory="
		...
		if($vAddCond!="") $vCondition = $vCondition." inner join wh_lv0020 B1 on A.lv003=B1.lv003 AND A.lv014=B1.lv014  $vAddCond";		
		 $sqlS = "select A.lv001,A.lv002 ,A.lv004,C.lv002 DonViTinh,B.lv005,B.lv009 DateEnter,'N' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,D.lv006,D.lv004,D.lv005,D.lv007 NoteLot,E.lv002VN Colorlv002  from wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 and (((B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR) $vOrContractR2) left join sl_lv0005 C on A.lv005=C.lv001 left join wh_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003' 
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 DonViTinh,B.lv005,B.lv009 DateEnter,'X' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,D.lv006,D.lv004,D.lv005,D.lv007 NoteLot,E.lv002VN Colorlv002 from wh_lv0011 A inner join wh_lv0010 B on A.lv002=B.lv001 and ((B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO) $vOrContractO2) left join sl_lv0005 C on A.lv005=C.lv001  left join wh_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003' 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
...
//////////////////////////////////////////Purchase Order////////////////////////////////////////////////////////////////////
	...
	function SumSQLRun($vSQL,$vColpan,$vLang,$plang)
	{
		...
		$vValue="";
		while($arrS=db_fetch_array($bResultS)){		
			if($vValue=="") $vValue=$this->FormatView($arrS['SumQty'],10).$arrS['DonViTinh'];
			else $vValue=$vValue." ; ".$this->FormatView($arrS['SumQty'],10).$arrS['DonViTinh'];
		}
