<?php
/////////////coding sl_lv0203///////////////
class   sl_lv0203 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function LV_GetDetailGroup($vLangArr,&$vSum,$vOpt=0)
	{
		...
		$vstr='
			...
			<table class="lvtable">
			<tr class="lvhtable"><td class="lvhtable">'.$vLangArr[18].'</td><td style class="lvhtable" style="width:10px">M</td><td style class="lvhtable" style="width:10px">K</td><td  class="lvhtable" style="width:20px">R</td><td class="lvhtable">Bàn</td><td class="lvhtable">Giờ</td><td class="lvhtable">Tên</td><td class="lvhtable">Mã SP</td><td class="lvhtable">SL</td><td class="lvhtable"><image src="../images/icon/note_re.png"/></td><td class="lvhtable"><image src="../images/icon/note_all.png"/></td><td class="lvhtable">Ghi chú</td></tr>
		';
		$vCondition="";
		...
		if($vOpt==0)
		{
			...
			while($vrow = db_fetch_array ($vresult))
			{
				...
				switch($this->viewshow)
				{
					...
					if($vItem!=$vrow['lv003'])
					{
						...
						{
							$vstr=$vstr.'
								<tr class="lvhtable"><td class="lvhtable" colspan="4">&nbsp;<!--<input type="button" value="Xong tất cả" onclick="changestaffreceivefoodall(\''.$vCodeID.'\')"/>--></td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">'.$this->FormatView($vSumQty,10).'</td><td  colspan="3"></td></tr>
								';
						}
						$vSumQty=0;
						$vSumG=0;
			...
			foreach($vArrItemSort as $vItemRun)
			{
				...
				$vstr=$vstr.'<tr class="lvhtable"><td class="lvhtable" colspan="4">&nbsp;<!--<input type="button" value="Xong tất cả" onclick="changestaffreceivefoodall(\''.$vItemRun[1].'\')"/>--></td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">'.$this->FormatView($vItemRun[3],10).'</td><td  colspan="3"></td></tr>							';
			}
		}
		else
		{
				...
				switch($this->viewshow)
				{
					case 1:
						...
						if($vItem!=$vrow['lv003'])
						{
							...
							{
								$vstr=$vstr.'
									<tr class="lvhtable"><td class="lvhtable" colspan="4">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">'.$this->FormatView($vSumQty,10).'</td><td  colspan="3"></td></tr>
									';
							}
							$vSumQty=0;
							$vSumG=0;
						...
						$vSum=$vSum+$vrow['lv004']*$vrow['lv006']-$vrow['lv004']*$vrow['lv006']*$vrow['lv011']/100;
						//$vSumTT=$vSumTT+$vrow['lv017']*$vrow['lv006'];
						$vstr=$vstr.'<tr class="lvlinehtable'.($i%2).(($vrow['lv004']==0)?' textunderline':'').'"  ><td style="color:'.$vrow['ColorName'].'">'.$i.'</td><td style="color:'.$vrow['ColorName'].'">'.$vrow['lv018'].'</td><td style="color:'.$vrow['ColorName'].'">'.(($vrow['lv019']==0 && $this->GetAdd()>0)?'<input type="checkbox" onclick="changestaffreceivefood(this,\''.$vrow['lv001'].'\','.$vBangID.')"/>':$vrow['lv019']).'</td><td style="color:'.$vrow['ColorName'].'"><input type="button" value="Hoàn lại" onclick="changestaffcomeback(\''.$vrow['lv001'].'\')"/>'.$vrow['lv017'].'</td>'.'<td>'.$this->getvaluelink('lv007',$vrow['bangid']).'</td>'.'<td>'.substr($vrow['lv014'],11,8).'</td><td style="color:'.$vrow['ColorName'].'">'.$vrow['Name'].'</td><td style="color:'.$vrow['ColorName'].'">'.$vrow['ItemID'].'</td><td  align=right>'.$vrow['lv004'].'</td><td>'.$vrow['lv021'].'</td><td>'.$vrow['lv022'].'</td><td><div style="float:left"><input type="textbox" value="'.$vrow['lv023'].'" style="width:150px;text-align:center;background:orange" onblur="changeqtytratruoc(this,\''.$vrow['lv001'].'\','.$vBangID.')" name="tratruoc_'.$vContractID.'_'.$i.'" title="'.$this->FormatView($vrow['lv013'],4).'"/></div></td></td></tr>';
						$i++;
						break;
				default:
						if($vDaXoa==1)
					...
					else
					{
						...
						if($vItem!=$vrow['lv003'])
						{
							...
							{
								$vstr=$vstr.'
									<tr class="lvhtable"><td class="lvhtable" colspan="5">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">'.$this->FormatView($vSumQty,10).'</td><td  colspan="3"></td></tr>
									';
							}
							$vSumQty=0;
							$vSumG=0;
						...
						$vSum=$vSum+$vrow['lv004']*$vrow['lv006']-$vrow['lv004']*$vrow['lv006']*$vrow['lv011']/100;
						//$vSumTT=$vSumTT+$vrow['lv017']*$vrow['lv006'];
						$vstr=$vstr.'<tr class="lvlinehtable'.($i%2).(($vrow['lv004']==0)?' textunderline':'').'"  ><td style="color:'.$vrow['ColorName'].'">'.$i.'</td><td style="color:'.$vrow['ColorName'].'">'.$vrow['lv018'].'</td><td style="color:'.$vrow['ColorName'].'">'.(($vrow['lv019']==0 && $this->GetAdd()>0)?'<input type="checkbox" onclick="changestaffreceivefood(this,\''.$vrow['lv001'].'\','.$vBangID.')"/>':$vrow['lv019']).'</td><td style="color:'.$vrow['ColorName'].'"><input type="button" value="Hoàn lại" onclick="changestaffcomeback(\''.$vrow['lv001'].'\')"/>'.$vrow['lv017'].'</td>'.'<td>'.$this->getvaluelink('lv007',$vrow['bangid']).'</td>'.'<td>'.substr($vrow['lv014'],11,8).'</td><td style="color:'.$vrow['ColorName'].'">'.$vrow['Name'].'</td><td style="color:'.$vrow['ColorName'].'">'.$vrow['ItemID'].'</td><td  align=right '.$vStyle.'>'.$vrow['lv004'].'</td><td>'.$vrow['lv021'].'</td><td>'.$vrow['lv022'].'</td><td><div style="float:left"><input type="textbox" value="'.$vrow['lv023'].'" style="width:150px;text-align:center;background:orange" onblur="changeqtytratruoc(this,\''.$vrow['lv001'].'\','.$vBangID.')" name="tratruoc_'.$vContractID.'_'.$i.'" title="'.$this->FormatView($vrow['lv013'],4).'"/></div></td></td></tr>';
						$i++;
						break;
				}
		...
		$vstr=$vstr.'
		<tr class="lvhtable"><td class="lvhtable" colspan="4">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">&nbsp;</td><td class="lvhtable">'.$this->FormatView($vSumQty,10).'</td><td  colspan="3"><span style="display:none" id="tongtienct_'.$vBangID.'">'.$this->FormatView($vSum,10).'</span></td></tr>';
		$vstr=$vstr.'
		</table>
		';
		return $vstr;
