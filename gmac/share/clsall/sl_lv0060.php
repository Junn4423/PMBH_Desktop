...
////////////
	...
	{
		$lvsql="select lv008 from sl_lv0059 B where  B.lv001='$this->lv002'";
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM sl_lv0060  WHERE sl_lv0060.lv001 IN ($lvarr) and (select lv008 from sl_lv0059 B where  B.lv001= sl_lv0060.lv002)<=0 ";
		$vReturn= db_query($lvsql);
