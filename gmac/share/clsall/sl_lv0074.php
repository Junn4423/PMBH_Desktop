...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function PrintInOutPutInStockInvoiceSumBangKe($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$vCustomerID,$vlv005_opt,$vSalerID,$vlv013_opt,$vItemID,$vProgramID,$vGift,$vCateID,$vCateOpt,$vtax,$vlv007,$vlv007_opt)
	{
		...
		$sqlS = "select B.lv001 InvoiceID,J.lv002 RoomName,B.lv004 DateInvoice,B.lv011 State,F.lv002 stateName,B.lv005 DateInvoiceTo,B.lv002 CustomerID,B.lv003 CustomerName,B.lv009 CustomerAdd,B.lv013 CustomerNote,B.lv010 EmployeeID,sum(A.lv006*A.lv004-A.lv006*A.lv004*B.lv022/100+A.lv006*A.lv004*B.lv006/100) SumTotal,TIME_TO_SEC(substr(B.lv004,12,8)) timeview,TIME_TO_SEC(TIMEDIFF('24:00:00',substr(B.lv004,12,8))) timeagain,TIME_TO_SEC('24:00:00') h24,DATEDIFF(B.lv005,B.lv004) days,TIME_TO_SEC(substr(B.lv005,12,8)) curtime from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 left join sl_lv0054 F on B.lv011=F.lv001 left join sl_lv0009 J on B.lv007=J.lv001 where 1=1 $vCondition group by  A.lv002";	
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select B.lv001 InvoiceID,J.lv002 RoomName,B.lv004 DateInvoice,B.lv011 State,F.lv002 stateName,B.lv005 DateInvoiceTo,B.lv002 CustomerID,B.lv003 CustomerName,B.lv009 CustomerAdd,B.lv013 CustomerNote,B.lv010 EmployeeID,sum(A.lv006*A.lv004-A.lv006*A.lv004*B.lv022/100-A.lv006*A.lv004*A.lv011/100+A.lv006*A.lv004*B.lv006/100) SumTotal,sum(A.lv006*A.lv004*B.lv022/100+A.lv006*A.lv004*A.lv011/100) TCK,sum(A.lv006*A.lv004)*B.lv006/100 VAT,TIME_TO_SEC(substr(B.lv004,12,8)) timeview,TIME_TO_SEC(TIMEDIFF('24:00:00',substr(B.lv004,12,8))) timeagain,TIME_TO_SEC('24:00:00') h24,DATEDIFF(B.lv005,B.lv004) days,TIME_TO_SEC(substr(B.lv005,12,8)) curtime from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 left join sl_lv0054 F on B.lv011=F.lv001 left join sl_lv0009 J on B.lv007=J.lv001 where 1=1 $vCondition group by  A.lv002";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
