<?php
/////////////coding jo_lv0004///////////////
class   jo_lv0010 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update jo_lv0004 set lv004='0'  WHERE jo_lv0004.lv001 IN ($lvarr)  and lv006=0 and lv021=0";
	...
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update jo_lv0004 set lv004='0'  WHERE jo_lv0004.lv001 IN ($lvarr)";
		$vReturn= db_query($lvsql);
...
//////////////////////Buil list////////////////////
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$sqlS = "SELECT *,lv015 lv100 FROM jo_lv0004 WHERE 1=1  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
...
//////////////////////Buil list////////////////////
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		{
			case 'lv003':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  jo_lv0002";
				break;
			case 'lv004':
	...
	private  function getvaluelink($vFile,$vSelectID)
	{
		switch($vFile)
		{
			case 'lv002':
				...
				break;
			case 'lv003':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  jo_lv0002 where lv001='$vSelectID'";
				break;
			case 'lv004':
