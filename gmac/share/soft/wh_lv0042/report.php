...
$mowh_lv0042->ArrFunc[11]=$vLangArr[36];
$mowh_lv0042->ArrFunc[12]=$vLangArr[37];
$mowh_lv0042->ArrFunc[13]=$vLangArr[38];
$mowh_lv0042->ArrFunc[14]=$vLangArr[39];
$mowh_lv0042->ArrFunc[15]=$vLangArr[40];
////Other
$mowh_lv0042->ArrOther[1]=$vLangArr[31];
$mowh_lv0042->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mowh_lv0042->lv002=base64_decode($_GET['ID']);
...
?>
						...
						<?php echo $mowh_lv0042->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
