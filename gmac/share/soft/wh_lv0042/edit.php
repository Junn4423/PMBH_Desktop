...
$lvwh_lv0042->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
...
if($vFlag==1)
{
$lvwh_lv0042->lv002=$_POST['txtlv002'];
...
$lvwh_lv0042->lv018=$_POST['txtlv018'];
		...
		$vresult=$lvwh_lv0042->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvwh_lv0042->LV_LoadID($lvwh_lv0042->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0042->lv001=="")?InsertWithCheckExt('wh_lv0042', 'lv001', '',10):$lvwh_lv0042->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
