...
$vNow=GetServerDate();
$mowh_lv0076->lv002=getyear($vNow)."-".getmonth($vNow)."-"."01";
$mowh_lv0076->lv003=$vNow;
//$ma=$_GET['ma'];
                    ...
                    <input type="hidden" name="lang" value="<?php echo $plang;?>" />
					 <table width="100%" border="0" align="center" id="table1">
							<tr>
							 ...
							 $vStr=$mowh_lv0076->GetBuilCheckListDept($mowh_lv0076->lv001,'chklv001',10,'wh_lv0001','lv002',$mowh_lv0076->lv001,$vCount);
							 if($vCount<=1)
							 {
								 echo  $vStr;
							 }
							...
							<!--  <select name="txtlv001" id="txtlv001"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
							   				<?php
												...
												?>
							  <?php //echo $mowh_lv0076->LV_LinkField('lv002',$mowh_lv0076->lv002);?>
							 
                              </select>-->							    </td>
							</tr>
						<tr>
							<td  height="20"><?php echo $vLangArr[2];?></td>
							<td  height="20"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmRpt.txtlv002);return false;" name="txtlv002" type="text" id="txtlv002" value="<?php echo formatdate($mowh_lv0076->lv002,$plang);?>" tabindex="11" maxlength="100" style="width:100%;text-align:center;" onKeyPress="return CheckKey(event,7)">
							</td>
						</tr>							 
						<tr>
							<td  height="20"><?php echo $vLangArr[3];?></td>
							<td  height="20"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmRpt.txtlv003);return false;" name="txtlv003" type="text" id="txtlv003" value="<?php echo formatdate($mowh_lv0076->lv003,$plang);?>" tabindex="11" maxlength="100" style="width:100%;text-align:center;" onKeyPress="return CheckKey(event,7)"></td>
						</tr>					  						
						<tr>
						<td  height="20" valign="top"><?php echo $vLangArr[39];?></td>
						<td  height="20">
						<input name="txtlv008" type="hidden" id="txtlv008" value="<?php echo $mowh_lv0076->lv008;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							<div style="width:100%;height:140px;overflow:scroll;"> 
							<?php echo $mowh_lv0076->GetBuilCheckList($mowh_lv0076->lv008,'chklv008',10);?>
						</div>
						</td>
					</tr>
					<tr>
						<td colspan="2" style="height:1px;border-top:1px #000 solid;"></td>
						  ...
						  <tr>
							...
							<?php echo $mowh_lv0076->GetBuilCheckListGia($mowh_lv0076->lv012,'chklv012',10,'','lv002',$mowh_lv0076->lv012);?>	
							</div>
							</td>
						  </tr>
						  <tr>
