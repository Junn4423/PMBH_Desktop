...
<div class="hd_cafe">
	<ul class="qlycafe">
		<li><div class="licafe" onclick="TaoBang()" >TẠO BÀN</div></li>
		<li><div class="licafe" title='Tạo khu vực' onclick="TaoKhuVuc()">TẠO KV</div></li>
		<li><div class="licafe" title='Tạo chương trình' onclick="ChuongTrinhBH()">C.TRÌNH</div></li>
		<li><div class="licafe" title='Tạo sản phẩm' onclick="taosanpham()">TẠO SP</div></li>
