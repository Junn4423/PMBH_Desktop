...
define("DB_USER","root");
define("DB_PWD","hungsofv.3");
define("DB_DATABASE","mu_light-entertainmentv3_0");
define ("No_Date_Default","1900-01-01");

define("DB_SERVER_SECOND","localhost");
define("DB_USER_SECOND","root");
define("DB_PWD_SECOND","hungsofv.3");
define("DB_DATABASE_SECOND","mu_light-entertainmentv3_0");
global $pListFolder;
...
function db_connect_second()
{
	...
	$db_link_second=mysql_connect(DB_SERVER_SECOND,DB_USER_SECOND,DB_PWD_SECOND);
	if($db_link_second) mysql_select_db(DB_DATABASE_SECOND);
	mysql_query('SET NAMES utf8');
	return $db_link_second;
}
function db_close_second()
{
	global $db_link_second;
	$result=mysql_close($db_link_second);
	return $db_link_second;
}
function db_query_second($db_query_second){
	global $db_link_second;
	$result=mysql_query($db_query_second,db_connect_second());
	return $result;
}
function db_fetch_array_second($db_query_second)
{
	if($db_query_second==NULL) return NULL;
	$result=mysql_fetch_array($db_query_second);
	return $result;
}
function db_num_rows_second($db_query_second)
{
	if($db_query_second==NULL) return -1;
	$result=mysql_num_rows($db_query_second);
	return $result;
}
/*endconnect database second*/
//general function
