<?php
class wh_lv0014 extends lv_controler{
	var $vRowHeader="
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function PrintInOutPutInStock($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$vExistItem)
	{
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select * from (select A.*,B.lv002 Unitlv002,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR)) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR)) InReceiptQty,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO)) ReOutlv004 ,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO)) InOutlv004  from  all_gmacv3_0.sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001  where 1=1 and A.lv015>=0 $vConditionStock) MP  where ((MP.ReReceiptQty-MP.ReOutlv004)<>0 or  MP.InReceiptQty<>0 or MP.InOutlv004<>0 )";
...
function PrintInOutPutInStockDetail($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$vExistItem)
	{
	if($vDateStart!="") $vDateStart=$vDateStart." 00:00:00";
	if($vDateEnd!="") $vDateEnd=$vDateEnd." 23:59:59";
	$vHeaderReportInventory="
		...
		if($strContractlv001!="")
		{
			$vAddContractR=" AND A11.lv006='".$strContractlv001."' and (A11.lv005=4 or A11.lv005=7) ";				
			$vAddContractO=" AND A21.lv006='".$strContractlv001."' and A21.lv005=4  ";						 
		 }
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		if($vAddCond!="") $vCondition = $vCondition." inner join wh_lv0020 B1 on A1.lv003=B1.lv003 AND A1.Lot=B1.lv014  $vAddCond";
		$vConditionStock="";
		$strwh=$this->Get_WHControler();
		if($vExistItem==1)
		{
		...
		$sqlS = "select A.*,B.lv002 Unitlv002,(select sum(A1.lv004) from wh_lv0009 A1  $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR) ) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR) ) InReceiptQty,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO) ) ReOutlv004 ,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO) ) InOutlv004  from  all_gmacv3_0.sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001  where 1=1 and A.lv015>=0 $vConditionStock";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				{
					case 3:
						$vLineRun = str_replace("@20", $this->GetBuildTableInputOutputDetail($plang, $vArrLang,$vDateStart,$vDateEnd,$arrS['lv001'],$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$vlv001), $vLineRun);	
						break;
					case 4:
						$vLineRun = str_replace("@20", $this->GetBuildTableInputOutputDetailStyle($plang, $vArrLang,$vDateStart,$vDateEnd,$arrS['lv001'],$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$vlv001), $vLineRun);	
						break;
					default:
						$vLineRun = str_replace("@20", $this->GetBuildTableInputOutput($plang, $vArrLang,$vDateStart,$vDateEnd,$arrS['lv001'],$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$vlv001), $vLineRun);					
					break;
				}
	...
	function GetBuildTableInputOutput($plang, $vArrLang,$vDateStart,$vDateEnd,$vlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$vlv001)
	{
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select A.lv001, A.lv002 ,A.lv004,C.lv002 Unitlv002,B.lv005 Type,B.lv009 DateEnter,'N' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference  from wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 and (B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR  left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' 
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 Unitlv002,B.lv005 Type,B.lv009 DateEnter,'X' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference from wh_lv0011 A inner join wh_lv0010 B on A.lv002=B.lv001 and B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
...
//////////////////////////////////Purchase Order////////////////////////////
	function GetBuildTableInputOutputDetail($plang, $vArrLang,$vDateStart,$vDateEnd,$vlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$vlv001)
	{
	$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" class=\"tblprint\">
			<tr height=\"5px\" class=\"tblRunChild\" >
...
//////////////////////////////////Detail Sale Style////////////////////////////
	function GetBuildTableInputOutputDetailStyle($plang, $vArrLang,$vDateStart,$vDateEnd,$vlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$vlv001)
