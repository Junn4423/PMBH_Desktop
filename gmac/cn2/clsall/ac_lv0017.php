<?php
/////////////coding ac_lv0017///////////////
class   ac_lv0017 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"0","lv006"=>"0","lv007"=>"0","lv008"=>"0","lv009"=>"2","lv010"=>"0","lv011"=>"0","lv012"=>"0","lv013"=>"0","lv014"=>"2","lv015"=>"0","lv016"=>"0");	
	...
	function LV_Update()
	{
		...
		$this->lv009 = ($this->lv009!="")?recoverdate(($this->lv009), $this->lang):$this->DateDefault;
		$this->lv014 = ($this->lv014!="")?recoverdate(($this->lv014), $this->lang):$this->DateDefault;
		  $lvsql="Update ac_lv0004 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008',lv009='$this->lv009',lv010='$this->lv010',lv011='$this->lv011',lv012='$this->lv012',lv013='$this->lv013',lv014='$this->lv014',lv015='$this->lv015' where  lv001='$this->lv001' and lv016<=0";
		$vReturn= db_query($lvsql);
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM ac_lv0004  WHERE ac_lv0004.lv016<=0 AND ac_lv0004.lv001 IN ($lvarr) and (select count(*) from ac_lv0007 B where  B.lv002= ac_lv0004.lv001)<=0  ";
		$vReturn= db_query($lvsql);
	...
	{
		$lvsql = "select (select if(ISNULL(sum(lv008)),0,sum(lv008)) from ac_lv0007 A  WHERE A.lv002 ='$vVoiceID' and A.lv010='$vAccount' and A.lv010<>A.lv011) AddMN ,(select if(ISNULL(sum(lv008)),0,sum(lv008)) from ac_lv0007 A  WHERE A.lv002 ='$vVoiceID' and A.lv011='$vAccount' and A.lv010<>A.lv011) SubMN,((select if(ISNULL(sum(lv008)),0,sum(lv008)) from ac_lv0007 A  WHERE A.lv002 ='$vVoiceID' and A.lv010='$vAccount' and A.lv010<>A.lv011)-(select if(ISNULL(sum(lv008)),0,sum(lv008)) from ac_lv0007 A  WHERE A.lv002 ='$vVoiceID' and A.lv011='$vAccount' and A.lv010<>A.lv011)) SumSub, B.lv010,B.lv011 from ac_lv0007 B where B.lv002 ='$vVoiceID' and (B.lv010='$vAccount' or B.lv011='$vAccount') and B.lv010<>B.lv011 ";
		$vReturnArr=array();
		...
		while($row= db_fetch_array($lvResult)){
			...
			$vReturnArr[2]=$vReturnArr[2].$row['lv010'];
			$vReturnArr[3]=$vReturnArr[3].$row['lv011'];
			$vflag=2;
			}
			else
			{
			if(strpos(",".$row['lv010'].",",",".$vReturnArr[2].",")===false)
				$vReturnArr[2]=$vReturnArr[2].','.$row['lv005'];
			if(strpos(",".$row['lv011'].",",",".$vReturnArr[3].",")===false)
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('ac_lv0017/?lang=".$this->lang."&func='+value,'','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
