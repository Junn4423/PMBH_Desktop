<?php
class sl_lv0046 extends lv_controler{
	var $vRowHeader="
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function PrintInOutPutInStockDetail($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strCategory,$vExistItem)
	{
	$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" class=\"tblprint\">
			<tr height=\"30px\" class=\"tblcaption\">
				...
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_5',this,@!79)\" style=\"cursor:pointer\">@10</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_6',this,@!79)\" style=\"cursor:pointer\">@11</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_7',this,@!79)\" style=\"background-color:#eee;cursor:pointer\">@12</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_8',this,@!79)\" style=\"background-color:#eee;cursor:pointer\">@13</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_9',this,@!79)\" style=\"cursor:pointer\">@06</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_10',this,@!79)\" style=\"cursor:pointer\">@14</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_11',this,@!79)\" style=\"cursor:pointer\">@07</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_12',this,@!79)\" style=\"cursor:pointer\">@15</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_13',this,@!79)\" style=\"background-color:#eee;cursor:pointer\">@08</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_14',this,@!79)\"style=\"background-color:#eee;cursor:pointer\">@16</td>				
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_15',this,@!79)\" style=\"cursor:pointer\">@09</td>
		...
		$vRowFirst="
			<tr>
				...
				<td class=\"right_style\" id=\"col_5_@02\">@10</td>
				<td class=\"right_style\" id=\"col_6_@02\">@11</td>
				<td class=\"right_style\" id=\"col_7_@02\" style=\"background-color:#eee\">@12</td>
				<td class=\"right_style\" id=\"col_8_@02\" style=\"background-color:#eee\">@13</td>	
				<td class=\"right_style\" id=\"col_9_@02\" >@06</td>
				<td class=\"right_style\" id=\"col_10_@02\">@14</td>
				<td class=\"right_style\" id=\"col_11_@02\">@07</td>
				<td class=\"right_style\" id=\"col_12_@02\">@15</td>
				<td class=\"right_style\" id=\"col_13_@02\" style=\"background-color:#eee\">@08</td>
				<td class=\"right_style\" id=\"col_14_@02\" style=\"background-color:#eee\">@16</td>
				<td class=\"right_style\" id=\"col_15_@02\">@09</td>
		...
		$vRowLightText="
			<tr>
				...
				<td class=\"right_style\" style=\"background-color:#eee\">@12</td>
				<td class=\"right_style\" style=\"background-color:#eee\">@13</td>	
				<td class=\"right_style\" >@06</td>
				<td class=\"right_style\" >@14</td>
				<td class=\"right_style\" >@07</td>
				<td class=\"right_style\" >@15</td>
				<td class=\"right_style\" style=\"background-color:#eee\">@08</td>
				<td class=\"right_style\" style=\"background-color:#eee\">@16</td>
				<td class=\"right_style\" >@09</td>
				<td class=\"right_style\" >@17</td>							
			</tr>";
		$vCondition="";
		$vAddCond=""; 
		if($strSupplierlv001!="")
		...
		if($vlv001!="")
		{
			...
			$vConditionStock =$vConditionStock." AND (A.lv016 ='$vlv001')";			
		}
		else 
		{
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		...
		(select sum(A1.lv004) from wh_lv0009 A1  $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR) ) ReReceiptQty,
		(select sum(A1.lv004*A1.lv008+A1.lv004*A1.lv008*A1.lv010/100) from wh_lv0009 A1  $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR) ) PriceReReceiptQty,
		(select sum(A1.lv004) from wh_lv0009 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd 23:00:00' $vAddContractR) ) InReceiptQty,
		(select sum(A1.lv004*A1.lv008+A1.lv004*A1.lv008*A1.lv010/100) from wh_lv0009 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd 23:00:00' $vAddContractR) ) PriceInReceiptQty,
		(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO) ) ReOutlv004 ,
		(select sum(A1.lv004*A1.lv008+A1.lv004*A1.lv008*A1.lv010/100 -A1.lv004*A1.lv008*A1.lv011/100) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO) ) PriceReOutlv004 ,
		(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd 23:00:00' $vAddContractO) ) InOutlv004,
		(select sum(A1.lv004*A1.lv008+A1.lv004*A1.lv008*A1.lv010/100 -A1.lv004*A1.lv008*A1.lv011/100) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd 23:00:00' $vAddContractO) ) PriceInOutlv004  
		from  all_gmacv3_0.sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 where 1=1  and A.lv015>=0 $vConditionStock";	
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vLineRun = str_replace("@10", $this->FormatView($arrS['ReReceiptQty'],10), $vLineRun);
				$vLineRun = str_replace("@11", $this->FormatView($arrS['PriceReReceiptQty'],10), $vLineRun);
				$vLineRun = str_replace("@12", $this->FormatView($arrS['ReOutlv004'],10), $vLineRun);
				$vLineRun = str_replace("@13", $this->FormatView($arrS['PriceReOutlv004'],10), $vLineRun);
				$vLineRun = str_replace("@06", $this->FormatView($arrS['ReReceiptQty']-$arrS['ReOutlv004'],10), $vLineRun);
				$vLineRun = str_replace("@14", $this->FormatView(($arrS['ReReceiptQty']-$arrS['ReOutlv004'])*$arrS['PriceReOutlv004']/(($arrS['ReOutlv004']==0)?1:$arrS['ReOutlv004']),10), $vLineRun);
				$vLineRun = str_replace("@07", $this->FormatView($arrS['InReceiptQty'],10), $vLineRun);
				$vLineRun = str_replace("@15", $this->FormatView($arrS['PriceInReceiptQty'],10), $vLineRun);
				$vLineRun = str_replace("@08", $this->FormatView($arrS['InOutlv004'],10), $vLineRun);	
				$vLineRun = str_replace("@16", $this->FormatView($arrS['PriceInOutlv004'],10), $vLineRun);		
				if($arrS['ReOutlv004']+$arrS['InOutlv004']==0)
				$vPrice=0;
				else
				{
					if(($arrS['ReReceiptQty']+$arrS['InReceiptQty'])==0)
						$vPrice=0;
					else
						$vPrice=($arrS['PriceReReceiptQty']+$arrS['PriceInReceiptQty'])/($arrS['ReReceiptQty']+$arrS['InReceiptQty'])	;
				...
				switch($stropt)
				{
					...
					default:
						...
						$strReplace="<tr>
							<td colspan=\"16\">".$strreturn."</td></tr>";
						$vLineRun = str_replace("@20",$strReplace, $vLineRun);					
					break;
				}
		...
		$strExpportAll=$strExpportAll.$this->SumSQLRun($sqlS,16,$vArrLang[14],$plang);	
		$strExpportAll = str_replace("@01", $vNumline, $strExpportAll);
		///////////////////////////////////////////////////////////////
		$vHeader = str_replace("@!79",$totalRows,$vHeaderReportInventory);
		//Order
		...
		//Last
		$vHeader = str_replace("@10",$vArrLang[40], $vHeader);
		$vHeader = str_replace("@11",$vArrLang[41], $vHeader);
		$vHeader = str_replace("@12",$vArrLang[42], $vHeader);
		$vHeader = str_replace("@13",$vArrLang[43], $vHeader);
		$vHeader = str_replace("@14",$vArrLang[44], $vHeader);
		$vHeader = str_replace("@15",$vArrLang[45], $vHeader);
		$vHeader = str_replace("@16",$vArrLang[46], $vHeader);	
		$vHeader = str_replace("@17",$vArrLang[47], $vHeader);	
