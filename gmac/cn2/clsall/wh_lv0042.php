...
//////////////////////Buil list////////////////////
	...
	function PrintInPackingListParent($plang,$vlv001)
	{
		...
		if($vlv001!="") 	$vConditionStock=$vConditionStock." AND C.lv001 like '$vlv001'";
		 $sqlS = "select distinct A.lv002,A.lv003,A.lv005 UnitName,A.lv008,A.lv009,B.lv002 ItemName,D.lv004 lvLong,D.lv005 lvWidth,D.lv006 lvHeight,C.lv010 maxCol from wh_lv0042 A left join  all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 inner join wh_lv0041 C on A.lv002=C.lv001 left join wh_lv0036 D on D.lv001=A.lv012  where 1=1    $vConditionStock";	
...
.htable
{
	...
	if($lvFirst==1)
		...
		$vConditionStock="and A.lv002='$lvPackingId' and A.lv003='$lvItemId' and A.lv008='$lvColor' and A.lv009='$lvCut' " ;
		 $sqlS = "select distinct A.lv002,A.lv003,A.lv004,A.lv005 UnitName,A.lv008,A.lv009,A.lv011,B.lv002 ItemName,D.lv004 lvLong,D.lv005 lvWidth,D.lv006 lvHeight from wh_lv0042 A left join  all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 inner join wh_lv0041 C on A.lv002=C.lv001 left join wh_lv0036 D on D.lv001=A.lv012  where 1=1    $vConditionStock order by A.lv003 asc,A.lv011 asc,A.lv004 desc,A.lv018 asc";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
	...
	private function sqlconditionmulti($vFile,$vcondition)
	{
		...
		{
			case 'lv003':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from   all_gmacv3_0.sl_lv0007 where 1=1  $vcondition";
				break;
			case 'lv005':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from all_gmacv3_0.sl_lv0005 where 1=1  $vcondition";
				break;
			case 'lv007':
