...
//////////////////////Buil list////////////////////
	...
	{		
		...
		$sqlS = "SELECT distinct A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,B.lv002 NVID,C.lv029 lv001,D.lv007 Shift FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join all_gmacv3_0.hr_lv0020 C on C.lv001=B.lv002 left join tc_lv0008 D on D.lv002=B.lv002 WHERE 1=1  ".$this->GetConditionOrther()."  order by C.lv029 ASC,A.lv004 ASC";
		$vorder=$curRow;
...
////GetTime list
	...
	function Get_Arr_Employees()
	{
		...
		if($this->lvSort==0)
			$lvsql="select DD.lv001 CodeID,concat(DD.lv004,' ',DD.lv003,' ',DD.lv002) Name,DD.lv029 Dep from all_gmacv3_0.hr_lv0020 DD where 1=1 $strCondi  order by DD.lv029";
		else 
			$lvsql="select DD.lv001 CodeID,concat(DD.lv004,' ',DD.lv003,' ',DD.lv002) Name,DD.lv029 Dep from all_gmacv3_0.hr_lv0020 DD where 1=1 $strCondi  order by DD.lv001";
		$vresult=db_query($lvsql);	
		$i=0;
		while($vrow=db_fetch_array($vresult))
		{
...
//////////Get Filter///////////////
	...
	{
		$strCondi=" and A.lv002 in (select CC.lv001 from tc_lv0010 CC where CC.lv002 in (select DD.lv001 from all_gmacv3_0.hr_lv0020 DD where (DD.lv009=0 or DD.lv009=1)))";
		...
		if($this->lv028!="")  $strCondi=$strCondi." and A.lv002 in (select CC.lv001 from tc_lv0010 CC where CC.lv002 in (select DD.lv001 from all_gmacv3_0.hr_lv0020 DD where DD.lv009 in ('".str_replace(",","','",$this->lv028)."')))";
		if($this->lv029!="")  $strCondi=$strCondi." and A.lv002 in (select CC.lv001 from tc_lv0010 CC where CC.lv002 in (select DD.lv001 from all_gmacv3_0.hr_lv0020 DD where (DD.lv009=0 or DD.lv009=1) and DD.lv029 in ('".str_replace(",","','",$this->lv029)."')))";
		return $strCondi;
	}
	protected function GetConditionOrther()
	{
		...
		if($this->lv010!="")  $strCondi=$strCondi." and A.lv010 like '%$this->lv010%'";
		if($this->lv028!="")  $strCondi=$strCondi." and A.lv002 in (select CC.lv001 from tc_lv0010 CC where CC.lv002 in (select DD.lv001 from all_gmacv3_0.hr_lv0020 DD where DD.lv009 in ('".str_replace(",","','",$this->lv028)."')))";
		if($this->lv029!="")  $strCondi=$strCondi." and A.lv002 in (select CC.lv001 from tc_lv0010 CC where CC.lv002 in (select DD.lv001 from all_gmacv3_0.hr_lv0020 DD where DD.lv029 in ('".str_replace(",","','",$this->lv029)."')))";
...
private function sqlcondition($vFile,$vSelectID)
	...
	public  function getvaluelink($vFile,$vSelectID)
	{
		...
		{
			case 'lv002':
				$vsql="select tc_lv0010.lv002,concat(hr_lv0020.lv004,' ',hr_lv0020.lv003,' ',hr_lv0020.lv002,'(',hr_lv0020.lv001,')') lv002,IF(tc_lv0010.lv001='$vSelectID',1,0) lv003 from  tc_lv0010 left join all_gmacv3_0.hr_lv0020 on hr_lv0020.lv001=tc_lv0010.lv002 where tc_lv0010.lv001='$vSelectID'";
				break;
			case 'lv007':
