...
////////////
	...
	{
		$lvsql="select A.lv004 lv004 from sl_lv0014 A inner join all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001  where A.lv001 in ($vDetailID) and A.lv030=1";
		$vReturn= db_query($lvsql);
		while($vrow=db_fetch_array($vReturn))
		{
			$this->lv004=$vrow['lv004'];
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv011':
				...
				break;
			case 'lv911':
				$vsql="select B.lv001,concat(B.lv004,B.lv003,B.lv002) lv002,IF(B.lv001='$vSelectID',1,0) lv003 from all_gmacv3_0.wh_lv0034 A inner join all_gmacv3_0.lv_lv0007 C on C.lv001=A.lv002 inner join all_gmacv3_0.hr_lv0020 B on C.lv006=B.lv001   where A.lv003='$vSelectID'";
				break;
			case 'lv099':
