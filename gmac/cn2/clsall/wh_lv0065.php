	...
	$vHeaderReportInventory="
		...
		if(count($this->vArrDay)>0){
			foreach($this->vArrDay as $vDateCal)
			{
				...
				{
					case 1:
						$vsql="select A.lv003,sum(A.lv004) lv004,'' lv006,'' lv011,sum(A.lv004*A.lv008) thanhtien,C.lv002 Names from wh_lv0009 A inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 inner join wh_lv0008 B on A.lv002=B.lv001 and substr(B.lv009,1,10)='".$vDateCal."' group by A.lv003";
						break;
					case 2:
						$vsql="select C.lv003,sum(A.lv004) lv004,'' lv006,'' lv011,sum(A.lv004*A.lv008) thanhtien,D.lv002 Names from wh_lv0009 A inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 inner join wh_lv0008 B on A.lv002=B.lv001 and substr(B.lv009,1,10)='".$vDateCal."' left join  all_gmacv3_0.sl_lv0006 D on C.lv003=D.lv001 group by C.lv003";
						break;
					case 3:
						$vsql="select B.lv010,sum(A.lv004) lv004,'' lv006,'' lv011,sum(A.lv004*A.lv008) thanhtien,C.lv002 Names from wh_lv0009 A  inner join wh_lv0008 B on A.lv002=B.lv001 and substr(B.lv009,1,10)='".$vDateCal."' inner join all_gmacv3_0.hr_lv0020 C on B.lv003=C.lv001 group by B.lv003";
						break;
					case 4:
						...
						break;
					default:
						$vsql="select A.lv003,A.lv004,A.lv008 lv006,A.lv012 lv011,(A.lv004*A.lv008) thanhtien,C.lv002 Names from wh_lv0009 A inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 inner join wh_lv0008 B on A.lv002=B.lv001 and substr(B.lv009,1,10)='".$vDateCal."'";
						break;
				}
