...
///////////Load max////////////
	...
	private function SetOnce($vCheckAdmin,$vUserID,$vright,$vrightcontrol)
	{
		...
		{
			$vsql="select count(*) as count from all_gmacv3_0.lv_lv0009 A Where A.lv002='$vrightcontrol' and A.lv004=1 and A.lv003 in (select lv001 from all_gmacv3_0.lv_lv0008 B where B.lv002='$vUserID' and B.lv003='$vright' and B.lv004=1) ";
	...
	{
		$vsql="select $vField from all_gmacv3_0.lv_lv0007 where lv001='$vUserID'";
			$tresult=db_query($vsql);
			$trow=db_fetch_array($tresult);
			return $trow[$vField];		
	}
...
///WH controler
	public function Get_WHControler()
	{
		...
		if('admin'==$this->isRight)
		{
			...
			$lvsql="select  lv003 as lv001 from all_gmacv3_0.wh_lv0034 where lv002='$vUserID'";
		$str_return="";
		$vresult=db_query($lvsql);
