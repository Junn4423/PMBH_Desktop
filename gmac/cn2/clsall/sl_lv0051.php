<?php
/////////////coding sl_lv0051///////////////
class   sl_lv0051 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
///////////
	public $DefaultFieldList="lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017";	
////////////////////GetDate
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"1","lv005"=>"0","lv006"=>"1","lv007"=>"0","lv008"=>"10","lv009"=>"0","lv010"=>"10","lv011"=>"2","lv012"=>"0","lv013"=>"0","lv014"=>"0","lv015"=>"0","lv016"=>"2","lv017"=>"10");	
	...
	function LV_Insert()
	{
		...
		$lvsql="insert into wh_lv0009 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016) values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016')";
		$vReturn= db_query($lvsql);
		if($vReturn){
	...
	function LV_UpdateEdit($vOldlv004,$vOldlv006)
	{
		...
		if($vReturn){
			...
			if(	db_query($vsql1)) $this->InsertLogOperation($this->DateCurrent,'wh_lv0009.update',sof_escape_string($vsql1));
	...
	{
		$sqlD = "SELECT A.*,B.lv002 lvb002 FROM sl_lv0051 A inner join wh_lv0008 B on A.lv002=B.lv001 WHERE B.lv007<=0;";
		$vresult=db_query($sqlD);
		$strReturn=false;
		while($vrow=db_fetch_array($vresult))
		{
			...
			if(db_query($vsql))
			{
				$tsql="delete from sl_lv0051 where lv001='".$vrow['lv001']."'";
				if(db_query($tsql))
				{
					if($this->obj_wb_lv0006!=null)
				 	{
	...
	protected function GetCondition()
	{
		...
		$strCondi=$strCondi." and lv002 in (select B.lv001 from wh_lv0008 B where B.lv002 in ($strwh))";		
		return $strCondi;
	}
	////////////////Count///////////////////////////
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums FROM wh_lv0009 WHERE 1=1 ".$this->GetCondition();
		$bResultC = db_query($sqlC);
		$arrRowC = db_fetch_array($bResultC);
		return $arrRowC['nums'];
	}
...
//////////////////////Buil list////////////////////
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$sqlS = "SELECT * FROM wh_lv0009 WHERE 1=1  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."sl_lv0051/?lang=".$this->lang."&childdetailfunc='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	...
	private function sqlconditionext($vFile,$vSelectID)
	{
		...
		{
			case 'lv003':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from   all_gmacv3_0.sl_lv0007 where 1=1 and lv015>=0 and lv016 ='$vSelectID'";
				break;
			case 'lv005':
