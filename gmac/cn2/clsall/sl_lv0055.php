<?php
/////////////coding sl_lv0055///////////////
class   sl_lv0055 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update sl_lv0013 set lv011=4,lv020='$vUserID',lv021=concat(CURDATE(),' ',CURTIME())  WHERE sl_lv0013.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
	...
	function LV_UnAproval($lvarr)
	{
		...
		$vUserID=getInfor($_SESSION['ERPSOFV2RUserID'], 2);
		$lvsql = "Update sl_lv0013 set lv011=3,lv020='$vUserID',lv021=concat(CURDATE(),' ',CURTIME())  WHERE sl_lv0013.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."sl_lv0055/?lang=".$this->lang."&childfunc='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
