...
////////////
	...
	function LV_Load()
	{
		$vsql="select * from  all_gmacv3_0.hr_lv0020";
	...
	{
		$lvsql="select * from  all_gmacv3_0.hr_lv0020 Where lv001='$vlv001'";
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE from all_gmacv3_0.hr_lv0020   WHERE hr_lv0020.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
	...
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums from all_gmacv3_0.hr_lv0020 WHERE 1=1 ".$this->GetCondition();
	...
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$sqlS = "SELECT * from all_gmacv3_0.hr_lv0020 WHERE 1=1  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$lvTd="<td align=@#05>@02</td>";
		$lvImg="<td  ><img name=\"imgView\" border=\"0\" style=\"border-color:#CCCCCC\" title=\"\" alt=\"Image\" width=\"96px\" height=\"128px\" src=\"../../images/employees/@01/@02\" /></td>";
		$sqlS = "SELECT * from all_gmacv3_0.hr_lv0020 WHERE 1=1  ".$this->RptCondition." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
