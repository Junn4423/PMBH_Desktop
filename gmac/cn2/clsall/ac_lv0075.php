<?php
/////////////coding ac_lv0075///////////////
class   ac_lv0075 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
//GetMoney
	...
	function LV_InsertPO($vPOID,$vUserID,$vlv005,$vlv006,$vlv011,$vlv012)
	{
		if($vlv010=='') $vlv010='1111';
	 	$this->LV_DeleteTemp($vUserID);
		$lvsql="insert into ac_lv0077(lv002,lv003,lv004,lv005,lv006,lv007,lv008) select '$vUserID' ,sum(A.lv004*A.lv006+A.lv016),sum(A.lv009+A.lv017),'$vlv005','$vlv006','PO(Mua hàng)','$vPOID' from ac_lv0006 A inner join ac_lv0004 B on A.lv002=B.lv001  where 1=1 and A.lv002='$vPOID'";		
		$vresult=db_query($lvsql);
		return $vresult;		
	}
	function LV_DeleteTemp($vlv002)
	{
		$lvsql = "DELETE FROM ac_lv0076  WHERE ac_lv0045.lv002='$vlv002'";
		$vReturn= db_query($lvsql);
		return $vReturn;
	}	
		////////////////Count///////////////////////////
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('ac_lv0075/?lang=".$this->lang."&func='+value,'','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	function LV_BuilListReportMini($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvDateSort)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class=\"@#04\" align=\"@#05\">@02</td>";
		$sqlS = "SELECT * FROM ac_lv0004 WHERE 1=1 and lv009 like '$lvDateSort%' ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
