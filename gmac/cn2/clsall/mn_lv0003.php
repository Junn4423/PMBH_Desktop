...
class   mn_lv0003 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
///////////
	public $DefaultFieldList="lv001,lv002";	
////////////////////GetDate
...
////////////
	...
	var $ArrPush=array();
	var $ArrFunc=array();
	var $ArrGet=array("lv001"=>"2","lv002"=>"3");
	var $ArrView=array("lv001"=>"0","lv002"=>"0");
	...
	function LV_Insert()
	{
		...
		$lvsql="insert into  all_gmacv3_0.sl_lv0006 (lv001,lv002) values('$this->lv001','$this->lv002')";
	...
	function LV_Update()
	{
		if($this->isEdit==0) return false;
		 $lvsql="Update  all_gmacv3_0.sl_lv0006 set lv002='$this->lv002' where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
	...
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."mn_lv0003/?lang=".$this->lang."&func='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
