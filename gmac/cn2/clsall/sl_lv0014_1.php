...
////////////
	...
	{
		$vsql="select B.lv006,A.lv002 ContractID,C.lv007 RoomID from sl_lv0014_1 A inner join  all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 left join sl_lv0013 C on C.lv001=A.lv002 where A.lv001='".$vDetailID."' and (select AA.lv011 from sl_lv0013 AA where AA.lv001=A.lv002)<=0";
		$vresult=db_query($vsql);	
		$vrow = db_fetch_array ($vresult);
		if($vrow)
		{
	...
	{
		$vsql="select B.lv006,A.lv002 ContractID from sl_lv0014_1 A inner join  all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 where A.lv001='".$vDetailID."' and (select AA.lv011 from sl_lv0013 AA where AA.lv001=A.lv002)<=0";
		$vresult=db_query($vsql);	
		$vrow = db_fetch_array ($vresult);
		if($vrow)
		{
