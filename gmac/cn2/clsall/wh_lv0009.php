...
////////////
	...
	{
		$lvsql="select '$vInvoiceID' lv002,A.lv003,A.lv004*$vQty lv004,A.lv005 lv005,'' lv006,'' lv007,B.lv007 lv008,B.lv008 lv009,'' lv010,'' lv011,concat(CURDATE(),' ',CURTIME()) lv016,B.lv016 WHID from all_gmacv3_0.mn_lv0004 A inner join  all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001  where A.lv002='$vTemID'";
		$vReturn= db_query($lvsql);
		while($vrow=db_fetch_array($vReturn))
		{
			$this->lv002=$vrow['lv002'];
	...
	{
		$lvsql="select '$vInvoiceID' lv002,A.lv003,A.lv004,B.lv004 lv005,'' lv006,'' lv007,A.lv006 lv008,A.lv007 lv009,A.lv008 lv010,'' lv011,concat(CURDATE(),' ',CURTIME()) lv016,B.lv016 WHID from sl_lv0014 A inner join  all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001  where A.lv002='$vlv002'";
		$vReturn= db_query($lvsql);
		while($vrow=db_fetch_array($vReturn))
		{
			$this->lv002=$vrow['lv002'];
...
//////////////////////Buil list////////////////////
	...
	private function sqlconditionext($vFile,$vSelectID)
	{
		...
		{
			case 'lv003':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from   all_gmacv3_0.sl_lv0007 where 1=1 and lv015>=0 and (lv016 ='$vSelectID' or lv016='')";
				break;
			case 'lv005':
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			case 'lv003':
				$strwh=$this->Get_WHControler();
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from   all_gmacv3_0.sl_lv0007 where 1=1 and lv015>=0 and (lv016 in ($strwh)) order by lv001 asc";
				break;
			case 'lv005':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from all_gmacv3_0.sl_lv0005";
				break;
