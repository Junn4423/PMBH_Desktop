...
class sl_lv0007 extends lv_controler
{
	...
	public $lv019=null;
///////////
	public $DefaultFieldList="lv001,lv002,lv003,lv004,lv007,lv008,lv005,lv006,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv022";	
////////////////////GetDate
	...
	public $paging=null;
	public $lang=null;
	protected $objhelp=' all_gmacv3_0.sl_lv0007';
////////////
	var $ArrOther=array();
	var $ArrPush=array();
	var $ArrFunc=array();
	var $ArrGet=array("lv001"=>"2","lv002"=>"3","lv003"=>"4","lv004"=>"5","lv005"=>"6","lv006"=>"7","lv007"=>"8","lv008"=>"9","lv009"=>"10","lv010"=>"11","lv011"=>"12","lv012"=>"13","lv013"=>"14","lv014"=>"15","lv015"=>"16","lv016"=>"17","lv017"=>"18","lv018"=>"19","lv019"=>"20","lv022"=>"23");
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"0","lv006"=>"0","lv007"=>"10","lv008"=>"0","lv009"=>"0","lv010"=>"0","lv011"=>"0","lv012"=>"0","lv013"=>"0","lv014"=>"6","lv015"=>"0","lv016"=>"0","lv017"=>"6","lv018"=>"10","lv019"=>"10","lv022"=>"10");	
	var $ArrViewEnter=array("lv003"=>"88","lv004"=>"88","lv005"=>"88","lv008"=>"88","lv013"=>"88","lv016"=>"88");
	...
	function LV_Load()
	{
		$vsql="select * from   all_gmacv3_0.sl_lv0007";
	...
	{
		$lvsql="select * from   all_gmacv3_0.sl_lv0007 Where lv001='$vlv001'";
	...
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums FROM  all_gmacv3_0.sl_lv0007 WHERE 1=1 ".$this->GetCondition();
	...
	function LV_GetGiaVon($vlv001,$vWHID)
	{
		if($vWHID!="")
			...
			$vslq="select sum(A.lv004*IF(ISNULL(C.lv008),0,C.lv008)) giavon from all_gmacv3_0.mn_lv0004 A inner join  all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 left join wh_lv0012 C on B.lv001=C.lv002 and B.lv016=C.lv003 where A.lv002='$vlv001'";
		$vresult=db_query($vslq);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
			return round($vrow['giavon'],1);
		}
		return 0;
	}
	//////////////////////Buil list////////////////////
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$sqlS = "SELECT * FROM  all_gmacv3_0.sl_lv0007 WHERE 1=1  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open(' all_gmacv3_0.sl_lv0007/?lang=".$this->lang."&func='+value,'','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td align=@#05>@02</td>";
		$sqlS = "SELECT * FROM  all_gmacv3_0.sl_lv0007 WHERE 1=1  ".$this->RptCondition." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv012':
				...
				break;
			case 'lv013':
				$vsql="select lv001,concat(lv001,' ',lv002) lv002,IF(lv001='$vSelectID',1,0) lv003 from  wh_lv0003";
				break;
			case 'lv016':
				$strwh=$this->Get_WHControler();
