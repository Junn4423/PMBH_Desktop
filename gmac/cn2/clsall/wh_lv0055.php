<?php
class wh_lv0055 extends lv_controler{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select A.*,B.lv002 UnitName,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' and A11.lv002='$vlv001')) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' and A11.lv002='$vlv001')) InReceiptQty,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' and A21.lv002='$vlv001')) ReOutlv004 ,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' and A21.lv002='$vlv001')) InOutlv004  from  all_gmacv3_0.sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 where 1=1 and A.lv015>=0";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vNumline++;			
				$vLineRun = str_replace("@05", ($arrS['UnitName']!="" || $arrS['UnitName']!=NULL)?$arrS['UnitName']:"-", $vLineRun);
		...
		$sqlS = "select MP.lv004,MP.UnitName,sum(IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)+IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)-IF(ISNULL(MP.ReOutlv004),0,MP.ReOutlv004)-IF(ISNULL(MP.InOutlv004),0,MP.InOutlv004) ) SumQty from (select A.lv004,B.lv002 UnitName,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009<'$vDateStart' and A11.lv002='$vlv001')) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from wh_lv0008 A11 Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' and A11.lv002='$vlv001')) InReceiptQty,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' and A21.lv002='$vlv001')) ReOutlv004 ,(select sum(A2.lv004) from wh_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from wh_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' and A21.lv002='$vlv001')) InOutlv004   from  all_gmacv3_0.sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 where 1=1 and A.lv015>=0) MP group by MP.lv004,MP.UnitName ";		
	...
	$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"tblprint\">
			<tr height=\"5px\" class=\"tblRunChild\" >
				...
				<td style=\"border-left:1px #303030 solid;\" class=\"htablerun\" width=\"15%\" >".$vArrLang[24]."</td>
				".((trim($vlv001." ")!="")?"":"<td style=\"border-left:1px #303030 solid;\" class=\"htablerun\" width=\"15%\" >".$vArrLang[1]."</td>")."
				<td style=\"border-left:1px #303030 solid;\" class=\"htablerun\" width=\"15%\" >".$vArrLang[29]."</td>
				<td style=\"border-left:1px #303030 solid;\" class=\"htablerun\" width=\"*%\" >".$vArrLang[22]."</td>
				<td style=\"border-left:1px #303030 solid;\" class=\"htablerun\" width=\"15%\" >".$vArrLang[53]."</td>
			</tr>
			@01
		</table>";			
		$vRowFirst="
			<tr>
				...
				".((trim($vlv001." ")!="")?"":"<td style=\"border-top:1px #303030 solid;border-left:1px #303030 solid;\" class=\"left_style\" rowspan=\"@01\" valign=\"top\">@06</td>")."			
		...
		while($row=db_fetch_array($lvResult)){
				$lvTemp=str_replace("@02",$row['lv001']."&nbsp",$vRowFirst);
				$lvTemp=str_replace("@08",$row['lv008']."&nbsp",$lvTemp);
				$lvTemp=str_replace("@06",$row['lv003']."&nbsp",$lvTemp);
				$lvTemp=str_replace("@03",$this->LV_Get_slt_lot($row['lv001'],$row['lv002'],$row['lv003']),$lvTemp);
				$lvTemp=str_replace("@04",$this->FormatView($row['lv004'],2)."&nbsp",$lvTemp);
...
function PrintInOutPutInStockDetail($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strCategory,$vVS_Color,$vExistItem,$vExistItemCur,$vshowimage)
	...
	$vHeaderReportInventory="
		...
		if($strContractlv001!="") {$vAddContractR=" AND A11.lv006='".$strContractlv001."'";
		$vAddContractO=" AND A21.lv006='".$strContractlv001."'";
		}
		if($strSource!=""){ 
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		...
		$vSPNhap2=$this->LV_GetSophieu("select A11.lv001 from wh_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd 23:59:59' $vAddContractR");
		$vSPXuat1=$this->LV_GetSophieu("select A21.lv001 from wh_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO");
		$vSPXuat2=$this->LV_GetSophieu("select A21.lv001 from wh_lv0010 A21 Where A21.lv010 NOT IN ('CANCEL','DEFECT') and A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd 23:59:59' $vAddContractO");
		$vSPXuat3=$this->LV_GetSophieu("select A21.lv001 from wh_lv0010 A21 Where A21.lv010='CANCEL' and A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd 23:59:59' $vAddContractO");
		$vSPXuat4=$this->LV_GetSophieu("select A21.lv001 from wh_lv0010 A21 Where A21.lv010='DEFECT' and A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd 23:59:59' $vAddContractO");
		$sqlS = "select A.*,B.lv002 UnitName,C.lv002 UnitNameP,(select sum(A1.lv004) from wh_lv0009 A1  $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPNhap1) ) ReReceiptQty,(select sum(A1.lv004) from wh_lv0009 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPNhap2) ) InReceiptQty,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat1) ) ReOutlv004 ,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat2) ) InOutlv004,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat3) ) InOutBo,(select sum(A1.lv004) from wh_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat4) ) InOutDefect,A.lv006 OtherC  from  all_gmacv3_0.sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 left join sl_lv0005 C on A.lv005=C.lv001 where 1=1  and A.lv015>=0 $vConditionStock";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vNumline++;			
				$vLineRun = str_replace("@05", ($arrS['UnitName']!="" || $arrS['UnitName']!=NULL)?$arrS['UnitName']:"-", $vLineRun);
				$vLineRun = str_replace("@11", ($arrS['UnitNameP']!="" || $arrS['UnitNameP']!=NULL)?$arrS['UnitNameP']:"-", $vLineRun);
				...
				$vLineRun = str_replace("@12", $this->FormatView($arrS['InOutBo'],10), $vLineRun);				
				$vLineRun = str_replace("@13", $this->FormatView($arrS['InOutDefect'],10), $vLineRun);			
				$vLineRun = str_replace("@15", $this->FormatView($arrS['lv014'],6), $vLineRun);							
				$vLineRun = str_replace("@09",$this->FormatView( ( $arrS['ReReceiptQty']-$arrS['ReOutlv004'])+( $arrS['InReceiptQty']-$arrS['InOutlv004']-$arrS['InOutBo']-$arrS['InOutDefect']),10), $vLineRun);
				$vOtherC=$arrS['OtherC'];
				if($arrS['OtherC']==0) $vOtherC=1;
				$vLineRun = str_replace("@10",$this->FormatView( ( $arrS['ReReceiptQty']-$arrS['ReOutlv004'])+( $arrS['InReceiptQty']-$arrS['InOutlv004'])/$vOtherC,10), $vLineRun);
				...
				switch($stropt)
				{
					...
					case 3:
						...
						$vLineRun = str_replace("@20", "<tr><td colspan=\"12\">".$vdetail."</td></tr>", $vLineRun);
						if($vExistItemCur==1)
						{
					...
					case 4:
						...
						$vLineRun = str_replace("@20","<tr><td colspan=\"".(($vshowimage==1)?13:12)."\">".$vdetail."</td></tr>", $vLineRun);	
						if($vExistItemCur==1)
						{
							if($vdetail=="") {$vOrder--; $vLineRun="";}
		...
		$vHeader = str_replace("@04", $vArrLang[6], $vHeader);
		//Unit
		$vHeader = str_replace("@11", $vArrLang[7], $vHeader);
		//Unit
		$vHeader = str_replace("@05",$vArrLang[7], $vHeader);
		//Fist
		$vHeader = str_replace("@06", $vArrLang[8], $vHeader);
	...
	$vHeaderReportInventory="
		<table style=\"border-top:0xp;border-bottom:0px;border-left:0px;border-right:0px\" width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"tblprint\">
			<tr height=\"5px\" class=\"tblRunChild\" >
				<td width=\"5%\" >@02</td>
				...
				<td style=\"border-left:1px #303030 solid;\" class=\"htablerun\" width=\"10%\" >Giá</td>
		...
		$vRowFirst="
			<tr>
				...
				<td style=\"border-top:1px #303030 solid;border-left:1px #303030 solid;\" class=\"right_style\" >@07</td>				
		...
		//if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		  ...
		  $sqlS = "select A.lv001, A.lv002 ,A.lv004,C.lv002 UnitName,B.lv005 Type,B.lv009 DateEnter,'N' CategoryPut,A.lv008 Price,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference,B.lv002 WhID  from wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 and (B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR  left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' $vAddLot
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 UnitName,B.lv005 Type,B.lv009 DateEnter,'X' CategoryPut,A.lv008 Price,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference,B.lv002 WhID from wh_lv0011 A inner join wh_lv0010 B on A.lv002=B.lv001 and B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' $vAddLot 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vNumline++;			
				$vLineRun = str_replace("@05", ($arrS['lv004']!="" || $arrS['lv004']!=NULL)?Lcurrency($arrS['lv004'],$plang)."(".$arrS['UnitName'].")":"-", $vLineRun);
				$vLineRun = str_replace("@06", $arrS['CategoryPut'], $vLineRun);
				$vLineRun = str_replace("@07", $this->FormatView($arrS['Price'],10)."&nbsp;", $vLineRun);				
...
//////////////////////////////////Purchase Order////////////////////////////
	...
	$vHeaderReportInventory="
		...
		if($vAddCond!="") $vCondition = $vCondition." inner join wh_lv0020 B1 on A.lv003=B1.lv003 AND A.lv014=B1.lv014  $vAddCond";		
		 $sqlS = "select A.lv001,A.lv002 ,A.lv004,C.lv002 UnitName,B.lv005,B.lv009 DateEnter,'N' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,D.lv006,D.lv004,D.lv005,D.lv007 NoteLot,E.lv002VN Colorlv002  from wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 and (B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR  left join sl_lv0005 C on A.lv005=C.lv001 left join wh_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003' 
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 UnitName,B.lv005,B.lv009 DateEnter,'X' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,D.lv006,D.lv004,D.lv005,D.lv007 NoteLot,E.lv002VN Colorlv002 from wh_lv0011 A inner join wh_lv0010 B on A.lv002=B.lv001 and B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO left join sl_lv0005 C on A.lv005=C.lv001  left join wh_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003' 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
...
//////////////////////////////////////////Purchase Order////////////////////////////////////////////////////////////////////
	...
	function SumSQLRun($vSQL,$vColpan,$vLang,$plang)
	{
		...
		$vValue="";
		while($arrS=db_fetch_array($bResultS)){		
			if($vValue=="") $vValue=$this->FormatView($arrS['SumQty'],10).$arrS['UnitName'];
			else $vValue=$vValue." ; ".$this->FormatView($arrS['SumQty'],10).$arrS['UnitName'];
		}
