<?php
/////////////coding wh_lv0052///////////////
class   wh_lv0052 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"0","lv006"=>"0","lv007"=>"0","lv008"=>"0","lv009"=>"0","lv010"=>"0","lv011"=>"0","lv012"=>"0","lv013"=>"0","lv014"=>"0","lv015"=>"0","lv016"=>"0","lv017"=>"10","lv018"=>"0");	
	...
	function LV_Insert()
	{
		...
		if($vReturn) 
		{
			$lvsql="insert into ac_lv0005 (lv002,lv003,lv004,lv005,lv006,lv007) values('$this->lv001','$this->lv019','$this->lv019','331','111','PO(Mua h�ng)')";
			$vReturn= db_query($lvsql);
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('wh_lv0052/?lang=".$this->lang."&func='+value,'','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
