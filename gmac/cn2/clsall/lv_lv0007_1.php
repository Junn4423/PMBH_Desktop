...
class lv_lv0007{
	...
	function Insert(){
		$vsql="INSERT INTO all_gmacv3_0.lv_lv0007(lv001, lv002, lv003, lv004, lv005, lv006) VALUES ('$this->lv001', '$this->lv002', '$this->lv003', '$this->lv004', '".md5($this->lv005)."', '$this->lv006') ;";
		return db_query($vsql);
	}

	function Update(){
		$vsql="UPDATE all_gmacv3_0.lv_lv0007 SET lv002='$this->lv002', lv003='$this->lv003', lv004='$this->lv004', lv006='$this->lv006' WHERE lv001='$this->lv001' ;";
		return db_query($vsql);		
	}

	function Delete($strar){
		$sqlD = "DELETE FROM all_gmacv3_0.lv_lv0007 WHERE all_gmacv3_0.lv_lv0007.lv001 IN (".$strar.") and (select count(*) from rightdetail B where B.lv_lv0007lv001=lv_lv0007.lv001)<=0;";
