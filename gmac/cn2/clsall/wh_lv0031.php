...
////////////
	...
	function LV_InsertCONTRACT($vlvUser,$vlv005,$vlv006,$vlWHID,$vDate)
	{
		if(1==1)
		{
			...
			$lvsql="select '$vlvUser' lv002,A.lv003,A.lv004,A.lv005,A.lv004 lv006,A.lv005 lv007,A.lv006 lv008,A.lv007 lv009,A.lv008 lv010,A.lv011,A.lv012,B.lv012 State,concat(A.lv009,'-',A.lv010,':',A.lv013) lv015,Now() lv016,A.lv015 isCN  from sl_lv0014 A inner join  all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 where A.lv002='$vlv006'";
