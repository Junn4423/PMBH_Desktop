<?php
/////////////coding wh_lv0010///////////////
class   sl_lv0024 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"0","lv006"=>"0","lv007"=>"0","lv008"=>"0","lv009"=>"2","lv010"=>"0","lv011"=>"0","lv012"=>"10");	
	...
	function LV_Get_MainPage($vtoday,&$numinvoice,$lang=NULL)
	{
		...
		{
			if($vrow['lv007']==0)
				$str=$str.'<font color="black" title="'.$vrow['lv008'].'" >Invoice:'.$vrow['lv001']."(".$vrow['lv004']."-".$vrow['lv002']."-".$vrow['lv003']."-[ Total:".$this->FormatView($this->LV_GetBLMoney($vrow['lv001']),10)." ])"."</font> | ";
			else 
				$str=$str.'<font color="red" title="'.$vrow['lv008'].'" >Invoice:'.$vrow['lv001']."(".$vrow['lv004']."-".$vrow['lv002']."-".$vrow['lv003']."-[ Total:".$this->FormatView($this->LV_GetBLMoney($vrow['lv001']),10)." ])"."</font> | ";
			$i++;
		}
		$numinvoice=$i-1;
		if($i==1) 
	...
	function LV_Insert()
	{
		...
		$this->lv009 = ($this->lv009!="")?recoverdate(($this->lv009), $this->lang):$this->DateDefault;
		 $lvsql="insert into wh_lv0010 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008',concat(CURRENT_DATE(),' ',CURRENT_TIME()),'$this->lv010','$this->lv011')";
	...
	function LV_InsertOther($vlv002)
	{
	 $lvsql="DELETE FROM wh_lv0005  where lv002='$vlv002'";
	 $vReturn= db_query($lvsql);
	 $lvsql="insert into wh_lv0005 (lv002,lv003,lv004,lv005) select '$vlv002',lv001,lv004,lv005 from  all_gmacv3_0.sl_lv0007";
	 $vReturn= db_query($lvsql);
	...
	function LV_Update()
	{
		...
		$this->lv009 = ($this->lv009!="")?recoverdate(($this->lv009), $this->lang):$this->DateDefault;
		  $lvsql="Update wh_lv0010 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv008='$this->lv008',lv009='$this->lv009' where  lv001='$this->lv001' AND lv007<=0;";
		$vReturn= db_query($lvsql);
		if($vReturn) {
		$this->LV_InsertOther($this->lv001);
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM wh_lv0010  WHERE wh_lv0010.lv007<=0 AND wh_lv0010.lv001 IN ($lvarr) and (select count(*) from wh_lv0011 B where  B.lv002= wh_lv0010.lv001)<=0  ";
		$vReturn= db_query($lvsql);
	...
	function LV_Aproval($lvarr)
	{
		...
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'wh_lv0010.approval',sof_escape_string($lvsql));
		return $vReturn;
	}	
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv005':
				...
				break;
			case 'lv010':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0059 where lv008=1";
				break;
			case 'lv011':
				$vsql="select lv001,concat(lv004,lv003,lv002) lv002,IF(lv001='$vSelectID',1,0) lv003 from  all_gmacv3_0.hr_lv0020";
				break;
