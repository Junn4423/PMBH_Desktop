<?php
/////////////coding sl_lv0070///////////////
class   sl_lv0070 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function LV_Load()
	{
		$vsql="select * from all_gmacv3_0.sl_lv0070";
	...
	function LV_AutoUpdate($month,$year)
	{
		//$vsql="insert into hr_lv0106 select *,$month,$year inner all_gmacv3_0.sl_lv0070";
		//$vresult=db_query($vsql);
		return $vresult;
	}
	function LV_LoadMonthYear($month,$year)
	{
		$vsql="select A.*,B.lv002 doanhthu,B.lv003 percent1,B.lv004 percent2,B.lv005 percent3,B.lv006 percent4 from  hr_lv0106 A left join sl_lv0042 B on A.lv006=B.lv001 where A.lv015='$month' and A.lv016='$year'";
		$vresult=db_query($vsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
			...
			$this->lv030=$vrow['lv030'];
			$this->lv031=$vrow['lv031'];
			$this->percent1=$vrow['percent1'];
			$this->percent2=$vrow['percent2'];
			$this->percent3=$vrow['percent3'];
			$this->percent4=$vrow['percent4'];
			$this->doanhthu=$vrow['doanhthu'];
		}
	}
	function LV_LoadID($vlv001)
	{
		$lvsql="select * from all_gmacv3_0.sl_lv0070 Where lv001='$vlv001'";
	...
	function LV_LoadMonthID($vlv001)
	{
		$lvsql="select * from  hr_lv0106 Where concat(lv015,lv016)='$vlv001'";
		$vresult=db_query($lvsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
	...
	function LV_Insert()
	{
		...
		$this->lv002 = GetServerDate()." ".GetServerTime() ;
		...
		$this->lv016 = ($this->lv016!="")?recoverdate(($this->lv016), $this->lang):$this->DateDefault;
		 $lvsql="insert into sl_lv0070 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv022,lv023,lv024,lv025,lv026,lv027,lv028,lv029,lv030) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016','$this->lv017','$this->lv018','$this->lv019','$this->lv020','$this->lv021','$this->lv022','$this->lv023','$this->lv024','$this->lv025','$this->lv026','$this->lv027','$this->lv028','$this->lv029','$this->lv030')";
		$vReturn= db_query($lvsql);
		if($vReturn){
		 $this->InsertLogOperation($this->DateCurrent,'sl_lv0070.insert',sof_escape_string($lvsql));
		 }
		return $vReturn;
	}	
	function LV_InsertMonth()
	{
		
		if($this->isAdd==0) return false;
		$this->lv002 = GetServerDate()." ".GetServerTime() ;
		$lvsql="insert into hr_lv0106 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv022,lv023,lv024,lv030,lv031) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016','$this->lv017','$this->lv018','$this->lv019','$this->lv020','$this->lv021','$this->lv022','$this->lv023','$this->lv024','$this->lv030','$this->lv031')";
		$vReturn= db_query($lvsql);
		if($vReturn){
		 $this->InsertLogOperation($this->DateCurrent,'sl_lv0070.insert',sof_escape_string($lvsql));
		 }
	...
	function LV_Update()
	{
		...
		$this->lv015 = ($this->lv015!="")?recoverdate(($this->lv015), $this->lang):$this->DateDefault;
		$this->lv016 = ($this->lv016!="")?recoverdate(($this->lv016), $this->lang):$this->DateDefault;
		$this->lv015=str_replace("/","-",$this->lv015);
		$this->lv016=str_replace("/","-",$this->lv016);
		$lvsql="Update sl_lv0070 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008',lv009='$this->lv009',lv010='$this->lv010',lv011='$this->lv011',lv012='$this->lv012',lv013='$this->lv013',lv014='$this->lv014',lv015='$this->lv015',lv016='$this->lv016',lv017='$this->lv017',lv018='$this->lv018',lv019='$this->lv019',lv020='$this->lv020',lv021='$this->lv021',lv022='$this->lv022',lv023='$this->lv023',lv024='$this->lv024',lv025='$this->lv025',lv026='$this->lv026',lv027='$this->lv027',lv028='$this->lv028',lv029='$this->lv029',lv030='$this->lv030',lv031='$this->lv031' ";//where  lv001='$this->lv001';
		$vReturn= db_query($lvsql);
		if($vReturn) {
			$this->InsertLogOperation($this->DateCurrent,'sl_lv0070.update',sof_escape_string($lvsql));
		}
		return $vReturn;
	}
	function LV_UpdateMonth($vlv001)
	{
		if($this->isEdit==0) return false;
		$this->lv002 = GetServerDate()." ".GetServerTime() ;
		$lvsql="Update hr_lv0106 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008',lv009='$this->lv009',lv010='$this->lv010',lv011='$this->lv011',lv012='$this->lv012',lv013='$this->lv013',lv014='$this->lv014',lv015='$this->lv015',lv016='$this->lv016',lv017='$this->lv017',lv018='$this->lv018',lv019='$this->lv019',lv020='$this->lv020',lv021='$this->lv021',lv022='$this->lv022',lv023='$this->lv023',lv024='$this->lv024',lv025='$this->lv025',lv026='$this->lv026',lv027='$this->lv027',lv028='$this->lv028',lv029='$this->lv029',lv030='$this->lv030',lv031='$this->lv031' where  concat(lv015,lv016)='$vlv001' AND lv007<=0;";
		$vReturn= db_query($lvsql);
		if($vReturn) {
			$this->InsertLogOperation($this->DateCurrent,'sl_lv0070.update',sof_escape_string($lvsql));
		}
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE from all_gmacv3_0.sl_lv0070  WHERE sl_lv0070.lv007<=0 AND sl_lv0070.lv001 IN ($lvarr) and (select count(*) from wh_lv0009 B where  B.lv002= sl_lv0070.lv001)<=0  ";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'sl_lv0070.delete',sof_escape_string($lvsql));
		return $vReturn;
	}	
	function LV_Aproval($lvarr)
	{
		if($this->isApr==0) return false;
		$lvsql = "Update sl_lv0070 set lv007=1  WHERE sl_lv0070.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'sl_lv0070.approval',sof_escape_string($lvsql));
		return $vReturn;
	}	
	function LV_Exist()
	{
		$lvsql="select count(*) num inner all_gmacv3_0.sl_lv0070 ";
		$vresult=db_query($lvsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
	...
	{
		if($this->isApr==0) return false;
		$lvsql = "Update sl_lv0070 set lv007=0  WHERE sl_lv0070.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'sl_lv0070.unapproval',sof_escape_string($lvsql));
		return $vReturn;
	}
	public function GetBuilCheckList($vListID,$vID,$vTabIndex,$vTbl,$vFieldView='lv002')
	{
		...
		";
		$vsql="select * from  ".$vTbl." where lv003=''";
		$strGetList="";
		$strGetScript="";
		$i=0;
		$vresult=db_query($vsql);
	...
	function GetBuilCheckListChild($vListID,$vID,$vParentID,$vTbl,$vFieldView,&$i,&$numrows,$vspace)
	{
		...
		";
		$vsql1="select * from  ".$vTbl." where lv003='".$vParentID."' order by lv003";
	...
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums from all_gmacv3_0.sl_lv0070 WHERE 1=1 ".$this->GetCondition();
		$bResultC = db_query($sqlC);
		$arrRowC = db_fetch_array($bResultC);
		return $arrRowC['nums'];
	}
	function LV_GetMoneyTimes($vtime)
	{
		$time=$vtime%10;
		if(strpos(','.$this->lv008.',',','.$time.',')===false)
		{
			return $this->lv011;
		}
		else
	...
	{
		$lvsql="select sum(PM.lv003) money,sum(PM.lv004) convertmoney from ((select sum(A.lv004*A.lv008) lv003,sum(A.lv004*A.lv008*A.lv010/100) lv004 from wh_lv0009 A inner join sl_lv0070 B on A.lv002=B.lv001  where 1=1 and B.lv001='$vContractID' )) PM ";	
		$vresult=db_query($lvsql);
		$vrow = db_fetch_array ($vresult);
...
//////////////////////Buil list////////////////////
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		";
		$lvHref="<a href=\"javascript:FunctRunning1('@01')\" style=\"text-decoration:none\" align='@#05'>@02</a>";
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class='@#04' align='@#05'>@02</td>";
		$sqlS = "SELECT * FROM hr_lv0106 WHERE 1=1  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			$strTr=$strTr.str_replace("@#01",$strL,str_replace("@02",$vrow['lv015'].$vrow['lv016'],str_replace("@03",$vorder,str_replace("@01",$vorder%2,$lvTr))));
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."sl_lv0070/?lang=".$this->lang."&childfunc='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		";
		$lvTr="<tr class=\"lvlinehtable@01\">
			<td width=1% align='@#05'>@03</td>
			@#01
		</tr>
		";
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class='@#04' align='@#05'>@02</td>";
		$sqlS = "SELECT * from all_gmacv3_0.sl_lv0070 WHERE 1=1  ".$this->RptCondition." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
...
//////////////////////Buil list////////////////////
	function LV_BuilListReportMini($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvDateSort)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class='@#04' align='@#05'>@02</td>";
		$sqlS = "SELECT * from all_gmacv3_0.sl_lv0070 WHERE 1=1 and lv009='$lvDateSort' ".$this->GetConditionMini()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
	...
	function LV_BuilListReportOther($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class='@#04' align='@#05'>@02</td>";
		$sqlS = "SELECT * from all_gmacv3_0.sl_lv0070 WHERE 1=1  ".$this->GetConditionRpt()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv003':
				...
				break;
			case 'lv008':
				$vsql="select lv001,lv002 lv002,IF(lv001='$vSelectID',1,0) lv003 from  all_gmacv3_0.sl_lv0007";
				break;
			case 'lv010':
				$vsql="select lv001,lv002 lv002,IF(lv001='$vSelectID',1,0) lv003 from  all_gmacv3_0.sl_lv0007";
				break;
	...
	public  function getvaluelink($vFile,$vSelectID)
	{
		switch($vFile)
		{
			...
			case 'lv003':
				...
				break;
			case 'lv006':
				$vsql="select lv001,lv001 lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0042 where lv001='$vSelectID'";
				break;
			default:
				$vsql ="";
				break;
