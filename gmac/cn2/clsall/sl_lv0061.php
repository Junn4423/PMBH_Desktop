<?php
class sl_lv0061 extends lv_controler{
	var $vRowHeader="
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function PrintInOutPutInStockInvoiceSum($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$vCustomerID,$vlv005_opt,$vSalerID,$vlv013_opt,$vItemID,$vProgramID,$vGift,$vCateID,$vCateOpt=0,$vtax=0)
	{
	$vHeaderReportInventory="
		...
		$vRowFirst="
			<tr>
				...
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_9_@02\"  nowrap>@10</td>
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_10_@02\" nowrap>@11</td>
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_18_@02\"  nowrap>@19</td>
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_19_@02\" nowrap>@20</td>
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_15_@02\" nowrap>@16</td>
				<td class=\"left_style\" rowspan=\"@01\" id=\"col_3_@02\" nowrap>@04</td>
				<td class=\"left_style\" rowspan=\"@01\" id=\"col_4_@02\" nowrap>@05</td>
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_5_@02\" nowrap>@06</td>
				<td class=\"center_style\" id=\"col_16_@02\">@17</td>
		...
		$vRowLast="
			<tr>
				...
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_9_@02\" >&nbsp;</td>
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_10_@02\"><strong>&nbsp;</td>
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_18_@02\" >&nbsp;</td>
				<td class=\"center_style\" rowspan=\"@01\" id=\"col_19_@02\"><strong>&nbsp;</td>
				<td class=\"left_style\" id=\"col_15_@02\">&nbsp;</td>
				<td class=\"left_style\" id=\"col_3_@02\">&nbsp;</td>
				<td class=\"center_style\" id=\"col_4_@02\">&nbsp;</td>
				<td class=\"left_style\" id=\"col_5_@02\"><strong>@07</td>
				<td class=\"center_style\" id=\"col_16_@02\">&nbsp;</td>
				<td class=\"center_style\" id=\"col_8_@02\"><strong>@09</strong></td>					
				<td class=\"center_style\" id=\"col_17_@02\"><strong>&nbsp;</strong></td>	
			</tr>
			";
		$vRowLightText="
			<tr>
			...
			while($arrS=db_fetch_array($bResultS)){
				$vincrease++;
					if($vtInventorylv001 != $arrS['InvoiceID']){
						...
						if($arrS['State']>0) 
						{
							$vLineRun = str_replace("@05", $this->FormatView($arrS['DateInvoiceTo'],22), $vLineRun);
	...
	function SumKhachNo($vDateStart,$vDateEnd)
	{
		...
		$vsql="select sum(A.lv004*A.lv006) Money from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 where B.lv011=3 $vCondition";
		$vresult=db_query($vsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
	...
	function PrintInOutPutInStockDetail($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$vCustomerID,$vlv005_opt,$vSalerID,$vlv013_opt,$vItemID,$vProgramID,$vGift,$vCateID,$vCateOpt,$vtax,$vCusCat,$vlv015)
	{
	$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" class=\"tblprint\">
			<tr height=\"30px\" class=\"tblcaption\">
				...
				<td class=\"htable\" width=\"5%\" ondblclick=\"RemoveCol('col_3',this,@!79)\" style=\"cursor:pointer\">@04</td>
				<td class=\"htable\" width=\"5%\" ondblclick=\"RemoveCol('col_4',this,@!79)\" style=\"cursor:pointer\">@05</td>
				...
				<td class=\"htable\" width=\"1%\" ondblclick=\"RemoveCol('col_14',this,@!79)\">@15</td>				
				<td class=\"htable\" width=\"1%\" ondblclick=\"RemoveCol('col_15',this,@!79)\" style=\"cursor:pointer\">@16</td>
				<td class=\"htable\" width=\"1%\" ondblclick=\"RemoveCol('col_16',this,@!79)\" style=\"cursor:pointer\">@17</td>
				<td class=\"htable\" width=\"1%\" ondblclick=\"RemoveCol('col_17',this,@!79)\" style=\"cursor:pointer\">@18</td>
				<td class=\"htable\" width=\"1%\" ondblclick=\"RemoveCol('col_27',this,@!79)\" style=\"cursor:pointer\">@28</td>
				<td class=\"htable\" width=\"1%\" ondblclick=\"RemoveCol('col_28',this,@!79)\" style=\"cursor:pointer\">@29</td>
				<td class=\"htable\" width=\"1%\" ondblclick=\"RemoveCol('col_29',this,@!79)\" style=\"cursor:pointer\">@30</td>
				<td class=\"htable\" width=\"1%\" ondblclick=\"RemoveCol('col_20',this,@!79)\" style=\"cursor:pointer\">@21</td>
			</tr>
			@01
		</table>";			
		$vRowFirst="
			<tr>
				...
				<td class=\"center_style\" id=\"col_14_@02\" nowrap>@15</td>
				<td class=\"center_style\" id=\"col_15_@02\" nowrap>@16</td>
				<td class=\"center_style\" id=\"col_16_@02\" nowrap>@17</td>
				...
				<td class=\"center_style\" id=\"col_20_@02\" nowrap>@21</td>					
			</tr>
			@60
			";
		$vRowLast="
			<tr>
				...
				<td class=\"center_style\" id=\"col_14_@02\">&nbsp;</td>
				<td class=\"center_style\" id=\"col_15_@02\">&nbsp;</td>
				<td class=\"center_style\" id=\"col_16_@02\">&nbsp;</td>
				...
				<td class=\"center_style\" id=\"col_20_@02\"><strong></strong></td>	
			</tr>
			";
		$vRowLightText="
			<tr>
				...
				<td class=\"center_style\" id=\"col_14_@02\">@15</td>
				<td class=\"center_style\"  id=\"col_15_@02\">@16</td>
				<td class=\"center_style\"  id=\"col_16_@02\">@17</td>
				...
				<td class=\"center_style\" id=\"col_20_@02\">@20</td>						
			</tr>";
		$vCondition="";
		$vAddCond=""; 
		if($vDateStart!="")
		...
		if($vlv015!="" && $vlv015!="2")
		{
				$vCondition = $vCondition." AND B.lv015 ='$vlv015' ";
		}
		if($vItemID!="")
		{
				$vCondition = $vCondition." AND A.lv003='$vItemID' ";
		...
		if($vlv015=="2")
			$sqlS = "select A.lv001,A.lv002,A.lv003,IF(B.lv015=0,A.lv004,-(A.lv004)) lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv011,A.lv012,A.lv013,A.lv015,A.lv014,A.lv016,A.lv017,A.lv090,A.lv091,concat(E.lv002,'(',E.lv001,')') ProgramName,B.lv022 CKTM,D.lv002 UnitName,C.lv002 ItemName,B.lv001 InvoiceID,B.lv004 DateInvoice,B.lv002 CustomerID,B.lv010 EmployeeID from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition";	
		else
			$sqlS = "select A.lv001,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv011,A.lv012,A.lv013,A.lv015,A.lv014,A.lv016,A.lv017,A.lv090,A.lv091,concat(E.lv002,'(',E.lv001,')') ProgramName,B.lv022 CKTM,D.lv002 UnitName,C.lv002 ItemName,B.lv001 InvoiceID,B.lv004 DateInvoice,B.lv002 CustomerID,B.lv010 EmployeeID from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vLineRun = str_replace("@16", $this->getvaluelink('lv003',$arrS['EmployeeID']), $vLineRun);
...
function PrintInOutPutInStockSum($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$vCustomerID,$vlv005_opt,$vSalerID,$vlv013_opt,$vItemID,$vProgramID,$vGift,$vCateID,$vCateOpt,$vtax)
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select * from (select B.lv002 lv003,sum(A.lv004) sl,sum(A.lv004*A.lv006) thanhtien,sum(A.lv004*A.lv006*A.lv008/100) thue,sum(A.lv004*A.lv006*A.lv011/100) chietkhau,(A.lv004*IF(ISNULL(ZC.lv008),0,ZC.lv008)) TienVon,sum(A.lv012) diem,sum(A.lv004*A.lv006*B.lv022/100) CKTM,C.lv002 CusName,C.lv006 CusAdd,C.lv003 FirstName from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join wh_lv0012 ZC on ZC.lv002=A.lv003 and ZC.lv003='GMAC' left join all_gmacv3_0.sl_lv0001 C on B.lv002=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition group by lv003) MP order by MP.FirstName asc ";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
	...
	$vHeaderReportInventory="
		...
		if($vCateID!="")
		{
		 ...
		 $sqlS = "select B.lv010 lv003,sum(A.lv004) sl,sum(A.lv004*A.lv006) thanhtien,sum(A.lv004*A.lv006*A.lv008/100) thue,sum(A.lv004*A.lv006*A.lv011/100) chietkhau,(A.lv004*IF(ISNULL(ZC.lv008),0,ZC.lv008)) TienVon,sum(A.lv012) diem,sum(A.lv004*A.lv006*B.lv022/100) CKTM,concat(C.lv004,' ',C.lv003,' ',C.lv002) CusName from sl_lv0014 A  inner  join sl_lv0013 B on A.lv002=B.lv001  left join wh_lv0012 ZC on ZC.lv002=A.lv003 and ZC.lv003='GMAC' left join all_gmacv3_0.hr_lv0020 C on B.lv010=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition group by lv003";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
	...
	public  function getvaluelink($vFile,$vSelectID)
	{
		switch($vFile)
		{
			case 'lv002':
				...
				break;
			case 'lv003':
				$vsql="select lv001, lv002,IF(lv001='$vSelectID',1,0) lv003 from  all_gmacv3_0.hr_lv0020 where lv001='$vSelectID'";
				break;
			case 'lv005':
