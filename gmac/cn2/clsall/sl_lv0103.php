...
////////////
		...
		function LV_GetDetail($vContractID,$vBangID,$vLangArr,&$vSum)
	{
		...
		';		
		$lvsql="select A.*,C.lv002 Name,C.lv009 ColorName,A.lv003 ItemID from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 where 1=1 and B.lv001='$vContractID' order by A.lv019 asc,lv014 asc";	
		$vresult=db_query($lvsql);
		$i=1;
		$vSum=0;
		$vSumTT=0;
	...
	function LV_GetChildGroupItem($vCateID)
	{
		...
		$vsql="select lv001 from   all_gmacv3_0.sl_lv0006 where lv003 ='$vCateID' ";
	...
	function LV_GetDetailGroup($vLangArr,&$vSum,$vOpt=0)
	{
		...
		{
			case 1:
				$lvsql="select A.*,B.lv007 bangid,A.lv003 ItemID,C.lv002 Name,C.lv009 ColorName from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 where A.lv019<>1 $vCondition and B.lv011=0 and A.lv004>0 order by A.lv019,A.lv003,A.lv014";	
				break;
			default:
				$lvsql="
				SELECT MP.* from 
				(
					select 0 DaXoa,A.lv103,TIME_TO_SEC(TIMEDIFF(NOW(),A.lv014)) TimeExpire,A.lv001,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv011,A.lv012,A.lv014,A.lv020,A.lv021,A.lv022,A.lv023,B.lv007 bangid,A.lv003 ItemID,C.lv002 Name,C.lv009 ColorName from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 where A.lv019<>1  $vCondition and B.lv011=0 and A.lv004>0 
				UNION
					select 1 DaXoa,A.lv103,TIME_TO_SEC(TIMEDIFF(NOW(),A.lv014)) TimeExpire,A.lv001,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv011,A.lv012,A.lv014,A.lv020,A.lv021,A.lv022,A.lv023,B.lv007 bangid,A.lv003 ItemID,C.lv002 Name,C.lv009 ColorName from sl_lv0014_1 A inner join sl_lv0013 B on A.lv002=B.lv001 inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 where A.lv019<>1  $vCondition and B.lv011=0 and A.lv004>0
				) MP
		...
		{
			case 1:
				$lvsql="select A.*,B.lv007 bangid,C.lv002 Name,C.lv009 ColorName,A.lv003 ItemID from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 where A.lv019=1 $vCondition and B.lv001 in (select BB.lv001 from sl_lv0013 BB where BB.lv011=0) order by A.lv019,A.lv003,A.lv014";	
				break;
			default:
				$lvsql="
				SELECT MP.* from 
				(
					select 0 DaXoa,A.lv001,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv011,A.lv012,A.lv014,A.lv020,A.lv021,A.lv022,A.lv023,B.lv007 bangid,C.lv002 Name,C.lv009 ColorName,A.lv003 ItemID from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 where A.lv019=1 $vCondition and B.lv011=0 and A.lv004>0	 
				UNION
					select 1 DaXoa,A.lv001,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv011,A.lv012,A.lv014,A.lv020,A.lv021,A.lv022,A.lv023,B.lv007 bangid,C.lv002 Name,C.lv009 ColorName,A.lv003 ItemID from sl_lv0014_1 A inner join sl_lv0013 B on A.lv002=B.lv001 inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 where A.lv019=1 $vCondition and B.lv011=0 and A.lv004>0
				) MP
				order by MP.DaXoa,MP.lv014,MP.lv003
				";	
				//$lvsql="select A.*,B.lv007 bangid,C.lv002 Name,C.lv009 ColorName,A.lv003 ItemID from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 where A.lv019=1 and B.lv001 in (select BB.lv001 from sl_lv0013 BB where BB.lv011=0) order by A.lv003,A.lv014";	
				break;
		}
		$vresult=db_query($lvsql);
		$i=1;
