<?php
class sl_lv0074 extends lv_controler{
	var $vRowHeader="
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function LV_GET_DONHANG_CATE($vCateID,$vDateStart)
	{
		...
		if($str_return=="") $str_return="''";
		$vCondition = $vCondition." AND B.lv005<='$vDateStart 23:59:59' AND B.lv005>'$vDateStart 00:00:00'";
		$vsql="select A.lv002 from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 where 1=1 and A.lv003 in ($str_return) $vCondition";
		$vresult=db_query($vsql);
		while($vrow=db_fetch_array($vresult))
		{
			if($str_return1=="")
	...
	function PrintInOutPutInStockInvoiceSumBangKe($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$vCustomerID,$vlv005_opt,$vSalerID,$vlv013_opt,$vItemID,$vProgramID,$vGift,$vCateID,$vCateOpt,$vtax,$vlv007,$vlv007_opt)
	{
		$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" class=\"tblprint\">
			<tr height=\"30px\" class=\"tblcaption\">
				<td rowspan=\"2\" class=\"htable\" width=\"3%\" >@02</td>
				<td rowspan=\"2\" class=\"htable\" width=\"8%\" >@03</td>
				<td rowspan=\"2\" class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_10',this,@!79)\" style=\"cursor:pointer\">@11</td>
				<td rowspan=\"2\" class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_18',this,@!79)\" style=\"cursor:pointer\">@19</td>
				<td rowspan=\"2\" class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_9',this,@!79)\" style=\"cursor:pointer\">@10</td>
				<td rowspan=\"2\" class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_3',this,@!79)\" style=\"cursor:pointer\">@04</td>
				<td rowspan=\"2\" class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_4',this,@!79)\" style=\"cursor:pointer\">@05</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_16',this,@!79)\" style=\"cursor:pointer\" colspan=\"3\">@17</td>
				<td rowspan=\"2\" class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_8',this,@!79)\" style=\"background-color:#eee;cursor:pointer\">@09</td>
				<td rowspan=\"2\" class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_19',this,@!79)\" style=\"cursor:pointer\">@20</td>
			</tr>
			<tr height=\"30px\" class=\"tblcaption\">
				
				<td class=\"htable\" width=\"50\" ondblclick=\"RemoveCol('col_16',this,@!79)\" style=\"cursor:pointer\" >Ngày</td>
				<td class=\"htable\" width=\"50\" ondblclick=\"RemoveCol('col_16',this,@!79)\" style=\"cursor:pointer\" >1h</td>
				<td class=\"htable\" width=\"50\" ondblclick=\"RemoveCol('col_16',this,@!79)\" style=\"cursor:pointer\">2h</td>
		...
		$vRowLast="
			<tr>
				<td class=\"center_style\" rowspan=\"@01\" valign=\"top\" colspan=\"5\"><STRONG>TỔNG CÔNG</STRONG></td>
				<td class=\"left_style\" id=\"col_10_@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_18_@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_9_@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_3_@02\">&nbsp;</td>
			...
			<tr>
				<td class=\"center_style\" rowspan=\"@01\" valign=\"top\" colspan=\"5\"><STRONG>10% THUẾ GTGT</STRONG></td>
				<td class=\"left_style\" id=\"col_10_#@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_18_#@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_9_#@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_3_#@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_16_#@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_8_#@02\" style=\"background-color:#eee\"><strong>@19</strong></td>					
				<td class=\"right_style\" id=\"col_17_#@02\"><strong>&nbsp;</strong></td>	
			</tr>
			<tr>
				<td class=\"center_style\" rowspan=\"@01\" valign=\"top\" colspan=\"5\"><STRONG>TỔNG CÔNG TIỀN THANH TOÁN</STRONG></td>
				<td class=\"left_style\" id=\"col_10_!@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_18_!@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_9_!@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_3_!@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_16_!@02\">&nbsp;</td>
				<td class=\"right_style\" id=\"col_8_!@02\" style=\"background-color:#eee\"><strong>@29</strong></td>					
				<td class=\"right_style\" id=\"col_17_!@02\"><strong>&nbsp;</strong></td>	
			</tr>
			";
		$vRowLightText="
		...
		{
			$vCondition = $vCondition." AND B.lv005<='$vDateStart 23:59:59' AND B.lv005>'$vDateStart 00:00:00'";
			//$vCondition = $vCondition." AND (YEAR(B.lv005)=YEAR('$vDateStart') AND MONTH(B.lv005)=MONTH('$vDateStart') AND DAY(B.lv005)=DAY('$vDateStart'))";
		}
		if($vSalerID!="")
		{
			if($vlv013_opt==1)
			...
			while($arrS=db_fetch_array($bResultS)){
				$vincrease++;
					if($vtInventorylv001 != $arrS['InvoiceID']){
						...
						$vLineRun = str_replace("@17", '&nbsp;', $vLineRun);
		...
		$vRowLast=str_replace("@19",$this->FormatView($vsum09*0.1,10),$vRowLast);
		$vRowLast=str_replace("@29",$this->FormatView($vsum09+$vsum09*0.1,10),$vRowLast);
		...
		$vRowLast=str_replace("!@02",$vincrease+2,$vRowLast);
		$vRowLast=str_replace("#@02",$vincrease+1,$vRowLast);
		$vRowLast=str_replace("@02",$vincrease,$vRowLast);
		$vincrease=$vincrease+2;
		$strExpportAll=$strExpportAll.$vRowLast;	
		$strExpportAll = str_replace("@01", $vNumline, $strExpportAll);
		///////////////////////////////////////////////////////////////
		$vHeader = str_replace("@!79",$totalRows+3,$vHeaderReportInventory);
		//Order
		...
		$vHeader = str_replace("@17",'Đớn giá', $vHeader);	
	...
	$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" class=\"tblprint\">
			<tr height=\"30px\" class=\"tblcaption\">
				...
				<!--<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_13',this,@!79)\" style=\"cursor:pointer\">@14</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_12',this,@!79)\" style=\"cursor:pointer\">@13</td>
				<td class=\"htable\" width=\"10%\" ondblclick=\"RemoveCol('col_14',this,@!79)\" style=\"cursor:pointer\">@15</td>
		...
		$vRowFirst="
			<tr>
				...
				<td class=\"right_style\" id=\"col_14_@02\">@15</td>
				<td class=\"right_style\" id=\"col_6_@02\">@07</td>-->
		...
		$vRowLast="
			<tr>
				...
				<td class=\"right_style\" id=\"col_5_@02\"><strong>@06</td>			
				<td class=\"right_style\" id=\"col_16_@02\">&nbsp;</td>
				<!--<td class=\"right_style\" id=\"col_13_@02\">@14</td>
				<td class=\"right_style\" id=\"col_12_@02\">@13</td>
				<td class=\"right_style\" id=\"col_14_@02\">@15</td>
		...
		$sqlS = "select B.lv001 InvoiceID,J.lv002 RoomName,B.lv004 DateInvoice,B.lv011 State,F.lv002 stateName,B.lv005 DateInvoiceTo,B.lv002 CustomerID,B.lv003 CustomerName,B.lv009 CustomerAdd,B.lv013 CustomerNote,B.lv010 EmployeeID,sum(A.lv006*A.lv004-A.lv006*A.lv004*B.lv022/100-A.lv006*A.lv004*A.lv011/100+A.lv006*A.lv004*B.lv006/100) SumTotal,sum(A.lv006*A.lv004*B.lv022/100+A.lv006*A.lv004*A.lv011/100) TCK,sum(A.lv006*A.lv004)*B.lv006/100 VAT,TIME_TO_SEC(substr(B.lv004,12,8)) timeview,TIME_TO_SEC(TIMEDIFF('24:00:00',substr(B.lv004,12,8))) timeagain,TIME_TO_SEC('24:00:00') h24,DATEDIFF(B.lv005,B.lv004) days,TIME_TO_SEC(substr(B.lv005,12,8)) curtime from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 left join sl_lv0054 F on B.lv011=F.lv001 left join sl_lv0009 J on B.lv007=J.lv001 where 1=1 $vCondition group by  A.lv002";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
			...
			while($arrS=db_fetch_array($bResultS)){
				$vincrease++;
					if($vtInventorylv001 != $arrS['InvoiceID']){
						...
						$vLineRun = str_replace("@16", $arrS['EmployeeID'], $vLineRun);
						$vLineRun = str_replace("@04", $this->FormatView($arrS['DateInvoice'],4), $vLineRun);
						$vsum13=$vsum13+$arrS['VAT'];
						$vLineRun = str_replace("@13", $this->FormatView($arrS['VAT'],10), $vLineRun);
						$vsum14=$vsum14+$arrS['SumTotal'];	
						$lvCKTM=$arrS['TCK'];
						$vsumCKTM=$vsumCKTM+$lvCKTM;
						$vLineRun = str_replace("@21", $this->FormatView($lvCKTM,10), $vLineRun);
						$vLine15=$this->LV_GetPTMoney($arrS['InvoiceID']);						
						$vLineRun = str_replace("@15", $this->FormatView($vLine15,10), $vLineRun);
						$vLine07=$this->LV_GetPCMoney($arrS['InvoiceID']);
						$vLineRun = str_replace("@07", $this->FormatView($vLine07,10), $vLineRun);
						$vLineRun = str_replace("@14", $this->FormatView($arrS['SumTotal'],10), $vLineRun);
						$vLineRun = str_replace("@09", $this->FormatView($arrS['SumTotal']-$vLine15+$arrS['VAT'],10), $vLineRun);
						$vsum15=$vsum15+$vLine15;
						$vsum07=$vsum07+$vLine07;
						...
						$vsum09=$vsum09+$arrS['SumTotal']-$vLine15+$vsum13;
						$strExpportAll = str_replace("@01", $vNumline, $strExpportAll);
						$vNumline = 0;
					}
					$vArrSate[$arrS['State']]=$vArrSate[$arrS['State']]+$arrS['SumTotal'];
		...
		$vRowLast=str_replace("@13",$this->FormatView($vsum13,10),$vRowLast);
		$vRowLast=str_replace("@14",$this->FormatView($vsum14,10),$vRowLast);
		$vRowLast=str_replace("@15",$this->FormatView($vsum15,10),$vRowLast);
		$vRowLast=str_replace("@21",$this->FormatView($vsumCKTM,10),$vRowLast);
		$vRowLast=str_replace("@06",$this->sec_to_times($sumlimittime),$vRowLast);
		...
		$vHeader = str_replace("@12",$vArrLang[49], $vHeader);
		//Tax Amount
		$vHeader = str_replace("@13","%VAT", $vHeader);
		//Score
		$vHeader = str_replace("@14","Tổng tiền", $vHeader);
		//
		//$vHeader = str_replace("@15","Tiền ứng", $vHeader);
		//$vHeader = str_replace("@07","Trả tiền ứng", $vHeader);
		//Program
		$vHeader = str_replace("@16",$vArrLang[26], $vHeader);	
	...
	function SumTamUngNgay($vDateStart)
	{
		$vCondition = $vCondition." AND B.lv009<='$vDateStart 23:59:59' AND B.lv009>'$vDateStart 00:00:00'";
		$vsql="select sum(A.lv004) Money from ac_lv0005 A inner join ac_lv0004 B on A.lv002=B.lv001 where B.lv002=0 and B.lv007=0  $vCondition";
		$vresult=db_query($vsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
	...
	function SumTraTamUngNgay($vDateStart)
	{
		$vCondition = $vCondition." AND B.lv009<='$vDateStart 23:59:59' AND B.lv009>'$vDateStart 00:00:00'";
		$vsql="select sum(A.lv004) Money from ac_lv0005 A inner join ac_lv0004 B on A.lv002=B.lv001 where B.lv002=1 and B.lv007=0 $vCondition";
		$vresult=db_query($vsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
	...
	{
		$vsql="select sum(A.lv004*A.lv006) Money from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 where (YEAR(B.lv005)=YEAR('$vDateStart') AND MONTH(B.lv005)=MONTH('$vDateStart') AND DAY(B.lv005)=DAY('$vDateStart')) and B.lv011=3";
		$vresult=db_query($vsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
	...
	{
		$vlistItem=$this->LV_GET_ITEMS_CATE('DAY,TIME,SURCHARGE');
		$vCondition = $vCondition." AND B.lv005<='$vDateStart 23:59:59' AND B.lv005>'$vDateStart 00:00:00'";
		$vsql="select sum(A.lv004*A.lv006) Money from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 where 1=1 $vCondition and B.lv011 in (1,2) and A.lv003 not in ($vlistItem)";
		$vresult=db_query($vsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
	...
	{
		$vlscate=$this->LV_GET_DONHANG_CATE($vCateID,$vDateStart);
		$vsql="select A.lv002,sum(A.lv004*A.lv006) Money,sum(A.lv006*A.lv004)*B.lv006/100 VAT from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 where  B.lv011 in (1,2) AND A.lv002 in ($vlscate) group by A.lv002";
		$vresult=db_query($vsql);
		$vSumTotal=0;
		while($vrow=db_fetch_array($vresult))
		{
			$vSumTotal=$vSumTotal+$vrow['Money']+$vrow['VAT']-$this->LV_GetPTMoney($vrow['lv002']);
	...
	function PrintStateValues($vArrState,$vArrStateName,$vDateStart)
	{
		...
		<table width="100%" align="center" cellpadding="0" cellspacing="0" border="1" class="tblprint">
			<tr class=\"tblcaption\">
				<td class="htable">Doanh thu theo giờ(1)</td><td class="htable">Doanh thu theo đêm(2)</td><td class="htable">Doanh thu theo ngày(3)</td><td class="htable">Tổng doanh thu nước(4)</td><td class="htable">Tổng tiền nợ(5)</td><td class="htable">Tổng tiền trả nợ(6)</td><td class="htable">Tổng tiền ứng trước(7)</td><td class="htable">Tổng trả tiền ứng (8)</td><td class="htable">Tiền thu((9)=1+2+3)</td><td class="htable">Tổng thu(6+7-8+9)</td>
			</tr>
			<tr>
				<td class="right_style">@#07</td><td class="right_style">@#08</td><td class="right_style">@#09</td><td class="right_style">@#03</td><td class="right_style">@#01</td><td class="right_style">@#02</td><td class="right_style">@#04</td><td class="right_style">@#14</td><td class="right_style">@#05</td><td class="right_style">@#06</td>
			</tr>
		';
		$vlistdonhang=$this->LV_GET_DONHANG_DANGTHUE();
		$vTamUng=$this->SumTamUngNgay($vDateStart);
		$vTraTamUng=$this->SumTraTamUngNgay($vDateStart);
		$vTienNo=$this->SumKhachNo($vDateStart);
		$vTienTraNo=$this->SumKhachTraNo($vDateStart);		
		$vNuoc=$this->SumNuoc($vDateStart);
		$vNgay=$this->SumTheoNgay($vDateStart,'DAY');
		$vGio=$this->SumTheoNgay($vDateStart,'TIME');
		$vDem=$this->SumTheoNgay($vDateStart,'NIGHT');
		$strReturn=str_replace("@#05",$this->FormatView($vGio+$vNgay+$vDem,10),$strReturn);
		...
		$strReturn=str_replace("@#14",$this->FormatView($vTraTamUng,10),$strReturn);
		$strReturn=str_replace("@#06",$this->FormatView($vGio+$vNgay+$vDem+$vTienTraNo+$vTamUng,10),$strReturn);
	...
	$vHeaderReportInventory="
		...
		$vRowLast="
			<tr>
				...
				<td class=\"left_style\" rowspan=\"@01\" valign=\"top\" >&nbsp;</td>
				<td class=\"right_style\" rowspan=\"@01\" id=\"col_9_@02\" >&nbsp;</td>
				<td class=\"right_style\" rowspan=\"@01\" id=\"col_10_@02\"><strong>@11</td>
				<td class=\"right_style\" rowspan=\"@01\" id=\"col_18_@02\" >&nbsp;</td>
				<td class=\"right_style\" rowspan=\"@01\" id=\"col_19_@02\"><strong>&nbsp;</td>
		...
		$sqlS = "select A.*,concat(E.lv002,'(',E.lv001,')') ProgramName,J.lv002 RoomName,B.lv022 CKTM,D.lv002 UnitName,C.lv002 ItemName,B.lv001 InvoiceID,B.lv004 DateInvoice,B.lv005 DateInvoiceTo,B.lv002 CustomerID,B.lv003 CustomerName,B.lv009 CustomerAdd,B.lv013 CustomerNote,B.lv010 EmployeeID,TIME_TO_SEC(substr(B.lv004,12,8)) timeview,TIME_TO_SEC(TIMEDIFF('24:00:00',substr(B.lv004,12,8))) timeagain,TIME_TO_SEC('24:00:00') h24,DATEDIFF(B.lv005,B.lv004) days,TIME_TO_SEC(substr(B.lv005,12,8)) curtime from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001  left join sl_lv0009 J on B.lv007=J.lv001 where 1=1 $vCondition";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
...
function PrintInOutPutInStockSum($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$vCustomerID,$vlv005_opt,$vSalerID,$vlv013_opt,$vItemID,$vProgramID,$vGift,$vCateID,$vCateOpt,$vtax,$vlv007,$vlv007_opt)
	...
	$vHeaderReportInventory="
		...
		if($vCateID!="")
		{
		 ...
		 $sqlS = "select B.lv002 lv003,sum(A.lv004) sl,sum(A.lv004*A.lv006) thanhtien,sum(A.lv004*A.lv006*A.lv008/100) thue,sum(A.lv004*A.lv006*A.lv011/100) chietkhau,sum(A.lv012) diem,sum(A.lv004*A.lv006*B.lv022/100) CKTM,C.lv002 CusName from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join all_gmacv3_0.sl_lv0001 C on B.lv002=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition group by lv003";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
	...
	$vHeaderReportInventory="
		...
		if($vCateID!="")
		{
		 ...
		 $sqlS = "select B.lv010 lv003,sum(A.lv004) sl,sum(A.lv004*A.lv006) thanhtien,sum(A.lv004*A.lv006*A.lv008/100) thue,sum(A.lv004*A.lv006*A.lv011/100) chietkhau,sum(A.lv012) diem,sum(A.lv004*A.lv006*B.lv022/100) CKTM,concat(C.lv004,' ',C.lv003,' ',C.lv002) CusName from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 left join all_gmacv3_0.hr_lv0020 C on B.lv010=C.lv001 left join sl_lv0005 D on A.lv003=D.lv001 left join sl_lv0059 E on A.lv009=E.lv001 where 1=1 $vCondition group by lv003";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
