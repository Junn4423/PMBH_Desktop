<?php
class sl_lv0040 extends lv_controler{
	var $vRowHeader="
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function LV_Get_No_CoDauKy($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv005,$strlv006,$opt='')
	{
		$vCondition="";
		$vAddCond=""; 
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		...
		$sqlS = "select sum(A.lv004) sumall from ac_lv0005 A inner join ac_lv0004 B on A.lv002=B.lv001   where  B.lv017=0 $vCondition order by B.lv002,B.lv014,A.lv001";
		$bResultS = db_query($sqlS);
		$row=db_fetch_array($bResultS);
		return $row['sumall'];
	}
	function LV_Get_No_CoPhatSinh($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv005,$strlv006,$opt='')
	{
		$vCondition="";
		$vAddCond=""; 
		if($vDateStart!="") 	$vAddCond=$vAddCond." AND B.lv009>= '$vDateStart'";		
...
function PrintInOutPutInStockDetail($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv005,$strlv006)
	{
		$CoDK=$this->LV_Get_No_CoDauKy($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv005,$strlv006,"1");
		$NoDK=$this->LV_Get_No_CoDauKy($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv005,$strlv006,"0");
		$CoPS=$this->LV_Get_No_CoPhatSinh($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv005,$strlv006,"1");
		$NoPS=$this->LV_Get_No_CoPhatSinh($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv005,$strlv006,"0");
		if($CoPS==NULL) $CoPS=0;
		if($NoDK==NULL) $NoDK=0;
		if($CoDK==NULL) $CoDK=0;
		if($NoPS==NULL) $NoPS=0;		
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from wh_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from wh_lv0020 B where 1=1 $vAddCond)";
		...
		if($strlv003!="") $vConditionStock = "";	
		 $sqlS = "select A.*,EE.lv002 NameDebitAccount,FF.lv002 NameCreditAccount,B.lv009 VoiceDate,B.lv015 InvoiceSoureID,B.lv001 InvoiceID,B.lv005 NameObj,B.lv004 CustomerID,B.lv007 Description,CC.lv002 CustomerName,DD.lv002 SupplierName,B.lv002 TypeView,B.lv007 description  from ac_lv0005 A inner join ac_lv0004 B on A.lv002=B.lv001 left join all_gmacv3_0.sl_lv0001 CC on B.lv004=CC.lv001 left join wh_lv0003 DD on B.lv004=DD.lv001 left join ac_lv0002 EE on A.lv005=EE.lv001 left join ac_lv0002 FF on A.lv006=FF.lv001  where B.lv017=0 $vCondition order by B.lv002,B.lv009,B.lv001";
		$bResultS = db_query($sqlS);
...
//////////////////////////////////////////Purchase Order////////////////////////////////////////////////////////////////////
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv005':
				$vsql="select A.lv002 lv001,concat(B.lv004,' ',B.lv003,' ',B.lv002) lv002,IF(A.lv002='$vSelectID',1,0) lv003 from  sl_lv0037 A left join all_gmacv3_0.hr_lv0020 B on A.lv002=B.lv001";
				break;
		}
		return $vsql;
	}
	private  function getvaluelink($vFile,$vSelectID)
	{
		...
		{
			case 'lv005':
				$vsql="select lv002 lv001,lv002,IF(lv002='$vSelectID',1,0) lv003 from  sl_lv0037 where lv001='$vSelectID'";
				break;
			default:
				$vsql ="";
				break;
