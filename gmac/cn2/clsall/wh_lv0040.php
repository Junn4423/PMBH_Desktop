...
////////////
	...
	{
		$this->lv011 = ($this->lv011!="")?recoverdate(($this->lv011), $this->lang):$this->DateDefault;
		$lvsql="select '$vlvUser' lv002,A.lv003 lv003,A.lv004 lv004,A.lv005 lv005,A.lv004 lv006,A.lv005 lv007,A.lv006 lv008,A.lv007 lv009,A.lv008 lv010,CURRENT_DATE() lv011,A.lv009 lv012,'$vlv913' lv013,IF(A.lv011<>'' and A.lv010<>'',concat(A.lv011,'-',A.lv010),IF(A.lv011<>'',A.lv011,IF(A.lv010<>'',A.lv010,''))) lv014,'' lv015,'$vDate' lv016,A.lv010 lv017,A.lv011 lv018,A.lv002 POID from  all_gmacv3_0.sl_lv0007 B inner join  wh_lv0022 A on A.lv003=B.lv001 where A.lv002='$vlv006'  AND (B.lv016 like '%$vlWHID%')";
		$vresult= db_query($lvsql);
	...
	function LV_InsertCONTRACT($vlvUser,$vlv005,$vlv006,$vlWHID,$vDate,$vlv913=0)
	{
		...
		,A.lv008,'','',''
		,A.lv010
		,'','$vDate',A.lv009,A.lv012,A.lv011 from  all_gmacv3_0.sl_lv0007 B inner join sl_lv0014 A  on A.lv003=B.lv001 and B.lv016 = '$vlWHID' where A.lv002='$vlv006'";
		//$vReturn= db_query($lvsql);
		...
		,'' lv015,'$vDate' lv016,A.lv009 lv017,A.lv012 lv018,A.lv011 lv019 from  all_gmacv3_0.sl_lv0007 B inner join sl_lv0014 A  on A.lv003=B.lv001 and B.lv016 = '$vlWHID' where A.lv002='$vlv006'";
		$vresult= db_query($lvsql);
		while($vrow=db_fetch_array($vresult))
		{			
