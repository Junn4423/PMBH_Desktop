<?php
/////////////coding sl_lv0214///////////////
class  sl_lv0214 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
	...
	$vHeaderReportInventory="
		...
		if(count($this->vArrDay)>0){
			foreach($this->vArrDay as $vDateCal)
			{
				...
				{
					case 1:
						$vsql="select A.lv003,sum(A.lv004) lv004,'' lv006,'' lv011,'' CKTM,sum((A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100 -(A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100)*B.lv022/100)) thanhtien,C.lv002 Names from sl_lv0014 A inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 inner join sl_lv0013 B on A.lv002=B.lv001 and substr(B.lv004,1,10)='".$vDateCal."' group by A.lv003";
						break;
					case 2:
						$vsql="select C.lv003,sum(A.lv004) lv004,'' lv006,'' lv011,'' CKTM,sum((A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100 -(A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100)*B.lv022/100)) thanhtien,D.lv002 Names from sl_lv0014 A inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 inner join sl_lv0013 B on A.lv002=B.lv001 and substr(B.lv004,1,10)='".$vDateCal."' left join  all_gmacv3_0.sl_lv0006 D on C.lv003=D.lv001 group by C.lv003";
						break;
					case 3:
						$vsql="select B.lv010,sum(A.lv004) lv004,'' lv006,'' lv011,'' CKTM,sum((A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100 -(A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100)*B.lv022/100)) thanhtien,C.lv002 Names from sl_lv0014 A  inner join sl_lv0013 B on A.lv002=B.lv001 and substr(B.lv004,1,10)='".$vDateCal."' inner join all_gmacv3_0.hr_lv0020 C on B.lv010=C.lv001 group by B.lv010";
						break;
					case 13:
							$vsql="select B.lv032 lv010,sum(A.lv004) lv004,'' lv006,'' lv011,'' CKTM,sum((A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100 -(A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100)*B.lv022/100)) thanhtien,C.lv002 Names from sl_lv0014 A  inner join sl_lv0013 B on A.lv002=B.lv001 and substr(B.lv004,1,10)='".$vDateCal."' inner join all_gmacv3_0.hr_lv0020 C on B.lv032=C.lv001 group by B.lv032";
							break;
					case 4:
						$vsql="select B.lv002,sum(A.lv004) lv004,'' lv006,'' lv011,'' CKTM,sum((A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100 -(A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100)*B.lv022/100)) thanhtien,C.lv002 Names from sl_lv0014 A inner join sl_lv0013 B on A.lv002=B.lv001 and substr(B.lv004,1,10)='".$vDateCal."' inner join all_gmacv3_0.sl_lv0001 C on B.lv002=C.lv001  group by B.lv002";
						break;
					default:
						$vsql="select A.lv003,A.lv004,A.lv006,A.lv011,B.lv022 CKTM,(A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100 -(A.lv004*A.lv006-A.lv004*A.lv006*A.lv011/100)*B.lv022/100) thanhtien,C.lv002 Names from sl_lv0014 A inner join  all_gmacv3_0.sl_lv0007 C on A.lv003=C.lv001 inner join sl_lv0013 B on A.lv002=B.lv001 and substr(B.lv004,1,10)='".$vDateCal."'";
						break;
				}
