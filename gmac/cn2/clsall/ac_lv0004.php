<?php
/////////////coding ac_lv0004///////////////
class   ac_lv0004 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM ac_lv0004  WHERE ac_lv0004.lv001 IN ($lvarr) and (select count(*) from sl_lv0010 B where  B.lv002= ac_lv0004.lv001)<=0  and (select count(*) from sl_lv0013 B where  B.lv002= ac_lv0004.lv001)<=0 ";
		$vReturn= db_query($lvsql);
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('ac_lv0004/?lang=".$this->lang."&func='+value,'','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
