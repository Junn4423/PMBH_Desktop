...
*/
session_start();
//require_once("../../clsall/wh_lv0023.php");
...
require_once("../../clsall/wh_lv0023.php");
//////////////init object////////////////
$lvwh_lv0023=new wh_lv0023($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0023');
/////////Get ID///////////////
$lvwh_lv0023->lv001=$_GET['ChildID'];
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0030.txt",$plang);
...
if($vFlag==1)
{
		$lvwh_lv0023->lv002=$_POST['txtlv002'];
		$lvwh_lv0023->lv003=$_POST['txtlv003'];
		$lvwh_lv0023->lv004=$_POST['txtlv004'];
		$lvwh_lv0023->lv005=$_POST['txtlv005'];
		if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
		{
		$lvwh_lv0023->lv006=$_FILES['userfile']['name'];
		}
		else
			{
			$lvwh_lv0023->lv006=$_POST['txtlv006'];	
			}		
		$vresult=$lvwh_lv0023->LV_Update();
		if($vresult==true) {
			if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
			{
			UploadImg($lvwh_lv0023->lv002."_".$lvwh_lv0023->lv001, $lvwh_lv0023->lv006);
			}
...
$lvwh_lv0023->LV_LoadID($lvwh_lv0023->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvwh_lv0023->lv002;?>";
		o.txtlv003.value="<?php echo $lvwh_lv0023->lv003;?>";
		o.txtlv004.value="<?php echo $lvwh_lv0023->lv004;?>";
		o.txtlv005.value="<?php echo $lvwh_lv0023->lv005;?>";
		o.txtlv006.value="<?php echo $lvwh_lv0023->lv006;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
								...
								<td  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvwh_lv0023->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvwh_lv0023->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
<tr>
				  ...
				  <td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <?php echo $lvwh_lv0023->LV_LinkField('lv003',$lvwh_lv0023->lv003);?>
							  </select>	</td>
						  </tr>								
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvwh_lv0023->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
						  
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvwh_lv0023->FormatView($lvwh_lv0023->lv005,2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <input name="txtlv006" type="hidden" id="txtlv006" value="<?php echo $lvwh_lv0023->lv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>				 
							<tr>
