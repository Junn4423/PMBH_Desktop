...
$ml_menusl0003->level3lst=$plevel3lst;
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($ml_menusl0003->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$ml_menusl0003->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$ml_menusl0003->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
