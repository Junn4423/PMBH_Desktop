...
////Init object//////////////
		$mosl_lv0046 = new sl_lv0046($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0015');	
/////////Varian////////////////		
...
<body onLoad="moveImgPrint()" onResize="moveImgPrint()">
	<table border="0" cellpadding="0" cellspacing="0" width="940px" align="center">
	    ...
	    <td align="center" colspan="6"><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" valign="middle"><img  src="<?php echo $mosl_lv0046->GetLogo();?>" /></td>
              </tr>
              <tr>
		...
		<tr height="40px">
			<td width="399" valign="middle" class="address">
				<div id="addr" align="left" style="width:480px;">
					<?php echo $mosl_lv0046->GetCompany();?>
				<br><?php echo $vLangArr[18].":".$mosl_lv0046->GetAddress();?>	
					<br><?php echo $vLangArr[15].":".$mosl_lv0046->GetPhone()."&nbsp;&nbsp;&nbsp;".$vLangArr[16].":".$mosl_lv0046->GetFax();?>
		  </div></td>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
						switch($vOptRun)
							{
								case 2:
							$strDataShow = $mosl_lv0046->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vexist);
									break;
								case 3:
							$strDataShow = $mosl_lv0046->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),1,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vexist);									
									break;
							}
