...
if($lvwh_lv0008->lv009=="") $lvwh_lv0008->lv009=GetServerDate();
if($vFlag==1)
{
					...
					<form action="#"   name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0008->lv001=="")?InsertWithCheckExt('wh_lv0008', 'lv001', 'PN',10):$lvwh_lv0008->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
...
<tr>
							  ...
							  <ul id="pop-nav2" lang="pop-nav2" onMouseOver="ChangeName(this,2)"> <li class="menupopT">
