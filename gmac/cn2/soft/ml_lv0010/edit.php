...
/////////Get ID///////////////
$lvml_lv0010->lv001=$_GET['ChildID'];
...
if($vFlag==1)
{
		...
		$lvml_lv0010->lv004=$_POST['txtlv004'];
		...
		$lvml_lv0010->lv005=$_FILES['userfile']['name'];
			...
			{
			$lvml_lv0010->lv005=$_POST['txtlv006'];	
			}		
		$lvml_lv0010->lv005=unicode_to_none(unicode_to_upperexist(str_replace(" ","_",$lvml_lv0010->lv005)));
		$vresult=$lvml_lv0010->LV_Update();
		if($vresult==true) {
			if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
			{
			UploadImg($lvml_lv0010->lv002."_".$lvml_lv0010->lv001, $lvml_lv0010->lv006);
			}
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvml_lv0010->lv002;?>";
		o.txtlv003.value="<?php echo $lvml_lv0010->lv003;?>";
		o.txtlv004.value="<?php echo $lvml_lv0010->lv004;?>";
		o.txtlv005.value="<?php echo $lvml_lv0010->lv005;?>";
		o.txtlv006.value="<?php echo $lvml_lv0010->lv006;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
