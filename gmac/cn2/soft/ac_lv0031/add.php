...
$lvac_lv0031->lv001=InsertWithCheckExt('ac_lv0031', 'lv001', '',0);
$lvac_lv0031->lv002=$_GET['ChildID'];
$lvac_lv0031->lv003=$_POST['txtlv003'];
$lvac_lv0031->lv004=$_POST['txtlv004'];
$lvac_lv0031->lv005=GetServerDate()." ".GetServerTime();
$lvac_lv0031->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvac_lv0031->LV_Insert();
		if($vresult==true) {
			UploadImg($lvac_lv0031->lv002."_".$lvac_lv0031->lv001, $lvac_lv0031->lv006);
			$vStrMessage=$vLangArr[12];
			$vFlag = 1;	
		} else{
			$vStrMessage=$vLangArr[13].mysql_error();		
			$vFlag = 0;
		}
}
