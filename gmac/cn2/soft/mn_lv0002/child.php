...
require_once("../paras.php");
require_once("../../clsall/lv_menusl0017.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0036.txt",$plang);
//init object
$molv_menusl0017=new lv_menusl0017();
//Set variant
$molv_menusl0017->itemlst=$pitemlst;
$molv_menusl0017->childlst=$pchildlst;
$molv_menusl0017->level3lst=$plevel3lst;
$molv_menusl0017->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($molv_menusl0017->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[10];?></option>
						<option value="2" <?php echo ((int)$molv_menusl0017->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[11];?></option>
						<option value="3" <?php echo ((int)$molv_menusl0017->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[12];?></option>
						<option value="4" <?php echo ((int)$molv_menusl0017->level3lst==4)?'selected="selected"':'';?>>4.<?php echo $vLangArr[13];?></option>
						<option value="5" <?php echo ((int)$molv_menusl0017->level3lst==5)?'selected="selected"':'';?>>5.<?php echo $vLangArr[14];?></option>
						<option value="6" <?php echo ((int)$molv_menusl0017->level3lst==6)?'selected="selected"':'';?>>6.<?php echo $vLangArr[15];?></option>
						<option value="7" <?php echo ((int)$molv_menusl0017->level3lst==7)?'selected="selected"':'';?>>7.<?php echo $vLangArr[16];?></option>
						<option value="8" <?php echo ((int)$molv_menusl0017->level3lst==8)?'selected="selected"':'';?>>8.<?php echo $vLangArr[17];?></option>
						<option value="9" <?php echo ((int)$molv_menusl0017->level3lst==9)?'selected="selected"':'';?>>9.<?php echo $vLangArr[18];?></option>
						<option value="10" <?php echo ((int)$molv_menusl0017->level3lst==10)?'selected="selected"':'';?>>10.<?php echo $vLangArr[19];?></option>
						<option value="11" <?php echo ((int)$molv_menusl0017->level3lst==11)?'selected="selected"':'';?>>11.<?php echo $vLangArr[20];?></option>
						<option value="12" <?php echo ((int)$molv_menusl0017->level3lst==12)?'selected="selected"':'';?>>12.<?php echo $vLangArr[28];?></option>
						<option value="13" <?php echo ((int)$molv_menusl0017->level3lst==13)?'selected="selected"':'';?>>13.<?php echo $vLangArr[29];?></option>
					</select>
	...
	<?php
	$molv_menusl0017->Dir="../";
include($molv_menusl0017->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $molv_menusl0017->level3lst;?>";
