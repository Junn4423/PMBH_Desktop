					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
                            ...
                            <tr>
                              ...
                              <option value="">...</option>
							  <?php echo $lvmn_lv0002->LV_LinkField('lv003',$vlv003);?>
...
<tr>
                                ...
                                <option value="">...</option>
							  <?php echo $lvmn_lv0002->LV_LinkField('lv007',$vlv007);?>
							  </select>	<br><table><tr><td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							...
							<tr>
                              ...
                              <option value="">...</option>
							  <?php echo $lvmn_lv0002->LV_LinkField('lv008',$vlv008);?>
							  </select><br><table><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $vlv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						   ...
						   <tr>
								...
								<td width="178"  height="20"><input name="txtlv011" id="txtlv011"   tabindex="15"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvmn_lv0002->lv011;?>" type="text"/>							 </td>	</tr>
								<tr>
                              ...
                              <option value="">...</option>
							  <?php echo $lvmn_lv0002->LV_LinkField('lv012',$vlv012);?>
							  </select><br>
							  <table><tr><td>
							...
							<tr>
                              ...
                              <option value="">...</option>
							  <?php echo $lvmn_lv0002->LV_LinkField('lv013',$vlv013);?>
							  </select><br><table><tr><td>
							...
							<tr>
                              ...
                              <option value="">...</option>
							  <?php echo $lvmn_lv0002->LV_LinkField('lv014',$vlv014);?>
							  </select><br><table><tr><td>
						...
						<tr>
                              ...
                              <option value="">...</option>
							  <option value="0" <?php echo ($vlv014=='0')?'selected="selected"':''?>>0</option>
							  <option value="1" <?php echo ($vlv014=='1')?'selected="selected"':''?>>1</option>
							  </select>
							  </td>
							  </tr>		 				  
						  <tr>
