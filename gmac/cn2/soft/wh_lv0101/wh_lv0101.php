...
if(isset($_GET['ajaxcustomertext']))
{
	...
	if($vcusid!='' && $vcusid!=NULL)
	{
		...
		{
			case 2:
				$vsql="update all_gmacv3_0.sl_lv0001 set lv002='$vText',lv003='".GetLastName($vText)."' where lv001='$vcusid'";
			break;
			case 6:
				$vsql="update all_gmacv3_0.sl_lv0001 set lv006='$vText' where lv001='$vcusid'";
			break;
			case 16:
				echo $vsql="update all_gmacv3_0.sl_lv0001 set lv010='$vText' where lv001='$vcusid'";
			break;
			case 23:
