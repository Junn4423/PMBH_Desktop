...
require_once("../../clsall/ac_lv0076.php");
//////////////init object////////////////
$lvac_lv0076=new ac_lv0076($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ac0076');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvac_lv0076->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
...
if($vFlag==1)
{
$lvac_lv0076->lv002=$_POST['txtlv002'];
$lvac_lv0076->lv003=$_POST['txtlv003'];
$lvac_lv0076->lv004=$_POST['txtlv004'];
$lvac_lv0076->lv005=$_POST['txtlv005'];
$lvac_lv0076->lv006=$_POST['txtlv006'];
$lvac_lv0076->lv007=$_POST['txtlv007'];
$lvac_lv0076->lv016=GetServerDate()." ".GetServerTime();
		
		$vresult=$lvac_lv0076->LV_Update();
		if($vresult==true) {
...
$lvac_lv0076->LV_LoadID($lvac_lv0076->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvac_lv0076->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><input name="txtlv003" type="text"  id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvac_lv0076->lv003;?>"/>			</td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[18];?></td>
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvac_lv0076->lv004;?>"/></td>
</tr>							  
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[19];?></td>
							  <td  height="20">
							  <table style="width:80%"><tr><td width="50%"><select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  <?php echo $lvac_lv0076->LV_LinkField('lv005',$lvac_lv0076->lv005);?>
							  </select>
							  </td>
							  <td>
							  <ul id="pop-nav" lang="pop-nav1" onkeyup="ChangeName(this,1)" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv005_search" id="txtlv005_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv005','ac_lv0002','concat(lv001,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv005','ac_lv0002','concat(lv001,@! @!,lv002)')" tabindex="200" >
							...
							<tr>
							  ...
							  <?php echo $lvac_lv0076->LV_LinkField('lv006',$lvac_lv0076->lv006);?>
							  </select>
							  </td>
							  <td
							  <ul id="pop-nav2" lang="pop-nav2" onkeyup="ChangeName(this,2)" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv006_search" id="txtlv006_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv006','ac_lv0002','concat(lv001,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv006','ac_lv0002','concat(lv001,@! @!,lv002)')" tabindex="200" >
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv007" id="txtlv007"  style="width:80%"  tabindex="12"  value="<?php echo $lvac_lv0076->lv007;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
						<tr>
