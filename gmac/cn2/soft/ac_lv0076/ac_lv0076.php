...
$moac_lv0076->ArrPush[17]=$vLangArr[34];
...
$moac_lv0076->ArrFunc[11]=$vLangArr[28];
$moac_lv0076->ArrFunc[12]=$vLangArr[29];
$moac_lv0076->ArrFunc[13]=$vLangArr[30];
$moac_lv0076->ArrFunc[14]=$vLangArr[31];
$moac_lv0076->ArrFunc[15]=$vLangArr[32];

////Other
$moac_lv0076->ArrOther[1]=$vLangArr[26];
$moac_lv0076->ArrOther[2]=$vLangArr[27];
//////Delete message///
$lvMessage=array();
...
if($flag==1)
{
	$moac_lv0058->lv001=$_GET['txtlv001'];
	$moac_lv0076->lv002=$_SESSION['ERPSOFV2RUserID'];
	$moac_lv0076->lv003=$_GET['txtlv003'];
	$moac_lv0076->lv004=$_GET['txtlv004'];
	$moac_lv0076->lv005=$_GET['txtlv005'];
	$moac_lv0076->lv006=$_GET['txtlv006'];
	$moac_lv0076->lv007=$_GET['txtlv007'];
	$moac_lv0076->lv008=$_GET['txtlv008'];
	$strReturn=$moac_lv0076->LV_Insert();
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$moac_lv0076->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"ac_lv0076",$lvMessage);
}
elseif($flagID==2)
{
$moac_lv0076->lv001=$_POST['txtlv001'];
$moac_lv0076->lv002=$_GET['ID'];
$moac_lv0076->lv003=$_POST['txtlv003'];
$moac_lv0076->lv004=$_POST['txtlv004'];
$moac_lv0076->lv005=$_POST['txtlv005'];
$moac_lv0076->lv006=$_POST['txtlv006'];
$moac_lv0076->lv007=$_POST['txtlv007'];
}
//first is load
if($_POST["txtFlag"]=="")
{
...
$moac_lv0076->SaveOperation($_SESSION['ERPSOFV2RUserID'],'ac_lv0076',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
{
	var str="<br><iframe id='lvframefrm' height=900 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir;?>ac_lv0076?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&childdetailfunc="+func+"&ID=<?php echo $_GET['ID'];?>&ChildID=<?php echo $_GET['ChildID'];?>&ChildDetailID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&ChildID=<?php echo $_GET['ChildID'];?>&ID=<?php echo $_GET['ID']?>&<?php  echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose"> <input type="hidden" name="allcreen" value="<?php echo $_POST['allcreen'];?>"/>
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $moac_lv0076->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $moac_lv0076->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $moac_lv0076->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $moac_lv0076->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $moac_lv0076->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $moac_lv0076->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $moac_lv0076->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $moac_lv0076->lv007;?>"/>
					</form>
...
<?php
	...
	include("$vDir../ac_lv0076/permit.php");
}
?>
<script language="javascript">
div = document.getElementById('lvtitlelist');
div.innerHTML='<?php echo $moac_lv0076->ArrPush[0];?>';	
</script>
</html>