...
$lvwh_lv0001->lv001=$_POST['txtlv001'];
					...
					<form action="#" name="frmadd" method="post">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0001->lv001=="")?InsertWithCheckExt('huyvanv2_0.wh_lv0001', 'lv001', 'WH',4):$lvwh_lv0001->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
