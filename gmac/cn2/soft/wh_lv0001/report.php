...
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0001.txt",$plang);
...
$mowh_lv0001->ArrFunc[5]='';
$mowh_lv0001->ArrFunc[6]='';
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mowh_lv0001->lv002=base64_decode($_GET['ID']);
...
?>
				...
				<?php echo $mowh_lv0001->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
