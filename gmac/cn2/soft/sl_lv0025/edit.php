...
require_once("../../clsall/sl_lv0025.php");
//////////////init object////////////////
$lvsl_lv0025=new sl_lv0025($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0025');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvsl_lv0025->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0043.txt",$plang);
$mosl_lv0025->lang=strtoupper($plang);
$curPage=(int)$_POST['curPg'];	
$vFlag=(int)$_POST['txtFlag'];
if($vFlag==1)
{
$lvsl_lv0025->lv002=$_POST['txtlv002'];
$lvsl_lv0025->lv003=$_POST['txtlv003'];
$lvsl_lv0025->lv004=$_POST['txtlv004'];
$lvsl_lv0025->lv005=$_POST['txtlv005'];
$lvsl_lv0025->lv006=$_POST['txtlv006'];
$lvsl_lv0025->lv007=$_POST['txtlv007'];
$lvsl_lv0025->lv008=$_POST['txtlv008'];
$lvsl_lv0025->lv009=$_POST['txtlv009'];
$lvsl_lv0025->lv010=$_POST['txtlv010'];
$lvsl_lv0025->lv011=$_POST['txtlv011'];
$lvsl_lv0025->lv012=$_POST['txtlv012'];
$lvsl_lv0025->lv013=$_POST['txtlv013'];
$lvsl_lv0025->lv014=$_POST['txtlv014'];
$lvsl_lv0025->lv015=$_POST['txtlv015'];
$lvsl_lv0025->lv016=GetServerDate()." ".GetServerTime();
		
		$vresult=$lvsl_lv0025->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvsl_lv0025->LV_LoadID($lvsl_lv0025->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0025->lv001=="")?InsertWithCheckExt('sofv1_0.sl_lv0025', 'lv001', '',10):$lvsl_lv0025->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvsl_lv0025->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvsl_lv0025->LV_LinkField('lv003',$lvsl_lv0025->lv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
	              ...
	              <td  height="20"><input type="hidden" name="txtlv004old" id="txtlv004old" value="<?php echo $lvsl_lv0025->lv004;?>" />
			                  <input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvsl_lv0025->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvsl_lv0025->LV_LinkField('lv005',$lvsl_lv0025->lv005);?>
							  ...
							  <td  height="20"><input type="hidden" name="txtlv006old" id="txtlv006old" value="<?php echo $lvsl_lv0025->lv006;?>" /><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvsl_lv0025->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvsl_lv0025->LV_LinkField('lv007',$lvsl_lv0025->lv007);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv008" id="txtlv008"  style="width:80%"  tabindex="12"  value="<?php echo (float)$lvsl_lv0025->lv008;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvsl_lv0025->LV_LinkField('lv009',$lvsl_lv0025->lv009);?>
							  </select>	<br><table><tr><td>
							  <ul id="pop-nav4" lang="pop-nav4" onkeyup="ChangeName(this,4)" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch9" id="txtlvsearch9" tabindex="200" style="width:200px" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0025->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','hr_lv0018','lv002')" onFocus="LoadSelf(this,'txtlv009','hr_lv0018','lv002')">
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvsl_lv0025->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							 <tr>
							  ...
							  <?php echo $lvsl_lv0025->LV_LinkField('lv011',$lvsl_lv0025->lv011);?>
							  </select><br>
							  <table><tr><td>
							  <ul id="pop-nav4" lang="pop-nav4" onkeyup="ChangeName(this,4)" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							...
							<tr>
							  ...
							  <?php echo $lvsl_lv0025->LV_LinkField('lv012',$lvsl_lv0025->lv012);?>
							  </select><br><table><tr><td>
							  <ul id="pop-nav5" lang="pop-nav5" onkeyup="ChangeName(this,5)" onMouseOver="ChangeName(this,5)" onkeyup="ChangeName(this,5)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch5" id="txtlvsearch5" style="width:200px" onKeyUp="LoadPopup(this,'txtlv012','ac_lv0002','concat(lv001,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv012','ac_lv0002','concat(lv001,@! @!,lv002)')" tabindex="200" >
							...
							<tr>
							  ...
							  <?php echo $lvsl_lv0025->LV_LinkField('lv013',$lvsl_lv0025->lv013);?>
							  </select><br><table><tr><td>
							  <ul id="pop-nav6" lang="pop-nav6" onkeyup="ChangeName(this,6)" onMouseOver="ChangeName(this,6)" onkeyup="ChangeName(this,6)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch6" id="txtlvsearch6" style="width:200px" onKeyUp="LoadPopup(this,'txtlv013','ac_lv0002','concat(lv001,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv013','ac_lv0002','concat(lv001,@! @!,lv002)')" tabindex="200" >
				  ...
				  <td  height="20"><input  name="txtlv014" type="text" id="txtlv014" value="<?php echo $lvsl_lv0025->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[29];?></td>
				  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvsl_lv0025->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						<tr>
