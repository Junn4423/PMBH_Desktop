...
{
$lvsql="select distinct * from (select lv001,$objfield lv002 from $objtable where $objfield like '$objvalue%' union select lv001,$objfield lv002 from $objtable where $objfield like '%$objvalue%' union select lv001,$objfield lv002 from $objtable where $objfield like '%$objvalue') A limit 0,20";
