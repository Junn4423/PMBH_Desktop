...
/////////Get ID///////////////
$lvwh_lv0034->lv001=$_GET['ID'];
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0049.txt",$plang);
...
if($vFlag==1)
{
		$lvwh_lv0034->lv002=$_POST['txtlv002'];
		$lvwh_lv0034->lv003=$_POST['txtlv003'];	
		$lvwh_lv0034->lv004=$_POST['txtlv004'];	
		$lvwh_lv0034->lv005=$_POST['txtlv005'];	
		$vresult=$lvwh_lv0034->LV_Update();
		if($vresult==true) {
...
$lvwh_lv0034->LV_LoadID($lvwh_lv0034->lv001);
...
function isphone(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvwh_lv0034->lv002;?>";
		o.txtlv003.value="<?php echo $lvwh_lv0034->lv003;?>";
		o.txtlv004.value="<?php echo $lvwh_lv0034->lv004;?>";
		o.txtlv005.value="<?php echo $lvwh_lv0034->lv005;?>";
		o.txtlv006.value="<?php echo $lvwh_lv0034->lv006;?>";		
		o.txtlv007.value="<?php echo $lvwh_lv0034->lv007;?>";		
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvwh_lv0034->lv001;?>" /></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvwh_lv0034->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
							  ...
							  <td  height="20px"><select name="txtlv003" id="txtlv003"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
							   <?php echo $lvwh_lv0034->LV_LinkField('lv003',$lvwh_lv0034->lv003);?>
                              </select></td>
							</tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input name="txtlv004" type="text" id="txtlv004"  value="<?php echo $lvwh_lv0034->lv004;?>" tabindex="7" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005"  value="<?php echo $lvwh_lv0034->lv005;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>					 
							<tr>
