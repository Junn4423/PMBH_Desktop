...
require_once("../../clsall/sl_lv0013.php");
//////////////init object////////////////
$lvsl_lv0013=new sl_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0033');
...
<tr>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv011" value="<?php echo $vlv011;?>" tabindex="15" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
						  </tr>		
						    <tr>
