...
/////////////init object//////////////
$mosl_lv0014=new sl_lv0014($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0033');
...
$mosl_lv0014->ArrPush[14]=$vLangArr[38];
$mosl_lv0014->ArrPush[15]=$vLangArr[39];
...
<body onLoad="moveImgPrint()" onResize="moveImgPrint()">
  ...
  <tr>
    <td align="center"><img  src="<?php echo $mosl_lv0014->GetLogo();?>" /></td>
  </tr>
   <tr>
    <td align="center" class="lv0" >&nbsp;</td>
  </tr>
  <tr>
    <td align="center" class="lv0" onDblClick="this.innerHTML='&nbsp;'"><?php echo $mosl_lv0013->lv014;?></td>
  </tr>
    <tr>
    <td align="center"><h3 onDblClick="this.innerHTML='&nbsp;'"><?php echo "No:".$mosl_lv0013->lv001."&nbsp;&nbsp;&nbsp;"."DATE: "." ".getday($mosl_lv0013->lv004).(($plang=="EN")?" ".$lvArrMonth[(int)getmonth($mosl_lv0013->lv004)].", ":"/".getmonth($mosl_lv0013->lv004)."/").getyear($mosl_lv0013->lv004);?></h3></td>
  </tr>
    <tr>
    <td align="right" class="bodyTXT" onDblClick="this.innerHTML='&nbsp;'">Quotation No:<?php echo $mosl_lv0013->lv012;?></td>
  </tr>  
  <tr>
    <td align="center"><?php echo str_replace("<!--strAttack-->",$strDetail,$mosl_lv0013->lv013);?></td>
  </tr>
</table>
</body>
	<?php
