...
<table width="150" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td align="center">
	<br/>
	<font style="font-size:18px;font-weight:bold">PHIẾU ĂN</font></td>
  </tr>
   <tr>
	...
	<br/>
			<table width="100%" style="border:0px;text-align:left;" cellpadding="0" cellspacing="0">
				<tr><td><strong>Mã phiếu:</strong><?php echo $mosl_lv0013->lv001;?></td><td>&nbsp;</td></tr>
	...
	<tr>
    <td align="left">
		<strong>Số bàn:</strong><font style="font-size:14px;font-weight:bold"> <?php echo $mosl_lv0013->getvaluelink('lv077',$mosl_lv0013->lv007);?></font>
		<strong>Mã NV:</strong> <?php echo $mohr_lv0020->lv001;?>
...
<?php
	...
	$vorder=1;
	$sqlS = "SELECT A.*,B.lv003 CateID,B.lv002 ItemName,C.lv002 UnitName,D.lv002 ProgName FROM sl_lv0014 A inner join all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 left join sl_lv0005 C on A.lv005=C.lv001 left join sl_lv0059 D on A.lv009=D.lv001 WHERE A.lv101<>1 and B.lv003 not in ($vlsCate) and A.lv002='".$mosl_lv0013->lv001."' and trim(A.lv015)='".trim($vroworder['vorder'])."' order by A.lv015 asc,A.lv001 asc";
	$bResult = db_query($sqlS);
	$sumMoney=0;
	$sumScore=0;
	$sumDiscount=0;
