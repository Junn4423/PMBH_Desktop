...
<?php
	$vorder=1;
	$sqlS = "SELECT A.*,B.lv002 ItemName,C.lv002 UnitName,D.lv002 ProgName FROM sl_lv0014 A left join all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 left join sl_lv0005 C on A.lv005=C.lv001 left join sl_lv0059 D on A.lv009=D.lv001 WHERE A.lv002='".$mosl_lv0013->lv001."' order by A.lv015 asc,A.lv001 asc";
...
?>		
		<tr class="lvlinehtable1">
			...
			<td align="right"><?php echo $mosl_lv0014->FormatView($vrow['lv011'],10)."%";?></td>
...
<?php
	...
	{
		 $vsumCash=($sumMoney)*$mosl_lv0013->lv022/100;
?>		
		<tr ondblclick="this.innerHTML=''">
			<td class="lvlineboldtable" colspan="6" >CK TIỀN MẶT(<?php echo $mosl_lv0013->FormatView($mosl_lv0013->lv022,10);?>%):</td>
			<td class="lvlineboldtable" align="right" style="padding:2px;padding-right:5px;padding-left:5px;font-size:14px"><?php echo $mosl_lv0014->FormatView($vsumCash,10);?></td>
			<td align="left" colspan="2">&nbsp;</td>
		</tr>
<?php
	}
?>				
			...
			<td class="lvlineboldtable" align="right" style="padding:2px;padding-right:5px;padding-left:5px;font-size:14px"><?php echo $mosl_lv0014->FormatView($sumMoney-$sumDiscount-$vsumCash,10);?></td>
			<td align="left" colspan="2">&nbsp;</td>
		</tr>
		<tr ondblclick="this.innerHTML=''">
