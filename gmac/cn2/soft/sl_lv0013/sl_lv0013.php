...
$mosl_lv0013->ArrPush[3]='KH';//$vLangArr[20];
...
$mosl_lv0013->ArrPush[99]=$vLangArr[63];
$mosl_lv0013->ArrPush[33]="Người thu tiền";
$mosl_lv0013->ArrPush[101]='KH khác';
...
$mosl_lv0013->ArrFunc[5]=GetLangExcept('Rpt',$plang);
$mosl_lv0013->ArrFunc[6]=GetLangExcept('Apr',$plang);
$mosl_lv0013->ArrFunc[7]=GetLangExcept('UnApr',$plang);
...
$mosl_lv0013->ArrFunc[16]=$vLangArr[43];
$mosl_lv0013->ArrFunc[17]=$vLangArr[44];
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$mosl_lv0013->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"sl_lv0013",$lvMessage);
}
elseif($flagID==2)
{
$mosl_lv0013->lv001=$_POST['txtlv001'];
if($_GET['ID']=="")
$mosl_lv0013->lv002=$_POST['txtlv002'];
else
$mosl_lv0013->lv002=$_GET['ID'];
$mosl_lv0013->lv003=$_POST['txtlv003'];
$mosl_lv0013->lv004=$_POST['txtlv004'];
$mosl_lv0013->lv005=$_POST['txtlv005'];
$mosl_lv0013->lv006=$_POST['txtlv006'];
$mosl_lv0013->lv007=$_POST['txtlv007'];
$mosl_lv0013->lv008=$_POST['txtlv008'];
$mosl_lv0013->lv009=$_POST['txtlv009'];
$mosl_lv0013->lv010=$_POST['txtlv010'];
$mosl_lv0013->lv011=$_POST['txtlv011'];
$mosl_lv0013->lv012=$_POST['txtlv012'];
}
elseif($flagID==3)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
...
$mosl_lv0013->SaveOperation($_SESSION['ERPSOFV2RUserID'],'sl_lv0013',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
{
	var str="<br><iframe id='lvframefrm' height=2000 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir;?>sl_lv0013?func=<?php echo $_GET['func'];?>&childfunc="+func+"&ID=<?php echo $_GET['ID'];?>&ChildID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mosl_lv0013->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mosl_lv0013->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $mosl_lv0013->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $mosl_lv0013->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $mosl_lv0013->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $mosl_lv0013->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $mosl_lv0013->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $mosl_lv0013->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $mosl_lv0013->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $mosl_lv0013->lv009;?>"/>
						<input type="hidden" name="txtlv010" id="txtlv010" value="<?php echo $mosl_lv0013->lv010;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $mosl_lv0013->lv011;?>"/>
						<input type="hidden" name="txtlv012" id="txtlv012" value="<?php echo $mosl_lv0013->lv012;?>"/>
						<input type="hidden" name="txtlv013" id="txtlv013" value="<?php echo $mosl_lv0013->lv013;?>"/>
						<input type="hidden" name="txtlv014" id="txtlv014" value="<?php echo $mosl_lv0013->lv014;?>"/>
				 </form>
...
div.innerHTML='<?php echo $mosl_lv0013->ArrPush[0];?>';	
</script>
</html>