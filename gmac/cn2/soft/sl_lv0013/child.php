...
require_once("../paras.php");
require_once("../../clsall/lv_menusl0013.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0031.txt",$plang);
//init object
$lv_menusl0013=new lv_menusl0013();
//Set variant
$lv_menusl0013->itemlst=$pitemlst;
$lv_menusl0013->childlst=$pchildlst;
$lv_menusl0013->level3lst=$plevel3lst;
$lv_menusl0013->child3lst=$pchild3lst;
...
<div id="content_child">
              ...
              <tr>
                <td><TABLE id="toolbar" cellSpacing="0" cellPadding="0" border="0" width="100%">
					<TBODY>
	 			 	...
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)" style="width:80px">
						<option value="1" <?php echo ($lv_menusl0013->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$lv_menusl0013->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$lv_menusl0013->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
						<option value="4" <?php echo ((int)$lv_menusl0013->level3lst==4)?'selected="selected"':'';?>>4.<?php echo $vLangArr[12];?></option>
						<option value="5" <?php echo ((int)$lv_menusl0013->level3lst==5)?'selected="selected"':'';?>>5.<?php echo $vLangArr[11];?></option>
						<option value="6" <?php echo ((int)$lv_menusl0013->level3lst==6)?'selected="selected"':'';?>>6.<?php echo $vLangArr[13];?></option>
						<option value="7" <?php echo ((int)$lv_menusl0013->level3lst==7)?'selected="selected"':'';?>>7.<?php echo $vLangArr[14];?></option>
						<option value="8" <?php echo ((int)$lv_menusl0013->level3lst==8)?'selected="selected"':'';?>>8.<?php echo $vLangArr[15];?></option>
						<option value="9" <?php echo ((int)$lv_menusl0013->level3lst==9)?'selected="selected"':'';?>>9.<?php echo $vLangArr[16];?></option>
					</select>
					...
					<input type="hidden" name="txtFlagDocument" id="txtFlagDocument" />
							...
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==1)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(1);">
							...
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==8)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(8);">
								<img src="../images/controlright/immigration.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[15];?></a></TD>	
							<TD>&nbsp;</TD>							
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==2)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(2);">
								<img src="../images/controlright/save_document.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[9];?></a></TD>
								<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<!--
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==3)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(3);">
								<img src="../images/controlright/instock_add.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[10];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==4)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(4);">
								<img src="../images/controlright/instock_add	.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[12];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==5)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(5);">
								<img src="../images/controlright/outstock_sub.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[11];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==6)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(6);">
								<img src="../images/controlright/outstock_sub.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
							...
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==7)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(7);">
								<img src="../images/controlright/immigration.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
							...
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($lv_menusl0013->level3lst==9)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(9);">
	...
	<?php
	$lv_menusl0013->Dir="../";
include($lv_menusl0013->GetLinkEmp());
?>
	</div></div></td>
              </tr>
            </table>
...
document.frmhr_employee.cbxoption.value="<?php echo $lv_menusl0013->level3lst;?>";
