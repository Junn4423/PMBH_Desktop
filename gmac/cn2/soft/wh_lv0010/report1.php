...
$vlv001=$varr[0];
/////////////init object//////////////
$mowh_lv0010=new sl_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0013');
$mowh_lv0010=new sl_lv0001($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0001');
...
//$vFieldList="lv001,lv002,lv004,lv005,lv006,lv008,lv009,lv010,lv011,lv099";
...
<body onLoad="moveImgPrint()" onResize="moveImgPrint()">
	...
	if($mowh_lv0010->lv005=='GMAC' || $mowh_lv0010->lv005=='TRAHANG')
	{
		$mowh_lv0010->LV_LoadID($mowh_lv0010->lv006);
		$mohr_lv0020->LV_LoadID($mowh_lv0010->lv010);
		$mowh_lv0010->LV_LoadID($mowh_lv0010->lv002);
		$mosl_lv0009->LV_LoadID($mowh_lv0010->lv007);
	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  <tr>
	<td><div align="center" ><strong>Ngày</strong> <?php echo getday($mowh_lv0010->lv009);?> <strong>tháng</strong> <?php echo getmonth($mowh_lv0010->lv009);?> <strong>năm</strong> <?php echo getyear($mowh_lv0010->lv009);?></div></td>
  </tr>
  <?php
  if(1!=1)//($mowh_lv0010->lv005=='GMAC' || $mowh_lv0010->lv005=='CUS') && ($mowh_lv0010->lv001!=NULL))
  {
  ?>
  <tr>
    <td align="center">
		<div style="float:left;text-align:left;width:50%;font-weight:none">
			<div style="padding-right:10px">
				<strong>Tên KH:</strong> <?php echo $mowh_lv0010->lv002;?>
				<br><strong>Ð.CHỈ:</strong> <?php echo $mowh_lv0010->lv006;?>
			</div>
		</div>
		<div style="float:left;text-align:left;width:50%;font-weight:none">
