...
$lvsl_lv0064->lv001=InsertWithCheckExt('sl_lv0064', 'lv001', '',1);
$lvsl_lv0064->lv002=$_GET['ChildID'];
					...
					<form action="#"   name="frmadd" id="frmadd"  method="post">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20px">
								<input  name="txtlv003" type="text" id="txtlv003" value="<?php echo (float)$lvsl_lv0064->lv003;?>" tabindex="7" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							 </td>
							  </tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><table style="width:80%"><tr><td><select name="txtlv004" id="txtlv004"   tabindex="8"  style="width:100%" onKeyPress="return CheckKey(event,7)" onblur="LoadUnit()"/>
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo (int)$lvsl_lv0064->lv007;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      </td>
							  </tr>																	
							<tr>
