...
require_once("../../clsall/wh_lv0031.php");
//////////////init object////////////////
$lvwh_lv0031=new wh_lv0031($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0031');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvwh_lv0031->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
...
if($vFlag==1)
{
$lvwh_lv0031->lv002=$_POST['txtlv002'];
...
$lvwh_lv0031->lv016=GetServerDate()." ".GetServerTime();
		...
		$vresult=$lvwh_lv0031->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvwh_lv0031->LV_LoadID($lvwh_lv0031->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td   height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0031->lv001=="")?InsertWithCheckExt('wh_lv0031', 'lv001', '',10):$lvwh_lv0031->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							...
							<tr>
							  ...
							  <td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvwh_lv0031->LV_LinkField('lv003',$lvwh_lv0031->lv003);?>
							  </select></td>
							  <td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:100%" onKeyUp="LoadPopup(this,'txtlv003','*@*@*.sl_lv0007','concat(lv002,@! @!,lv001)')" onFocus="LoadPopup(this,'txtlv003','*@*@*.sl_lv0007','concat(lv002,@! @!,lv001)')" tabindex="200" >
...
<tr>
	              ...
	              <td  height="20"><input type="hidden" name="txtlv004old" id="txtlv004old" value="<?php echo $lvwh_lv0031->lv004;?>" />
			                  <input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvwh_lv0031->lv004;?>"/></td>
</tr>							  
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[19];?></td>
							  <td  height="20"><table style="width:80%"><tr>
							  <td width="50%"><select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:100%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <td  height="20"><input type="hidden" name="txtlv006old" id="txtlv006old" value="<?php echo $lvwh_lv0031->lv006;?>" /><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvwh_lv0031->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
								<td width="166"  height="20" valign="top"><?php echo $vLangArr[21];?></td>
								<td   height="20"><table style="width:80%"><tr>
							  <td width="50%"><select name="txtlv007" id="txtlv007"   tabindex="11"  style="width:100%" onKeyPress="return CheckKey(event,7)"/>
							...
							<tr>
							  ...
							  <td  height="20"><table style="width:80%"><tr>
							  <td width="50%"><select name="txtlv009" id="txtlv009"   tabindex="13"  style="width:100%" onKeyPress="return CheckKey(event,7)"/>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvwh_lv0031->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
							  ...
							  <td  height="20"><input type="text" name="txtlv011" id="txtlv011"  style="width:80%"  tabindex="15"  value="<?php echo (float)$lvwh_lv0031->lv011;?>" onKeyPress="return CheckKey(event,7)">	</td></tr>
					<!--
							<tr>
