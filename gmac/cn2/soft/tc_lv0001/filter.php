					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvtc_lv0001->lv001=="")?InsertWithCheckExt('tc_lv0001', 'lv001', 'PN',10):$lvtc_lv0001->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
...
<tr>
						  ...
						  <br></td></tr><tr>
							...
							<tr>
								...
								<td width="178"  height="20"><input name="txtlv007" id="txtlv007"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" maxlength="225" value="<?php echo $lvtc_lv0001->lv007;?>" />													 </td>
					      </tr>		
						  <tr>
								<td width="166"  height="20" valign="top"><?php echo $vLangArr[22];?></td>
								<td width="178"  height="20"><input name="txtlv008" id="txtlv008"   tabindex="13"  style="width:80%" onKeyPress="return CheckKey(event,7)" maxlength="225" value="<?php echo $lvtc_lv0001->lv008;?>" />													 </td>
					      </tr>	
						  <tr>
								<td width="166"  height="20" valign="top"><?php echo $vLangArr[23];?></td>
								<td width="178"  height="20"><input name="txtlv009" id="txtlv009"   tabindex="14"  style="width:80%" onKeyPress="return CheckKey(event,7)" maxlength="225" value="<?php echo $lvtc_lv0001->lv009;?>" />													 </td>
					      </tr>						  
						  <tr>
