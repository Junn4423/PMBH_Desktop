...
$mosl_lv0013->LV_LoadID($mosl_lv0058->lv013);
...
<table width="280" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <TD COLSPAN=2>
   ...
   <tr>
	...
	<strong><?php echo $mosl_lv0058->GetCompany();?></strong><br><?php echo $mosl_lv0058->GetAddress();?>
<br><?php echo "Điện thoại: ";?><?php echo $mosl_lv0058->GetPhone();?>    
		</div>
	
</td>
  </tr>
  <tr>
    <td align="center" COLSPAN=2 style="text-align:center"><font style="font-size:25px;font-weight:bold">PHIẾU TẠM ỨNG</font></td>
  </tr>
  <tr>
  <td colspan=2 style="text-align:center">
	<strong>NGÀY:</strong><?php echo $mosl_lv0058->FormatView($mosl_lv0058->lv009,4);?>
  </td>
  </tr>
   <tr>
    <td align="center" COLSPAN=2>
		...
		<div style="float:left;text-align:left;width:40%;font-weight:none">
			...
			<br><strong>SỐ:</strong><?php echo $mosl_lv0058->lv001;?>
			</div>
		</div>
	</td>
  </tr>
...
<TR VALIGN=TOP>
  ...
  <TD style="width:180px"><?php echo $mosl_lv0058->lv005;?>&nbsp;</TD>
  </TR>
<TR VALIGN=TOP>
  <TD =6>Địa chỉ : </TD>
  <TD =38><?php echo $mosl_lv0058->lv006;?>&nbsp;</TD>
  </TR>
<TR VALIGN=TOP>
  <TD =6>Lý do : </TD>
  <TD =38><?php echo $mosl_lv0058->lv007;?></TD>
  </TR>
<TR VALIGN=TOP>
  <TD  =6><strong>Số tiền :</strong></TD>
  <TD =38><strong><?php echo $mosl_lv0058->FormatView($vArrMN[4],1);?></strong></TD>
  </TR>
<TR VALIGN=TOP>
...
<TR VALIGN=TOP>
  <TD =6>Kèm theo :  </TD>
  <TD =11><?php echo $mosl_lv0058->lv013;?>&nbsp;</TD>
</tr>
<tr> 
  <TD>Chứng từ gốc:</td><td> <?php echo $mosl_lv0058->lv015;?>&nbsp;</TD>
</TR>
</table>  
<table width="280" border="0" cellspacing="0" cellpadding="0" align="center">  
  <tr>
