...
require_once("../paras.php");
require_once("../../clsall/sl_menusl0058.php");
...
//init object
$mosl_menusl0058=new sl_menusl0058();
//Set variant
$mosl_menusl0058->itemlst=$pitemlst;
$mosl_menusl0058->childlst=$pchildlst;
$mosl_menusl0058->level3lst=$plevel3lst;
$mosl_menusl0058->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($mosl_menusl0058->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$mosl_menusl0058->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[12];?></option>
					</select>
	...
	<?php
	$mosl_menusl0058->Dir="../";
include($mosl_menusl0058->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $mosl_menusl0058->level3lst;?>";
