...
require_once("../clsall/wh_lv0055.php");

/////////////init object//////////////
$mowh_lv0055=new  wh_lv0055($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0055');
/////////////init object//////////////
...
$vNow=GetServerDate();
$mowh_lv0055->lv002=getyear($vNow)."-".getmonth($vNow)."-"."01";
$mowh_lv0055->lv003=$vNow;
//$ma=$_GET['ma'];
...
//-->
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                    ...
                    <input type="hidden" name="lang" value="<?php echo $plang;?>" />
					 <table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv001" id="txtlv001"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
							   				<?php
												if($mowh_lv0055->GetApr()==11)
												{
												?>
												<option value="">...</option>
												<?php
												...
												?>
							  <?php echo $mowh_lv0055->LV_LinkField('lv002',$mowh_lv0055->lv002);?>
							 
                              </select>							    </td>
							</tr><tr>
				      <td  height="20"><?php echo $vLangArr[2];?></td>
				      <td  height="20"><input name="txtlv002" type="text" id="txtlv002" value="<?php echo formatdate($mowh_lv0055->lv002,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				      ...
				      <td  height="20"><input name="txtlv003" type="text" id="txtlv003" value="<?php echo formatdate($mowh_lv0055->lv003,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				        <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
						 ...
						 <tr>
							  ...
							  <option value="">...</option>
							  <?php echo $mowh_lv0055->LV_LinkField('lv004',$mowh_lv0055->lv004);?>
							  </select>	</td></tr>
						  <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[27];?></td>
							  <td  height="20">
							   <table width="80%"><tr><td width="50%">
							    <input name="txtlv005" type="text" id="txtlv005"  value="<?php echo $mowh_lv0055->lv005;?>" tabindex="10" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7)"/>
							    </td>
							    <td>
						 ...
						 <tr>
							  ...
							  <option value="">...</option>
							  <?php echo $mowh_lv0055->LV_LinkField('lv006',$mowh_lv0055->lv006);?>
							  </select>
							  </td>
							  <td>
                             ...
                             <tr>
							  ...
							  <td  height="20"><input name="txtlv008" type="hidden" id="txtlv008" value="<?php echo $mowh_lv0055->lv008;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mowh_lv0055->GetBuilCheckList($mowh_lv0055->lv008,'chklv008',10);?></td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[24];?></td>
				  <td  height="20">
							  <table width="80%"><tr><td width="50%">
							  <input  name="txtlv007" type="text" id="txtlv007" value="<?php echo $mowh_lv0055->lv007;?>" tabindex="9" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" />
							  </td>
							  <td>
				  ...
				  <td  height="20">
							  <table width="80%"><tr><td width="50%">
							  <input  name="txtlv009" type="text" id="txtlv009" value="<?php echo $mowh_lv0055->lv009;?>" tabindex="9" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" />
							  </td>
							  <td>
