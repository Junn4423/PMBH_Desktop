...
{
$lvsql="select distinct * from (select $objfield lv001,$objfield lv002 from $objtable where $objfield like '$objvalue%' union select $objfield lv001,$objfield lv002 from $objtable where $objfield like '%$objvalue%' union select $objfield lv001,$objfield lv002 from $objtable where $objfield like '%$objvalue') A";
