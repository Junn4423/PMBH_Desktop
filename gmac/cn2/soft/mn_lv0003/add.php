...
require_once("../../clsall/mn_lv0003.php");
//////////////init object////////////////
$lvmn_lv0003=new  mn_lv0003($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Mn0003');
...
$lvmn_lv0003->lv001=$_POST['txtlv001'];
$lvmn_lv0003->lv002=$_POST['txtlv002'];
if($vFlag==1)
{
		
		$vresult=$lvmn_lv0003->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvmn_lv0003->lv001=="")?InsertWithCheckExt('mn_lv0003', 'lv001', 'CAI',3):$lvmn_lv0003->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input  name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvmn_lv0003->lv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
