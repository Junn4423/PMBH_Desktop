...
//require_once("../../clsall/wh_lv0054.php");
...
//////////////init object////////////////
$lvwh_lv0054=new wh_lv0054($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0054');
$mowb_lv0006=new wb_lv0006($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wb0006');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvwh_lv0054->lv001=$_GET['ChildDetailID'];
$lvwh_lv0054->obj_wb_lv0006=$mowb_lv0006;
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0064.txt",$plang);
$mowh_lv0054->lang=strtoupper($plang);
$curPage=(int)$_POST['curPg'];	
$vFlag=(int)$_POST['txtFlag'];
if($vFlag==1)
{
$lvwh_lv0054->lv002=$_POST['txtlv002'];
$lvwh_lv0054->lv003=$_POST['txtlv003'];
$lvwh_lv0054->lv004=$_POST['txtlv004'];
$lvwh_lv0054->lv005=$_POST['txtlv005'];
$lvwh_lv0054->lv006=$_POST['txtlv006'];
$lvwh_lv0054->lv007=$_POST['txtlv007'];
$lvwh_lv0054->lv008=$_POST['txtlv008'];
$lvwh_lv0054->lv009=$_POST['txtlv009'];
$lvwh_lv0054->lv010=$_POST['txtlv010'];
$lvwh_lv0054->lv011=$_POST['txtlv011'];
$lvwh_lv0054->lv012=$_POST['txtlv012'];
$lvwh_lv0054->lv013=$_POST['txtlv013'];
$lvwh_lv0054->lv014=$_POST['txtlv014'];
$lvwh_lv0054->lv015=$_POST['txtlv015'];
$lvwh_lv0054->lv016=GetServerDate()." ".GetServerTime();
		
		$vresult=$lvwh_lv0054->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvwh_lv0054->LV_LoadID($lvwh_lv0054->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0054->lv001=="")?InsertWithCheckExt('wh_lv0054', 'lv001', '',10):$lvwh_lv0054->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvwh_lv0054->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
						<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20">
							  <table style="width:80%"><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><?php echo $lvwh_lv0054->LV_LinkField('lv003',$lvwh_lv0054->lv003);?>
							  </select>
							  </td>
							  <td>
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvwh_lv0054->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvwh_lv0054->LV_LinkField('lv005',$lvwh_lv0054->lv005);?>
							  </select>
							  </td>
							  <td>
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvwh_lv0054->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvwh_lv0054->LV_LinkField('lv007',$lvwh_lv0054->lv007);?>
							  </select>
							  </td>
							  <td>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv008" id="txtlv008"  style="width:80%"  tabindex="12"  value="<?php echo (float)$lvwh_lv0054->lv008;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvwh_lv0054->LV_LinkField('lv009',$lvwh_lv0054->lv009);?>
							  </select>
							  </td><td>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvwh_lv0054->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							 <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[25];?></td>
							  <td  height="20"><input name="txtlv011" id="txtlv011"   tabindex="15"  style="width:100%" onkeypress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0054->FormatView($lvwh_lv0054->lv011,2);?>"/></td></tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[26];?></td>
							  <td  height="20"><input type="text" name="txtlv012" id="txtlv012"   tabindex="16"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0054->lv012;?>" /> </td>
						    </tr>
							<!--<tr>
							  ...
							  <?php echo $lvwh_lv0054->LV_LinkField('lv013',$lvwh_lv0054->lv013);?>
				  ...
				  <td  height="20"><input  name="txtlv014" type="text" id="txtlv014" value="<?php echo $lvwh_lv0054->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
						   <tr>
							  <td  height="20"><?php echo $vLangArr[29];?></td>
				  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvwh_lv0054->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
						<tr>
