...
$lvwh_lv0010->lv003=$_POST['txtlv003'];
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0010->lv001=="")?InsertWithCheckExt('wh_lv0010', 'lv001', '',10):$lvwh_lv0010->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
...
<tr>
								...
								<?php echo $lvwh_lv0010->LV_LinkField('lv003',$lvwh_lv0010->lv003);?>
						  ...
						  <br></td></tr>
							...
							<tr>
							  ...
							  <td  height="20"><textarea name="txtlv008" rows="20" id="txtlv008" style="width:80%" tabindex="13" ><?php echo $lvwh_lv0010->lv007;?></textarea></td>
						    </tr>		
						<tr>
