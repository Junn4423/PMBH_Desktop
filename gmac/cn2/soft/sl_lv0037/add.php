...
$lvsl_lv0037->lv001=$_POST['txtlv001'];
...
$lvsl_lv0037->lv005=GetServerDate().' '.GetServerTime();
if($vFlag==1)
{
		
		$vresult=$lvsl_lv0037->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0037->lv001=="")?InsertWithCheck('sl_lv0037', 'lv001', '',1):$lvsl_lv0037->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							  <tr>
