...
if ($sExport == "excel") {
   ...
   header('Content-Disposition: attachment; filename=bc_doanhthu_'.str_replace("/","",formatdate($strNow,$plang)).'.xls');
}
if ($sExport == "word") {
    header('Content-Type: application/vnd.ms-word; charset=utf-8');
    header('Content-Disposition: attachment; filename=bc_doanhthu_'.str_replace("/","",formatdate($strNow,$plang)).'.doc');
}
if($sExport=="pdf"){
...
/////////Varian////////////////		
$mosl_lv0070->LV_Load();
$mosl_lv0061->obj_conf=$mosl_lv0070;
			...
			<td align="center" colspan="6">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
				  <tr>
					...
					<tr>
					<td align="center">
					<font style="font-size:14px;font-weight:bold"><?php echo $mosl_lv0061->GetCompany();?></font>
					<br/>
					<div>
					Địa chỉ:<?php echo $mosl_lv0061->GetAddress();?>
					<div style="border-top:1px #000 solid;width:84%;height:20px;margin-top:5px;"></div>
					</div>
					</td>
				  </tr>
				    <tr>
                 <td align="center"><font style="font-size:25px;font-weight:bold"><?php echo $vLangArr[0];?></font></td>
              </tr>
              <tr>
                <td align="center">
...
?>			
		...
		<tr>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
$mosl_lv0061->mosl_lv0007=$mosl_lv0007;
				switch($vOptRun)
				{	
					case 5:
						
						echo $strDataShow = $mosl_lv0061->PrintInOutPutInStockSumGroup($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv022,$vlv015);
						break;
					case 4:
						echo $strDataShow = $mosl_lv0061->PrintInOutPutInStockEmp($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv022,$vlv015);
						break;
					case 3:
						echo $strDataShow = $mosl_lv0061->PrintInOutPutInStockCustomer($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vPoint,$vlv022,$vlv015);
						break;
					case 2:
						echo $strDataShow = $mosl_lv0061->PrintInOutPutInStockSum($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv022,$vlv015);
						break;
					case 1:
						echo $strDataShow = $mosl_lv0061->PrintInOutPutInStock($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv022,$vlv015);
						break;
					default:
						echo $strDataShow = $mosl_lv0061->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv022,$vlv015);
						break;
				}
				?></td>
		</tr>
