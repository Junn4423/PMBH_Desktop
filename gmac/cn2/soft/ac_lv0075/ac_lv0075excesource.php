...
require_once("../../clsall/ac_lv0075.php");
...
$vDate=GetServerDate();
///////////Init object ///////////////////////////////
if($vlPOID!="" && $vlPOID!=NULL)
{
$mowh_lv0003->LV_LoadID($vSupID);
$moac_lv0075=new ac_lv0075($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ac0045');
$vReturn=$moac_lv0075->LV_InsertPO($vlPOID,$_SESSION['ERPSOFV2RUserID'],$vlv005,$vlv006,$vlv011,$vlv012);
///Save object
$moac_lv0004=new ac_lv0004($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ac0004');
$moac_lv0004->LV_LoadID($vlPOID);
...
div14.value='<?php echo str_replace("'","",$moac_lv0004->FormatView($moac_lv0004->lv014,2));?>';
div18 = document.getElementById('txtlv818');
div18.value='<?php echo str_replace("'","",$moac_lv0004->lv018);?>';	
<?php
	if($mowh_lv0003->lv001==NULL || $mowh_lv0003->lv001=='')
	{
		$mowh_lv0003->LV_LoadID($moac_lv0004->lv004);
	}
}
?>
div4 = document.getElementById('txtlv804');
div4.value='<?php echo str_replace("'","",$mowh_lv0003->lv001);?>';
