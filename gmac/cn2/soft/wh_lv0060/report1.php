...
/////////Varian////////////////		
$mosl_lv0070->LV_Load();
$mowh_lv0060->obj_conf=$mosl_lv0070;
			...
			<td align="center" colspan="6">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
				  <tr>
					...
					<tr>
					<td align="center">
					<font style="font-size:14px;font-weight:bold"><?php echo $mosl_lv0001->GetCompany();?></font>
					<br/>
					<div>
					Địa chỉ:<?php echo $mosl_lv0001->GetAddress();?>
					<div style="border-top:1px #000 solid;width:84%;height:20px;margin-top:5px;"></div>
					</div>
					</td>
				  </tr>
				    <tr>
                 <td align="center"><font style="font-size:25px;font-weight:bold"><?php echo 'BÁO CÁO CÔNG NỢ KHÁCH HÀNG';?></font></td>
              </tr>
              <tr>
                <td align="center">
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				...
				{	
					case 5:
						...
						echo $strDataShow = $mowh_lv0060->PrintInOutPutInStockInvoiceSum($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv022);
						break;
					case 3:
						echo $strDataShow = $mowh_lv0060->PrintInOutPutInStockCustomer($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vPoint,$vlv022);
						break;
					default:
						echo $strDataShow = $mowh_lv0060->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005_opt,$vlv013,$vlv013_opt,$vlv006,$vlv009,$vlv016,$vlv008,$vCateOpt,$vtax,$vlv022);
						break;
				}
				?></td>
		</tr>
