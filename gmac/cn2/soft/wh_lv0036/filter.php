		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f1f1f1">
			...
			<tr>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $vlv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/><br>
							  <table><tr><td>
				  ...
				  <td  height="20px"><input type="text" value=" <?php echo $vlv003;?>"  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							...
							<tr>
							  ...
							  <td  height="20px"> <input name="txtlv005" type="text" tabindex="9" value="<?php echo $vlv005;?>" style="width:80%" />
						 </td>
							</tr>	
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $vlv007;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"><br>
							  <table><tr><td>
							  <ul id="pop-nav2" lang="pop-nav2" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:200px" onKeyUp="LoadPopup(this,'txtlv007','*@*@*.hr_lv0020','concat(lv004,lv003,lv002)')" onFocus="LoadPopup(this,'txtlv007','*@*@*.hr_lv0020','concat(lv002,lv003,lv004)')" tabindex="200" >
							  ...
							  <td  height="20px"><textarea name="txtlv008" cols="50" rows="4" id="txtlv008" style="width:80%" tabindex="11" ><?php echo $vlv008;?></textarea></td>
							  </tr>																		
							<tr>
