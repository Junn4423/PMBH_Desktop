...
require_once("../paras.php");
require_once("../../clsall/wh_menusl0012.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0041.txt",$plang);
//init object
$wh_menusl0012=new wh_menusl0012();
//Set variant
$wh_menusl0012->itemlst=$pitemlst;
$wh_menusl0012->childlst=$pchildlst;
$wh_menusl0012->level3lst=$plevel3lst;
$wh_menusl0012->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($wh_menusl0012->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$wh_menusl0012->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<!--<option value="3" <?php echo ((int)$wh_menusl0012->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>-->
	...
	<?php
	$wh_menusl0012->Dir="../";
include($wh_menusl0012->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $wh_menusl0012->level3lst;?>";
