...
if(isset($_GET['ajaxitemsend']))
{
	...
	if($vContractID!="" && $vContractID!=NULL)
	{
		...
		if($vDetailID!='' && $vDetailID!=NULL)
			...
			$vsql="insert into sl_lv0014(lv002,lv003,lv004,lv005,lv006,lv007,lv008) select '$vContractID','$vItemID',1,A.lv004,A.lv007,A.lv008,0 from all_gmacv3_0.sl_lv0007 A where lv001='$vItemID'";
