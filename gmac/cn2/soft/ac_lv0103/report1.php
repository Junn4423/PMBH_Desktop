...
require_once("../../clsall/ac_lv0114.php");
////Init object//////////////
$moac_lv0103 = new ac_lv0103($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ac0103');	
$moac_lv0114 = new ac_lv0114($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ac0114');
/////////Varian////////////////		
...
$moac_lv0114->LV_LoadActiveID();
$strNow=GetServerDate();
	if($plang=="" || $plang!="EN") $plang="VN";
		$vLangArr = GetLangFile("../../","AC0064.txt",$plang);
		$moac_lv0103->lang=strtoupper($plang);
$moac_lv0103->lvobj=$moac_lv0114;
...
function ViewInfos(vValue,vType){
	...
	//o.txtFlag.value = "5";
	o.action="<?php echo $vDir;?>ac_lv0103/ac_lv0103outstock.php?lang=<?php echo $plang;?>";
	}
	else
	{
	...
	//o.txtFlag.value = "5";
	o.action="<?php echo $vDir;?>ac_lv0103/ac_lv0103receiption.php?lang=<?php echo $plang;?>";
		...
		<tr>
			<td align="center" colspan="6">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<td align="center">
							<font style="font-size:14px;font-weight:bold"><?php echo $moac_lv0103->GetCompany();?></font>
							<br/>
							<div>
							Địa chỉ:<?php echo $moac_lv0103->GetAddress();?>
				...
				if(($vlv005!="" && $vlv005!=NULL))
				{
					if(strpos($vlv005,'111')===false )
					{
					...
					else
						{
							...
							echo $vLangArr[36].'   <br/><font style="font-size:14px">TK:'.$vlv005."</font>";
						else
							echo $vLangArr[35].' '.$vlv005.(($vlv005!=""&& $vlv006!="")?" & ".$vlv006:$vlv006);
					}
				}
    ...
    <td><?php echo $vlv003;?></td>
		...
		<tr>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
							$strDataShow = $moac_lv0103->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv005,$moac_lv0114);
