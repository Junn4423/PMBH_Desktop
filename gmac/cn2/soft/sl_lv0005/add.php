...
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0011.txt",$plang);
	
$curPage=(int)$_POST['curPg'];
$vFlag=(int)$_POST['txtFlag'];
$lvsl_lv0005->lv001=$_POST['txtlv001'];
$lvsl_lv0005->lv002=$_POST['txtlv002'];
$lvsl_lv0005->lv003=$_POST['txtlv003'];
if($vFlag==1)
{
		
		$vresult=$lvsl_lv0005->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0005->lv001=="")?InsertWithCheckExt('sl_lv0005', 'lv001', 'UN',3):$lvsl_lv0005->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input  name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvsl_lv0005->lv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
							  <td  height="20px"><input type="text" name="txtlv003" id="txtlv003" tabindex="7" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvsl_lv0005->lv003;?>"/>
							  </td>
							</tr>
							<tr>
