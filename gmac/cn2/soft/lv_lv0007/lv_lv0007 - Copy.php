...
if($flagID==1)
{
	...
	$strar="'".$strar."'";
	$sql="DELETE from all_gmacv3_0.lv_lv0007 WHERE lv_lv0007.lv001 IN (".$strar.") and (select count(*) from all_gmacv3_0.lv_lv0008 B where B.lv002=lv_lv0007.lv001)<=0 ";
	db_query($sql);
...
$vsql=$psql;
$tsql="SELECT count(*) as nums from all_gmacv3_0.lv_lv0007 WHERE 1=1 ".$psqlfix.$vsql;
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="?<?php echo $psaveget;?>" name="frmchoose" method="post">
						...
						if($totalRows>0)
						 {
								$vorder=$curRow;
								$tsql="SELECT lv001 ID, lv002 UserGroupID, lv003 UserRight,lv004 UserName,lv006 EmployeeID,lv099 themes from all_gmacv3_0.lv_lv0007 WHERE 1=1 ".$psqlfix.$vsql." limit $curRow,$maxRows";
