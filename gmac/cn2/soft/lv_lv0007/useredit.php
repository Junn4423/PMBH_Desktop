...
if($plang=="")  $plang="EN";
$vLangArr=GetLangFile("../","AD0043.txt",$plang);
...
if($vFlag==1)
{
	...
	$vsql="update all_gmacv3_0.lv_lv0007 SET lv004='$vUserName',lv002='$vUserGroupID',lv003='$vUserRight',lv006='$vEmployeeID',lv099='$vThemes' where lv001='$vUserID'";
...
$vsql="select * from all_gmacv3_0.lv_lv0007 Where lv001='$vUserID'";
$vresult=db_query($vsql);
...
<div id="content_child">
  ...
  <TR>
    <TD class=menudottedline width="20%">
      <DIV class=pathway><A 
      href="http://www.sof.vn"><STRONG></STRONG></A></DIV></TD>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
						...
						<table width="100%" border="0" align="center" class="table1" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td width="*"  height="20px">
									...
									<input name="txtlv001_" type="text" id="txtlv001_"  value="<?php echo $lvac_lv0018->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>			
							</tr>
							  <tr>
								<td height="20px"><?php echo $vLangArr[7];?></td>
								<td><input name="txtUserName" type="text" id="txtUserName" width="144px"></td>
							</tr>
								  <tr>
				...
				//Get list of department
					...
					$vresult=db_query($vsql);
					while ($vrow2 = db_fetch_array ($vresult))
					{
				
				?>
							  <option value="<?php echo $vrow2['lv001'];?>" ><?php echo $vrow2['lv003'];?></option>
							  <?php 
							  $vsql1="select * from hr_lv0002 where lv002='".$vrow2['lv001']."'";	
				...
				?>
							  <option value="<?php echo $vrow1['lv001'];?>" ><?php echo $vrow1['lv002'];?></option>
							  <?php 
					}
					?>
									</select>
						...
						<td><input type="text" name="txtEmployeeID" id="txtEmployeeID" readonly="true" style="background-color:#DFDFDF; font-weight:bold"/><br><table><tr><td></td><td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:200px" onKeyUp="LoadPopupParent(this,'txtEmployeeID','*@*@*.hr_lv0020','concat(lv004,@! @!,lv003,@! @!,lv002)')" onFocus="LoadPopupParent(this,'txtEmployeeID','*@*@*.hr_lv0020','concat(lv004,@! @!,lv003,@! @!,lv002)')" tabindex="200" >
					 ...
					 <script language="javascript">
						var o =document.frmEmployee;
						o.txtlv001.value="<?php echo $vrow['lv001'];?>";
						o.txtUserName.value="<?php echo $vrow['lv004'];?>";
						o.cboRight.value="<?php echo $vrow['lv003'];?>";	
						o.txtEmployeeID.value="<?php echo $vrow['lv006'];?>";
					  </script>
					  <?php
					  }
					  else
					  {
						  echo "This group is not exist !";
						  echo "<br><input name=\"cmdReturn\" type=\"button\" id=\"cmdReturn\" value=\"Back\"  onclick=\"javascript:history.back();\"/>";
					  }
					  ?>
					  <input type="hidden" name="txtSQL" id="txtSQL" value="<?php echo $psql;?>" />
					  <input type="hidden" name="curPg" id="curPg" value="<?php echo $curPage;?>">												                      </form>
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				</td></tr></table>
