...
$vStrMessage="";
////////////////////////////////////////////Get Employee Data////////////////////////////////////////////
$strSQL = "SELECT lv001, lv002 from all_gmacv3_0.lv_lv0007 WHERE lv001='$vlv001'";
...
if($vFlagID==1)
{
	$strSQL2 = "update all_gmacv3_0.lv_lv0007 SET lv005='".md5($vNewPwd)."' WHERE (lv001='$vlv001')";
