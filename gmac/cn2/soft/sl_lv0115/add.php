...
$lvsl_lv0115->lv001=InsertWithCheckExt('sl_lv0115', 'lv001', '',0);
$lvsl_lv0115->lv002=$_GET['ID'];
$lvsl_lv0115->lv003=$_POST['txtlv003'];
$lvsl_lv0115->lv004=$_POST['txtlv004'];
$lvsl_lv0115->lv005=$_POST['txtlv005'];
$lvsl_lv0115->lv006=$_POST['txtlv005'];
$lvsl_lv0115->lv007=GetServerDate().' '.GetServerTime();
