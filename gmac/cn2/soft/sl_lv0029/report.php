...
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0044.txt",$plang);
...
?>
				...
				<?php echo $mosl_lv0029->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
