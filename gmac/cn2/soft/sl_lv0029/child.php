...
require_once("../paras.php");
require_once("../../clsall/lv_menusl0029.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0046.txt",$plang);
//init object
$molv_menusl0029=new lv_menusl0029();
//Set variant
$molv_menusl0029->itemlst=$pitemlst;
$molv_menusl0029->childlst=$pchildlst;
$molv_menusl0029->level3lst=$plevel3lst;
$molv_menusl0029->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($molv_menusl0029->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[10];?></option>
					</select>
	...
	<?php
	$molv_menusl0029->Dir="../";
include($molv_menusl0029->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $molv_menusl0029->level3lst;?>";
