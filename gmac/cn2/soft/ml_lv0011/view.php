				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form name="frm_mail" action="#" method="post" enctype="multipart/form-data" autocomplete="off">
					  <table width="680" border="0" align="left" id="table1">							  
							...
							<tr>
							  <td  height="20" colspan="2"><input name="txtFlag" type="hidden" id="txtFlag" /><input name="txtFlagFw" type="hidden" id="txtFlagFw"  value="<?php echo $_POST['txtFlagFw'];?>"/><input type="hidden" name="txtmail_lv010" id="txtmail_lv010" value='<?php echo $lvml_lv0011->lv010;?>'/>
