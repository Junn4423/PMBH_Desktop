...
/////////Get ID///////////////
//$lvml_lv0011->lv001=(float)($_GET['ID']);
$lvml_lv0009->LV_LoadSMTP();
$lvml_lv0011->Domain=$lvml_lv0009->lv010;
...
$lvml_lv0011->lv003=$_SESSION['ERPSOFV2RUserID'];
$lvml_lv0011->lv004=$_POST['txtmail_lv004'];
$lvml_lv0011->lv005=$_POST['txtmail_lv005'];
$lvml_lv0011->lv006=$_POST['txtmail_lv006'];
$lvml_lv0011->lv007=$_POST['txtmail_lv007'];
$lvml_lv0011->lv008=$_POST['txtmail_lv008'];
$lvml_lv0011->lv009=$_POST['txtmail_lv009'];
$lvml_lv0011->lv010=$_POST['txtmail_lv010'];
$lvml_lv0011->lv011=$_POST['txtmail_lv011'];
$lvml_lv0011->lv012=$_POST['txtmail_lv012'];
$lvml_lv0011->lv013=$_POST['txtmail_lv013'];
if($vFlag==1)
{
		$lvml_lv0011->lv004=GetServerDate();
		$lvml_lv0011->lv014=GetServerTime();
		$lvml_lv0011->lv002=2;
		$lvml_lv0011->lv011=1;
		$lvml_lv0011->lv012=0;
		$lvml_lv0008->LV_LoadUser($lvml_lv0011->lv003,$lvml_lv0011->lv006);
		$lvml_lv0007->LV_LoadUser($lvml_lv0011->lv003,$lvml_lv0011->lv006);
		if(strpos($lvml_lv0011->lv009,$lvml_lv0007->lv004)===false)
			 $lvml_lv0011->lv009=$lvml_lv0011->lv009.$lvml_lv0007->lv004;
		if($lvml_lv0008->lv006==1)
		{
			$vstrTo=SplitTo(str_replace(";",",",str_replace(" ","",$lvml_lv0011->lv007)),"<",">",",");
			$vstrToSend=$lvml_lv0011->SplitToEsc($vstrTo,",",0);
			$vstrCC=SplitTo(str_replace(";",",",str_replace(" ","",$lvml_lv0011->lv008)),"<",">",",");
			$vstrCCSend=$lvml_lv0011->SplitToEsc($vstrCC,",",0);
			...
			while($vrow = db_fetch_array ($vResult))
			{
				...
				$lvml_lv0011->AttachFile($lvml_lv0011->SaveAndGetFile("../../images/human/File/MailTemp/".$vrow['lv002']."_".$vrow['lv001']."/".$vrow['lv005'],"../../SendFile/",$lvml_lv0011->lv003,str_replace(" ","_",trim($vrow['lv005'])),str_replace(" ","_",trim($vrow['lv005']))),$vrow['lv005']);
			}
			if($lvml_lv0011->lv001==0)
			{
			
				$lvml_lv0011->lv001=InsertWithCheck('ml_lv0011', 'lv001', '',0);
				$vresult=$lvml_lv0011->LV_Insert();
			}
			else
			...
			if($vresult==true) {
				if($lvml_lv0008->lv005==1)
				{
					if(trim($vstrToSend)!="" || trim($vstrCCSend)!="")				{
						...
						$lvml_lv0100->To(explode(",",$vstrToSend));
						$lvml_lv0100->From($lvml_lv0011->lv006);
						$lvml_lv0100->Subject($lvml_lv0011->lv005);
						...
						$lvml_lv0100->Body($lvml_lv0011->lv009,'');
						if($lvml_lv0100->Send())
						{
							$lvml_lv0011->SendLocal($lvml_lv0011->SplitToEsc($lvml_lv0011->lv007,",",1),$lvml_lv0011->SplitToEsc($lvml_lv0011->lv008,",",1),1,1,0);
						$lvml_lv0011->LV_UpdateDel();
...
$lvml_lv0011->lv002=$_SESSION['ERPSOFV2RUserID'];
if($vFlagFw==0)
{
$lvml_lv0010->Dir="../";
$lvml_lv0010->lv002=$_SESSION['ERPSOFV2RUserID'];
$lvml_lv0010->LV_DeleteUser($_SESSION['ERPSOFV2RUserID']);
if($lvml_lv0011->lv010!=NULL || $lvml_lv0011->lv010!="") $lvml_lv0010->LV_GetForward($lvml_lv0011->lv010,$lvml_lv0011->lv013);
}
if($lvml_lv0011->lv001!=0) 
{
...
<div id="content_child">
  <div class="story">
    <h3>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form name="frm_mail" action="#" method="post" enctype="multipart/form-data" autocomplete="off">
					  <table width="680" border="0" align="left" id="table1">							  
							

							<tr>
							  <td width="166"  height="20"><?php echo $vLangArr[20];?>
						      <input name="hidden" type="hidden" style="width:90%" value="<?php echo $lvml_lv0011->lv001;?>"/></td>
							  ...
							  <?php echo $lvml_lv0011->LV_LinkField('lv030',$lvml_lv0011->lv006);?>
							  </select>	</td>
						    </tr>		
							<tr>
							  <td  height="20"><?php echo $vLangArr[21];?></td>
							  <td  height="20"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td>
							  <ul style="margin: 0;padding: 0;list-style: none;" id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT"><input name="txtmail_lv007" id="txtmail_lv007" type="text" style="width:400px" value='<?php echo $lvml_lv0011->lv007;?>' tabindex="13" onKeyUp="LoadSelfNext(this,'txtmail_lv007','ml_lv0006','lv003','lv004')" onFocus="LoadSelfNext(this,'txtmail_lv007','ml_lv0006','lv003','lv004')" /><div id="lv_popup" lang="lv_popup1"> </div>						  
						</li>
					</ul></td></tr></table></td>
						    </tr>							
							<tr>
							  ...
							  <td  height="20"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td>
							  <ul id="pop-nav2" lang="pop-nav2" onMouseOver="ChangeName(this,1)" style="margin: 0;padding: 0;list-style: none;"> <li class="menupopT" ><input name="txtmail_lv008" id="txtmail_lv008" type="text" style="width:400px" value='<?php echo $lvml_lv0011->lv008;?>' tabindex="14" onKeyUp="LoadSelfNext(this,'txtmail_lv008','ml_lv0006','lv003','lv004')" onFocus="LoadSelfNext(this,'txtmail_lv008','ml_lv0006','lv003','lv004')" /><div id="lv_popup2" lang="lv_popup2"> </div>						  
						</li>
					</ul></td></tr></table></td>
						    </tr>	
							<tr>
							  <td  height="20"><?php echo $vLangArr[19];?></td>
							  <td  height="20"><input name="txtmail_lv005" id="txtmail_lv005" type="text" style="width:400px" value="<?php echo $lvml_lv0011->lv005;?>" tabindex="15"/></td>
						    </tr>
							<tr>
							...
							<tr>
							  <td  height="20" colspan="2"><textarea name="txtmail_lv009" id="txtmail_lv009" rows="15" style="width:100%" tabindex="16"><?php echo $lvml_lv0011->lv009;?></textarea></td>
					    </tr>
							<tr>
							  <td  height="20"><a href="javascript:Atachfile()" target="_self"><?php echo $vLangArr[24];?></a></td>
							  <td  height="20"><?php echo $lvml_lv0010->LV_LoadUserID($_SESSION['ERPSOFV2RUserID']);?></td>
					    </tr>
							<tr>
							  <td  height="20" colspan="2"><input name="txtFlag" type="hidden" id="txtFlag" /><input name="txtFlagFw" type="hidden" id="txtFlagFw" value="1" /><input type="hidden" name="txtmail_lv010" id="txtmail_lv010" value='<?php echo $lvml_lv0011->lv010;?>'/>
						<input type="hidden" name="txtmail_lv013" id="txtmail_lv013" value='<?php echo $lvml_lv0011->lv013;?>'/></td>
						  </tr>
					<tr>
