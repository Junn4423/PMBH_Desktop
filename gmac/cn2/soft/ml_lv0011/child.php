...
require_once("../paras.php");
require_once("../../clsall/ml_menusl0011.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","ML0017.txt",$plang);
//init object
$ml_menusl0011=new ml_menusl0011();
//Set variant
$ml_menusl0011->itemlst=$pitemlst;
$ml_menusl0011->childlst=$pchildlst;
$ml_menusl0011->level3lst=$plevel3lst;
$ml_menusl0011->child3lst=$pchild3lst;
...
document.frmhr_employee.cbxoption.value=vOpt;
o.target="_self";
	switch(vOpt) {
		case 1:
		...
		case 3:
			...
			break;
		case 4:
			o.action="?func=<?php echo $_GET['func'];?>"+"&ID=<?php echo $_GET['ID']?>&ChildID=<?php echo $_GET['ChildID']?>"+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,4,0)?>";	
			break;
		case 5:
			o.action="?func=<?php echo $_GET['func'];?>"+"&ID=<?php echo $_GET['ID']?>&ChildID=<?php echo $_GET['ChildID']?>"+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,5,0)?>";	
			break;		
	}
	o.submit();
}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<TBODY>
						<TR vAlign="center" align="middle">				
							<TD><a class="toolbar" href="javascript:rundisplayLayer(1);">
								<img src="../images/controlright/viewmail.gif" title="<?php echo $vLangArr[100];?>" 
							...
							<TD><a class="toolbar" href="javascript:rundisplayLayer(2);">
								<img src="../images/controlright/createemail.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[9];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD><a class="toolbar" href="javascript:rundisplayLayer(3);">
								<img src="../images/controlright/attach.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[10];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD><a class="toolbar" href="javascript:rundisplayLayer(4);">
								<img src="../images/controlright/createemailhtml.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[11];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD><a class="toolbar" href="javascript:rundisplayLayer(5);">
								<img src="../images/controlright/forward.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($ml_menusl0011->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$ml_menusl0011->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$ml_menusl0011->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
						<option value="4" <?php echo ((int)$ml_menusl0011->level3lst==4)?'selected="selected"':'';?>>4.<?php echo $vLangArr[11];?></option>
						<option value="5" <?php echo ((int)$ml_menusl0011->level3lst==5)?'selected="selected"':'';?>>5.<?php echo $vLangArr[12];?></option>
	...
	<?php
	$ml_menusl0011->Dir="../";
include($ml_menusl0011->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $ml_menusl0011->level3lst;?>";
