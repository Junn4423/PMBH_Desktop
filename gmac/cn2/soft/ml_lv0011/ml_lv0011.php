...
/////////////init object//////////////
$moml_lv0001=new ml_lv0011($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ml0011');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../","ML0023.txt",$plang);
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$vStrMessage=GetNoDelete($strar,"ml_lv0011",$lvMessage);
}
else
{
	$moml_lv0001->lv001=$_POST['txtlv001'];
	$moml_lv0001->lv002=$_POST['txtlv002'];
	$moml_lv0001->lv003=$_POST['txtlv003'];
	$moml_lv0001->lv004=$_POST['txtlv004'];
	$moml_lv0001->lv005=$_POST['txtlv005'];
	$moml_lv0001->lv006=$_POST['txtlv006'];
	$moml_lv0001->lv007=$_POST['txtlv007'];
	$moml_lv0001->lv008=$_POST['txtlv008'];
	$moml_lv0001->lv009=$_POST['txtlv009'];
	$moml_lv0001->lv010=$_POST['txtlv010'];
	$moml_lv0001->lv011=$_POST['txtlv011'];
	$moml_lv0001->lv012=$_POST['txtlv012'];
	$moml_lv0001->lv013=$_POST['txtlv013'];
	$moml_lv0001->lv014=$_POST['txtlv014'];
}
//first is load
if($_POST["txtFlag"]=="")
{
	//////////////////////////////////////////////////////////////////////////////////////////////////////
$moml_lv0001->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'ml_lv0011');
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
$moml_lv0001->SaveOperation($_SESSION['ERPSOFV2RUserID'],'ml_lv0011',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
{
	var str="<br><iframe id='lvframefrm' height=750 marginheight=0 marginwidth=0 frameborder=0 src=ml_lv0011?func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onsubmit="return false;" action="?<?php echo $psaveget;?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						...
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $moml_lv0001->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $moml_lv0001->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $moml_lv0001->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $moml_lv0001->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $moml_lv0001->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $moml_lv0001->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $moml_lv0001->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $moml_lv0001->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $moml_lv0001->lv009;?>"/>
						<input type="hidden" name="txtlv010" id="txtlv010" value="<?php echo $moml_lv0001->lv010;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $moml_lv0001->lv011;?>"/>
						<input type="hidden" name="txtlv012" id="txtlv012" value="<?php echo $moml_lv0001->lv012;?>"/>
						<input type="hidden" name="txtlv013" id="txtlv013" value="<?php echo $moml_lv0001->lv013;?>"/>
						<input type="hidden" name="txtlv014" id="txtlv014" value="<?php echo $moml_lv0001->lv014;?>"/>
