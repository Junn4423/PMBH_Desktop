					 ...
					 <table width="100%" border="0" align="center" id="table1">
							<tr>
                             ...
                             <tr>
							  ...
							  <td width="178"  height="20"><input name="txtlv002" type="hidden" id="txtlv002" value="<?php echo $morp_lv0011->lv002;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $morp_lv0011->GetBuilCheckList($morp_lv0011->lv002,'chklv002',10,'hr_lv0002','lv003');?></td>
						    </tr>	
						  <tr>
							  <td  height="20"><?php echo $vLangArr[3];?></td>
							  <td  height="20"><input name="txtlv003" type="hidden" id="txtlv003" value="<?php echo $morp_lv0011->lv003;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $morp_lv0011->GetBuilCheckList($morp_lv0011->lv003,'chklv003',10,'hr_lv0022');?></td>
					   </tr>	
                      
					   		<tr>
							  <td  height="20"><?php echo $vLangArr[4];?></td>
							  <td  height="20"><input name="txtlv004" type="text" id="txtlv004" value="<?php echo $morp_lv0011->lv004;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)" /><br><table><tr><td>
			          ...
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
					   ...
					   <tr>
					   		...
					   		<td><table align="center" class="lvtable">
		<input type="hidden" value="6" name="chklv005" id="chklv005"><input type="hidden"  name="txtlv020" id="txtlv020">
		<tbody><tr class="lvlinehtable1">
			<td width="1%"><input type="checkbox" tabindex="10" title="" value="5" id="chklv0050" checked="checked"></td><td><?php echo $vLangArr[15];?></td>
			
		</tr>
		<tr class="lvlinehtable1">
			<td width="1%"><input type="checkbox" tabindex="10" title="" value="6" id="chklv0051"></td><td><?php echo $vLangArr[16];?></td>
		</tr>
		<tr class="lvlinehtable1">
			<td width="1%"><input type="checkbox" tabindex="10" title="" value="7" id="chklv0052"></td><td><?php echo $vLangArr[17];?></td>
		</tr>
		<tr class="lvlinehtable1">
			<td width="1%"><input type="checkbox" tabindex="10" title="" value="20" id="chklv0053"></td><td><?php echo $vLangArr[19];?></td>
		</tr>
		<tr class="lvlinehtable1">
			<td width="1%"><input type="checkbox" tabindex="10" title="" value="10" id="chklv0054"></td><td><?php echo $vLangArr[18];?></td>
		</tr>
		<tr class="lvlinehtable1">
			<td width="1%"><input type="checkbox" tabindex="10" title="" value="21" id="chklv0055"></td><td><?php echo $vLangArr[20];?></td>
					   ...
					   <tr>
					   		<td><?php echo $vLangArr[14];?></td><td><select name="txtlv022">
					   			...
					   			<option value="1" selected="selected"><?php echo $vLangArr[22];?></option>
					   		</select></td>
					   </tr>						
							<tr>
