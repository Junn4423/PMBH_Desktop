				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                    ...
                    <input type="hidden" name="lang" value="<?php echo $plang;?>" />
					 <table width="100%" border="0" align="center" id="table1">
							...
							<tr>
				      <td  height="20" width="150"><?php echo $vLangArr[3];?></td>
				      <td  height="20"><input name="txtlv002" type="text" id="txtlv002" value="<?php echo formatdate($mosl_lv0074->lv002,$plang);?>" tabindex="7" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="110"
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $mosl_lv0074->LV_LinkField('lv007',$mosl_lv0074->lv007);?>
							  </select></td>
							  <td>
						  ...
						  <tr>
							  ...
							  <option value="">...</option>
							  <?php echo $mosl_lv0074->LV_LinkField('lv005',$mosl_lv0074->lv005);?>
							  </select></td>
							  <td>
							  <ul id="pop-nav" lang="pop-nav1" onkeyup="ChangeName(this,1)" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
						 ...
						 <tr>
							  ...
							  <table width="80%"><tr><td width="50%">
								<select name="txtlv013" id="txtlv013"   tabindex="11"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
									<option value="">...</option>
									<?php echo $mosl_lv0074->LV_LinkField('lv003',$mosl_lv0074->lv003);?>
								</select>
								</td><td>
						 ...
						 <tr>
							  ...
							  <table width="80%"><tr><td width="50%">
								<select name="txtlv006" id="txtlv006"   tabindex="11"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
									<option value="">...</option>
									<?php echo $mosl_lv0074->LV_LinkField('lv006',$mosl_lv0074->lv006);?>
								</select>
								</td><td>
                             ...
                             <tr>
							  ...
							  <td  height="20"><input name="txtlv008" type="hidden" id="txtlv008" value="<?php echo $mosl_lv0074->lv008;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mosl_lv0074->GetBuilCheckList($mosl_lv0074->lv008,'chklv008',12);?></td>
						    </tr>	
							<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv011" type="hidden" id="txtlv011" value="<?php echo $mosl_lv0074->lv011;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mosl_lv0074->GetBuilCheckListState($mosl_lv0074->lv011,'chklv011',11);?>
							 </td>
						    </tr>
							<tr>
							  ...
							  <td  height="20">
								<div style="float:left;width:60%" >
									<select name="rad" id="rad"   tabindex="11"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
										...
										<option value="6"><?php echo 'Báo cáo Bảng Kê';?></option>
...
div.innerHTML='<?php echo 'Báo cáo doanh thu theo ngày thanh toán';?>';	
