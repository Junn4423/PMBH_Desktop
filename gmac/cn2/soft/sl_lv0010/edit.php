...
require_once("../../clsall/sl_lv0010.php");
//////////////init object////////////////
$lvsl_lv0010=new sl_lv0010($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0012');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvsl_lv0010->lv001=$_GET['ChildID'];
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0021.txt",$plang);
...
$lvsl_lv0010->lv003=$_POST['txtlv003'];
$lvsl_lv0010->lv004=$_POST['txtlv004'];
$lvsl_lv0010->lv005=$_POST['txtlv005'];
$lvsl_lv0010->lv006=$_POST['txtlv006'];
if($_FILES['userfile']['name']=="")
$lvsl_lv0010->lv007=$_POST['txtlv007'];
else
$lvsl_lv0010->lv007=$_FILES['userfile']['name'];
$lvsl_lv0010->lv008=$_POST['txtlv008'];
$lvsl_lv0010->lv009=$_POST['txtlv009'];
$lvsl_lv0010->lv010=$_POST['txtlv010'];
$lvsl_lv0010->lv011=$_POST['txtlv011'];
$lvsl_lv0010->lv012=$_POST['txtlv012'];
$lvsl_lv0010->lv013=$_POST['txtlv013'];
$lvsl_lv0010->lv014=$_POST['txtlv014'];
$lvsl_lv0010->lv015=$_POST['txtlv015'];
$lvsl_lv0010->lv016=$_POST['txtlv016'];
		
		$vresult=$lvsl_lv0010->LV_Update();
		if($vresult==true) {
...
$lvsl_lv0010->LV_LoadID($lvsl_lv0010->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0010->lv001=="")?InsertWithCheckExt('sl_lv0010', 'lv001', '',10):$lvsl_lv0010->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvsl_lv0010->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/><br>
							  <table><tr><td>
							  <ul id="pop-nav3" lang="pop-nav3" onMouseOver="ChangeName(this,3)" onkeyup="ChangeName(this,3)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch3" id="txtlvsearch3" style="width:200px" onKeyUp="LoadPopup(this,'txtlv002','*@*@*.sl_lv0001','lv002')" onFocus="LoadPopup(this,'txtlv002','*@*@*.sl_lv0001','lv002')" tabindex="200" >
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0010->lv003;?>" type="text"/>	</td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[18];?></td>
				  <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0010->FormatView($lvsl_lv0010->lv004,2);?>"/><span class="td"><img tabindex="8" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
															onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv004);return false;" /></span>
							 </td>
						  </tr>							  
							<tr>
							  <td  height="20"><?php echo $vLangArr[19];?></td>
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvsl_lv0010->FormatView($lvsl_lv0010->lv005,2);?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="9"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvsl_lv0010->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvsl_lv0010->LV_LinkField('lv007',$lvsl_lv0010->lv007);?>
							...
							<tr>
							  ...
							  <?php echo $lvsl_lv0010->LV_LinkField('lv008',$lvsl_lv0010->lv008);?>
							  </select><br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><textarea name="txtlv009" rows="20" id="txtlv009" style="width:80%" tabindex="13"><?php echo $lvsl_lv0010->lv009;?></textarea></td>
						    </tr>
                          <tr>
							  <td  height="20"><?php echo $vLangArr[24];?></td>
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvsl_lv0010->LV_UserID;?>" tabindex="14" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
						  </tr>	
						<tr>
