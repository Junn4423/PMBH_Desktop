...
/////////////init object//////////////
$mowh_lv0014=new  wh_lv0014($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0014');
/////////////init object//////////////
...
$vNow=GetServerDate();
$mowh_lv0014->lv002=getyear($vNow)."-".getmonth($vNow)."-"."01";
$mowh_lv0014->lv003=$vNow;
//$ma=$_GET['ma'];
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form  method="get" name="frmRpt" id="frmRpt" enctype="multipart/form-data">
					 <table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv001" id="txtlv001"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
							   <?php
								...
								?>
								<?php echo $mowh_lv0014->LV_LinkField('lv002',$mowh_lv0014->lv002);?>
                              </select>							    </td>
							</tr><tr>
				      <td  height="20"><?php echo $vLangArr[2];?></td>
				      <td  height="20"><input name="txtlv002" type="text" id="txtlv002" value="<?php echo formatdate($mowh_lv0014->lv002,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				      ...
				      <td  height="20"><input name="txtlv003" type="text" id="txtlv003" value="<?php echo formatdate($mowh_lv0014->lv003,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				        <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							 ...
							 <tr>
							  ...
							  <option value="3"><?php echo $vLangArr[36];?></option>
							    </select>		<?php echo $vLangArr[40];?><input type="checkbox" value="1" name="txtexist" checked="checked" />					  </td>
					   </tr>										
							<tr>
