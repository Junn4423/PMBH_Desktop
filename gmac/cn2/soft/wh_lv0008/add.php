...
$lvwh_lv0008->lv001=$_POST['txtlv001'];
if($_GET['ID']=="")
$lvwh_lv0008->lv002=$_POST['txtlv002'];
else
$lvwh_lv0008->lv002=$_GET['ID'];
$lvwh_lv0008->lv003=getInfor($_SESSION['ERPSOFV2RUserID'],2);
...
if($lvwh_lv0008->lv009=="") $lvwh_lv0008->lv009=$vNow;
if($vFlag==1)
{
		...
		if($vresult==true) {
			...
			$lvwh_lv0008->lv009=$_POST['txtlv009'];
			$lvwh_lv0008->lv001=InsertWithCheck('wh_lv0008', 'lv001', 'PN-'.getmonth($vNow)."/".getyear($vNow)."-",4);
			$vresult=$lvwh_lv0008->LV_Insert();
			if($vresult==true) {
			$vStrMessage=$vLangArr[9];
			$vFlag = 1;
					...
					<form action="#"   name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0008->lv001=="")?InsertWithCheck('wh_lv0008', 'lv001', 'PN-'.getmonth($vNow)."/".getyear($vNow)."-",4):$lvwh_lv0008->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)"  readonly="true"/>			</td>
						    </tr>
							<tr>
...
<tr>
								...
								<td  height="20"><input type="text" name="txtlv003" id="txtlv003"   tabindex="7" style="width:80%" onkeypress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0008->lv003;?>" readonly="readonly" />
							  				 </td>
					      </tr>
							<tr>
						  ...
						  <br></td></tr>
							...
							<tr>
							  ...
							  <td  height="20"><textarea name="txtlv008" rows="20" id="txtlv008" style="width:80%" tabindex="13" ><?php echo $lvwh_lv0008->lv008;?></textarea></td>
						    </tr>							 			  							  																			
							<tr>
