...
<html>
<head>
<title><?php echo $mosl_lv0013->lv014;?></title>
...
<body  onkeyup="KeyPublicRun(event)">
  ...
  <tr>
    ...
    <tr>
    <td align="center"><h3 onDblClick="this.innerHTML='&nbsp;'"><?php echo "NGÀY : "." ".getday($vNow)."/".getmonth($vNow)."/".getyear($vNow);?></h3></td>
  </tr>
    <tr>
    <td align="right" class="bodyTXT" onDblClick="this.innerHTML='&nbsp;'"><strong>Mã hợp đồng:<?php echo $mosl_lv0013->lv016;?></strong></td>
  </tr>  
  <tr>
