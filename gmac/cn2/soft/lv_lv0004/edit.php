...
require_once("../../clsall/lv_lv0004.php");
//////////////init object////////////////
$lvlv_lv0004=new lv_lv0004($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ad0005');
/////////Get ID///////////////
$lvlv_lv0004->lv001=$_GET['ID'];
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","AD0026.txt",$plang);
...
if($vFlag==1)
{
		$lvlv_lv0004->lv002=$_POST['txtlv002'];		
		$vresult=$lvlv_lv0004->LV_Update();
		if($vresult==true) {
...
$lvlv_lv0004->LV_LoadID($lvlv_lv0004->lv001);
...
function isphone(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvlv_lv0004->lv002;?>";
		o.txtlv003.value="<?php echo $lvlv_lv0004->lv003;?>";
		o.txtlv004.value="<?php echo $lvlv_lv0004->lv004;?>";
		o.txtlv005.value="<?php echo $lvlv_lv0004->lv005;?>";	
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvlv_lv0004->lv001;?>" /></td>
							</tr>
						<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input  name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvlv_lv0004->lv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
