...
require_once("../clsall/sl_lv0073.php");

/////////////init object//////////////
$mosl_lv0073=new  sl_lv0073($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0073');
/////////////init object//////////////
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                    ...
                    <input type="hidden" name="lang" value="<?php echo $plang;?>" />
					 <table width="100%" border="0" align="center" id="table1">
							...
							<tr>
				      <td  height="20" width="150"><?php echo $vLangArr[2];?></td>
				      <td  height="20"><input name="txtlv002" type="text" id="txtlv002" value="<?php echo formatdate($mosl_lv0073->lv002,$plang);?>" tabindex="7" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="110"
							...
							<tr>
							  <td  height="20" valign="top"><?php echo 'Chọn bàn';?></td>
							  <td  height="20"><table width="80%"><tr><td width="50%">
							  <select name="txtlv007" id="txtlv007"   tabindex="9"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
							  <option value="">...</option>
							  <?php echo $mosl_lv0073->LV_LinkField('lv007',$mosl_lv0073->lv007);?>
							  </select></td>
							  <td>
							  <ul id="pop-nav" lang="pop-nav1" onkeyup="ChangeName(this,1)" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv007_search" id="txtlv007_search" style="width:50%" onKeyUp="LoadPopupParent(this,'txtlv007','*@*@*.sl_lv0001','concat(lv002,@!-@!,lv001)')" onFocus="LoadPopupParent(this,'txtlv007','*@*@*.sl_lv0001','concat(lv002,@!-@!,lv001)')"  tabindex="200" ><input type="checkbox" name="txtlv007_opt" id="txtlv007_opt" value="1">Không chọn
						  ...
						  <tr>
							  ...
							  <option value="">...</option>
							  <?php echo $mosl_lv0073->LV_LinkField('lv005',$mosl_lv0073->lv005);?>
							  </select></td>
							  <td>
							  <ul id="pop-nav" lang="pop-nav1" onkeyup="ChangeName(this,1)" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv005_search" id="txtlv005_search" style="width:50%" onKeyUp="LoadPopupParent(this,'txtlv005','*@*@*.sl_lv0001','concat(lv002,@!-@!,lv001)')" onFocus="LoadPopupParent(this,'txtlv005','*@*@*.sl_lv0001','concat(lv002,@!-@!,lv001)')"  tabindex="200" ><input type="checkbox" name="txtlv005_opt" id="txtlv005_opt" value="1">Không chọn
							    <div id="lv_popup" lang="lv_popup1"> </div>						  
						</li>
					</ul></td></tr></table></td></tr>
						 <tr>
							  ...
							  <table width="80%"><tr><td width="50%">
								<select name="txtlv013" id="txtlv013"   tabindex="11"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
									<option value="">...</option>
									<?php echo $mosl_lv0073->LV_LinkField('lv003',$mosl_lv0073->lv003);?>
								</select>
								</td><td>
						 ...
						 <tr>
							  ...
							  <table width="80%"><tr><td width="50%">
								<select name="txtlv006" id="txtlv006"   tabindex="11"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
									<option value="">...</option>
									<?php echo $mosl_lv0073->LV_LinkField('lv006',$mosl_lv0073->lv006);?>
								</select>
								</td><td>
                             ...
                             <tr>
							  ...
							  <td  height="20"><input name="txtlv008" type="hidden" id="txtlv008" value="<?php echo $mosl_lv0073->lv008;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mosl_lv0073->GetBuilCheckList($mosl_lv0073->lv008,'chklv008',12);?></td>
						    </tr>		
							<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv011" type="hidden" id="txtlv011" value="<?php echo $mosl_lv0073->lv011;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mosl_lv0073->GetBuilCheckListState($mosl_lv0073->lv011,'chklv011',11);?>
							 </td>
						    </tr>
							<tr>
							  <td  height="20" valign="top"><?php  echo 'Báo cáo khai/không khai thuế';?></td>
							  <td  height="20">
								<div style="float:left;width:60%" >
									<select name="tax" id="tax"   tabindex="11"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
										<option value=""><?php echo '...........';?></option>
										<option value="0"><?php echo 'Không khai thuế';?></option>							
										<option value="1"><?php echo 'Khai thuế';?></option>
									</select>
								</div>
								</td>
						    </tr>
							  ...
							  <td  height="20">
								<div style="float:left;width:60%" >
									<select name="rad" id="rad"   tabindex="11"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"/>
										<option value="0"><?php echo 'Báo cáo kiểm tra với giờ ghi bảo vệ';?></option>
										<option value="5"><?php echo $vLangArr[64];?></option>										
...
div.innerHTML='<?php echo 'Báo cáo doanh thu theo ngày đăng ký';?>';	
