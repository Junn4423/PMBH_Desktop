...
$lvhr_lv0008->lv001=InsertWithCheckExt('hr_lv0008', 'lv001', 'LC',4);
$lvhr_lv0008->lv002=$_POST['txtlv002'];
$lvhr_lv0008->lv003=$_POST['txtlv003'];
if($vFlag==1)
{
		
		$vresult=$lvhr_lv0008->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvhr_lv0008->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
