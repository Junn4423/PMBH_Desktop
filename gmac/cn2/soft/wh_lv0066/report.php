...
$mowh_lv0066->ArrPush[17]=$vLangArr[46];
$mowh_lv0066->ArrPush[18]=$vLangArr[47];
$mowh_lv0066->ArrPush[19]=$vLangArr[48];
$mowh_lv0066->ArrPush[20]=$vLangArr[49];
$mowh_lv0066->ArrPush[21]=$vLangArr[41];
$mowh_lv0066->ArrPush[26]=$vLangArr[54];
...
$mowh_lv0066->ArrFunc[6]='';
$mowh_lv0066->ArrFunc[7]='';
$mowh_lv0066->ArrFunc[8]=$vLangArr[10];
$mowh_lv0066->ArrFunc[9]=$vLangArr[12];
$mowh_lv0066->ArrFunc[10]=$vLangArr[0];
$mowh_lv0066->ArrFunc[11]=$vLangArr[33];
$mowh_lv0066->ArrFunc[12]=$vLangArr[34];
$mowh_lv0066->ArrFunc[13]=$vLangArr[35];
$mowh_lv0066->ArrFunc[14]=$vLangArr[36];
$mowh_lv0066->ArrFunc[15]=$vLangArr[37];

////Other
$mowh_lv0066->ArrOther[1]=$vLangArr[31];
$mowh_lv0066->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
<table style="width:100%;max-with:375px;" border="0" cellspacing="0" cellpadding="0" align="center">
	<?php echo ($mowh_lv0066->lv011>0)?"<tr><td><img style='max-width:375px;width:100%;height:50px;' src='../../clsall/barcode/barcode.php?barnumber=".$mosl_lv0013->lv001."'></td></tr>":"<tr><td height=5></td></tr>";?>
   <tr>
    <td align="center" onDblClick="this.innerHTML=''">
	<div style="clear:both;"> 
		<div style="float:left;width:85%;text-align:left;">
		
			<strong><span style="font:18px arial,tahoma"><?php echo $mowh_lv0066->GetCompany();?></span></strong>
			<br><span style="font:12px arial,tahoma"><?php echo 'ĐC: ';?><?php echo $mowh_lv0066->GetAddress();?></span>
			<br><span style="font:12px arial,tahoma"><?php echo 'ĐT: ';?><?php echo $mowh_lv0066->GetPhone();?>  </span>
			<!--<br><span style="font:10px arial,tahoma"><?php echo 'Web';?><?php echo $mowh_lv0066->GetWeb();?>   </span> -->
	</div>
  ...
  <tr>
   ...
   <tr>
	...
	<td>
  <?php
			echo $strDataShow = $mowh_lv0066->PrintInOutPutInStockDetail($plang, $vLangArr,$mowh_lv0066->datefrom,$mowh_lv0066->dateto,$mowh_lv0066->optrpt);
		?>		
                        <td>
    </tr>
    <td>
