...
/////////Get ID///////////////
$lvml_lv0006->lv001=$_GET['ID'];
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","ML0010.txt",$plang);
...
if($vFlag==1)
{
		$lvml_lv0006->lv002=$_POST['txtlv002'];
		$lvml_lv0006->lv003=$_POST['txtlv003'];
		$lvml_lv0006->lv004=$_POST['txtlv004'];
		$lvml_lv0006->lv005=$_POST['txtlv005'];
		$lvml_lv0006->lv006=$_POST['txtlv006'];		
		$vresult=$lvml_lv0006->LV_Update();
		if($vresult==true) {
...
$lvml_lv0006->LV_LoadID($lvml_lv0006->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvml_lv0006->lv002;?>";
		o.txtlv003.value="<?php echo $lvml_lv0006->lv003;?>";
		o.txtlv004.value="<?php echo $lvml_lv0006->lv004;?>";
		o.txtlv005.value="<?php echo $lvml_lv0006->lv005;?>";
		o.txtlv006.value="<?php echo $lvml_lv0006->lv006;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
						...
						?>
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvml_lv0006->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvml_lv0006->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
<tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
				  <td  height="20px"><input  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvml_lv0006->lv003;?>"/></td>
						  </tr>								
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvml_lv0006->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
						  
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><textarea name="txtlv005" style="width:80%" tabindex="9"  id="txtlv005" ><?php echo $lvml_lv0006->lv005;?></textarea></td>
						  </tr>
								<tr>
							  <td  height="20px"><?php echo $vLangArr[20];?></td>
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (int)$lvml_lv0006->lv006;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
								</tr>																			
							<tr>
