...
$lvml_lv0006->lv001=InsertWithCheckExt('ml_lv0006', 'lv001', '',0);
$lvml_lv0006->lv002=$_SESSION['ERPSOFV2RUserID'];
...
if($vFlag==1)
{
		...
		$vresult=$lvml_lv0006->LV_Insert();
		if($vresult==true) {
			UploadImg($lvml_lv0006->lv002."_".$lvml_lv0006->lv001, $lvml_lv0006->lv006);
					...
					<form action="#" method="post" enctype="multipart/form-data"   name="frmadd" id="frmadd" >
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvml_lv0006->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/><br><table><tr><td>
