...
$moac_lv0018->LV_LoadID($vlv001);
$mohr_lv0001->LV_LoadID($moac_lv0018->lv022);
$vArrMN=$moac_lv0018->LV_GetMN($vlv001,$moac_lv0018->lv010);
?>
<HTML>
<head>
...
<TR VALIGN=TOP>
<TD NOWRAP COLSPAN=44 align="right"><?php echo ($moac_lv0018->lv016>0)?"<img src='../../clsall/barcode/barcode.php?barnumber=".$moac_lv0018->lv001."'>":"";?></TD>
</TR>
<!--<TR VALIGN=TOP>
<TD COLSPAN=44 HEIGHT=13  onDblClick="this.innerHTML=''"><img  src="<?php echo $moac_lv0018->GetLogo();?>" /></TD>
</TR>-->
<TR VALIGN=TOP>
...
<TR VALIGN=TOP>
<TD COLSPAN=14></TD>
<TD NOWRAP COLSPAN=10 ROWSPAN=2><FONT SIZE=3 FACE=".VnTime">Ngày:</FONT><?php echo $moac_lv0018->FormatView($moac_lv0018->lv009,2);?></TD>
<TD COLSPAN=19>Số:<?php echo $moac_lv0018->lv001;?></TD>
</TR>
<TR VALIGN=TOP>
<TD COLSPAN=14></TD>
<TD COLSPAN=26></TD>
...
<TR VALIGN=TOP>
  ...
  $vArrView=split(",",$vArrMN[3]);  
  if(count($vArrView)==1 && count(split(",",$vArrMN[2]))==1)
	  echo $vArrMN[2];
  else
  {
	  echo $vArrMN[2].":";?> <?php echo $moac_lv0018->FormatView($vArrMN[4],10);?>
    <?php
  }
  ?></TD>
</TR>
  ...
  <TD NOWRAP COLSPAN=18>Ghi có:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php 
	if(count($vArrView)==1 && count(split(",",$vArrMN[2]))==1)
	...
	else
		{
			...
			{
				if($i==0)
					echo $vArrView[$i].": ".$moac_lv0018->LV_GetAccountAmount($vlv001,$moac_lv0018->lv010,$vArrView[$i]);
				else
				{
				echo '<br>';
				echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$vArrView[$i].": ".$moac_lv0018->LV_GetAccountAmount($vlv001,$moac_lv0018->lv010,$vArrView[$i]);
...
<TR VALIGN=TOP>
  <TD COLSPAN=6 style="white-space:nowrap">Họ và tên người nộp : </TD>
  <TD COLSPAN=38><?php echo $moac_lv0018->lv005;?></TD>
  </TR>
<TR VALIGN=TOP>
  <TD COLSPAN=6>Địa chỉ : </TD>
  <TD COLSPAN=38><?php echo $moac_lv0018->lv006;?></TD>
  </TR>
<TR VALIGN=TOP>
  <TD COLSPAN=6>Lý do : </TD>
  <TD COLSPAN=38><?php echo $moac_lv0018->lv007;?></TD>
  </TR>
<TR VALIGN=TOP>
  <TD  COLSPAN=6>Số tiền :</TD>
  <TD COLSPAN=38><?php echo $moac_lv0018->FormatView($vArrMN[4],10);?></TD>
  </TR>
<TR VALIGN=TOP>
...
<TR VALIGN=TOP>
  ...
  <TD COLSPAN=11><?php echo $moac_lv0018->lv013;?></TD>
  <TD NOWRAP COLSPAN=27>Chứng từ gốc: <?php echo $moac_lv0018->lv015;?></TD>
</TR>
