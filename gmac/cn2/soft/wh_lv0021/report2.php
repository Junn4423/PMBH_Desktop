...
if($plang=="") $plang="EN";
$vOrderList="1,2,2,3,7,8,9,10,11,12,3,4,5,13,14,15";
//////Delete message///
$lvMessage=array();
...
<body  onkeyup="KeyPublicRun(event)" style="background-color:#fff!important">
	...
	$vFieldList="lv088,lv003,lv004,lv005,lv006,lv009,lv010,lv011,lv012,lv015";
	else
	$vFieldList="lv088,lv003,lv004,lv005,lv006,lv008,lv009,lv010,lv011,lv012,lv015";
		...
		<tr>
			...
			<td style="width:30%" align="center" valign="top">
				...
				<div style="text-align:left;border:1px #434343 solid;padding:5px;min-height:90px">
					<strong><?php echo $vLangArr1[39];?>:</strong> <?php echo $mowh_lv0003->lv006;?>
					<br>
					<strong><?php echo $vLangArr1[40];?>:</strong> <?php echo $mowh_lv0003->lv010;?>
					<br>
					 <strong><?php echo $vLangArr1[41];?>:</strong> <?php echo $mowh_lv0003->lv012;?>
					 <br>
					 <strong><?php echo $vLangArr1[44];?>:</strong> <?php echo $mowh_lv0003->lv003;?>
				</div>
			</td>
			<td style="width:30%" align="center" valign="top">
				<div style="text-align:left;min-height:35px;border:1px #434343 solid;padding:5px">
					...
					<br>
					<?php echo $mowh_lv0021->ArrPush[5];?>: <?php echo $mowh_lv0021->FormatView($mowh_lv0021->lv004,4);?>
					</div>
				<div style="height:5px"></div>
				<div style="text-align:left;min-height:40px;border:1px #434343 solid;padding:5">
