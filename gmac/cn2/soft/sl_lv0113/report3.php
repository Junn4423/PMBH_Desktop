...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mosl_lv0113->ArrPush[0]=$vLangArr[54];
...
$mosl_lv0114->ArrPush[16]=$vLangArr[33];
$mosl_lv0114->ArrPush[18]=$vLangArr[46];
$mosl_lv0114->ArrPush[19]=$vLangArr[47];
$mosl_lv0114->ArrPush[20]=$vLangArr[48];
$mosl_lv0114->ArrPush[21]=$vLangArr[49];
$mosl_lv0114->ArrPush[22]=$vLangArr[41];
$mosl_lv0114->ArrPush[26]=$vLangArr[54];
$mosl_lv0114->ArrPush[17]=$vLangArr[59];
...
$mosl_lv0114->ArrPush[28]=$vLangArr[56];
...
if($mosl_lv0113->GetView()==1)
{
  ...
  $mosl_lv0001->LV_LoadID($mosl_lv0113->lv002);
	...
	$vFieldList="lv003,lv004,lv005,lv006,lv008,lv009,lv010,lv011,lv012";//$vFieldList="lv003,lv004,lv005,lv006,lv008,lv009,lv010";*/
	 $strDetail=$mosl_lv0114->LV_BuilListReportOther($vFieldList,'document.frmchoose','chkAll','lvChk',0, 1000,$paging,$vOrderList,$mosl_lv0113->lv006,0,$vSortNum,$mosl_lv0113->lv022);
...
<body  onkeyup="KeyPublicRun(event)">
 ...
 <tr>
    <td align="center" onDblClick="this.innerHTML=''"><img  src="<?php echo $mosl_lv0113->GetLogo();?>" /></td>
  </tr>
   <tr>
...
<?php echo $vLangArr1[28];?>: <?php echo $mosl_lv0001->lv010;?> <?php echo $vLangArr1[30];?>: <?php echo $mosl_lv0001->lv012;?><br> <?php echo $vLangArr1[21];?>: <?php echo $mosl_lv0001->lv003;?></div><div style="float:right;text-align:right"><strong><?php echo $mosl_lv0113->GetCompany();?></strong><br><?php echo $vLangArr1[24];?>: <?php echo $mosl_lv0113->GetAddress();?>
<br><?php echo $vLangArr1[28];?>: <?php echo $mosl_lv0113->GetPhone();?>   <?php echo $vLangArr1[30];?>: <?php echo $mosl_lv0113->GetFax();?> <br> 
<?php echo $vLangArr1[32];?>: <a href="<?php echo $mosl_lv0113->GetWeb();?>" target="_blank"><?php echo $mosl_lv0113->GetWeb();?></a></div>
    </div></td>
  </tr>
  <tr>
...
$lvMessage[1]=$vLangArr[15];
  ...
  <?php 
  	//Nhap
  	$vdsnhap=$mosl_lv0020->LV_LoadWH($vrow['lv001'],$mosl_lv0113->lv001);
  	...
  	//Xuat
  	$vdsxuat=$mosl_lv0021->LV_LoadWH($vrow['lv001'],$mosl_lv0113->lv001);
...
$moac_lv0033->ArrPush[17]=$vLangArr[34];
	$moac_lv0018->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'sl_lv0114');
	$moac_lv0032->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'sl_lv0032');
//////////////////////////////////////////////////////////////////////////////////////////////////////
  	$vdsinvoice=$moac_lv0018->LV_LoadList($mosl_lv0113->lv001);
	$vFieldList1='';
	$vOrderList1='';
	$vFieldList2='';
	$vOrderList2='';
  ...
  <br/>
  <div style="background-color:#555;color:#fff;height:28px;font-size:14px;padding-top:5px">
  <strong><?php echo $vLangArr2[58]; ?></strong>
  </div>
  </td>
  </tr>
  <tr>
  ...
  <?php
  //Hợp đồng
  	$vdshopdong=$mosl_lv0113->LV_LoadChild($mosl_lv0113->lv001);
	$vFieldList1=$mosl_lv0113->ListView;
	$vOrderList1=$mosl_lv0113->ListOrder;
	$vFieldList2=$mosl_lv0114->ListView;
	$vOrderList2=$mosl_lv0114->ListOrder;
	$mosl_lv0113->lv001='';
	$mosl_lv0113->lv002='';
	$mosl_lv0113->lv003='';
	$mosl_lv0113->lv004='';
	$mosl_lv0113->lv005='';
	$mosl_lv0113->lv006='';
  	 while($vhopdong=db_fetch_array($vdshopdong))
  	{
  		$mosl_lv0113->lv001=$vhopdong['lv001'];
  		$mosl_lv0114->lv002=$vhopdong['lv001'];	
  		echo "<li  style='padding-left:10px;padding-top:10px'><strong> + ".$vhopdong['lv001'].":".$vhopdong['lv003']."</strong><HR>
  		<ul><li  style='padding-left:20px;padding-top:0px'>";
		$mosl_lv0113->ArrPush[0]='';
  		echo $strParent=$mosl_lv0113->LV_BuilListReportOther($vFieldList1,'document.frmchoose','chkAll','lvChk',0, 1000,1,$vOrderList1);
	 	echo $strDetail=$mosl_lv0114->LV_BuilListReportOther($vFieldList2,'document.frmchoose','chkAll','lvChk',0, 1000,$paging,$vOrderList2,$mosl_lv0113->lv006,0,$vSortNum,$vhopdong['lv001']);
	 	echo "</li></ul></li>";/**/
  	}
  ?>
