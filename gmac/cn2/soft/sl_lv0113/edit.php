...
$lvsl_lv0113->lv001=$_GET['ChildID'];
if($plang=="") $plang="EN";
...
$lvsl_lv0113->lv007=$_FILES['userfile']['name'];
...
$lvsl_lv0113->LV_LoadID($lvsl_lv0113->lv001);
?>
...
function isphone(s){
	...
	function Save()
	{
		...
		else if(o.txtlv001.value==o.txtlv017.value)
		{
			alert("<?php echo "Hợp đồng cha phải khác mã họp đồng" ;?>");
			o.txtlv017.focus();
		}
		else
			{
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0113->lv001=="")?InsertWithCheckExt('sl_lv0113', 'lv001', '',10):$lvsl_lv0113->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
                          <tr>
				  ...
				  <td  height="20"><input  name="txtlv016" type="text" id="txtlv016" value="<?php echo $lvsl_lv0113->lv016;?>" tabindex="5" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
							...
							<tr>
							  ...
							  <input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvsl_lv0113->lv002;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  </td>
							  <td>
...
<tr>
				  ...
				  <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0113->FormatView($lvsl_lv0113->lv004,4);?>"/><span class="td"><img tabindex="8" src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvsl_lv0113->FormatView($lvsl_lv0113->lv005,4);?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="9"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
                          ...
                          <tr>
							  ...
							  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvsl_lv0113->lv010;?>" tabindex="14" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						  </tr>	
						  <tr>
