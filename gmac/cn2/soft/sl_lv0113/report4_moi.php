...
<table width="680" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
   ...
   <tr>
	...
	<?php echo $mosl_lv0114->GetCompany();?></strong><br><?php echo $mosl_lv0114->GetAddress();?>
<br><?php echo $vLangArr1[40];?>: <?php echo $mosl_lv0114->GetPhone();?>   <?php echo $vLangArr1[41];?>: <?php echo $mosl_lv0114->GetFax();?> <br> 
		</div>
	</div>
	<div style="float:left;width:50%">
		<div style="padding:10px">
			<table width="80%" style="border:0px;text-align:center"><tr><td><strong>NGÀY:</strong></td><td><?php echo $mosl_lv0113->FormatView($mosl_lv0113->lv004,2);?></td><td><strong>SỐ HÐ:</strong></td><td><?php echo $mosl_lv0113->lv001;?></td></tr></table>
		</div>
	</div>
    </div></td>
  </tr>
  ...
  <tr>
    <td align="center"><table align="center" class="lvtable" border="1" cellspacing="0" cellpadding="0">
		<tbody><tr class="lvhtable">
			...
			<td width="" class="lvhtable" style="padding-left:73px;padding-right:73px"><?php echo $vLangArr[21];?></td>
			<td width="" class="lvhtable"><?php echo $vLangArr[23];?></td>
			<td width="" class="lvhtable" style="padding-left:6px;padding-right:6px"><?php echo "SL";?> </td>
			<td width="" class="lvhtable" style="padding-left:13px;padding-right:13px"><?php echo $vLangArr[24];?></td>
			<td width="" class="lvhtable"><?php echo "CK";?></td>
			<td width="" class="lvhtable" style="padding-left:15px;padding-right:15px"><?php echo $vLangArr[41];?></td>
			<td width="" class="lvhtable" style="width:50px"><?php echo $vLangArr[27];?></td>
			<td width="" class="lvhtable"><?php echo $vLangArr[30];?></td>
		</tr>
<?php
	$vorder=1;
	$sqlS = "SELECT A.*,B.lv002 ItemName,C.lv002 UnitName,D.lv002 ProgName FROM sl_lv0114 A left join all_gmacv3_0.sl_lv0007 B on A.lv003=B.lv001 left join sl_lv0005 C on A.lv005=C.lv001 left join sl_lv0059 D on A.lv009=D.lv001 WHERE A.lv002='".$mosl_lv0113->lv001."' order by A.lv015 asc,A.lv001 asc";
...
?>		
		<tr class="lvlinehtable1">
			...
			<td align="right"><?php echo $mosl_lv0114->FormatView($vrow['lv011'],10)."%";?></td>
			...
			<td align="right" style="padding:2px;font-size:10px"><?php echo $vrow['ProgName'];?></td>
			<td align="right"><?php echo $mosl_lv0114->FormatView($vrow['lv012'],10);?></td>
...
?>		
		<tr class="lvlinehtable1">
			<td class="lvlineboldtable" colspan="6">TỔNG TIỀN:</td>
			...
			<td align="left">&nbsp;</td>
			<td align="right"><strong><?php echo $mosl_lv0114->FormatView($sumScore,10);?></strong></td>
		</tr>

		<!--<tr ondblclick="this.innerHTML=''">
			<td class="lvlineboldtable" colspan="6">TỔNG TIỀN CHIẾT KHẤU:</td>
			<td class="lvlineboldtable" align="right"><?php echo $mosl_lv0114->FormatView($sumDiscount,10);?></td>
			<td align="left" colspan="2">&nbsp;</td>-->
		</tr>
<?php
	if($mosl_lv0113->lv007=="CASH" && $mosl_lv0113->lv022>0)
	{
		 $vsumCash=($sumMoney)*$mosl_lv0113->lv022/100;
?>		
		<tr ondblclick="this.innerHTML=''">
			<td class="lvlineboldtable" colspan="6" >CK TIỀN MẶT(<?php echo $mosl_lv0113->FormatView($mosl_lv0113->lv022,10);?>%):</td>
			<td class="lvlineboldtable" align="right" style="padding:2px;padding-right:5px;padding-left:5px;font-size:14px"><?php echo $mosl_lv0114->FormatView($vsumCash,10);?></td>
			<td align="left" colspan="2">&nbsp;</td>
		</tr>
<?php
	}
?>				
			<tr ondblclick="this.innerHTML=''">
			<td class="lvlineboldtable" colspan="6">TỔNG TIỀN THANH TOÁN:</td>
			<td class="lvlineboldtable" align="right" style="padding:2px;padding-right:5px;padding-left:5px;font-size:14px"><?php echo $mosl_lv0114->FormatView($sumMoney-$sumDiscount-$vsumCash,10);?></td>
			<td align="left" colspan="2">&nbsp;</td>
		</tr>
		<tr ondblclick="this.innerHTML=''">
			<td class="lvlineboldtable" colspan="9">Bằng chữ: <?php echo LNum2Text($sumMoney-$sumDiscount-$vsumCash,$plang);?> </td>
		</tr>
