					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value="">...</option><?php echo $lvsl_lv0114->LV_LinkField('lv003',$vlv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
							...
							<tr>
							  ...
							  <?php echo $lvsl_lv0114->LV_LinkField('lv005',$vlv005);?>
...
<tr>
							  ...
							  <?php echo $lvsl_lv0114->LV_LinkField('lv007',$vlv007);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" name="txtlv009" id="txtlv009" tabindex="13"  value="<?php echo $lvsl_lv0114->lv009;?>" style="width:200px"onKeyPress="return CheckKey(event,7)"  onKeyUp="LoadSelf(this,'txtlv009','sl_lv0017','lv003')" onFocus="LoadSelf(this,'txtlv009','sl_lv0017','lv003')">
