...
$lvsl_lv0020->lv001=$_GET['ChildID'];
if($plang=="") $plang="EN";
...
$lvsl_lv0020->lv012=$_POST['txtlv012'];
$lvsl_lv0020->lv013=$_POST['txtlv013'];
$lvsl_lv0020->lv014=$_POST['txtlv014'];
$lvsl_lv0020->lv015=$_POST['txtlv015'];
$lvsl_lv0020->lv016=$_POST['txtlv016'];
		
		$vresult=$lvsl_lv0020->LV_Update();
		if($vresult==true) {
...
$lvsl_lv0020->LV_LoadID($lvsl_lv0020->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0020->lv001=="")?InsertWithCheckExt('sl_lv0020', 'lv001', '',10):$lvsl_lv0020->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
