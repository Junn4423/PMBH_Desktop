...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
if(isset($_GET['ajaxsize']))
{
	echo '[CHECKSIZE]';
	$sql="select * from sl_lv0030";
echo '<select name="txtlv918" id="txtlv918"   tabindex="23"  style="width:80%" onkeypress="return CheckKey(event,1)"  onblur="changesize_change()"/>'.$mowh_lv0009->LV_LinkField('lv018',$_GET['categoryid']).'</select>	';
	echo '[ENDCHECKSIZE]';
	exit;
}
if(isset($_GET['ajax']))
...
$mowh_lv0008->lv002=($mowh_lv0008->lv002=="")?"PRODUC":$mowh_lv0008->lv002;
...
<script language="javascript" src="<?php echo $vDir;?>../javascript/engine.js"></script>
	...
	{
	var str="<br><iframe id='lvframefrm' height=900 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>wh_lv0040/wh_lv0040.php?&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
	...
	var strvalue="&txtlv003="+o.txtlv903.value+"&txtlv004="+o.txtlv904.value+"&txtlv005="+o.txtlv905.value+"&txtlv006="+o.txtlv906.value+"&txtlv007="+o.txtlv907.value+"&txtlv008="+o.txtlv908.value+"&txtlv009="+o.txtlv909.value+"&txtlv010="+o.txtlv910.value+"&txtlv011="+o.txtlv911.value+"&txtlv013="+vlv913+"&txtlv014="+o.txtlv914.value+"&txtlv015="+o.txtlv915.value+"&txtlv017="+o.txtlv917.value+"&txtlv018="+o.txtlv918.value+"&txtlv019="+o.txtlv919.value+"&txtOpt=1";
	var str="<br><iframe id='lvframefrm' height=900 marginheight=0 marginwidth=0 frameborder=0 src='<?php echo $vDir;?>wh_lv0040/wh_lv0040.php?&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>"+strvalue+"' class=lvframe></iframe>";
	div = document.getElementById('lvloaddata');
	div.innerHTML=str;
	o.txtlv903.focus();
	}
	...
	{
		var o=document.frmadd;
		ajax_do ('wh_lv0037/wh_lv0037exce.php?&lang=<?php echo $plang;?>&childfunc=load'+'&lv002='+o.txtlv903.value+'&lv003='+o.txtlv802.value,1);
	}
	...
	if(o.txtlv913.checked)		vlv013='1';
		...
		{
			case 'GMAC':
				ajax_do ('wh_lv0037/wh_lv0037excesource.php?&lang=<?php echo $plang;?>&Type=GMAC&childfunc=load'+'&lv002='+o.txtlv802.value	+'&lv005='+o.txtlv805.value+'&lv006='+o.txtlv806.value+'&lv913='+vlv013,1);
				window.setTimeout('RunFunction()',500);
				break;
			case 'TRAHANG':
				ajax_do ('wh_lv0037/wh_lv0037excesource.php?&lang=<?php echo $plang;?>&Type=TRAHANG&childfunc=load'+'&lv002='+o.txtlv802.value	+'&lv005='+o.txtlv805.value+'&lv006='+o.txtlv806.value+'&lv913='+vlv013,1);
				window.setTimeout('RunFunction()',500);
				break;
			case 'MUAHANG':
				ajax_do ('wh_lv0037/wh_lv0037excesource.php?&lang=<?php echo $plang;?>&Type=MUAHANG&childfunc=load'+'&lv002='+o.txtlv802.value	+'&lv005='+o.txtlv805.value+'&lv006='+o.txtlv806.value+'&lv913='+vlv013,1);
				window.setTimeout('RunFunction()',500);
				break;
		}
	...
	function changesize_change()
	{
		if(frmadd.txtlv9181.checked)
		{
			if(frmadd.txtlv918.value!="" && frmadd.txtlv917.value!="")
			frmadd.txtlv914.value=	frmadd.txtlv918.value+'-'+frmadd.txtlv917.value;
			else if(frmadd.txtlv918.value!="")
			frmadd.txtlv914.value=	frmadd.txtlv918.value;
			else if(frmadd.txtlv917.value!="")
			frmadd.txtlv914.value=	frmadd.txtlv917.value;
										...
										<form   name="frmadd" id="frmadd"  id="frmadd" method="POST" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0);?>" autocomplete="off">
											...
											<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
												...
												<tr>
												  ...
												  <td><input name="txtlv809" type="text" id="txtlv809" value="<?php echo $mowh_lv0008->FormatView($mowh_lv0008->lv009,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="readonly" /><!-- 
												...
												<tr height="1">
												    ...
												    <td colspan="3" class="td"><textarea name="txtlv808" rows="3" id="txtlv808" style="width:80%" tabindex="13" ><?php echo $mowh_lv0008->lv007;?></textarea></td>
											    </tr>												
												<tr height="1">
			...
			<td><table width="100%" border="0">
                                                      ...
                                                      <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          ...
                                                          <td width="17%"><table>
                                                            ...
                                                            <td align="right" style="postion:relative"><div style="text-align:left"><input type="checkbox" name="txtlv913" id=txtlv913 value="0"/><?php echo $vLangArr[41];?><input type="checkbox" name="txtlv9181" id=txtlv9181 checked="checked"/><?php echo $vLangArr[62];?></div><div style="postion:relative;width:50%px;"><img id="txtimg_load_sp" name="txtimg_load_sp" style="right:50px;position:absolute;" src="http://thegioithietbilanh.vn/wp-content/plugins/load_products_content_trangchu/images/loading.gif" border="0" height="50"/></div></td>
                                                        </tr>
                                                        <tr>
                                                          <td><?php echo $vLangArr[32];?></td>
                                                          <td><input name="txtlv904" id="txtlv904"   tabindex="21"  style="width:80%" onKeyPress="return CheckKey(event,1)" value="<?php echo (float)$mowh_lv0009->lv004;?>"/></td>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td><input name="txtlv906" type="text" id="txtlv906" value="<?php echo (float)$mowh_lv0009->lv006;?>" tabindex="22" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
							  ...
							  <td>
							    <ul id="pop-nav7" lang="pop-nav7" onkeyup="ChangeName(this,7)" onMouseOver="ChangeName(this,7)" onkeyup="ChangeName(this,7)"> <li class="menupopT">
							      ...
							      <div id="lv_popup7" lang="lv_popup7"> </div>						  
                                                          ...
                                                          <td><select name="txtlv917" id="txtlv917"   tabindex="23"  style="width:80%" onkeypress="return CheckKey(event,1)" onblur="changesize_change()"/>
                                                            <?php echo $mowh_lv0009->LV_LinkField('lv017',$mowh_lv0009->lv017);?>
                                                            </select></td>
                                                        </tr>
                                                        <tr>
                                                        	<td><?php echo $vLangArr[54];?></td>
                                                          <td><div id="sizegetid">
                                                            <select name="txtlv918" id="txtlv918"   tabindex="23"  style="width:80%" onkeypress="return CheckKey(event,1)" onblur="changesize_change()"/>
                                                           
							  </select></div></td>
                                                          <td><?php echo $vLangArr[55];?></td>
                                                            <td><select name="txtlv919" id="txtlv919"   tabindex="23"  style="width:80%" onkeypress="return CheckKey(event,1)" onChange="changecategory_change(this.value)"/>
                                                          <?php echo $mowh_lv0009->LV_LinkField('lv019',$mowh_lv0009->lv019);?>
							  </select></td>
                                                        </tr>
                                                        <tr>
                                                          <td><?php echo $vLangArr[43];?></td>
                                                          <td><input type="hidden" name="txtlv911" id="txtlv911"   tabindex="26"  style="width:80%" onKeyPress="return CheckKey(event,1)"/>
                                                          <input  name="txtlv915" type="text" id="txtlv915" value="<?php echo $mowh_lv0009->lv015;?>" tabindex="24" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
                                                          <td><?php echo $vLangArr[38];?></td>
                                                          <td><input  name="txtlv910" type="text" id="txtlv910" value="<?php echo (float)$mowh_lv0009->lv010;?>" tabindex="26" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
                                                        </tr>
                                                        <tr>
                                                          <td><?php echo $vLangArr[36];?></td>
                                                          <td><input type="text" name="txtlv908" id="txtlv908"  style="width:80%"  tabindex="25"  value="<?php echo (float)$mowh_lv0009->lv008;?>" onKeyPress="return CheckKey(event,1)"></td>
							  ...
							  <?php echo $mowh_lv0009->LV_LinkField('lv009',$mowh_lv0009->lv009);?>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <?php echo $mowh_lv0009->LV_LinkField('lv012',$mowh_lv0009->lv012);?>
                                                            </select><br>
							  <table><tr><td>
							  ...
							  <?php echo $mowh_lv0009->LV_LinkField('lv013',$mowh_lv0009->lv013);?>
...
div.innerHTML='<?php echo $vLangArr[61];?> TP';
...
changecategory_change(document.frmadd.txtlv919.value);
function changecategory_change(value)
		{
			...
			var url=document.location;
			url=url+"?&ajaxsize=ajaxcheck"+"&categoryid="+value;
			url=url.replace("#","");
			xmlhttp1.onreadystatechange=stateChangedSize;
		...
		function stateChangedSize()
		{
			...
			{
				var startdomain=xmlhttp1.responseText.indexOf('[CHECKSIZE]')+11;
				var enddomain=xmlhttp1.responseText.indexOf('[ENDCHECKSIZE]');
