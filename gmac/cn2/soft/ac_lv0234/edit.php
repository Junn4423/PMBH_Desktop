...
require_once("../../clsall/ac_lv0234.php");
//////////////init object////////////////
$lvac_lv0234=new ac_lv0234($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ac0033');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvac_lv0234->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="EN";
...
if($vFlag==1)
{
$lvac_lv0234->lv002=$_POST['txtlv002'];
$lvac_lv0234->lv003=$_POST['txtlv003'];
$lvac_lv0234->lv004=$_POST['txtlv004'];
$lvac_lv0234->lv005=$_POST['txtlv005'];
$lvac_lv0234->lv006=$_POST['txtlv006'];
$lvac_lv0234->lv007=$_POST['txtlv007'];
$lvac_lv0234->lv016=GetServerDate()." ".GetServerTime();
		
		$vresult=$lvac_lv0234->LV_Update();
		if($vresult==true) {
...
$lvac_lv0234->LV_LoadID($lvac_lv0234->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvac_lv0234->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><input name="txtlv003" type="text"  id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvac_lv0234->lv003;?>"/>			</td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[18];?></td>
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvac_lv0234->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvac_lv0234->LV_LinkField('lv005',$lvac_lv0234->lv005);?>
							  </select><br>
							  <table><tr><td>
...
<tr>
							  ...
							  <?php echo $lvac_lv0234->LV_LinkField('lv006',$lvac_lv0234->lv006);?>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv007" id="txtlv007"  style="width:80%"  tabindex="12"  value="<?php echo $lvac_lv0234->lv007;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
						<tr>
