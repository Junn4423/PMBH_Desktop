...
$lvsl_lv0013=new sl_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0021');
$lvsl_lv0001=new sl_lv0001($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0003');
...
$vNow=GetServerDate();
$lvsl_lv0057->lv001=$_POST['txtlv001'];
$lvsl_lv0057->lv002='1';
$lvsl_lv0057->lv003=($_POST['txtlv003']=='')?'CUS':$_POST['txtlv003'];
$lvsl_lv0057->lv004=$lvsl_lv0013->lv007;
$lvsl_lv0057->lv005=$lvsl_lv0013->lv003;
$lvsl_lv0057->lv006=$lvsl_lv0013->lv009;
$lvsl_lv0057->lv007=$_POST['txtlv007'];
if($lvsl_lv0057->lv007=="") $lvsl_lv0057->lv007="Trả tiền tạm ứng phòng:".$lvsl_lv0013->lv007;
$lvsl_lv0057->lv008=getInfor($_SESSION['ERPSOFV2RUserID'],2);
$lvsl_lv0057->lv009=$_POST['txtlv009'];
if($lvsl_lv0057->lv009=="" || $lvsl_lv0057->lv009==NULL) $lvsl_lv0057->lv009=$vNow." ".GetServerTime();
$lvsl_lv0057->lv010=($_POST['txtlv010']=="")?'1111':$_POST['txtlv010'];
$lvsl_lv0057->lv011=($_POST['txtlv011']=="")?'VND':$_POST['txtlv011'];
$lvsl_lv0057->lv012=($_POST['txtlv012']=="")?'1':$_POST['txtlv012'];
$lvsl_lv0057->lv013=($_POST['txtlv013']=="")?$lvsl_lv0013->lv001:$_POST['txtlv013'];
$lvsl_lv0057->lv014=$_POST['txtlv014'];
if($lvsl_lv0057->lv014=="" || $lvsl_lv0057->lv014==NULL) $lvsl_lv0057->lv014=$vNow;
$lvsl_lv0057->lv015=$_POST['txtlv015'];
$lvsl_lv0057->lv017=0;
$lvsl_lv0057->lv016=$_POST['txtlv016'];
$lvsl_lv0057->lv019=($_POST['txtlv019']=='')?($lvsl_lv0013->lv023+$lvsl_lv0013->lv023*$lvsl_lv0013->lv006/100):$_POST['txtlv019'];
if($vFlag==1)
{
		
		$vresult=$lvsl_lv0057->LV_Insert();
		if($vresult==true) {
					...
					<form action="#"   name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
							...
							<tr>
							 ...
							 <tr>
								...
								<td width="178"  height="20">
									<input name="txtlv019" type="text" id="txtlv019"  value="<?php echo (float)$lvsl_lv0057->lv019;?>" tabindex="4" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
					      </tr>		
						   </table>
						<table width="100%" border="0" align="center" id="table1" style="display:none">
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvsl_lv0057->lv001=="")?InsertWithCheck('ac_lv0004', 'lv001', 'PC-'.getmonth($vNow)."/".getyear($vNow)."-",1):$lvsl_lv0057->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
