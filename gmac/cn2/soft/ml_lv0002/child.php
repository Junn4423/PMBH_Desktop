...
require_once("../paras.php");
require_once("../../clsall/ml_menusl0002.php");
...
//init object
$ml_menusl0002=new ml_menusl0002();
//Set variant
$ml_menusl0002->itemlst=$pitemlst;
$ml_menusl0002->childlst=$pchildlst;
$ml_menusl0002->level3lst=$plevel3lst;
$ml_menusl0002->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($ml_menusl0002->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$ml_menusl0002->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$ml_menusl0002->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
						<option value="4" <?php echo ((int)$ml_menusl0002->level3lst==4)?'selected="selected"':'';?>>4.<?php echo $vLangArr[11];?></option>
					</select>
	...
	<?php
	$ml_menusl0002->Dir="../";
include($ml_menusl0002->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $ml_menusl0002->level3lst;?>";
