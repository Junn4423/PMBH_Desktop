...
$moac_lv0077->ArrFunc[11]=$vLangArr[36];
$moac_lv0077->ArrFunc[12]=$vLangArr[37];
$moac_lv0077->ArrFunc[13]=$vLangArr[38];
$moac_lv0077->ArrFunc[14]=$vLangArr[39];
$moac_lv0077->ArrFunc[15]=$vLangArr[40];
////Other
$moac_lv0077->ArrOther[1]=$vLangArr[31];
$moac_lv0077->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$moac_lv0077->lv002=base64_decode($_GET['ID']);
...
?>
						...
						<?php echo $moac_lv0077->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
