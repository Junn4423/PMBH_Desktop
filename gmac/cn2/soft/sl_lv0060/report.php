...
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","SL0072.txt",$plang);
...
$mosl_lv0060->ArrPush[11]=$vLangArr[30];

////Other
$mosl_lv0060->ArrOther[1]=$vLangArr[28];
$mosl_lv0060->ArrOther[2]=$vLangArr[29];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mosl_lv0060->lv002=base64_decode($_GET['ID']);
...
?>
						...
						<?php echo $mosl_lv0060->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
