...
<tr>
								...
								<td  height="20"><select name="txtlv007" id="txtlv007"   tabindex="11"  style="width:80%" onKeyPress="return CheckKeys(event,7,this)"/><option value="">...</option>
							  <?php echo $lvwh_lv0003->LV_LinkField('lv007',$vlv007);?>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKeys(event,7,this)"/><option value="">...</option>
							  <?php echo $lvwh_lv0003->LV_LinkField('lv008',$vlv008);?>
							  </select><br><table><tr><td>
