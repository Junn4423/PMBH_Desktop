...
require_once("../paras.php");
require_once("../../clsall/wh_menusl0004.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0023.txt",$plang);
//init object
$mowh_menusl0004=new wh_menusl0004();
//Set variant
$mowh_menusl0004->itemlst=$pitemlst;
$mowh_menusl0004->childlst=$pchildlst;
$mowh_menusl0004->level3lst=$plevel3lst;
$mowh_menusl0004->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($mowh_menusl0004->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$mowh_menusl0004->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$mowh_menusl0004->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
						<option value="4" <?php echo ((int)$mowh_menusl0004->level3lst==4)?'selected="selected"':'';?>>4.<?php echo $vLangArr[11];?></option>
	...
	<?php
	$mowh_menusl0004->Dir="../";
include($mowh_menusl0004->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $mowh_menusl0004->level3lst;?>";
