...
if($lvwh_lv0010->lv009=="") $lvwh_lv0010->lv009=GetServerDate();
if($vFlag==1)
{
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvwh_lv0010->lv001=="")?InsertWithCheckExt('wh_lv0010', 'lv001', 'PX',10):$lvwh_lv0010->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
