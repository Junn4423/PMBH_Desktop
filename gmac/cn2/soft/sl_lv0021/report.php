...
////Other
$mosl_lv0021->ArrOther[1]=$vLangArr[28];
$mosl_lv0021->ArrOther[2]=$vLangArr[29];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mosl_lv0021->lv002=base64_decode($_GET['ID']);
...
?>
						...
						<?php echo $mosl_lv0021->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
