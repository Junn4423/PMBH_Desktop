...
require_once("../../clsall/sl_lv0021.php");
//////////////init object////////////////
$lvsl_lv0021=new sl_lv0021($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wh0010');
					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($vlv001=="")?InsertWithCheckExt('sl_lv0021', 'lv001', '',10):$vlv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
							  ...
							  <td  height="20"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)"><option value="">...</option>
							   <?php echo $lvsl_lv0021->LV_LinkField('lv002',$vlv002);?>
                              </select>
							    <br>
							  <table><tr><td>
...
<tr>
								...
								<?php echo $lvsl_lv0021->LV_LinkField('lv003',$vlv003);?>
						  ...
						  <br></td></tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvsl_lv0021->FormatView($vlv009,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
