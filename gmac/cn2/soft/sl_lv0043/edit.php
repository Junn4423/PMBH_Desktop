...
$lvsl_lv0043->lv005=$_POST['txtlv005'];
$lvsl_lv0043->lv006=$_POST['txtlv006'];
if($_FILES['userfile']['name']=="")
$lvsl_lv0043->lv007=$_POST['txtlv007'];
else
$lvsl_lv0043->lv007=$_FILES['userfile']['name'];
$lvsl_lv0043->lv008=$_POST['txtlv008'];
$lvsl_lv0043->lv009=$_POST['txtlv009'];
$lvsl_lv0043->lv010=$_POST['txtlv010'];
$lvsl_lv0043->lv011=$_POST['txtlv011'];
$lvsl_lv0043->lv012=$_POST['txtlv012'];
$lvsl_lv0043->lv013=$_POST['txtlv013'];
$lvsl_lv0043->lv014=$_POST['txtlv014'];
$lvsl_lv0043->lv015=$_POST['txtlv015'];
$lvsl_lv0043->lv016=$_POST['txtlv016'];
$lvsl_lv0043->lv017=$_POST['txtlv017'];
$lvsl_lv0043->lv018=$_POST['txtlv018'];
$lvsl_lv0043->lv019=$_POST['txtlv019'];
$lvsl_lv0043->lv020=$_POST['txtlv020'];
$lvsl_lv0043->lv021=$_POST['txtlv021'];
$lvsl_lv0043->lv022=$_POST['txtlv022'];
$lvsl_lv0043->lv023=$_POST['txtlv023'];		
		$vresult=$lvsl_lv0043->LV_Update();
		if($vresult==true) {
...
$lvsl_lv0043->LV_LoadID($lvsl_lv0043->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvsl_lv0043->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							 <tr>
							  ...
							  <tr>
								...
								<td width="178"  height="20">
									<input name="txtlv003" type="text" id="txtlv003"  value="<?php echo $lvsl_lv0043->FormatView($lvsl_lv0043->lv003,2);?>" tabindex="17" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>	
							...
							<tr>
							  ...
							  <td  height="20"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvsl_lv0043->FormatView($lvsl_lv0043->lv004,2);?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv006" rows="5" id="txtlv006" style="width:80%" tabindex="23" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvsl_lv0043->lv006;?>"/></td>
						    </tr>
							  <tr>
