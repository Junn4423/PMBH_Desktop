...
$mosl_lv0043->ArrPush[11]=$vLangArr[28];
$mosl_lv0043->ArrPush[12]=$vLangArr[29];
$mosl_lv0043->ArrPush[13]=$vLangArr[30];
$mosl_lv0043->ArrPush[14]=$vLangArr[31];
$mosl_lv0043->ArrPush[15]=$vLangArr[32];
$mosl_lv0043->ArrPush[16]=$vLangArr[33];
$mosl_lv0043->ArrPush[17]=$vLangArr[34];
$mosl_lv0043->ArrPush[18]=$vLangArr[35];
$mosl_lv0043->ArrPush[19]=$vLangArr[36];
$mosl_lv0043->ArrPush[20]=$vLangArr[37];
$mosl_lv0043->ArrPush[21]=$vLangArr[38];
$mosl_lv0043->ArrPush[22]=$vLangArr[39];
$mosl_lv0043->ArrPush[23]=$vLangArr[40];
$mosl_lv0043->ArrPush[24]=$vLangArr[41];
$mosl_lv0043->ArrPush[25]=$vLangArr[42];
...
$mosl_lv0043->ArrFunc[5]='';
$mosl_lv0043->ArrFunc[6]='';
$mosl_lv0043->ArrFunc[7]='';
$mosl_lv0043->ArrFunc[8]=$vLangArr[10];
$mosl_lv0043->ArrFunc[9]=$vLangArr[12];
$mosl_lv0043->ArrFunc[10]=$vLangArr[0];
$mosl_lv0043->ArrFunc[11]=$vLangArr[63];
$mosl_lv0043->ArrFunc[12]=$vLangArr[64];
$mosl_lv0043->ArrFunc[13]=$vLangArr[65];
$mosl_lv0043->ArrFunc[14]=$vLangArr[66];

////Other
$mosl_lv0043->ArrOther[1]=$vLangArr[61];
$mosl_lv0043->ArrOther[2]=$vLangArr[62];
//////Delete message///
$lvMessage=array();
...
?>
						...
						<?php echo $mosl_lv0043->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
