					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20">
							  <table width="80%" border=0><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  	<option value="">...</option>
								<?php echo $lvwh_lv0022->LV_LinkField('lv003',$vlv003);?>
							  </select></td><td>
...
<tr>
							...
							<tr>
							  ...
							  <option value="">...</option>
							  <?php echo $lvwh_lv0022->LV_LinkField('lv005',$vlv005);?>
							  </select></td><td>
							  <ul id="pop-nav2" lang="pop-nav2" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv005_search" id="txtlv005_search" style="width:200px" onKeyUp="LoadPopup(this,'txtlv005','sl_lv0005','lv002')" onFocus="LoadPopup(this,'txtlv005','sl_lv0005','lv002')" tabindex="200" >
...
<tr>
								...
								<td  height="20"><table width="80%" border=0><tr><td width="50%"><select name="txtlv007" id="txtlv007"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)"/>
								<option value="">...</option>
							  <?php echo $lvwh_lv0022->LV_LinkField('lv007',$vlv007);?>
							  </select></td><td>
							  <ul id="pop-nav3" lang="pop-nav3" onMouseOver="ChangeName(this,3)" onkeyup="ChangeName(this,3)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv007_search" id="txtlv007_search" style="width:200px" onKeyUp="LoadPopup(this,'txtlv007','hr_lv0018','lv002')" onFocus="LoadPopup(this,'txtlv007','hr_lv0018','lv002')" tabindex="200" >
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $vlv008;?>"/>							  </td>
						    </tr>
							<tr>
							  ...
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:200px"onKeyPress="return CheckKey(event,7)" value="<?php echo $lvwh_lv0022->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','sl_lv0017','lv003')" onFocus="LoadSelf(this,'txtlv009','sl_lv0017','lv003')">
				  ...
				  <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo $vlv011;?>" tabindex="15" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	 	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[26];?></td>
				  <td  height="20"><input  name="txtlv012" type="text" id="txtlv012" value="<?php echo $vlv012;?>" tabindex="16" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[30];?></td>
				  			  <td  height="20"><input  name="txtlv013" type="text" id="txtlv013" value="<?php echo $vlv013;?>" tabindex="16" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /><img src="<?php echo $vDir;?>../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
															onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv013);return false;" /></td>
						  </tr>									  
						  <tr>
