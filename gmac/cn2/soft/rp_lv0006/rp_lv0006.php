...
if(!isset($_POST['txtlv005'])) $morp_lv0006->lv005=$vNow;
...
function RptWH(vValue)
{
	...
	o.target="_blank";
	o.txtdepid.value=getChecked(o.chklv002.value,'chklv002');
	o.txtstate.value=getChecked(o.chklv003.value,'chklv003');
	o.action="rp_lv0006?func=rpt"
	o.submit();
}
function Refresh()
{
					 ...
					 <table width="100%" border="0" align="center" id="table1">
							<tr>
                             ...
                             <tr>
							  ...
							  <td width="178"  height="20"><input name="txtdepid" type="hidden" id="txtdepid" value="<?php echo $morp_lv0006->lv002;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $morp_lv0006->GetBuilCheckList($morp_lv0006->lv002,'chklv002',10,'hr_lv0002','lv003');?></td>
						    </tr>	
						  <tr>
							  <td  height="20"><?php echo $vLangArr[3];?></td>
							  <td  height="20"><input name="txtstate" type="hidden" id="txtstate" value="<?php echo $morp_lv0006->lv003;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $morp_lv0006->GetBuilCheckList($morp_lv0006->lv003,'chklv003',10,'hr_lv0022');?></td>
					   </tr>	
                       <tr>
							  <td  height="20px"><?php echo $vLangArr[5];?></td>
							  <td  height="20px"><select name="txtlv006" id="txtlv006" tabindex="10" style="width:80%" onKeyPress="return CheckKey(event,7)"><option value="">...</option><?php echo $morp_lv0006->LV_LinkField('lv106','PN');?></select></td>
							  </tr>	
					   		<tr>
							  <td  height="20"><?php echo $vLangArr[4];?></td>
							  <td  height="20"><input name="txtlempid" type="text" id="txtlempid" value="<?php echo $morp_lv0006->lv004;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)" /><br><table><tr><td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:200px" onKeyUp="LoadPopupParent(this,'txtlempid','*@*@*.hr_lv0020','concat(lv004,lv003,lv002)')" onFocus="LoadPopupParent(this,'txtlempid','*@*@*.hr_lv0020','concat(lv004,lv003,lv002)')" tabindex="200" >
							    <div id="lv_popup" lang="lv_popup1"> </div>						  
						</li>
					</ul></td></tr></table>	</td>
					  		</tr>	
                              <tr>
				      <td  height="20"><?php echo $vLangArr[9]." from";?></td>
				      <td  height="20"><input name="txtdatefrom" type="text" id="txtdatefrom" value="<?php echo ($lvDateFrom);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
						  ...
						  <tr>
				      <td  height="20"><?php echo $vLangArr[9]." to";?></td>
				      <td  height="20"><input name="txtdateto" type="text" id="txtdateto" value="<?php echo ($lvDateTo);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
