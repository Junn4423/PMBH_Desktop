...
require_once("../paras.php");
require_once("../../clsall/ac_menusl0017.php");
...
//init object
$moac_menusl0017=new ac_menusl0017();
//Set variant
$moac_menusl0017->itemlst=$pitemlst;
$moac_menusl0017->childlst=$pchildlst;
$moac_menusl0017->level3lst=$plevel3lst;
$moac_menusl0017->child3lst=$pchild3lst;
...
<div id="content_child">
						...
						<TR vAlign="center" align="middle">				
							<td><form name="frmhr_employee" action="#" method="post">
									<select name="cbxoption" tabindex="1" onChange="callchange(this)" style="width:100px">	
										<option value="1" <?php echo ($moac_menusl0017->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[9];?></option>
										<option value="2" <?php echo ((int)$moac_menusl0017->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[16];?></option>
									</select>
									Chọn thao tác
	...
	<?php
	$moac_menusl0017->Dir="../";
include($moac_menusl0017->GetLinkEmp());
?>	</div></td></tr></table>	<div id="lvright"></div></div>
<script language="javascript">
document.frmhr_employee.cbxoption.value="<?php echo $moac_menusl0017->level3lst;?>";
