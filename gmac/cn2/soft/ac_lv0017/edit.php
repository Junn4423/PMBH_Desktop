...
$lvac_lv0017->lv016=$_POST['txtlv016'];
		
		$vresult=$lvac_lv0017->LV_Update();
		if($vresult==true) {
...
$lvac_lv0017->LV_LoadID($lvac_lv0017->lv001);
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvac_lv0017->lv001=="")?InsertWithCheckExt('ac_lv0004', 'lv001', '',1):$lvac_lv0017->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
