...
$lvwh_lv0011->obj_wb_lv0006=$mowb_lv0006;
if($plang=="") $plang="EN";
	$vLangArr=GetLangFile("../../","WH0018.txt",$plang);
$mowh_lv0011->lang=strtoupper($plang);
$curPage=(int)$_POST['curPg'];	
$vFlag=(int)$_POST['txtFlag'];
$lvwh_lv0011->lv001=$_POST['txtlv001'];
$lvwh_lv0011->lv002=$_GET['ChildID'];
