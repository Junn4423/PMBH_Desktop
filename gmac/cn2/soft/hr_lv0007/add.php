...
$lvhr_lv0007->lv001=$_POST['txtlv001'];
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvhr_lv0007->lv001=="")?InsertWithCheckExt('hr_lv0007', 'lv001', 'JB',4):$lvhr_lv0007->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
							</tr>
							<tr>
				  ...
				  <td  height="20px"><textarea type="text" name="txtlv004" id="txtlv004"  rows="4" tabindex="8" style="width:80%"><?php echo $lvhr_lv0007->lv004;?></textarea></td>
							...
							<tr>
							  ...
							  <td  height="20px"><select name="txtlv005" id="txtlv005" tabindex="9"  style="width:80%">
								...
								?>
                          		<option value="<?php echo $arrS1['lv001'];?>"><?php echo $arrS1['lv002']." [".$arrS1['lv001']."]";?></option>
                          		<?php
									}
								}
								?>
