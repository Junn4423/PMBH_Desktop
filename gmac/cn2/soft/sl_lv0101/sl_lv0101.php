...
if ($lvsl_lv0059->lv001 != '' && $lvsl_lv0059->lv001 != null) {
    if ($lvsl_lv0059->NumLine == 1) {
        $lvsl_lv0013->LV_ChangeShiftAutoUpdate($lvsl_lv0059->lv001);
    }
}
if ($lvsl_lv0013->GetAdd() > 0) {
    if (isset($_GET['ajaxitemsend'])) {
        ...
        if ($vContractID == '' || $vContractID == null) {
            ...
            if ($lvsl_lv0013->GetApr() == 0) {
                $lvsl_lv0013->lv010 = $lvsl_lv0013->LV_UserID;
            }
            if ($lvsl_lv0013->lv010 == '') {
                $lvsl_lv0013->lv010 = $lvsl_lv0013->LV_UserID;
            }
            ...
            if ($lvsl_lv0059->lv009 > 0) {
                $lvsl_lv0013->lv022 = $lvsl_lv0059->lv009;
            }
			...
			$vsql="update sl_lv0014 set lv004=lv004+1 where lv001='$vDetailID'";
                ...
                if ($vAddState == 1) {
                    switch ($lvsl_lv0070->lv017) {
                        ...
                        case 2:
                            if ($vTraHang == 1) {
                                $vsql = "insert into sl_lv0014(lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv011,lv012,lv014,lv016,lv100) select '$vContractID','$vItemID',-1,A.lv004,'" . $lvsl_lv0070->lv018 . "',A.lv008,0,'$vPercent','$vPoint',concat(CurDate(),' ',CurTime()),'$vItemIDPref',1 from sl_lv0007 A where lv001='$vItemID'";
                            } else {
                                $vsql = "insert into sl_lv0014(lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv011,lv012,lv014,lv016,lv100) select '$vContractID','$vItemID',1,A.lv004,'" . $lvsl_lv0070->lv018 . "',A.lv008,0,'$vPercent','$vPoint',concat(CurDate(),' ',CurTime()),'$vItemIDPref',1 from sl_lv0007 A where lv001='$vItemID'";
                            }
                            break;
                        ...
                        default:
                            if ($vTraHang == 1) {
                                $vsql = "insert into sl_lv0014(lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv011,lv012,lv014,lv016) select '$vContractID','$vItemID',-1,A.lv004,IF($vPrice=0,A.lv007,$vPrice),A.lv008,0,'$vPercent','$vPoint',concat(CurDate(),' ',CurTime()),'$vItemIDPref' from sl_lv0007 A where lv001='$vItemID'";
                            } else {
                                $vsql = "insert into sl_lv0014(lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv011,lv012,lv014,lv016) select '$vContractID','$vItemID',1,A.lv004,IF($vPrice=0,A.lv007,$vPrice),A.lv008,0,'$vPercent','$vPoint',concat(CurDate(),' ',CurTime()),'$vItemIDPref' from sl_lv0007 A where lv001='$vItemID'";
                            }
                            break;
    ...
    if (isset($_GET['ajaxcustomertext'])) {
        ...
        if ($vcusid != '' && $vcusid != null) {
            switch ($voption) {
                case 2:
                    $vsql = "update sl_lv0001 set lv002='$vText' where lv001='$vcusid'";
                    break;
                case 6:
...
if ($lvsl_lv0013->GetAdd() > 0) {
    ...
    if (isset($_GET['ajax'])) {
        ...
        if ($donhangid != '' && $donhangid != null) {
            ...
            if ($vprogid != '' && $vprogid != null) {
                $vsql = "select A.*,B.lv001 CusID from sl_lv0014 A left join sl_lv0001 B on concat(A.lv008,'')=B.lv001 where A.lv002='$donhangid' and A.lv100=0";
                $vresult = db_query($vsql);
                ...
                $vsql = "select A.*,B.lv001 CusID from sl_lv0014 A left join sl_lv0001 B on concat(A.lv008,'')=B.lv001 where A.lv002='$donhangid'";
                $vresult = db_query($vsql);
                while ($vrow = db_fetch_array($vresult)) {
                    $vchitietid = $vrow['lv001'];
                    if ($vrow['CusID'] != '' && $vrow['CusID'] != null && trim($vrow['CusID']) != '0') {
    ...
    if (isset($_GET['ajaxgopban'])) {
        ...
        if ((int) $_GET['delbang'] == 0) {
            ...
            if ($vrow) {
                ...
                $vsql =
                    "insert into sl_lv0014 ( lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv022,lv023,lv102) 
				select MP.* from (select '" .
                    $_GET['donhangid'] .
                    "',lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv022,lv023,'$vMaDonHang' from sl_lv0014 where lv002='" .
                    $vMaDonHang .
                    "') MP";
                $vresult = db_query($vsql);
    ...
    if (isset($_GET['ajaxquantity'])) {
        ...
        if ($vdata[4] == 0) {
            if ($optqty == 2) {
                $vsql = "update sl_lv0014 set lv010='" . $_GET['qty'] . "' where lv001='" . $_GET['chitietid'] . "' and (select A.lv011 from sl_lv0013 A where A.lv001=sl_lv0014.lv002)<=0";
            } elseif ($_GET['optdel'] != 1) {
                $vsql = "update sl_lv0014 set lv103=lv004,lv004='" . $_GET['qty'] . "' where lv001='" . $_GET['chitietid'] . "' and (select A.lv011 from sl_lv0013 A where A.lv001=sl_lv0014.lv002)<=0";
            }
            $vresult = db_query($vsql);
    ...
    if (isset($_GET['ajaxprice'])) {
        ...
        $vdata = $lvsl_lv0013->LV_GetBH_Invoice($_GET['chitietid']);
        if ($_GET['qty'] <= 0 && $_GET['optdel'] == 1) {
            $lvsl_lv0104->LV_Delete($_GET['chitietid']);
        }
        echo $_GET['bangid'];
        //echo $vdata[1];
        echo '[ENDCHECKDONHANG]';
    ...
    if ($lvsl_lv0013->lv005 == '') {
        $lvsl_lv0013->lv005 = LV_DATE_ADD($vNow, 30);
    }
    if ($flagCtrl == 1) {
        ...
        if ($lvsl_lv0013->LV_ExistTemp($lvsl_lv0013->lv023) > 0) {
            ...
            } elseif ((int) $isExists >= 1 && (int) $lvsl_lv0014->lv007 == 0) {
...
<head>
    ...
    <script>
        ...
        function notSpecialChar(evt) {
            ...
            if (charCode == 79 || charCode == 83 || charCode == 8 || charCode == 46 || charCode == 9 || charCode == 39 ||
                charCode == 13 || charCode == 37) return true;
            return false;
        ...
        function RunFunction() {
            var str =
                "<br><iframe id='lvframefrm' height=900 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir; ?>sl_lv0032/sl_lv0032.php?&<?php echo getsaveget($plang, $popt, $pitem, $plink, $pgroup, 0, 0, 0, 0); ?>\" class=lvframe></iframe>";
        ...
        function LoadItem() {
            var o = document.frmadd;
            ajax_do('sl_lv0101/sl_lv0101exce.php?&lang=<?php echo $plang; ?>&childfunc=load' + '&lv002=' + o.txtlv903.value,
                1);
        ...
        function LoadSource() {
            ...
            switch (vo) {
                ...
                case 'RECONTRACT':
                    break;
                case 'PO':
                    ajax_do('sl_lv0101/sl_lv0101excesource.php?&lang=<?php echo $plang; ?>&childfunc=load' + '&lv002=' + o
                        .txtlv802.value + '&lv005=' + o.txtlv805.value + '&lv006=' + o.txtlv806.value, 1);
        ...
        function LoadHD(vobj, vreturn) {
            var vcondi = "&contractid=" + document.frmadd.txtlv801.value + "&startdate=" + document.frmadd.txtlv804.value +
                "&enddate=" + document.frmadd.txtlv805.value + "&parentid=" + document.frmadd.txtlv817.value;
            LoadTextParentCond(vobj, vreturn, 'sl_lv0016', 'lv003', document.frmadd.txtlv802.value, 1,
                '<?php echo $plang; ?>', vcondi);
        }
        ...
        function CalculateM() {
            ...
            o.txtlvallamount.value = -parseFloat(o.txtlv911amount.value) + parseFloat(o.txtlv908amount.value) + parseFloat(o
                .txtlv904.value * o.txtlv906.value);
            if (parseFloat(o.txtlvnumber.value) != 0) o.txtlv912.value = parseFloat(o.txtlv904.value) * parseFloat(o
                .txtlvscore.value) / parseFloat(o.txtlvnumber.value);
        }
        ...
        function ReportCook(vValue) {
            var o = document.frmprocess;
            o.target = "_blank";
            o.action = "<?php echo $vDir; ?>sl_lv0013?func=<?php echo $_GET['func']; ?>&childfunc=rptwork&ID=" + vValue +
                "&lang=<?php echo $plang; ?>";
            o.submit();
        }
        ...
        function Report(vValue) {
            ...
            o1.target = "_blank";
            o1.action = "<?php echo $vDir; ?>sl_lv0013?func=<?php echo $_GET['func']; ?>&childfunc=rptretailall&ID=" + vValue +
                "&lang=<?php echo $plang; ?>";
            o1.submit();
        }
        ...
        function UpdateCustomer(o, vorder, option) {
            ...
            if (cusid == "") {
                alert("Xin vui lòng số điện thoại");
                return false;
            }
            ...
            url = url + "?&ajaxcustomertext=ajaxcheck" + "&donhangid=" + donhangid + "&cusid=" + cusid + "&textup=" + o
                .value + "&optrun=" + option;
            url = url.replace("#", "");
...
<div class="hd_cafe">
    <ul class="qlycafe">
        ...
        ?>
        <li>
            <div onclick="CombackHome()" style="cursor:pointer;background:#eaeaea;padding:7px;">
                &nbsp;&nbsp;&nbsp;&nbsp;<img src="images/controlright/move_f2.png" height="25" alt="Cancel"
                    name="cancel" title="Quay lại trang chủ" border="0" align="middle"
                    id="cancel">&nbsp;&nbsp;&nbsp;&nbsp;
        </li>
    </ul>
</div>
...
<body onkeyup="KeyPublicRun(event)">
    ...
    <div class="hd_cafe">
        <ul class="qlycafe">
            ...
            <li>
                <div id="cafetab_2" class="licafe"
                    onclick="enablecokhach(13);setviewhere(2);curtab(2);viewfloorallscreen()"><?php echo $vLangArr[67]; ?></div>
            </li>
            <li>
                <div id="cafetab_3" class="licafe" onclick="setviewhere(2);setbancokhach(1);curtab(3);">
                    <?php echo $vLangArr[68]; ?></div>
            </li>
            <li>
                <div id="cafetab_4" class="licafe" onclick="setviewhere(2);setbancokhach(2);curtab(4);">
                    <?php echo $vLangArr[69]; ?></div>
            </li>
            <li>
                <div id="cafetab_5" class="licafe" onclick="setviewhere(2);setbancokhach(3);curtab(5);">
                    <?php echo $vLangArr[86]; ?></div>
            </li>
    ...
    <div id="viewhere_3" style="display:none;">
        ...
        <div id="sanphamthuongchon" style="position:absolute;display:none;z-index:9999;width:100%;background:#fff;">
            <div style="float:left">
                <ul class="ulfix" style="padding:0px;margin:0px;">
                    <?php
								...
								{
									$vsql1="select * from sl_lv0007 where lv015=0 order by lv020 desc ";
									$vresult1=db_query($vsql1);
									$vWidth=$lvsl_lv0070->lv006;
									while($vrow1=db_fetch_array($vresult1))
									{
									?>
                    <li style="float:left" title="<?php echo $vrow1['lv001']; ?>">
                        <div style="position:relative;" onclick="AddProd('<?php echo $vrow1['lv001']; ?>')" class="buttonClass">
                            <?php
										
										if($lvsl_lv0070->lv010==1 && $vrow1['lv014']!="")
										{
										?>
                            <img style="width:<?php echo $vWidth; ?>px;position:absolute;top:0px;left:0px"
                                src="<?php echo $vrow1['lv014']; ?>" />
                            <?php
										}?>
                            <span style="margin-left:<?php echo $vWidth; ?>px;"><?php echo $vrow1['lv002']; ?></span>
                        </div>
                    </li>
                    <?php
									}
            ...
            <div style="position:absolute;top:0px;right:0px;"><img
                    onclick="document.getElementById('sanphamthuongchon').style.display='none'" width="60"
                    src="images/icon/closefull.png" /></div>
        </div>
        <div class="sanpham_bg" style="float:left;width:95%;cursor:pointer;">
            <div style="float:left;width:30%;z-index:999999">
                <ul id="pop-nav" lang="pop-nav" onMouseOver="ChangeName(this,0)" onkeyup="ChangeName(this,0)"
                    style="z-index:999999!important;">
                    <li class="menupopT">
                        <input aria-autocomplete="both" aria-haspopup="false" autocapitalize="off" autocomplete="off"
                            autocorrect="off" role="combobox" spellcheck="false" title="barcode hoặc mã sản phẩm"
                            name="txtlv903" id="txtlv903" tabindex="200"
                            style="width:90%;height:25px;text-align:center;"
                            onkeypress="LoadPopupParent(this,'txtlv903','sl_lv0007','concat(lv002,@! @!,lv001)');return CheckKeys(event,1,this);"
                            onFocus="if(document.frmadd.txtlv903.value=='') document.frmadd.txtlv903.select()"
                            onblur="//LoadItem();//changecategory_change(this.value)"
                            onKeyUp="LoadPopupParent(this,'txtlv903','sl_lv0007','concat(lv002,@! @!,lv001)')"
                            value="" />
            ...
            <div style="float:right;width:30%;paddinng-right:10px;"
                onclick="document.getElementById('sanphamthuongchon').style.display='block'">
                <div class="sanpham_bg_bnt">
    ...
    <div id="viewhere_1" style="display:none;">
        <div>
            <form name="frmadd" id="frmadd" id="frmadd" method="POST"
                action="?func=<?php echo $_GET['func']; ?>&ID=<?php echo $_GET['ID']; ?>&<?php echo getsaveget($plang, $popt, $pitem, $plink, $pgroup, 0, 0, 0, 0); ?>" autocomplete="off"
                ...
                <!---------SP------------------------->
                <div class="khungsp" id="khungsp"
                    style="position:absolute;display:none;z-index:9999;width:100%;background:#fff;top:80px;padding-bottom:10px;">
                    ...
                    <div style="display:block;position:absolute;right:0px;top:0px;z-index:99999">
                        <div id="morelistid" style="display:none" class="morelistid">
                            ...
                            <div><?php echo $vLangArr[38]; ?><div id="programid"><select name="txtlv909" id="txtlv909"
                                        tabindex="111" style="width:80%" onkeypress="return CheckKey(event,1)"
                                        onfocus="this.title='1';" />
                                    <?php echo $lvsl_lv0014->LV_LinkFieldExt('lv099', $lvsl_lv0014->lv009); ?>
                                    </select></div>
                                <div style="float:right"><img
                                        onclick="document.getElementById('morelistid').style.display='none';document.getElementById('morelistidmin').style.display='block'"
                                        width="60" src="images/icon/closefull.png" /></div>
                            </div>

                        </div>
                        <div id="morelistidmin" class="morelistidmin">
                            <div style="float:right;padding-top:65px;"><img
                                    onclick="document.getElementById('morelistid').style.display='block';document.getElementById('morelistidmin').style.display='none'"
                                    width="20" src="images/icon/mui_ten.png" /></div>
                        </div>
                    </div>
                    <div style="clear:both;width:100%;overflow:hidden;">
                        <div style="float:right;width:100%;overflow: auto;position:relative;" class="thanhprocess"
                            id="thanhprocess">
                            <div style="position:absolute;top:0px;right:0px;z-index:99999999"><img
                                    onclick="AnNhomSanPham()" width="60" src="images/icon/closefull.png" /></div>
                            <?php 
							...
							while($vrowparent=db_fetch_array($vresultparent))
							{
								...
								while($vrow=db_fetch_array($vresult))
								{
									...
									<div>
										<ul class="ulfix" style="padding:0px;margin:0px;">';
								$vsql1="select * from sl_lv0007 where lv003='".$vrow['lv001']."' and lv015<=1 order by lv001,lv002 asc ";
								$vresult1=db_query($vsql1);
								$vWidth=$lvsl_lv0070->lv006;
								while($vrow1=db_fetch_array($vresult1))
								{
                            ...
                            $vStrAllDetail=$vStrAllDetail.'<span
                                style="margin-left:'.$vWidth.'px;">'.$vrow1['lv002'].'</span>
                        </div>
                        </li>';
                        }
    ...
    echo '<div class="thanhnhom" style="float:left;width:105px;overflow: auto;" id="thanhnhom"><input type="hidden"
            id="txttongthanh" value="'.$i.'" />'.$strthanh.'</div>';
    echo $vStrAllDetail;
    ?>
    ...
    <!--////////////////////////////////////Code add here///////////////////////////////////////////--> </td>
    <div style="display:none;position:absolute;left:240px;bottom:0px;z-index:999999999999;" id="roomid"><select
            name="txtlv807tmp" id="txtlv807tmp" tabindex="2" style="width:100%"
            onKeyPress="return CheckKeys(event,7,this)" onchange="DoiBang(this)" />
    ...
    <iframe width=174 height=189 name="gToday:normal:agenda.js" id="gToday:normal:agenda.js"
        src="<?php echo $vDir; ?>../javascript/ipopeng.php?lang=<?php echo $_GET['lang']; ?>" scrolling="no" frameborder="0"
...
<script language="javascript">
    ...
    function setgopbang(o, bang, alarm) {
        ...
        var url = document.location;
        url = url + "?&ajaxgopban=ajaxcheck" + "&bangid=" + bang + "&donhangid=" + donhang + "&delbang=" + ((o
            .checked) ? '0' : '1');
        url = url.replace("#", "");
    ...
    function AddItemNew(vOrder, hdid, bangid, vo, vprogid) {
        ...
        if (o4.value != "") {
            ...
            url = url + "?&ajaxitemsend=ajaxcheck" + "&Order=" + vOrder + "&ContractID=" + hdid + "&BangID=" + bangid +
                "&ItemID=" + ArItem[1] + "&progid=" + vprogid + "&CusID=" + o5.value + "&AddState=" + o8.value +
                "&trahang=" + vth;
        } else
            url = url + "?&ajaxitemsend=ajaxcheck" + "&Order=" + vOrder + "&ContractID=" + hdid + "&BangID=" + bangid +
            "&ItemID=" + ArItem[1] + "&progid=" + vprogid + "&AddState=" + o8.value + "&trahang=" + vth;
        url = url.replace("#", "");
    ...
    function stateAddItemNew() {
        if (xmlhttp93.readyState == 4) {
            ...
            if (bang.className.indexOf('active') > 0) {} else {
                ...
                if (tratienid != null) {
                    ...
                    tratienid.setAttribute("onClick", "tratien('" + domainid + "','" + o3.value +
                        "',2);closepopcalendar(" + o3.value + ")");
                ...
                if (xuongbepbarid != null) {
                    var o2 = document.getElementById("txtbangid");
                    var o3 = document.getElementById("txtorderid");
                    xuongbepbarid.setAttribute("onClick", "tratien('" + domainid + "','" + o3.value +
                        "',15);closepopcalendar(" + o3.value + ")");
                }
            }
    ...
    function changeqtytratruoc(o, chitietid, bangid) {
        ...
        var url = document.location;
        url = url + "?&ajaxquantity=ajaxcheck" + "&qty=" + value + "&chitietid=" + chitietid + "&optqty=2&bangid=" +
            bangid;
        url = url.replace("#", "");
    ...
    function changeqty(o, chitietid, bangid) {
        ...
        <?php
			...
			?>
        url = url + "?&ajaxquantity=ajaxcheck" + "&qty=" + o.value + "&chitietid=" + chitietid + "&optqty=1&bangid=" +
            bangid;
        url = url.replace("#", "");
        xmlhttp3.onreadystatechange = statechitietdh;
        xmlhttp3.open("GET", url, true);
    ...
    function delline(o, chitietid, bangid) {
        ...
        var url = document.location;
        url = url + "?&ajaxquantity=ajaxcheck" + "&qty=" + 0 + "&chitietid=" + chitietid + "&optqty=1&bangid=" +
            bangid + '&optdel=1';
        url = url.replace("#", "");
        xmlhttp3.onreadystatechange = statechitietdh;
        xmlhttp3.open("GET", url, true);
    ...
    function UpdateTextQty(o, donhangid, bangid, option) {
        ...
        var url = document.location;
        url = url + "?&ajaxbangtextqty=ajaxcheck" + "&donhangid=" + donhangid + "&bangid=" + bangid + "&textup=" + o
            .value + "&optrun=" + option;
        url = url.replace("#", "");
    ...
    function UpdateText(o, donhangid, bangid, option) {
        ...
        var url = document.location;
        url = url + "?&ajaxbangtext=ajaxcheck" + "&donhangid=" + donhangid + "&bangid=" + bangid + "&textup=" + o
            .value + "&optrun=" + option;
        url = url.replace("#", "");
    ...
    function CheckVAT(o, donhangid, bangid) {
        ...
        var url = document.location;
        url = url + "?&ajaxbangvat=ajaxcheck" + "&donhangid=" + donhangid + "&bangid=" + bangid + "&taxonline=" +
            taxonline;
        url = url.replace("#", "");
    ...
    function tiencoc(donhangid, bangid, opt) {
        var str =
            "<br><iframe id='lvframefrm' height=300 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir; ?>sl_lv0058_/sl_lv0058.php?&<?php echo getsaveget($plang, $popt, $pitem, $plink, $pgroup, 0, 0, 0, 0); ?>&ChildID=" +
            donhangid + "\" class=lvframe></iframe>";
    ...
    function tratiencoc(donhangid, bangid, opt) {
        var str =
            "<br><iframe id='lvframefrm' height=300 marginheight=0 marginwidth=0 frameborder=0 src=\"<?php echo $vDir; ?>sl_lv0057_/sl_lv0057.php?&<?php echo getsaveget($plang, $popt, $pitem, $plink, $pgroup, 0, 0, 0, 0); ?>&ChildID=" +
            donhangid + "\" class=lvframe></iframe>";
        div = document.getElementById('lvloaddata_' + donhangid);
        div.innerHTML = str;
    }
    ...
    function loaddatachitietbang(vContractID, vBangID, sum) {
        ...
        url = url.replace("#", "");
        xmlhttp655.onreadystatechange = function() {
            stateactivebangchitiet(vBangID, xmlhttp655);
        };
        xmlhttp655.open("GET", url, true);
        xmlhttp655.send(null);
    }
    ...
    function changeprice(o, chitietid, bangid) {
        ...
        var url = document.location;
        url = url + "?&ajaxprice=ajaxcheck" + "&price=" + o.value + "&chitietid=" + chitietid + "&optprice=1&bangid=" +
            bangid;
        url = url.replace("#", "");
    ...
    function changenotenhanvien(o, chitietid, bangid) {
        ...
        url = url + "?&ajaxprice=ajaxcheck" + "&price=" + o.value + "&chitietid=" + chitietid + "&optprice=4&bangid=" +
            bangid;
        url = url.replace("#", "");
    ...
    function changeorder(o, chitietid, bangid) {
        ...
        if (o.value == "" && cus.value != "Mã KH")
            url = url + "?&ajaxprice=ajaxcheck" + "&price=" + cus.value + "&chitietid=" + chitietid +
            "&optprice=15&bangid=" + bangid;
        else
            url = url + "?&ajaxprice=ajaxcheck" + "&price=" + o.value + "&chitietid=" + chitietid +
            "&optprice=15&bangid=" + bangid;
        url = url.replace("#", "");
    ...
    function changediscount(o, chitietid, bangid) {
        ...
        var url = document.location;
        url = url + "?&ajaxprice=ajaxcheck" + "&price=" + o.value + "&chitietid=" + chitietid + "&optprice=3&bangid=" +
            bangid;
        url = url.replace("#", "");
        xmlhttp6.onreadystatechange = statepricedh;
        xmlhttp6.open("GET", url, true);
    ...
    function statetratien() {
        if (xmlhttp2.readyState == 4) {
            ...
            if (o.className.indexOf('active') > 0 || state == '2' || state == '7' || state == '15') {
                ...
                to.innerHTML = to.innerHTML.replace('viewpopcalendar(', 'tratiendonphong(\'' + donhang + '\',\'' +
                    domainid + '\',3,');
                if (state == '5') {
                    //
                } else if (state == '15') {
