...
require_once("../paras.php");
require_once("../../clsall/sl_menulv0059.php");
...
//init object
$mosl_menulv0059=new sl_menulv0059();
//Set variant
$mosl_menulv0059->itemlst=$pitemlst;
$mosl_menulv0059->childlst=$pchildlst;
$mosl_menulv0059->level3lst=$plevel3lst;
$mosl_menulv0059->child3lst=$pchild3lst;
...
<table width="100%" border="0">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($mosl_menulv0059->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>	
					</select>
	...
	<?php
	$mosl_menulv0059->Dir="../";
include($mosl_menulv0059->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $mosl_menulv0059->level3lst;?>";
