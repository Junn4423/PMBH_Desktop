<?php
/////////////coding wh_lv0031///////////////
class   wh_lv0039 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"1","lv005"=>"0","lv006"=>"1","lv007"=>"0","lv008"=>"10","lv009"=>"0","lv010"=>"10","lv011"=>"0","lv012"=>"10","lv013"=>"10","lv014"=>"0","lv015"=>"0","lv016"=>"2","lv017"=>"0","lv018"=>"0","lv019"=>"1","lv020"=>"1");	
	...
	function LV_Insert_FI_LI_FO($state,$vwhid)
	{
		if($state=="FIFO")
			$this->LV_Insert_LotConfirm($this->lv003,$vwhid,'asc');
		else
			$this->LV_Insert_LotConfirm($this->lv003,$vwhid,'desc');
	...
	function LV_Insert_LotConfirm($lvitem,$lvwhid,$lvsort)
	{
