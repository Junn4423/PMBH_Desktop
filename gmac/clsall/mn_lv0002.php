...
////////////
	...
	function LV_Insert()
	{
		...
		if($this->isAdd==0) return false;
		 $lvsql="insert into sl_lv0007 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015')";
	...
	function LV_Update()
	{
		if($this->isEdit==0) return false;
		  $lvsql="Update sl_lv0007 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008',lv009='$this->lv009',lv010='$this->lv010',lv011='$this->lv011',lv012='$this->lv012',lv013='$this->lv013',lv014='$this->lv014',lv015='$this->lv015'  where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM sl_lv0007  WHERE sl_lv0007.lv001 IN ($lvarr)";// and (select count(*) from sl_lv0007 B where  B.lv002= sl_lv0007.lv001)<=0  ";
		$vReturn= db_query($lvsql);
