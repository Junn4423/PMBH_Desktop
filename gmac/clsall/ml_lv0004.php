<?php
/////////////coding ml_lv0001///////////////
class   ml_lv0004 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function LV_InsertAuto()
	{
		...
		$lvsql="insert into ml_lv0001 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019) values('$vlv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv001','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv001','$this->lv016','$this->lv017','$this->lv018','$this->lv019')";
		$vReturn= db_query($lvsql);
		if($vReturn){
			$lvsql="insert into ml_lv0001_ (lv001,lv009,lv015) values('$vlv001','$this->lv009','$this->lv015')";
			$vReturn= db_query($lvsql);
			$this->InsertLogOperation($this->DateCurrent,'ml_lv0001.insert',sof_escape_string($lvsql));
		}
		return $vReturn;
	...
	{
		$strCondi="and lv006 in (".$this->GetBuilStringExc($_SESSION['ERPSOFV2RUserID'],'lv003').")";
	...
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$sqlS = "SELECT lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv016 FROM ml_lv0001 WHERE 1=1  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
	...
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."ml_lv0004/?lang=".$this->lang."&func='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$sqlS = "SELECT lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv016 FROM ml_lv0001 WHERE 1=1  ".$this->GetCondition()." $strSort DESC LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
