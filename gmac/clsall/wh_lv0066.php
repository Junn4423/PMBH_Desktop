<?php
/////////////coding wh_lv0066///////////////
class   wh_lv0066 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		function Export(vFrom,value)
		{
			...
			window.open('".$this->Dir."wh_lv0066/?lang=".$this->lang."&childdetailfunc='+value+'&datefrom='+datefrom+'&dateto='+dateto,'','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
