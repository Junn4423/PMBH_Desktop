...
//////////////////////////////////////////Purchase Order////////////////////////////////////////////////////////////////////
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv005':
				$vsql="select A.lv002 lv001,concat(B.lv004,' ',B.lv003,' ',B.lv002) lv002,IF(A.lv002='$vSelectID',1,0) lv003 from  sl_lv0037 A left join hr_lv0020 B on A.lv002=B.lv001";
				break;
		}
		return $vsql;
	}
