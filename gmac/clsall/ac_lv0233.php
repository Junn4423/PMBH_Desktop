...
//////////////////////Buil list////////////////////
	...
	public function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv199';
				$vsql="
			  	 select distinct A.lv008 lv001,B.lv002 lv002,IF(A.lv008='$vSelectID',1,0) lv003 from ac_lv0004 A  inner join hr_lv0020 B on A.lv008=B.lv001 where A.lv009>='".$this->datefrom."' and A.lv009<='".$this->dateto."' and  A.lv002=1";
			   break;	
		}
		return $vsql;
	}
