<?php
/////////////coding sl_lv0052///////////////
class   sl_lv0052 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"1","lv005"=>"0","lv006"=>"1","lv007"=>"0","lv008"=>"10","lv009"=>"0","lv010"=>"10","lv011"=>"10","lv012"=>"0","lv013"=>"0","lv014"=>"0","lv015"=>"0","lv016"=>"2","lv017"=>"10");	
	...
	{
		$lvsql="select '$vTemID' lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020 from wh_lv0031 where lv002='$vlv002'";
		$vReturn= db_query($lvsql);
	...
	{
		$sqlD = "SELECT A.*,B.lv002 lvb002 FROM sl_lv0052 A inner join wh_lv0010 B on A.lv002=B.lv001 WHERE B.lv007<=0;";
		$vresult=db_query($sqlD);
		$strReturn=false;
		while($vrow=db_fetch_array($vresult))
		{
			...
			if(db_query($vsql))
			{
				$tsql="delete from sl_lv0052 where lv001='".$vrow['lv001']."'";
				if(db_query($tsql))
				{
					if($this->obj_wb_lv0006!=null)
				 	{
	...
	protected function GetCondition()
	{
		...
		if($this->lv002=="")
		{
			...
			$strCondi=$strCondi." and lv002 in (select B.lv001 from wh_lv0010 B where B.lv002 in ($strwh))";
		}
		return $strCondi;
	}
	////////////////Count///////////////////////////
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."sl_lv0052/?lang=".$this->lang."&childdetailfunc='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	...
	private function sqlconditionext($vFile,$vSelectID)
	{
		...
		{
			case 'lv003':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007 where 1=1 and lv015>=0 and lv016 ='$vSelectID' order by lv001 asc";
				break;
			case 'lv005':
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			case 'lv003':
				$strwh=$this->Get_WHControler();
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007 where 1=1 and lv015>=0 and (lv016 in ($strwh))";
				break;
			case 'lv005':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0005";
				break;
			...
			case 'lv013':
				...
				break;
			case 'lv014':
				$vsql="select A.lv001,A.lv001 lv002,0 lv003,A.lv008 lv004,(select sum(B.lv004) from wh_lv0031 B where B.lv002='".getInfor($_SESSION['ERPSOFV2RUserID'],2)."' and B.lv003=A.lv002 and B.lv014=A.lv001 ) QuantityUsed from  wh_lv0020 A where A.lv002='$vSelectID' order by lv004";
				...
				while($row= db_fetch_array($lvResult)){
					...
					{
						if($vsql=="")
							$vsql=$vsql."select '".$row['lv001']."' lv001,'Slt: ".$this->FormatView($slt,10)." - VS-C: ".($row['lv004'])."' lv002,0 lv003";
						else
							$vsql=$vsql." UNION select '".$row['lv001']."' lv001,'Slt: ".$this->FormatView($slt,10)." - VS-C: ".($row['lv004'])."' lv002,0 lv003";
					}	
				}
				break;
			case 'lv017':
