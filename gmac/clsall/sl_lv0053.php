<?php
/////////////coding sl_lv0014///////////////
class   sl_lv0053 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
///////////
	public $DefaultFieldList="lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020";	
////////////////////GetDate
...
////////////
	...
	var $ArrPush=array();
	var $ArrFunc=array();
	var $ArrGet=array("lv001"=>"2","lv002"=>"3","lv003"=>"4","lv004"=>"5","lv005"=>"6","lv006"=>"7","lv007"=>"8","lv008"=>"9","lv009"=>"10","lv010"=>"11","lv011"=>"12","lv012"=>"13","lv013"=>"14","lv014"=>"15","lv015"=>"16","lv016"=>"17","lv017"=>"18","lv018"=>"19","lv019"=>"20","lv020"=>"21");
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"10","lv005"=>"0","lv006"=>"10","lv007"=>"0","lv008"=>"10","lv009"=>"0","lv010"=>"0","lv011"=>"0","lv012"=>"0","lv013"=>"2","lv014"=>"2","lv015"=>"0","lv016"=>"10","lv017"=>"10","lv018"=>"10","lv019"=>"10","lv020"=>"10");	
	...
	function LV_Insert()
	{
		...
		$this->lv014 = ($this->lv014!="")?recoverdate(($this->lv014), $this->lang):$this->DateDefault;
		 $lvsql="insert into sl_lv0014 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015')";
		$vReturn= db_query($lvsql);
		...
		function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update sl_lv0014 set lv015=1,lv014=concat(CURDATE(),' ',CURTIME())  WHERE sl_lv0014.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
	...
	{
		if($this->isApr==0) return false;
		$lvsql = "Update sl_lv0014 set lv015=0,lv014=concat(CURDATE(),' ',CURTIME())  WHERE sl_lv0014.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
	...
	{
		$lvsql="select '$vTemID' lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015 from sl_lv0032 where lv002='$vlv002'";
		$vReturn= db_query($lvsql);
	...
	function LV_Update()
	{
		...
		$this->lv013 = ($this->lv013!="")?recoverdate(($this->lv013), $this->lang):$this->DateDefault;
		$this->lv014 = ($this->lv014!="")?recoverdate(($this->lv014), $this->lang):$this->DateDefault;
		  $lvsql="Update sl_lv0014 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008',lv009='$this->lv009',lv010='$this->lv010',lv011='$this->lv011',lv012='$this->lv012',lv013='$this->lv013',lv014='$this->lv014' where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM sl_lv0014  WHERE sl_lv0014.lv001 IN ($lvarr) and (select lv011 from sl_lv0013 B where  B.lv001= sl_lv0014.lv002)<=0  ";
		$vReturn= db_query($lvsql);
	...
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			for($i=0;$i<count($lstArr);$i++)
			{
				...
				{
					case 'lv016':
						$vTemp=str_replace("@02",str_replace("@02",$this->getvaluelink($lstArr[$i],$this->FormatView($this->LV_GETNHAP_TP('CONTRACT',$vrow['lv002'],$vrow['lv003'],$vrow['lv010'],$vrow['lv009'],$vrow['lv012']),(int)$this->ArrView[$lstArr[$i]])),str_replace("@01",$vrow['lv001'] ,$lvHref)),$this->Align($lvTd,(int)$this->ArrView[$lstArr[$i]]));
						break;
					case 'lv017':
						$vTemp=str_replace("@02",str_replace("@02",$this->getvaluelink($lstArr[$i],$this->FormatView($this->LV_GETNHAP_TP('RECONTRACT',$vrow['lv002'],$vrow['lv003'],$vrow['lv010'],$vrow['lv009'],$vrow['lv012']),(int)$this->ArrView[$lstArr[$i]])),str_replace("@01",$vrow['lv001'] ,$lvHref)),$this->Align($lvTd,(int)$this->ArrView[$lstArr[$i]]));
						break;
					case 'lv018':
						$vTemp=str_replace("@02",str_replace("@02",$this->getvaluelink($lstArr[$i],$this->FormatView($this->LV_GETXUAT_TP('CONTRACT',$vrow['lv002'],$vrow['lv003'],$vrow['lv010'],$vrow['lv009'],$vrow['lv012']),(int)$this->ArrView[$lstArr[$i]])),str_replace("@01",$vrow['lv001'] ,$lvHref)),$this->Align($lvTd,(int)$this->ArrView[$lstArr[$i]]));
						break;
					case 'lv019':
						$vTemp=str_replace("@02",str_replace("@02",$this->getvaluelink($lstArr[$i],$this->FormatView($this->LV_GETXUAT_TP('RECONTRACT',$vrow['lv002'],$vrow['lv003'],$vrow['lv010'],$vrow['lv009'],$vrow['lv012']),(int)$this->ArrView[$lstArr[$i]])),str_replace("@01",$vrow['lv001'] ,$lvHref)),$this->Align($lvTd,(int)$this->ArrView[$lstArr[$i]]));
						break;
					case 'lv020':
						$vTemp=str_replace("@02",str_replace("@02",$this->getvaluelink($lstArr[$i],$this->FormatView($vrow['lv004']*$vrow['lv006'],(int)$this->ArrView[$lstArr[$i]])),str_replace("@01",$vrow['lv001'] ,$lvHref)),$this->Align($lvTd,(int)$this->ArrView[$lstArr[$i]]));
						break;
					default:
...
//////////////////////Buil list////////////////////
	...
	//////////////////////Buil list////////////////////
	function LV_BuilListReportOther($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$vTax,$optsum=0)
	{
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			for($i=0;$i<count($lstArr);$i++)
			{
				if($lstArr[$i]=="lv020")
				{
					...
					$vTemp=str_replace("@02",$this->getvaluelink($lstArr[$i],$this->FormatView($vrow[$lstArr[$i]],(int)$this->ArrView[$lstArr[$i]])).(($lstArr[$i]=='lv008')?'%':''),$this->Align($lvTd,(int)$this->ArrView[$lstArr[$i]]));
				$strL=$strL.$vTemp;
				if($lstArr[$i]=="lv003")
				{
					$vTemp=str_replace("@02",$this->FormatView($vrow[$lstArr[$i]],(int)$this->ArrView[$lstArr[$i]]),$lvTd);
			...
			$strTotalAmount=round($strSubTotal+$strSubTax);
