	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv016':
				...
				break;
			case 'lv199';
				$vsql="select distinct A.lv032 lv001,B.lv002 lv002,IF(A.lv032='$vSelectID',1,0) lv003 from  sl_lv0013 A inner join hr_lv0020 B on A.lv032=B.lv001 where A.lv004>='$this->datefrom 00:00:00' and A.lv004<='$this->dateto 23:59:59'";
				break;	
		}
		return $vsql;
	}
