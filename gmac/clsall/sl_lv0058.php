<?php
/////////////coding sl_lv0058///////////////
class   sl_lv0058 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function LV_Insert()
	{
		...
		if($vReturn) 
		{
			$lvsql="insert into ac_lv0005 (lv002,lv003,lv004,lv005,lv006,lv007) values('$this->lv001','$this->lv019','$this->lv019','1111','131','SL(B�n h�ng)')";
			$vReturn= db_query($lvsql);
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('sl_lv0058/?lang=".$this->lang."&func='+value,'','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
