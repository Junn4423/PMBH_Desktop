<?php
/////////////coding ml_lv0001///////////////
class   ml_lv0011 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	{
		$vsql="select (select count(*) from ml_lv0001 where lv002=1 and lv012=0 and lv011=1 and lv007 in (select ml_lv0008.lv003 from ml_lv0008 where ml_lv0008.lv002='$vlv003')) Inbox,(select count(*) from ml_lv0001 where lv002=2 and lv012=0  and lv011=1 and lv003='$vlv003') Outbox,(select count(*) from ml_lv0001 where lv002=1 and lv012=1  and lv011=1 and lv007 in (select ml_lv0008.lv003 from ml_lv0008 where ml_lv0008.lv002='$vlv003')) DeleteItem,(select count(*) from ml_lv0001 where lv002=2 and lv012=1 and lv011=1 and lv003='$vlv003') SendItem ";
...
function SaveFile($vPtich,$vFileName,$vTime,$NumTimes)
		...
		$endline="\n";
			...
			switch($vcodeconvert)
			{
				case 'quoted-printable':
					...
					break;
				case 'base64':
						$vContent=base64_decode($vContent);
					break;
			}
			$vAttachReturn["Content"]=$vContent;
	...
	function LV_Insert()
	{
		$lvsql="insert into ml_lv0001 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014')";
		$vReturn= db_query($lvsql);
	...
	function SendLocal($vAddMailTo,$vAddMailCC,$vType,$vNew,$vDelete)
	{
		$this->lv002=$vType;
		$this->lv011=$vNew;
		$this->lv012=$vDelete;
		$vAddMail=$vAddMailTo.",".$vAddMailCC;
	...
	{
		//$strCondi="and lv007 in (select C.lv003 from ml_lv0008 C where C.lv002='".$_SESSION['ERPSOFV2RUserID']."')";
	...
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."ml_lv0011/?lang=".$this->lang."&func='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
