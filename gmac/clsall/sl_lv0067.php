...
";
	...
	function Get_Arr_Employees()
	{
		...
		$lvsql="select distinct B.lv001 CodeID,B.lv002 Name from sl_lv0003 A inner join sl_lv0001 B on A.lv002=B.lv001 inner join hr_lv0020 DD on A.lv010=DD.lv001  where month(A.lv006)='$this->month' and year(A.lv006)='$this->year' $strCondi";
		$vresult=db_query($lvsql);	
		$i=0;
	...
	{		
		...
		if($this->lv029!="")  $strCondi=$strCondi." AND DD.lv029 in ('".str_replace(",","','",$this->lv029)."')";		
		if($this->lv001!="")  $strCondi=$strCondi." AND DD.lv001 in ('".str_replace(",","','",$this->lv001)."')";		
		$lvsql="select A.*,B.lv001 CodeID,B.lv002 Name from sl_lv0003 A inner join sl_lv0001 B on A.lv002=B.lv001  inner join hr_lv0020 DD on A.lv010=DD.lv001  where month(A.lv006)='$this->month' and year(A.lv006)='$this->year' $strCondi";
		$vorder=$curRow;
