...
//////////////////////Buil list////////////////////
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		{
			case 'lv002':
				$vsql="select lv001,lv004 lv002,IF(lv001='$vSelectID',1,0) lv003 from  lv_lv0007";
				break;
		}
		return $vsql;
	}
	private  function getvaluelink($vFile,$vSelectID)
	{
		...
		{
			case 'lv002':
				$vsql="select lv001,lv004 lv002,IF(lv001='$vSelectID',1,0) lv003 from  lv_lv0007 where lv001='$vSelectID'";
				break;
			default:
				$vsql ="";
				break;
