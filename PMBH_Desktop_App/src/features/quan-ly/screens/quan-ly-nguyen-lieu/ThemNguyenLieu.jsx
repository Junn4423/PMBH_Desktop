...
import {layAll_LoaiNVL, themNguyenLieu, loadKho} from '../../api/index';
import {kho, loaiNguyenLieu} from '../../types';

const ThemNguyenLieu = () => {
  ...
  const layDSLoaiNguyenLieu = async () => {
    try {
      setDangTai(true);
      const duLieuSanPham = await layAll_LoaiNVL<any[]>();
  ...
  return (
    <KeyboardAvoidingView style={styles.container}>
      ...
      <Appbar.Header>
        ...
        <Appbar.Content title="Thêm nguyên liệu mới" />
      </Appbar.Header>
